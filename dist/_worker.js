var ls=Object.defineProperty;var Gt=e=>{throw TypeError(e)};var cs=(e,t,a)=>t in e?ls(e,t,{enumerable:!0,configurable:!0,writable:!0,value:a}):e[t]=a;var g=(e,t,a)=>cs(e,typeof t!="symbol"?t+"":t,a),jt=(e,t,a)=>t.has(e)||Gt("Cannot "+a);var p=(e,t,a)=>(jt(e,t,"read from private field"),a?a.call(e):t.get(e)),y=(e,t,a)=>t.has(e)?Gt("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,a),b=(e,t,a,s)=>(jt(e,t,"write to private field"),s?s.call(e,a):t.set(e,a),a),k=(e,t,a)=>(jt(e,t,"access private method"),a);var Zt=(e,t,a,s)=>({set _(n){b(e,t,n,a)},get _(){return p(e,t,s)}});var Qt=(e,t,a)=>(s,n)=>{let i=-1;return r(0);async function r(d){if(d<=i)throw new Error("next() called multiple times");i=d;let o,l=!1,c;if(e[d]?(c=e[d][0][0],s.req.routeIndex=d):c=d===e.length&&n||void 0,c)try{o=await c(s,()=>r(d+1))}catch(u){if(u instanceof Error&&t)s.error=u,o=await t(u,s),l=!0;else throw u}else s.finalized===!1&&a&&(o=await a(s));return o&&(s.finalized===!1||l)&&(s.res=o),s}},us=Symbol(),ps=async(e,t=Object.create(null))=>{const{all:a=!1,dot:s=!1}=t,i=(e instanceof Ta?e.raw.headers:e.headers).get("Content-Type");return i!=null&&i.startsWith("multipart/form-data")||i!=null&&i.startsWith("application/x-www-form-urlencoded")?ms(e,{all:a,dot:s}):{}};async function ms(e,t){const a=await e.formData();return a?fs(a,t):{}}function fs(e,t){const a=Object.create(null);return e.forEach((s,n)=>{t.all||n.endsWith("[]")?hs(a,n,s):a[n]=s}),t.dot&&Object.entries(a).forEach(([s,n])=>{s.includes(".")&&(gs(a,s,n),delete a[s])}),a}var hs=(e,t,a)=>{e[t]!==void 0?Array.isArray(e[t])?e[t].push(a):e[t]=[e[t],a]:t.endsWith("[]")?e[t]=[a]:e[t]=a},gs=(e,t,a)=>{if(/(?:^|\.)__proto__\./.test(t))return;let s=e;const n=t.split(".");n.forEach((i,r)=>{r===n.length-1?s[i]=a:((!s[i]||typeof s[i]!="object"||Array.isArray(s[i])||s[i]instanceof File)&&(s[i]=Object.create(null)),s=s[i])})},ya=e=>{const t=e.split("/");return t[0]===""&&t.shift(),t},_s=e=>{const{groups:t,path:a}=bs(e),s=ya(a);return vs(s,t)},bs=e=>{const t=[];return e=e.replace(/\{[^}]+\}/g,(a,s)=>{const n=`@${s}`;return t.push([n,a]),n}),{groups:t,path:e}},vs=(e,t)=>{for(let a=t.length-1;a>=0;a--){const[s]=t[a];for(let n=e.length-1;n>=0;n--)if(e[n].includes(s)){e[n]=e[n].replace(s,t[a][1]);break}}return e},ft={},ys=(e,t)=>{if(e==="*")return"*";const a=e.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);if(a){const s=`${e}#${t}`;return ft[s]||(a[2]?ft[s]=t&&t[0]!==":"&&t[0]!=="*"?[s,a[1],new RegExp(`^${a[2]}(?=/${t})`)]:[e,a[1],new RegExp(`^${a[2]}$`)]:ft[s]=[e,a[1],!0]),ft[s]}return null},Pt=(e,t)=>{try{return t(e)}catch{return e.replace(/(?:%[0-9A-Fa-f]{2})+/g,a=>{try{return t(a)}catch{return a}})}},xa=e=>Pt(e,decodeURI),Ea=e=>{const t=e.url,a=t.indexOf("/",t.indexOf(":")+4);let s=a;for(;s<t.length;s++){const n=t.charCodeAt(s);if(n===37){const i=t.indexOf("?",s),r=t.indexOf("#",s),d=i===-1?r===-1?void 0:r:r===-1?i:Math.min(i,r),o=t.slice(a,d);return xa(o.includes("%25")?o.replace(/%25/g,"%2525"):o)}else if(n===63||n===35)break}return t.slice(a,s)},xs=e=>{const t=Ea(e);return t.length>1&&t.at(-1)==="/"?t.slice(0,-1):t},Be=(e,t,...a)=>(a.length&&(t=Be(t,...a)),`${(e==null?void 0:e[0])==="/"?"":"/"}${e}${t==="/"?"":`${(e==null?void 0:e.at(-1))==="/"?"":"/"}${(t==null?void 0:t[0])==="/"?t.slice(1):t}`}`),wa=e=>{if(e.charCodeAt(e.length-1)!==63||!e.includes(":"))return null;const t=e.split("/"),a=[];let s="";return t.forEach(n=>{if(n!==""&&!/\:/.test(n))s+="/"+n;else if(/\:/.test(n))if(/\?/.test(n)){a.length===0&&s===""?a.push("/"):a.push(s);const i=n.replace("?","");s+="/"+i,a.push(s)}else s+="/"+n}),a.filter((n,i,r)=>r.indexOf(n)===i)},Bt=e=>/[%+]/.test(e)?(e.indexOf("+")!==-1&&(e=e.replace(/\+/g," ")),e.indexOf("%")!==-1?Pt(e,Sa):e):e,ka=(e,t,a)=>{let s;if(!a&&t&&!/[%+]/.test(t)){let r=e.indexOf("?",8);if(r===-1)return;for(e.startsWith(t,r+1)||(r=e.indexOf(`&${t}`,r+1));r!==-1;){const d=e.charCodeAt(r+t.length+1);if(d===61){const o=r+t.length+2,l=e.indexOf("&",o);return Bt(e.slice(o,l===-1?void 0:l))}else if(d==38||isNaN(d))return"";r=e.indexOf(`&${t}`,r+1)}if(s=/[%+]/.test(e),!s)return}const n={};s??(s=/[%+]/.test(e));let i=e.indexOf("?",8);for(;i!==-1;){const r=e.indexOf("&",i+1);let d=e.indexOf("=",i);d>r&&r!==-1&&(d=-1);let o=e.slice(i+1,d===-1?r===-1?void 0:r:d);if(s&&(o=Bt(o)),i=r,o==="")continue;let l;d===-1?l="":(l=e.slice(d+1,r===-1?void 0:r),s&&(l=Bt(l))),a?(n[o]&&Array.isArray(n[o])||(n[o]=[]),n[o].push(l)):n[o]??(n[o]=l)}return t?n[t]:n},Es=ka,ws=(e,t)=>ka(e,t,!0),Sa=decodeURIComponent,ea=e=>Pt(e,Sa),Me,K,le,Aa,Da,Lt,ce,fa,Ta=(fa=class{constructor(e,t="/",a=[[]]){y(this,le);g(this,"raw");y(this,Me);y(this,K);g(this,"routeIndex",0);g(this,"path");g(this,"bodyCache",{});y(this,ce,e=>{const{bodyCache:t,raw:a}=this,s=t[e];if(s)return s;const n=Object.keys(t)[0];return n?t[n].then(i=>(n==="json"&&(i=JSON.stringify(i)),new Response(i)[e]())):t[e]=a[e]()});this.raw=e,this.path=t,b(this,K,a),b(this,Me,{})}param(e){return e?k(this,le,Aa).call(this,e):k(this,le,Da).call(this)}query(e){return Es(this.url,e)}queries(e){return ws(this.url,e)}header(e){if(e)return this.raw.headers.get(e)??void 0;const t={};return this.raw.headers.forEach((a,s)=>{t[s]=a}),t}async parseBody(e){return ps(this,e)}json(){return p(this,ce).call(this,"text").then(e=>JSON.parse(e))}text(){return p(this,ce).call(this,"text")}arrayBuffer(){return p(this,ce).call(this,"arrayBuffer")}blob(){return p(this,ce).call(this,"blob")}formData(){return p(this,ce).call(this,"formData")}addValidatedData(e,t){p(this,Me)[e]=t}valid(e){return p(this,Me)[e]}get url(){return this.raw.url}get method(){return this.raw.method}get[us](){return p(this,K)}get matchedRoutes(){return p(this,K)[0].map(([[,e]])=>e)}get routePath(){return p(this,K)[0].map(([[,e]])=>e)[this.routeIndex].path}},Me=new WeakMap,K=new WeakMap,le=new WeakSet,Aa=function(e){const t=p(this,K)[0][this.routeIndex][1][e],a=k(this,le,Lt).call(this,t);return a&&/\%/.test(a)?ea(a):a},Da=function(){const e={},t=Object.keys(p(this,K)[0][this.routeIndex][1]);for(const a of t){const s=k(this,le,Lt).call(this,p(this,K)[0][this.routeIndex][1][a]);s!==void 0&&(e[a]=/\%/.test(s)?ea(s):s)}return e},Lt=function(e){return p(this,K)[1]?p(this,K)[1][e]:e},ce=new WeakMap,fa),ks={Stringify:1},Ia=async(e,t,a,s,n)=>{typeof e=="object"&&!(e instanceof String)&&(e instanceof Promise||(e=e.toString()),e instanceof Promise&&(e=await e));const i=e.callbacks;return i!=null&&i.length?(n?n[0]+=e:n=[e],Promise.all(i.map(d=>d({phase:t,buffer:n,context:s}))).then(d=>Promise.all(d.filter(Boolean).map(o=>Ia(o,t,!1,s,n))).then(()=>n[0]))):Promise.resolve(e)},Ss="text/plain; charset=UTF-8",Ct=(e,t)=>({"Content-Type":e,...t}),Je=(e,t)=>new Response(e,t),at,st,ne,$e,ie,F,nt,Fe,Pe,Ee,it,rt,ue,Ce,ha,Ts=(ha=class{constructor(e,t){y(this,ue);y(this,at);y(this,st);g(this,"env",{});y(this,ne);g(this,"finalized",!1);g(this,"error");y(this,$e);y(this,ie);y(this,F);y(this,nt);y(this,Fe);y(this,Pe);y(this,Ee);y(this,it);y(this,rt);g(this,"render",(...e)=>(p(this,Fe)??b(this,Fe,t=>this.html(t)),p(this,Fe).call(this,...e)));g(this,"setLayout",e=>b(this,nt,e));g(this,"getLayout",()=>p(this,nt));g(this,"setRenderer",e=>{b(this,Fe,e)});g(this,"header",(e,t,a)=>{this.finalized&&b(this,F,Je(p(this,F).body,p(this,F)));const s=p(this,F)?p(this,F).headers:p(this,Ee)??b(this,Ee,new Headers);t===void 0?s.delete(e):a!=null&&a.append?s.append(e,t):s.set(e,t)});g(this,"status",e=>{b(this,$e,e)});g(this,"set",(e,t)=>{p(this,ne)??b(this,ne,new Map),p(this,ne).set(e,t)});g(this,"get",e=>p(this,ne)?p(this,ne).get(e):void 0);g(this,"newResponse",(...e)=>k(this,ue,Ce).call(this,...e));g(this,"body",(e,t,a)=>k(this,ue,Ce).call(this,e,t,a));g(this,"text",(e,t,a)=>!p(this,Ee)&&!p(this,$e)&&!t&&!a&&!this.finalized?new Response(e):k(this,ue,Ce).call(this,e,t,Ct(Ss,a)));g(this,"json",(e,t,a)=>k(this,ue,Ce).call(this,JSON.stringify(e),t,Ct("application/json",a)));g(this,"html",(e,t,a)=>{const s=n=>k(this,ue,Ce).call(this,n,t,Ct("text/html; charset=UTF-8",a));return typeof e=="object"?Ia(e,ks.Stringify,!1,{}).then(s):s(e)});g(this,"redirect",(e,t)=>{const a=String(e);return this.header("Location",/[^\x00-\xFF]/.test(a)?encodeURI(a):a),this.newResponse(null,t??302)});g(this,"notFound",()=>(p(this,Pe)??b(this,Pe,()=>Je()),p(this,Pe).call(this,this)));b(this,at,e),t&&(b(this,ie,t.executionCtx),this.env=t.env,b(this,Pe,t.notFoundHandler),b(this,rt,t.path),b(this,it,t.matchResult))}get req(){return p(this,st)??b(this,st,new Ta(p(this,at),p(this,rt),p(this,it))),p(this,st)}get event(){if(p(this,ie)&&"respondWith"in p(this,ie))return p(this,ie);throw Error("This context has no FetchEvent")}get executionCtx(){if(p(this,ie))return p(this,ie);throw Error("This context has no ExecutionContext")}get res(){return p(this,F)||b(this,F,Je(null,{headers:p(this,Ee)??b(this,Ee,new Headers)}))}set res(e){if(p(this,F)&&e){e=Je(e.body,e);for(const[t,a]of p(this,F).headers.entries())if(t!=="content-type")if(t==="set-cookie"){const s=p(this,F).headers.getSetCookie();e.headers.delete("set-cookie");for(const n of s)e.headers.append("set-cookie",n)}else e.headers.set(t,a)}b(this,F,e),this.finalized=!0}get var(){return p(this,ne)?Object.fromEntries(p(this,ne)):{}}},at=new WeakMap,st=new WeakMap,ne=new WeakMap,$e=new WeakMap,ie=new WeakMap,F=new WeakMap,nt=new WeakMap,Fe=new WeakMap,Pe=new WeakMap,Ee=new WeakMap,it=new WeakMap,rt=new WeakMap,ue=new WeakSet,Ce=function(e,t,a){const s=p(this,F)?new Headers(p(this,F).headers):p(this,Ee)??new Headers;if(typeof t=="object"&&"headers"in t){const i=t.headers instanceof Headers?t.headers:new Headers(t.headers);for(const[r,d]of i)r.toLowerCase()==="set-cookie"?s.append(r,d):s.set(r,d)}if(a)for(const[i,r]of Object.entries(a))if(typeof r=="string")s.set(i,r);else{s.delete(i);for(const d of r)s.append(i,d)}const n=typeof t=="number"?t:(t==null?void 0:t.status)??p(this,$e);return Je(e,{status:n,headers:s})},ha),O="ALL",As="all",Ds=["get","post","put","delete","options","patch"],Oa="Can not add a route since the matcher is already built.",Ra=class extends Error{},Is="__COMPOSED_HANDLER",Os=e=>e.text("404 Not Found",404),ta=(e,t)=>{if("getResponse"in e){const a=e.getResponse();return t.newResponse(a.body,a)}return console.error(e),t.text("Internal Server Error",500)},X,R,ja,G,ye,gt,_t,qe,Rs=(qe=class{constructor(t={}){y(this,R);g(this,"get");g(this,"post");g(this,"put");g(this,"delete");g(this,"options");g(this,"patch");g(this,"all");g(this,"on");g(this,"use");g(this,"router");g(this,"getPath");g(this,"_basePath","/");y(this,X,"/");g(this,"routes",[]);y(this,G,Os);g(this,"errorHandler",ta);g(this,"onError",t=>(this.errorHandler=t,this));g(this,"notFound",t=>(b(this,G,t),this));g(this,"fetch",(t,...a)=>k(this,R,_t).call(this,t,a[1],a[0],t.method));g(this,"request",(t,a,s,n)=>t instanceof Request?this.fetch(a?new Request(t,a):t,s,n):(t=t.toString(),this.fetch(new Request(/^https?:\/\//.test(t)?t:`http://localhost${Be("/",t)}`,a),s,n)));g(this,"fire",()=>{addEventListener("fetch",t=>{t.respondWith(k(this,R,_t).call(this,t.request,t,void 0,t.request.method))})});[...Ds,As].forEach(i=>{this[i]=(r,...d)=>(typeof r=="string"?b(this,X,r):k(this,R,ye).call(this,i,p(this,X),r),d.forEach(o=>{k(this,R,ye).call(this,i,p(this,X),o)}),this)}),this.on=(i,r,...d)=>{for(const o of[r].flat()){b(this,X,o);for(const l of[i].flat())d.map(c=>{k(this,R,ye).call(this,l.toUpperCase(),p(this,X),c)})}return this},this.use=(i,...r)=>(typeof i=="string"?b(this,X,i):(b(this,X,"*"),r.unshift(i)),r.forEach(d=>{k(this,R,ye).call(this,O,p(this,X),d)}),this);const{strict:s,...n}=t;Object.assign(this,n),this.getPath=s??!0?t.getPath??Ea:xs}route(t,a){const s=this.basePath(t);return a.routes.map(n=>{var r;let i;a.errorHandler===ta?i=n.handler:(i=async(d,o)=>(await Qt([],a.errorHandler)(d,()=>n.handler(d,o))).res,i[Is]=n.handler),k(r=s,R,ye).call(r,n.method,n.path,i)}),this}basePath(t){const a=k(this,R,ja).call(this);return a._basePath=Be(this._basePath,t),a}mount(t,a,s){let n,i;s&&(typeof s=="function"?i=s:(i=s.optionHandler,s.replaceRequest===!1?n=o=>o:n=s.replaceRequest));const r=i?o=>{const l=i(o);return Array.isArray(l)?l:[l]}:o=>{let l;try{l=o.executionCtx}catch{}return[o.env,l]};n||(n=(()=>{const o=Be(this._basePath,t),l=o==="/"?0:o.length;return c=>{const u=new URL(c.url);return u.pathname=u.pathname.slice(l)||"/",new Request(u,c)}})());const d=async(o,l)=>{const c=await a(n(o.req.raw),...r(o));if(c)return c;await l()};return k(this,R,ye).call(this,O,Be(t,"*"),d),this}},X=new WeakMap,R=new WeakSet,ja=function(){const t=new qe({router:this.router,getPath:this.getPath});return t.errorHandler=this.errorHandler,b(t,G,p(this,G)),t.routes=this.routes,t},G=new WeakMap,ye=function(t,a,s){t=t.toUpperCase(),a=Be(this._basePath,a);const n={basePath:this._basePath,path:a,method:t,handler:s};this.router.add(t,a,[s,n]),this.routes.push(n)},gt=function(t,a){if(t instanceof Error)return this.errorHandler(t,a);throw t},_t=function(t,a,s,n){if(n==="HEAD")return(async()=>new Response(null,await k(this,R,_t).call(this,t,a,s,"GET")))();const i=this.getPath(t,{env:s}),r=this.router.match(n,i),d=new Ts(t,{path:i,matchResult:r,env:s,executionCtx:a,notFoundHandler:p(this,G)});if(r[0].length===1){let l;try{l=r[0][0][0][0](d,async()=>{d.res=await p(this,G).call(this,d)})}catch(c){return k(this,R,gt).call(this,c,d)}return l instanceof Promise?l.then(c=>c||(d.finalized?d.res:p(this,G).call(this,d))).catch(c=>k(this,R,gt).call(this,c,d)):l??p(this,G).call(this,d)}const o=Qt(r[0],this.errorHandler,p(this,G));return(async()=>{try{const l=await o(d);if(!l.finalized)throw new Error("Context is not finalized. Did you forget to return a Response object or `await next()`?");return l.res}catch(l){return k(this,R,gt).call(this,l,d)}})()},qe),Ba=[];function js(e,t){const a=this.buildAllMatchers(),s=((n,i)=>{const r=a[n]||a[O],d=r[2][i];if(d)return d;const o=i.match(r[0]);if(!o)return[[],Ba];const l=o.indexOf("",1);return[r[1][l],o]});return this.match=s,s(e,t)}var yt="[^/]+",Ge=".*",Ze="(?:|/.*)",Le=Symbol(),Bs=new Set(".\\+*[^]$()");function Cs(e,t){return e.length===1?t.length===1?e<t?-1:1:-1:t.length===1||e===Ge||e===Ze?1:t===Ge||t===Ze?-1:e===yt?1:t===yt?-1:e.length===t.length?e<t?-1:1:t.length-e.length}var we,ke,Z,Ae,Ls=(Ae=class{constructor(){y(this,we);y(this,ke);y(this,Z,Object.create(null))}insert(t,a,s,n,i){if(t.length===0){if(p(this,we)!==void 0)throw Le;if(i)return;b(this,we,a);return}const[r,...d]=t,o=r==="*"?d.length===0?["","",Ge]:["","",yt]:r==="/*"?["","",Ze]:r.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);let l;if(o){const c=o[1];let u=o[2]||yt;if(c&&o[2]&&(u===".*"||(u=u.replace(/^\((?!\?:)(?=[^)]+\)$)/,"(?:"),/\((?!\?:)/.test(u))))throw Le;if(l=p(this,Z)[u],!l){if(Object.keys(p(this,Z)).some(m=>m!==Ge&&m!==Ze))throw Le;if(i)return;l=p(this,Z)[u]=new Ae,c!==""&&b(l,ke,n.varIndex++)}!i&&c!==""&&s.push([c,p(l,ke)])}else if(l=p(this,Z)[r],!l){if(Object.keys(p(this,Z)).some(c=>c.length>1&&c!==Ge&&c!==Ze))throw Le;if(i)return;l=p(this,Z)[r]=new Ae}l.insert(d,a,s,n,i)}buildRegExpStr(){const a=Object.keys(p(this,Z)).sort(Cs).map(s=>{const n=p(this,Z)[s];return(typeof p(n,ke)=="number"?`(${s})@${p(n,ke)}`:Bs.has(s)?`\\${s}`:s)+n.buildRegExpStr()});return typeof p(this,we)=="number"&&a.unshift(`#${p(this,we)}`),a.length===0?"":a.length===1?a[0]:"(?:"+a.join("|")+")"}},we=new WeakMap,ke=new WeakMap,Z=new WeakMap,Ae),Et,ot,ga,Ns=(ga=class{constructor(){y(this,Et,{varIndex:0});y(this,ot,new Ls)}insert(e,t,a){const s=[],n=[];for(let r=0;;){let d=!1;if(e=e.replace(/\{[^}]+\}/g,o=>{const l=`@\\${r}`;return n[r]=[l,o],r++,d=!0,l}),!d)break}const i=e.match(/(?::[^\/]+)|(?:\/\*$)|./g)||[];for(let r=n.length-1;r>=0;r--){const[d]=n[r];for(let o=i.length-1;o>=0;o--)if(i[o].indexOf(d)!==-1){i[o]=i[o].replace(d,n[r][1]);break}}return p(this,ot).insert(i,t,s,p(this,Et),a),s}buildRegExp(){let e=p(this,ot).buildRegExpStr();if(e==="")return[/^$/,[],[]];let t=0;const a=[],s=[];return e=e.replace(/#(\d+)|@(\d+)|\.\*\$/g,(n,i,r)=>i!==void 0?(a[++t]=Number(i),"$()"):(r!==void 0&&(s[Number(r)]=++t),"")),[new RegExp(`^${e}`),a,s]}},Et=new WeakMap,ot=new WeakMap,ga),Ms=[/^$/,[],Object.create(null)],bt=Object.create(null);function Ca(e){return bt[e]??(bt[e]=new RegExp(e==="*"?"":`^${e.replace(/\/\*$|([.\\+*[^\]$()])/g,(t,a)=>a?`\\${a}`:"(?:|/.*)")}$`))}function $s(){bt=Object.create(null)}function Fs(e){var l;const t=new Ns,a=[];if(e.length===0)return Ms;const s=e.map(c=>[!/\*|\/:/.test(c[0]),...c]).sort(([c,u],[m,h])=>c?1:m?-1:u.length-h.length),n=Object.create(null);for(let c=0,u=-1,m=s.length;c<m;c++){const[h,_,E]=s[c];h?n[_]=[E.map(([A])=>[A,Object.create(null)]),Ba]:u++;let w;try{w=t.insert(_,u,h)}catch(A){throw A===Le?new Ra(_):A}h||(a[u]=E.map(([A,x])=>{const B=Object.create(null);for(x-=1;x>=0;x--){const[C,L]=w[x];B[C]=L}return[A,B]}))}const[i,r,d]=t.buildRegExp();for(let c=0,u=a.length;c<u;c++)for(let m=0,h=a[c].length;m<h;m++){const _=(l=a[c][m])==null?void 0:l[1];if(!_)continue;const E=Object.keys(_);for(let w=0,A=E.length;w<A;w++)_[E[w]]=d[_[E[w]]]}const o=[];for(const c in r)o[c]=a[r[c]];return[i,o,n]}function je(e,t){if(e){for(const a of Object.keys(e).sort((s,n)=>n.length-s.length))if(Ca(a).test(t))return[...e[a]]}}var pe,me,wt,La,_a,Ps=(_a=class{constructor(){y(this,wt);g(this,"name","RegExpRouter");y(this,pe);y(this,me);g(this,"match",js);b(this,pe,{[O]:Object.create(null)}),b(this,me,{[O]:Object.create(null)})}add(e,t,a){var d;const s=p(this,pe),n=p(this,me);if(!s||!n)throw new Error(Oa);s[e]||[s,n].forEach(o=>{o[e]=Object.create(null),Object.keys(o[O]).forEach(l=>{o[e][l]=[...o[O][l]]})}),t==="/*"&&(t="*");const i=(t.match(/\/:/g)||[]).length;if(/\*$/.test(t)){const o=Ca(t);e===O?Object.keys(s).forEach(l=>{var c;(c=s[l])[t]||(c[t]=je(s[l],t)||je(s[O],t)||[])}):(d=s[e])[t]||(d[t]=je(s[e],t)||je(s[O],t)||[]),Object.keys(s).forEach(l=>{(e===O||e===l)&&Object.keys(s[l]).forEach(c=>{o.test(c)&&s[l][c].push([a,i])})}),Object.keys(n).forEach(l=>{(e===O||e===l)&&Object.keys(n[l]).forEach(c=>o.test(c)&&n[l][c].push([a,i]))});return}const r=wa(t)||[t];for(let o=0,l=r.length;o<l;o++){const c=r[o];Object.keys(n).forEach(u=>{var m;(e===O||e===u)&&((m=n[u])[c]||(m[c]=[...je(s[u],c)||je(s[O],c)||[]]),n[u][c].push([a,i-l+o+1]))})}}buildAllMatchers(){const e=Object.create(null);return Object.keys(p(this,me)).concat(Object.keys(p(this,pe))).forEach(t=>{e[t]||(e[t]=k(this,wt,La).call(this,t))}),b(this,pe,b(this,me,void 0)),$s(),e}},pe=new WeakMap,me=new WeakMap,wt=new WeakSet,La=function(e){const t=[];let a=e===O;return[p(this,pe),p(this,me)].forEach(s=>{const n=s[e]?Object.keys(s[e]).map(i=>[i,s[e][i]]):[];n.length!==0?(a||(a=!0),t.push(...n)):e!==O&&t.push(...Object.keys(s[O]).map(i=>[i,s[O][i]]))}),a?Fs(t):null},_a),fe,re,ba,qs=(ba=class{constructor(e){g(this,"name","SmartRouter");y(this,fe,[]);y(this,re,[]);b(this,fe,e.routers)}add(e,t,a){if(!p(this,re))throw new Error(Oa);p(this,re).push([e,t,a])}match(e,t){if(!p(this,re))throw new Error("Fatal error");const a=p(this,fe),s=p(this,re),n=a.length;let i=0,r;for(;i<n;i++){const d=a[i];try{for(let o=0,l=s.length;o<l;o++)d.add(...s[o]);r=d.match(e,t)}catch(o){if(o instanceof Ra)continue;throw o}this.match=d.match.bind(d),b(this,fe,[d]),b(this,re,void 0);break}if(i===n)throw new Error("Fatal error");return this.name=`SmartRouter + ${this.activeRouter.name}`,r}get activeRouter(){if(p(this,re)||p(this,fe).length!==1)throw new Error("No active router has been determined yet.");return p(this,fe)[0]}},fe=new WeakMap,re=new WeakMap,ba),Ve=Object.create(null),Hs=e=>{for(const t in e)return!0;return!1},he,M,Se,He,N,oe,xe,Ue,Us=(Ue=class{constructor(t,a,s){y(this,oe);y(this,he);y(this,M);y(this,Se);y(this,He,0);y(this,N,Ve);if(b(this,M,s||Object.create(null)),b(this,he,[]),t&&a){const n=Object.create(null);n[t]={handler:a,possibleKeys:[],score:0},b(this,he,[n])}b(this,Se,[])}insert(t,a,s){b(this,He,++Zt(this,He)._);let n=this;const i=_s(a),r=[];for(let d=0,o=i.length;d<o;d++){const l=i[d],c=i[d+1],u=ys(l,c),m=Array.isArray(u)?u[0]:l;if(m in p(n,M)){n=p(n,M)[m],u&&r.push(u[1]);continue}p(n,M)[m]=new Ue,u&&(p(n,Se).push(u),r.push(u[1])),n=p(n,M)[m]}return p(n,he).push({[t]:{handler:s,possibleKeys:r.filter((d,o,l)=>l.indexOf(d)===o),score:p(this,He)}}),n}search(t,a){var c;const s=[];b(this,N,Ve);let i=[this];const r=ya(a),d=[],o=r.length;let l=null;for(let u=0;u<o;u++){const m=r[u],h=u===o-1,_=[];for(let w=0,A=i.length;w<A;w++){const x=i[w],B=p(x,M)[m];B&&(b(B,N,p(x,N)),h?(p(B,M)["*"]&&k(this,oe,xe).call(this,s,p(B,M)["*"],t,p(x,N)),k(this,oe,xe).call(this,s,B,t,p(x,N))):_.push(B));for(let C=0,L=p(x,Se).length;C<L;C++){const mt=p(x,Se)[C],Q=p(x,N)===Ve?{}:{...p(x,N)};if(mt==="*"){const Oe=p(x,M)["*"];Oe&&(k(this,oe,xe).call(this,s,Oe,t,p(x,N)),b(Oe,N,Q),_.push(Oe));continue}const[ds,Xt,Ye]=mt;if(!m&&!(Ye instanceof RegExp))continue;const ae=p(x,M)[ds];if(Ye instanceof RegExp){if(l===null){l=new Array(o);let Re=a[0]==="/"?1:0;for(let Ke=0;Ke<o;Ke++)l[Ke]=Re,Re+=r[Ke].length+1}const Oe=a.substring(l[u]),Rt=Ye.exec(Oe);if(Rt){if(Q[Xt]=Rt[0],k(this,oe,xe).call(this,s,ae,t,p(x,N),Q),Hs(p(ae,M))){b(ae,N,Q);const Re=((c=Rt[0].match(/\//))==null?void 0:c.length)??0;(d[Re]||(d[Re]=[])).push(ae)}continue}}(Ye===!0||Ye.test(m))&&(Q[Xt]=m,h?(k(this,oe,xe).call(this,s,ae,t,Q,p(x,N)),p(ae,M)["*"]&&k(this,oe,xe).call(this,s,p(ae,M)["*"],t,Q,p(x,N))):(b(ae,N,Q),_.push(ae)))}}const E=d.shift();i=E?_.concat(E):_}return s.length>1&&s.sort((u,m)=>u.score-m.score),[s.map(({handler:u,params:m})=>[u,m])]}},he=new WeakMap,M=new WeakMap,Se=new WeakMap,He=new WeakMap,N=new WeakMap,oe=new WeakSet,xe=function(t,a,s,n,i){for(let r=0,d=p(a,he).length;r<d;r++){const o=p(a,he)[r],l=o[s]||o[O],c={};if(l!==void 0&&(l.params=Object.create(null),t.push(l),n!==Ve||i&&i!==Ve))for(let u=0,m=l.possibleKeys.length;u<m;u++){const h=l.possibleKeys[u],_=c[l.score];l.params[h]=i!=null&&i[h]&&!_?i[h]:n[h]??(i==null?void 0:i[h]),c[l.score]=!0}}},Ue),Te,va,Ws=(va=class{constructor(){g(this,"name","TrieRouter");y(this,Te);b(this,Te,new Us)}add(e,t,a){const s=wa(t);if(s){for(let n=0,i=s.length;n<i;n++)p(this,Te).insert(e,s[n],a);return}p(this,Te).insert(e,t,a)}match(e,t){return p(this,Te).search(e,t)}},Te=new WeakMap,va),D=class extends Rs{constructor(e={}){super(e),this.router=e.router??new qs({routers:[new Ps,new Ws]})}},zs=/^\s*(?:text\/(?!event-stream(?:[;\s]|$))[^;\s]+|application\/(?:javascript|json|xml|xml-dtd|ecmascript|dart|postscript|rtf|tar|toml|vnd\.dart|vnd\.ms-fontobject|vnd\.ms-opentype|wasm|x-httpd-php|x-javascript|x-ns-proxy-autoconfig|x-sh|x-tar|x-virtualbox-hdd|x-virtualbox-ova|x-virtualbox-ovf|x-virtualbox-vbox|x-virtualbox-vdi|x-virtualbox-vhd|x-virtualbox-vmdk|x-www-form-urlencoded)|font\/(?:otf|ttf)|image\/(?:bmp|vnd\.adobe\.photoshop|vnd\.microsoft\.icon|vnd\.ms-dds|x-icon|x-ms-bmp)|message\/rfc822|model\/gltf-binary|x-shader\/x-fragment|x-shader\/x-vertex|[^;\s]+?\+(?:json|text|xml|yaml))(?:[;\s]|$)/i,aa=(e,t=Ks)=>{const a=/\.([a-zA-Z0-9]+?)$/,s=e.match(a);if(!s)return;let n=t[s[1].toLowerCase()];return n&&n.startsWith("text")&&(n+="; charset=utf-8"),n},Ys={aac:"audio/aac",avi:"video/x-msvideo",avif:"image/avif",av1:"video/av1",bin:"application/octet-stream",bmp:"image/bmp",css:"text/css",csv:"text/csv",eot:"application/vnd.ms-fontobject",epub:"application/epub+zip",gif:"image/gif",gz:"application/gzip",htm:"text/html",html:"text/html",ico:"image/x-icon",ics:"text/calendar",jpeg:"image/jpeg",jpg:"image/jpeg",js:"text/javascript",json:"application/json",jsonld:"application/ld+json",map:"application/json",mid:"audio/x-midi",midi:"audio/x-midi",mjs:"text/javascript",mp3:"audio/mpeg",mp4:"video/mp4",mpeg:"video/mpeg",oga:"audio/ogg",ogv:"video/ogg",ogx:"application/ogg",opus:"audio/opus",otf:"font/otf",pdf:"application/pdf",png:"image/png",rtf:"application/rtf",svg:"image/svg+xml",tif:"image/tiff",tiff:"image/tiff",ts:"video/mp2t",ttf:"font/ttf",txt:"text/plain",wasm:"application/wasm",webm:"video/webm",weba:"audio/webm",webmanifest:"application/manifest+json",webp:"image/webp",woff:"font/woff",woff2:"font/woff2",xhtml:"application/xhtml+xml",xml:"application/xml",zip:"application/zip","3gp":"video/3gpp","3g2":"video/3gpp2",gltf:"model/gltf+json",glb:"model/gltf-binary"},Ks=Ys,Js=(...e)=>{let t=e.filter(n=>n!=="").join("/");t=t.replace(new RegExp("(?<=\\/)\\/+","g"),"");const a=t.split("/"),s=[];for(const n of a)n===".."&&s.length>0&&s.at(-1)!==".."?s.pop():n!=="."&&s.push(n);return s.join("/")||"."},Na={br:".br",zstd:".zst",gzip:".gz"},Vs=Object.keys(Na),Xs="index.html",Gs=e=>{const t=e.root??"./",a=e.path,s=e.join??Js;return async(n,i)=>{var c,u,m,h;if(n.finalized)return i();let r;if(e.path)r=e.path;else try{if(r=xa(n.req.path),/(?:^|[\/\\])\.{1,2}(?:$|[\/\\])|[\/\\]{2,}/.test(r))throw new Error}catch{return await((c=e.onNotFound)==null?void 0:c.call(e,n.req.path,n)),i()}let d=s(t,!a&&e.rewriteRequestPath?e.rewriteRequestPath(r):r);e.isDir&&await e.isDir(d)&&(d=s(d,Xs));const o=e.getContent;let l=await o(d,n);if(l instanceof Response)return n.newResponse(l.body,l);if(l){const _=e.mimes&&aa(d,e.mimes)||aa(d);if(n.header("Content-Type",_||"application/octet-stream"),e.precompressed&&(!_||zs.test(_))){const E=new Set((u=n.req.header("Accept-Encoding"))==null?void 0:u.split(",").map(w=>w.trim()));for(const w of Vs){if(!E.has(w))continue;const A=await o(d+Na[w],n);if(A){l=A,n.header("Content-Encoding",w),n.header("Vary","Accept-Encoding",{append:!0});break}}}return await((m=e.onFound)==null?void 0:m.call(e,d,n)),n.body(l)}await((h=e.onNotFound)==null?void 0:h.call(e,d,n)),await i()}},Zs=async(e,t)=>{let a;t&&t.manifest?typeof t.manifest=="string"?a=JSON.parse(t.manifest):a=t.manifest:typeof __STATIC_CONTENT_MANIFEST=="string"?a=JSON.parse(__STATIC_CONTENT_MANIFEST):a=__STATIC_CONTENT_MANIFEST;let s;t&&t.namespace?s=t.namespace:s=__STATIC_CONTENT;const n=a[e];if(!n)return null;const i=await s.get(n,{type:"stream"});return i||null},Qs=e=>async function(a,s){return Gs({...e,getContent:async i=>Zs(i,{manifest:e.manifest,namespace:e.namespace?e.namespace:a.env?a.env.__STATIC_CONTENT:void 0})})(a,s)},en=e=>Qs(e);const W={name:"Growth-engine365X",version:"ver1.00",tagline:"X (Twitter) 自動投稿プラットフォーム",longName:"X (Twitter) 自動投稿プラットフォーム",icon:"fa-bolt"},tn=`
<meta charset="utf-8">
...
`,an="bg-paper text-ink min-h-screen font-sans antialiased";function qt(e,t,a={}){return`<!DOCTYPE html>
<html lang="ja">
<head>
${tn}
...
</html>`}const Ma=new D;Ma.get("/login",e=>{const t=`
...
<\/script>
`;return e.html(qt("ログイン",t))});const de=new TextEncoder,$a=new TextDecoder;function Qe(e){let t="";for(let a=0;a<e.length;a++)t+=String.fromCharCode(e[a]);return btoa(t)}function et(e){const t=atob(e),a=new Uint8Array(t.length);for(let s=0;s<t.length;s++)a[s]=t.charCodeAt(s);return a}function vt(e){return Qe(e).replace(/\+/g,"-").replace(/\//g,"_").replace(/=+$/,"")}function Nt(e){const t="=".repeat((4-e.length%4)%4);return et((e+t).replace(/-/g,"+").replace(/_/g,"/"))}function dt(e){const t=new Uint8Array(e);return crypto.getRandomValues(t),t}function sn(e){return[...dt(e)].map(t=>t.toString(16).padStart(2,"0")).join("")}const sa=1e5,nn=32;async function kt(e){const t=dt(16),a=await crypto.subtle.importKey("raw",de.encode(e),{name:"PBKDF2"},!1,["deriveBits"]),s=await crypto.subtle.deriveBits({name:"PBKDF2",salt:t,iterations:sa,hash:"SHA-256"},a,nn*8);return`pbkdf2$${sa}$${Qe(t)}$${Qe(new Uint8Array(s))}`}async function Ht(e,t){try{const[a,s,n,i]=t.split("$");if(a!=="pbkdf2")return!1;const r=parseInt(s,10),d=et(n),o=et(i),l=await crypto.subtle.importKey("raw",de.encode(e),{name:"PBKDF2"},!1,["deriveBits"]),c=new Uint8Array(await crypto.subtle.deriveBits({name:"PBKDF2",salt:d,iterations:r,hash:"SHA-256"},l,o.length*8));return Fa(c,o)}catch{return!1}}function Fa(e,t){if(e.length!==t.length)return!1;let a=0;for(let s=0;s<e.length;s++)a|=e[s]^t[s];return a===0}async function Pa(e){return crypto.subtle.importKey("raw",de.encode(e),{name:"HMAC",hash:"SHA-256"},!1,["sign","verify"])}async function qa(e,t,a=3600*24*7){const s=Math.floor(Date.now()/1e3),n={iat:s,exp:s+a,...e},i=vt(de.encode(JSON.stringify({alg:"HS256",typ:"JWT"}))),r=vt(de.encode(JSON.stringify(n))),d=`${i}.${r}`,o=await Pa(t),l=new Uint8Array(await crypto.subtle.sign("HMAC",o,de.encode(d)));return`${d}.${vt(l)}`}async function Ha(e,t){try{const[a,s,n]=e.split(".");if(!a||!s||!n)return null;const i=await Pa(t);if(!await crypto.subtle.verify("HMAC",i,Nt(n),de.encode(`${a}.${s}`)))return null;const d=JSON.parse($a.decode(Nt(s)));return d.exp&&d.exp<Math.floor(Date.now()/1e3)?null:d}catch{return null}}async function Ua(e){const t=de.encode(e),a=t.length>=32?t.slice(0,32):new Uint8Array(await crypto.subtle.digest("SHA-256",t));return crypto.subtle.importKey("raw",a,{name:"AES-GCM"},!1,["encrypt","decrypt"])}async function ee(e,t){const a=dt(12),s=await Ua(t),n=new Uint8Array(await crypto.subtle.encrypt({name:"AES-GCM",iv:a},s,de.encode(e))),i=new Uint8Array(a.length+n.length);return i.set(a),i.set(n,a.length),Qe(i)}async function tt(e,t){const a=et(e),s=a.slice(0,12),n=a.slice(12),i=await Ua(t),r=await crypto.subtle.decrypt({name:"AES-GCM",iv:s},i,n);return $a.decode(r)}const na="ABCDEFGHJKLMNPQRSTUVWXYZ23456789";function Mt(e="VPS-GE365X"){const t=dt(8);let a="";for(let s=0;s<8;s++)a+=na[t[s]%na.length];return`${e}-${a}`}function Wa(e){return/^VPS-GE365X-[A-Z0-9]{6,12}$/i.test(e.trim())}function v(){return new Date(Date.now()+324e5).toISOString().replace("T"," ").slice(0,19)}function rn(e,t){return new Response(JSON.stringify(e),{...t,headers:{"content-type":"application/json; charset=utf-8",...(t==null?void 0:t.headers)||{}}})}function za(e,t){const s=(e.headers.get("cookie")||"").split(";").map(n=>n.trim()).find(n=>n.startsWith(t+"="));return s?decodeURIComponent(s.slice(t.length+1)):null}function Ut(e,t,a={}){const s=[`${e}=${encodeURIComponent(t)}`];return s.push(`Path=${a.path??"/"}`),a.maxAge!==void 0&&s.push(`Max-Age=${a.maxAge}`),a.httpOnly!==!1&&s.push("HttpOnly"),a.secure!==!1&&s.push("Secure"),s.push(`SameSite=${a.sameSite??"Lax"}`),s.join("; ")}const lt=Object.freeze(Object.defineProperty({__proto__:null,aesDecrypt:tt,aesEncrypt:ee,b64decode:et,b64encode:Qe,b64urlDecode:Nt,b64urlEncode:vt,buildSetCookie:Ut,generateLicenseKey:Mt,getCookie:za,hashPassword:kt,isValidLicenseKeyFormat:Wa,json:rn,nowJst:v,randomBytes:dt,randomHex:sn,signJWT:qa,timingSafeEqual:Fa,verifyJWT:Ha,verifyPassword:Ht},Symbol.toStringTag,{value:"Module"})),Wt="ge365x_session";function on(e){const t=e.req.header("Authorization")||e.req.header("authorization");return t&&t.startsWith("Bearer ")?t.slice(7):za(e.req.raw,Wt)}async function f(e,t){const a=on(e);if(!a)return e.json({error:"unauthenticated"},401);const s=await Ha(a,e.env.JWT_SECRET);if(!(s!=null&&s.uid))return e.json({error:"invalid_token"},401);const n=await e.env.DB.prepare("SELECT id,email,is_approved,is_admin,trial_start,trial_end FROM users WHERE id = ?").bind(s.uid).first();if(!n)return e.json({error:"user_not_found"},401);if(n.is_approved===0)return e.json({error:"not_approved"},403);if(n.is_admin===0&&n.trial_end){const d=new Date,o=new Date(n.trial_end.replace(" ","T")+(n.trial_end.includes("+")?"":"+09:00"));if(!await e.env.DB.prepare("SELECT status FROM user_subscriptions WHERE user_id = ? AND status='active' LIMIT 1").bind(n.id).first()&&d>o)return e.json({error:"trial_expired",message:"無料お試し期間が終了いたしました。"},403)}const i=await e.env.DB.prepare("SELECT plan_code,status FROM user_subscriptions WHERE user_id = ?").bind(n.id).first(),r={id:n.id,email:n.email,is_admin:n.is_admin===1,is_approved:n.is_approved===1,plan_code:i==null?void 0:i.plan_code,subscription_status:i==null?void 0:i.status};e.set("user",r),await t()}async function I(e,t){const a=e.get("user");if(!a)return e.json({error:"unauthenticated"},401);if(!a.is_admin)return e.json({error:"forbidden"},403);await t()}async function J(e,t,a={}){const s=e.req.header("cf-connecting-ip")||e.req.header("x-forwarded-for")||"",n=e.req.header("user-agent")||"";await e.env.DB.prepare(`INSERT INTO auth_logs (user_id, email, event_type, ip_address, user_agent, metadata)
     VALUES (?, ?, ?, ?, ?, ?)`).bind(a.userId??null,a.email??null,t,s,n,a.metadata?JSON.stringify(a.metadata):null).run()}const dn=[{key:"dashboard",label:"ダッシュボード",icon:"fa-gauge-high",path:"/dashboard"},{key:"target",label:"ターゲット設定",icon:"fa-bullseye",path:"/dashboard/target"},{key:"voice",label:"ブランドボイス",icon:"fa-palette",path:"/dashboard/voice"},{key:"pattern",label:"パターン別AI生成",icon:"fa-wand-magic-sparkles",path:"/dashboard/pattern"},{key:"generate",label:"AI生成2",icon:"fa-robot",path:"/dashboard/generate"},{key:"posts",label:"X投稿管理",icon:"fa-brands fa-x-twitter",path:"/dashboard/posts"},{key:"thread",label:"ツリー投稿",icon:"fa-reply",path:"/dashboard/thread"},{key:"scheduled",label:"予約状況",icon:"fa-calendar",path:"/dashboard/scheduled"},{key:"autopilot",label:"オートパイロット",icon:"fa-plane-departure",path:"/dashboard/autopilot"},{key:"accounts",label:"アカウント管理",icon:"fa-users-gear",path:"/dashboard/accounts"},{key:"api",label:"API設定",icon:"fa-key",path:"/dashboard/api"},{key:"export",label:"一括ダウンロード",icon:"fa-download",path:"/dashboard/export"}];function ln(e,t){return`
...
<div class="min-h-screen flex bg-paper">
  ...
  <main class="flex-1 min-w-0 flex flex-col">
    ${cn(e.accounts,e.currentAccountId)}
...
`;function S(e){return(e||"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}function Ya(e){return{pending:'<span class="pill pill-warn">未承認</span>',approved:'<span class="pill pill-blue">承認済</span>',publishing:'<span class="pill pill-blue">送信中</span>',posted:'<span class="pill pill-ok">投稿済</span>',failed:'<span class="pill pill-err">失敗</span>',cancelled:'<span class="pill pill-soft">キャンセル</span>'}[e||""]||`<span class="pill pill-soft">${e||"—"}</span>`}function mn(e){const{stats:t,health:a,recentLogs:s}=e;return`
<div class="space-y-4">
  <div>
...
</div>`}function fn(e){const t=e.target||{};return`
<div class="space-y-4">
  <div>
...
<\/script>`}function hn(e){const t=e.voice||{},a=[{k:"authority",l:"権威型",t:"専門家として断定的に、簡潔に、根拠を示して書く。"},{k:"empathy",l:"共感型",t:"読者の悩みに寄り添い、共感を起点に語りかけるように書く。"},{k:"provocative",l:"煽り型",t:"問題を鋭く突き、危機感を持たせる書き方にする。"},{k:"story",l:"ストーリー型",t:"体験談や変化の流れを感じさせる構成で書く。"},{k:"problem_raise",l:"問題提起型",t:"最初に課題を提示し、その原因と解決策を示す。"}];return`
<div class="space-y-4">
  <div>
...
<\/script>`}function gn(e){var a,s,n;const t=[["problem","問題提起型","fa-circle-question"],["before_after","ビフォーアフター型","fa-right-left"],["contrarian","逆張り型","fa-rotate-left"],["howto","HowTo実演型","fa-list-ol"],["numbers","数字インパクト型","fa-hashtag"]];return`
<div class="space-y-4">
  <div>
        ...
        <div style="display:grid;grid-template-columns:repeat(5,1fr);gap:.5rem" id="patt-grid">
          ${t.map(([i,r,d],o)=>`
            <div onclick="selectPatt(this,'${i}')" data-val="${i}"
              style="display:flex;flex-direction:column;align-items:center;gap:.375rem;padding:.75rem .5rem;border:2px solid ${o===0?"var(--accent)":"var(--line)"};border-radius:.5rem;cursor:pointer;background:${o===0?"var(--accent-light)":"#fff"};color:${o===0?"var(--accent)":"var(--ink)"};transition:all .15s;text-align:center">
              <i class="fas ${d}" style="font-size:1.1rem"></i>
...
<\/script>`}function bn(e){const{month:t,y:a,m:s,posts:n,stats:i}=e;return`
<div class="space-y-4">
  ${e.hasAccount?"":e.noAccountAlert}
  <div>
  ...
  <div class="card">
    ...
    `:e.history.map(t=>`
      <div class="border border-line rounded-lg p-3 mb-2">
        <div class="text-xs text-ink-muted mb-1">Parent: <span class="font-mono text-accent">${t.thread_parent_id||"-"}</span> ${Ya(t.status)}</div>
...
<\/script>`}function Sn(e){const t=e.settings||{};return`
<div class="space-y-4">
  <div>
...
<\/script>`}const U=new D;async function Tn(e,t){const{results:a}=await e.env.DB.prepare(`SELECT id, account_name, x_username, is_current
       FROM x_accounts WHERE user_id = ? AND is_active = 1 ORDER BY id`).bind(t.id).all(),s=(a||[]).map(i=>({id:i.id,account_name:i.account_name,x_username:i.x_username})),n=(a||[]).find(i=>i.is_current===1);return{accounts:s,currentAccountId:(n==null?void 0:n.id)??null}}U.get("/",e=>e.redirect("/login"));async function V(e,t,a){const s=e.get("user"),{accounts:n,currentAccountId:i}=await Tn(e,s),r=n.length>0&&i!==null,d=await Promise.resolve(a({user:s,hasAccount:r,accounts:n,currentAccountId:i})),o=pn({active:t,user:s,accounts:n,currentAccountId:i,pageBody:d});return e.html(qt("GE365x",o))}U.get("/dashboard",f,async e=>V(e,"dashboard",async({user:t,hasAccount:a})=>{const s=await e.env.DB.prepare("SELECT COUNT(*) AS n FROM x_accounts WHERE user_id=?").bind(t.id).first(),n=await e.env.DB.prepare("SELECT COUNT(*) AS n FROM post_logs WHERE user_id=? AND DATE(created_at)=DATE('now','+9 hours') AND status='posted'").bind(t.id).first(),i=await e.env.DB.prepare("SELECT COUNT(*) AS n FROM post_queue WHERE user_id=? AND status IN ('pending','approved')").bind(t.id).first(),r=await e.env.DB.prepare("SELECT COUNT(*) AS n FROM post_logs WHERE user_id=? AND status='failed' AND DATE(created_at)=DATE('now','+9 hours')").bind(t.id).first(),{results:d}=await e.env.DB.prepare(`SELECT id, account_name, x_username, account_health_score, health_status, is_active
         FROM x_accounts WHERE user_id = ? ORDER BY id`).bind(t.id).all(),{results:o}=await e.env.DB.prepare(`SELECT pl.content, pl.status, pl.posted_at, xa.x_username
         FROM post_logs pl LEFT JOIN x_accounts xa ON xa.id = pl.account_id
         WHERE pl.user_id = ? AND pl.status = 'posted'
         ORDER BY pl.id DESC LIMIT 5`).bind(t.id).all();return mn({stats:{accounts:(s==null?void 0:s.n)??0,today:(n==null?void 0:n.n)??0,pending:(i==null?void 0:i.n)??0,failed:(r==null?void 0:r.n)??0},health:d||[],recentLogs:o||[]})}));U.get("/dashboard/target",f,async e=>V(e,"target",async({user:t,currentAccountId:a,hasAccount:s})=>{const n=String(a??"default"),i=await e.env.DB.prepare("SELECT * FROM target_templates WHERE account_id=? AND user_id=? LIMIT 1").bind(n,t.id).first();return fn({target:i,hasAccount:s,noAccountAlert:ge})}));U.get("/dashboard/voice",f,async e=>V(e,"voice",async({user:t,currentAccountId:a,hasAccount:s})=>{const n=String(a??"default"),i=await e.env.DB.prepare("SELECT * FROM brand_voice WHERE account_id=? AND user_id=? LIMIT 1").bind(n,t.id).first();return hn({voice:i,hasAccount:s,noAccountAlert:ge})}));U.get("/dashboard/pattern",f,async e=>V(e,"pattern",async({user:t,hasAccount:a,currentAccountId:s,accounts:n})=>{const i=String(s??"default"),r=await e.env.DB.prepare("SELECT age_range, gender FROM target_templates WHERE account_id=? AND user_id=? LIMIT 1").bind(i,t.id).first(),d=await e.env.DB.prepare("SELECT tone FROM brand_voice WHERE account_id=? AND user_id=? LIMIT 1").bind(i,t.id).first(),o=n.find(l=>l.id===s);return gn({hasAccount:a,noAccountAlert:ge,target:r,voice:d,currentAcct:o})}));U.get("/dashboard/generate",f,async e=>V(e,"generate",({hasAccount:t})=>_n({hasAccount:t,noAccountAlert:ge})));U.get("/dashboard/posts",f,async e=>V(e,"posts",async({user:t,hasAccount:a})=>{const n=e.req.query("month")||new Date().toISOString().slice(0,7),[i,r]=n.split("-"),{results:d}=await e.env.DB.prepare(`SELECT pq.id, pq.body, pq.post_mode, pq.status, pq.account_id, xa.x_username
        ...
        ORDER BY pq.id DESC LIMIT 200`).bind(t.id,n).all(),o=(d||[]).length,l=(d||[]).filter(m=>m.status==="pending"||m.status==="approved").length,c=(d||[]).filter(m=>m.status==="posted").length,u=(d||[]).filter(m=>m.status==="failed").length;return bn({hasAccount:a,noAccountAlert:ge,month:n,y:i,m:parseInt(r,10),posts:d||[],stats:{total:o,pending:l,posted:c,failed:u}})}));U.get("/dashboard/thread",f,async e=>V(e,"thread",async({user:t,hasAccount:a})=>{const{results:s}=await e.env.DB.prepare(`SELECT pq.id, pq.body, pq.status, pq.posted_at, pq.created_at, pq.thread_parent_id
         FROM post_queue pq
        WHERE pq.user_id = ? AND pq.post_mode = 'thread' AND pq.thread_parent_id IS NOT NULL
        ORDER BY pq.id DESC LIMIT 30`).bind(t.id).all();return vn({hasAccount:a,noAccountAlert:ge,history:s||[]})}));U.get("/dashboard/scheduled",f,async e=>V(e,"scheduled",async({user:t,hasAccount:a})=>{const{results:s}=await e.env.DB.prepare(`SELECT pq.id, pq.body, pq.scheduled_at, pq.status, xa.x_username
         FROM post_queue pq LEFT JOIN x_accounts xa ON xa.id = pq.account_id
        WHERE pq.user_id = ? AND pq.scheduled_at IS NOT NULL
          AND pq.status NOT IN ('cancelled','rejected')
        ORDER BY pq.scheduled_at ASC LIMIT 100`).bind(t.id).all();return xn({hasAccount:a,noAccountAlert:ge})}));U.get("/dashboard/autopilot",f,async e=>V(e,"autopilot",async({user:t,hasAccount:a,accounts:s})=>{const{results:n}=await e.env.DB.prepare(`SELECT aj.*, xa.x_username FROM autopilot_jobs aj
         LEFT JOIN x_accounts xa ON xa.id = aj.account_id
        WHERE aj.user_id = ?
        ORDER BY COALESCE(aj.publish_at, aj.generate_at, aj.created_at) DESC LIMIT 50`).bind(t.id).all();return En({hasAccount:a,noAccountAlert:ge,accounts:s,jobs:n||[]})}));U.get("/dashboard/accounts",f,async e=>V(e,"accounts",async({user:t})=>{const{results:a}=await e.env.DB.prepare(`SELECT id, account_name, x_username, account_health_score, health_status,
              daily_post_count, daily_post_limit, last_posted_at, is_active
         FROM x_accounts WHERE user_id = ? ORDER BY id DESC`).bind(t.id).all();return wn({accounts:a||[]})}));U.get("/dashboard/api",f,async e=>V(e,"api",async({user:t})=>{const{aesDecrypt:a}=await Promise.resolve().then(()=>lt),s=async _=>{const E=await e.env.DB.prepare("SELECT value FROM system_settings WHERE key=?").bind(_).first();if(!(E!=null&&E.value))return"";try{return await a(E.value,e.env.ENCRYPTION_KEY)}catch{return""}},n=await e.env.DB.prepare("SELECT api_key, api_secret FROM x_api_settings WHERE user_id = ? LIMIT 1").bind(t.id).first();let i="",r="";if(n!=null&&n.api_key)try{const _=await a(n.api_key,e.env.ENCRYPTION_KEY);i=_?_.slice(0,6)+"••••":""}catch{}if(n!=null&&n.api_secret)try{const _=await a(n.api_secret,e.env.ENCRYPTION_KEY);r=_?_.slice(0,4)+"••••":""}catch{}const d=await s("openai_api_key"),o=await s("openai_model"),l=await s("gemini_api_key"),c=await s("gemini_model"),u=await s("telegram_bot_token"),m=await s("telegram_chat_id");return Sn({settings:{api_key:i,api_secret:r,openai_api_key:!!d,openai_model:o||"gpt-4o-mini",gemini_api_key:!!l,gemini_model:c||"gemini-1.5-flash",telegram_bot_token:!!u,telegram_chat_id:m||""}})}));U.get("/dashboard/export",f,async e=>V(e,"export",({user:t})=>kn({isAdmin:t.is_admin})));const P=new D;P.get("/admin",f,I,e=>{const t=`
...
@media(max-width:640px){
  ...
  .btn-ghost span{display:none}
...
</style>`+t))});P.get("/api/admin/users",f,I,async e=>{const t=e.req.query("filter")||"all",a=[];t==="pending"&&a.push("u.is_approved = 0"),t==="approved"&&a.push("u.is_approved = 1"),t==="admin"&&a.push("u.is_admin = 1");const s=`
    SELECT u.id, u.email, u.is_approved, u.is_admin, u.trial_start, u.trial_end, u.created_at,
      ...
      ORDER BY u.id DESC
      LIMIT 200`,{results:n}=await e.env.DB.prepare(s).all();return e.json({users:n||[]})});P.post("/api/admin/users/:id/approve",f,I,async e=>{const t=parseInt(e.req.param("id"),10),{is_approved:a}=await e.req.json();return await e.env.DB.prepare("UPDATE users SET is_approved=?, updated_at=datetime('now','+9 hours') WHERE id=?").bind(a,t).run(),await J(e,"admin_toggle_approval",{userId:e.get("user").id,metadata:{target_user_id:t,is_approved:a}}),e.json({ok:!0})});P.post("/api/admin/users/:id/admin",f,I,async e=>{const t=parseInt(e.req.param("id"),10),{is_admin:a}=await e.req.json();return await e.env.DB.prepare("UPDATE users SET is_admin=?, updated_at=datetime('now','+9 hours') WHERE id=?").bind(a,t).run(),await J(e,"admin_toggle_admin",{userId:e.get("user").id,metadata:{target_user_id:t,is_admin:a}}),e.json({ok:!0})});P.get("/api/admin/licenses",f,I,async e=>{const{results:t}=await e.env.DB.prepare(`SELECT l.*, u.email AS user_email
       FROM licenses l
       LEFT JOIN users u ON u.id = l.user_id
       ORDER BY l.id DESC LIMIT 500`).all();return e.json({licenses:t||[]})});P.post("/api/admin/licenses/issue",f,I,async e=>{const t=e.get("user"),{plan_code:a,license_type:s,expires_at:n,count:i=1,note:r}=await e.req.json();if(i<1||i>100)return e.json({error:"invalid_count"},400);const d=[];for(let o=0;o<i;o++){let l=Mt("VPS-GE365X");for(let c=0;c<3&&await e.env.DB.prepare("SELECT 1 FROM licenses WHERE license_key=?").bind(l).first();c++)l=Mt("VPS-GE365X");await e.env.DB.prepare(`INSERT INTO licenses (license_key, license_type, plan_code, is_active, expires_at, issued_by, note)
       VALUES (?, ?, ?, 1, ?, ?, ?)`).bind(l,s,a,n?n+" 23:59:59":null,t.id,r||null).run(),d.push(l)}return await J(e,"admin_issue_license",{userId:t.id,metadata:{count:i,plan_code:a,license_type:s}}),e.json({ok:!0,keys:d})});P.post("/api/admin/licenses/:id/revoke",f,I,async e=>{const t=parseInt(e.req.param("id"),10);return await e.env.DB.prepare("UPDATE licenses SET is_active=0, updated_at=datetime('now','+9 hours') WHERE id=?").bind(t).run(),await e.env.DB.prepare(`INSERT INTO license_activations (license_id, user_id, event_type)
     VALUES (?, ?, 'revoked')`).bind(t,e.get("user").id).run(),e.json({ok:!0})});P.post("/api/admin/licenses/:id/reactivate",f,I,async e=>{const t=parseInt(e.req.param("id"),10);return await e.env.DB.prepare("UPDATE licenses SET is_active=1, updated_at=datetime('now','+9 hours') WHERE id=?").bind(t).run(),e.json({ok:!0})});P.get("/api/admin/subscriptions",f,I,async e=>{const{results:t}=await e.env.DB.prepare(`SELECT s.*, u.email AS user_email
       FROM user_subscriptions s
       LEFT JOIN users u ON u.id = s.user_id
       ORDER BY s.updated_at DESC LIMIT 300`).all();return e.json({subscriptions:t||[]})});P.get("/api/admin/posts/summary",f,I,async e=>{const t=await e.env.DB.prepare("SELECT COUNT(*) AS n FROM post_queue").first(),a=await e.env.DB.prepare("SELECT COUNT(*) AS n FROM post_queue WHERE status='pending'").first(),s=await e.env.DB.prepare("SELECT COUNT(*) AS n FROM post_logs WHERE status='success'").first(),n=await e.env.DB.prepare("SELECT COUNT(*) AS n FROM post_logs WHERE status='failed'").first(),{results:i}=await e.env.DB.prepare(`SELECT pl.created_at, pl.content, pl.status,
            u.email, x.x_screen_name
       FROM post_logs pl
       LEFT JOIN users u  ON u.id = pl.user_id
       LEFT JOIN x_accounts x ON x.id = pl.x_account_id
       ORDER BY pl.created_at DESC LIMIT 100`).all();return e.json({stats:[{label:"全キュー",value:(t==null?void 0:t.n)??0},{label:"pending",value:(a==null?void 0:a.n)??0},{label:"成功",value:(s==null?void 0:s.n)??0},{label:"失敗",value:(n==null?void 0:n.n)??0}],recent:i||[]})});P.get("/api/admin/x-accounts",f,I,async e=>{const{results:t}=await e.env.DB.prepare(`SELECT xa.id, xa.x_screen_name, xa.is_active, xa.last_used_at, xa.token_expires_at,
            u.email AS user_email
       FROM x_accounts xa
       LEFT JOIN users u ON u.id = xa.user_id
       ORDER BY xa.id DESC LIMIT 500`).all();return e.json({accounts:t||[]})});P.get("/api/admin/audit-logs",f,I,async e=>{const{results:t}=await e.env.DB.prepare(`SELECT id, user_id, email, event_type, ip_address, user_agent, metadata, created_at
       FROM auth_logs ORDER BY id DESC LIMIT 300`).all();return e.json({logs:t||[]})});P.get("/api/admin/settings",f,I,async e=>{const{results:t}=await e.env.DB.prepare("SELECT key, value, description FROM system_settings ORDER BY key").all();return e.json({settings:t||[]})});P.post("/api/admin/settings",f,I,async e=>{const{key:t,value:a}=await e.req.json();return await e.env.DB.prepare(`INSERT INTO system_settings (key, value, updated_at)
     VALUES (?, ?, datetime('now','+9 hours'))
     ON CONFLICT(key) DO UPDATE SET value=excluded.value, updated_at=datetime('now','+9 hours')`).bind(t,a).run(),e.json({ok:!0})});const te=new D;te.post("/api/auth/register",async e=>{const t=await e.req.json(),a=(t.email||"").trim().toLowerCase(),s=t.password||"";if(!/^[^@\s]+@[^@\s]+\.[^@\s]+$/.test(a)||s.length<8)return e.json({error:"invalid_input"},400);const n=await e.env.DB.prepare("SELECT value FROM system_settings WHERE key='invite_only'").first();if((n==null?void 0:n.value)==="1")return e.json({error:"invite_only"},403);if(await e.env.DB.prepare("SELECT 1 FROM users WHERE email = ?").bind(a).first())return e.json({error:"email_taken"},409);const r=await kt(s),d=await e.env.DB.prepare("SELECT value FROM system_settings WHERE key='trial_days'").first(),o=parseInt((d==null?void 0:d.value)??"7",10),l=await e.env.DB.prepare("SELECT value FROM system_settings WHERE key='trial_require_approval'").first(),c=(l==null?void 0:l.value)!=="0";v();const m=(await e.env.DB.prepare(`INSERT INTO users (email, password_hash, is_approved, is_admin, trial_start, trial_end)
     ...
     VALUES (?, ?, datetime('now','+9 hours'),
             datetime('now','+9 hours', '+' || ? || ' days'))`).bind(a,m,o).run(),await J(e,"register",{userId:m,email:a}),e.json({ok:!0,user_id:m,approved:!c,message:c?"登録を受け付けました。管理者による承認後にログインできます。":"登録が完了しました。ログインしてください。"})});te.post("/api/auth/login",async e=>{const t=await e.req.json(),a=(t.email||"").trim().toLowerCase(),s=t.password||"";if(!a||!s)return e.json({error:"invalid_input"},400);const n=await e.env.DB.prepare("SELECT id,email,password_hash,is_approved,is_admin FROM users WHERE email = ?").bind(a).first();if(!n)return await J(e,"login_fail",{email:a,metadata:{reason:"no_user"}}),e.json({error:"invalid_credentials"},401);if(!await Ht(s,n.password_hash))return await J(e,"login_fail",{userId:n.id,email:a,metadata:{reason:"bad_password"}}),e.json({error:"invalid_credentials"},401);if(n.is_approved===0)return await J(e,"login_blocked",{userId:n.id,email:a,metadata:{reason:"not_approved"}}),e.json({error:"not_approved"},403);const r=n.trial_end;if(r&&!n.is_admin){const l=new Date,c=new Date(r.replace(" ","T")),u=await e.env.DB.prepare("SELECT status FROM user_subscriptions WHERE user_id = ?").bind(n.id).first();if((u==null?void 0:u.status)!=="active"&&l>c)return await J(e,"trial_expired",{userId:n.id,email:a}),e.json({error:"trial_expired",message:"無料お試し期間が終了いたしました。"},403)}const d=await qa({uid:n.id,email:n.email,adm:n.is_admin===1},e.env.JWT_SECRET,3600*24*7),o=Ut(Wt,d,{maxAge:3600*24*7});return await J(e,"login_success",{userId:n.id,email:a}),new Response(JSON.stringify({ok:!0,user_id:n.id,email:n.email,is_admin:n.is_admin===1}),{headers:{"content-type":"application/json","set-cookie":o}})});te.post("/api/auth/logout",async e=>{const t=e.get("user");t&&await J(e,"logout",{userId:t.id,email:t.email});const a=Ut(Wt,"",{maxAge:0});return new Response(JSON.stringify({ok:!0}),{headers:{"content-type":"application/json","set-cookie":a}})});te.get("/api/auth/me",f,e=>e.json({ok:!0,user:e.get("user")}));te.post("/api/auth/license/activate",f,async e=>{const t=e.get("user"),{license_key:a}=await e.req.json();if(!a||!Wa(a))return e.json({error:"invalid_license_format"},400);const s=a.trim().toUpperCase(),n=await e.env.DB.prepare("SELECT * FROM licenses WHERE license_key = ?").bind(s).first();if(!n)return e.json({error:"license_not_found"},404);if(n.is_active===0)return e.json({error:"license_inactive"},409);if(n.expires_at&&n.expires_at<v())return e.json({error:"license_expired"},409);if(n.user_id&&n.user_id!==t.id)return e.json({error:"license_already_used"},409);await e.env.DB.prepare(`UPDATE licenses
       SET user_id = ?, activated_at = COALESCE(activated_at, datetime('now','+9 hours')),
           updated_at = datetime('now','+9 hours')
     WHERE id = ?`).bind(t.id,n.id).run();const i=n.plan_code||"ge365x_standard",r=n.license_type==="trial"?"trial":"active",d=n.expires_at?n.expires_at:n.license_type==="lifetime"?"2099-12-31 23:59:59":null;return await e.env.DB.prepare(`INSERT INTO user_subscriptions
     ...
     ON CONFLICT(user_id) DO UPDATE SET
       ...
       updated_at = datetime('now','+9 hours')`).bind(t.id,i,r,d).run(),await e.env.DB.prepare(`UPDATE users
     ...
     VALUES (?, ?, 'activated', ?, ?)`).bind(n.id,t.id,e.req.header("cf-connecting-ip")||"",e.req.header("user-agent")||"").run(),await J(e,"license_activate",{userId:t.id,email:t.email,metadata:{license_id:n.id,plan_code:i}}),e.json({ok:!0,plan_code:i,status:r,license_type:n.license_type,expires_at:d})});te.post("/api/auth/password/change",f,async e=>{const t=e.get("user"),{current_password:a,new_password:s}=await e.req.json();if(!a||!s||s.length<8)return e.json({error:"invalid_input"},400);const n=await e.env.DB.prepare("SELECT password_hash FROM users WHERE id = ?").bind(t.id).first();if(!n)return e.json({error:"user_not_found"},404);if(!await Ht(a,n.password_hash))return e.json({error:"invalid_credentials"},401);const r=await kt(s);return await e.env.DB.prepare("UPDATE users SET password_hash=?, updated_at=datetime('now','+9 hours') WHERE id=?").bind(r,t.id).run(),await J(e,"password_change",{userId:t.id,email:t.email}),e.json({ok:!0})});te.get("/license-request",async e=>{const t=e.req.query("msg")||"",a=e.req.query("ok")||"";return e.html(`<!DOCTYPE html>
...
<div class="warn">⚠️ ログイン後すぐにパスワードを変更してください<br>このURLは設定後も有効なため、token を知らない人には教えないでください</div>
      ...
      WHERE is_active = 1
      ORDER BY sort_order ASC`).all(),a=(t||[]).map(s=>({...s,features:s.features?JSON.parse(s.features):[]}));return e.json({plans:a})});_e.get("/api/subscription/me",f,async e=>{const t=e.get("user"),a=await e.env.DB.prepare(`SELECT s.plan_code, s.status, s.started_at, s.current_period_end, s.cancel_at_period_end,
      ...
      WHERE s.user_id = ?`).bind(t.id).first();return a?e.json({subscription:{...a,features:a.features?JSON.parse(a.features):[]}}):e.json({subscription:null})});_e.post("/api/subscription/cancel",f,async e=>{const t=e.get("user");return await e.env.DB.prepare(`UPDATE user_subscriptions
       SET cancel_at_period_end = 1, updated_at = datetime('now','+9 hours')
     WHERE user_id = ?`).bind(t.id).run(),e.json({ok:!0})});_e.post("/api/subscription/reactivate",f,async e=>{const t=e.get("user");return await e.env.DB.prepare(`UPDATE user_subscriptions
       SET cancel_at_period_end = 0, status = 'active', updated_at = datetime('now','+9 hours')
     WHERE user_id = ?`).bind(t.id).run(),e.json({ok:!0})});_e.get("/api/subscription/payments",f,async e=>{const t=e.get("user"),{results:a}=await e.env.DB.prepare(`SELECT id, amount_jpy, currency, provider, external_id, status, plan_code, paid_at, created_at
       FROM payment_history
      WHERE user_id = ?
      ORDER BY created_at DESC
      LIMIT 50`).bind(t.id).all();return e.json({payments:a||[]})});_e.post("/api/subscription/stripe/checkout",f,async e=>e.env.STRIPE_SECRET_KEY?e.json({error:"not_implemented_yet"},501):e.json({error:"stripe_not_configured"},501));_e.post("/api/subscription/webhook/stripe",async e=>e.json({received:!0}));const ia=new TextEncoder,Ka="https://api.x.com/2",Ja="https://upload.x.com/1.1";class j extends Error{constructor(a,s=0,n="api_error"){super(a);g(this,"statusCode");g(this,"errorType");this.name="XApiError",this.statusCode=s,this.errorType=n}}class St extends j{constructor(a){super("Rate limited by X API (429)",429,"rate_limit");g(this,"resetAtEpoch");this.name="XApiRateLimitError",this.resetAtEpoch=a}}function se(e){return encodeURIComponent(e).replace(/[!'()*]/g,t=>"%"+t.charCodeAt(0).toString(16).toUpperCase())}function An(e){const t=new Uint8Array(e);return crypto.getRandomValues(t),[...t].map(a=>a.toString(16).padStart(2,"0")).join("")}function Dn(){return An(16)}async function In(e,t){const a=await crypto.subtle.importKey("raw",ia.encode(e),{name:"HMAC",hash:"SHA-1"},!1,["sign"]),s=await crypto.subtle.sign("HMAC",a,ia.encode(t)),n=new Uint8Array(s);let i="";for(let r=0;r<n.length;r++)i+=String.fromCharCode(n[r]);return btoa(i)}async function zt(e,t,a,s){const n={oauth_consumer_key:a.consumerKey,oauth_nonce:Dn(),oauth_signature_method:"HMAC-SHA1",oauth_timestamp:Math.floor(Date.now()/1e3).toString(),oauth_token:a.accessToken,oauth_version:"1.0"},i=new URL(t),r={...n};if(i.searchParams.forEach((m,h)=>{r[h]=m}),s)for(const[m,h]of Object.entries(s))h!=null&&(r[m]=String(h));const d=Object.keys(r).sort().map(m=>`${se(m)}=${se(r[m])}`).join("&"),o=[e.toUpperCase(),se(`${i.origin}${i.pathname}`),se(d)].join("&"),l=`${se(a.consumerSecret)}&${se(a.accessTokenSecret)}`,c=await In(l,o);return n.oauth_signature=c,`OAuth ${Object.keys(n).sort().map(m=>`${se(m)}="${se(n[m])}"`).join(", ")}`}async function ct(e,t,a,s){const n=`${Ka}${t}`,i=await zt(e,n,s),r={method:e,headers:{authorization:i,"content-type":"application/json"},signal:AbortSignal.timeout(3e4)};a!==void 0&&(r.body=JSON.stringify(a));const d=await fetch(n,r);if(d.status===429){const o=d.headers.get("x-rate-limit-reset");throw new St(o?Number(o):void 0)}if(!d.ok){const o=await d.text();throw new j(`X API ${e} ${t} failed: ${d.status} ${o.slice(0,500)}`,d.status,"api_error")}return d.status===204?{}:d.json()}async function Yt(e,t){var s,n;const a=await ct("POST","/tweets",{text:t},e);return{id:((s=a==null?void 0:a.data)==null?void 0:s.id)||"",text:((n=a==null?void 0:a.data)==null?void 0:n.text)||t}}async function Kt(e,t,a,s){var r,d;const n={text:t};a&&a.length&&(n.media={media_ids:a.slice(0,4)}),s&&(n.reply={in_reply_to_tweet_id:s});const i=await ct("POST","/tweets",n,e);return{id:((r=i==null?void 0:i.data)==null?void 0:r.id)||"",text:((d=i==null?void 0:i.data)==null?void 0:d.text)||t}}async function On(e,t){await ct("DELETE",`/tweets/${t}`,void 0,e)}async function Va(e){var a,s,n,i;if(!e)throw new j("credentials未設定",0,"missing_credentials");if(!((a=e.consumerKey)!=null&&a.trim()))throw new j("API Key未設定",0,"missing_credentials");if(!((s=e.consumerSecret)!=null&&s.trim()))throw new j("API Secret未設定",0,"missing_credentials");if(!((n=e.accessToken)!=null&&n.trim()))throw new j("Access Token未設定",0,"missing_token");if(!((i=e.accessTokenSecret)!=null&&i.trim()))throw new j("Access Token Secret未設定",0,"missing_token");const t=await ct("GET","/users/me?user.fields=profile_image_url,public_metrics",void 0,e);return t==null?void 0:t.data}async function Rn(e,t,a=20){const s=await ct("GET",`/users/${t}/tweets?max_results=${a}&tweet.fields=created_at,text,in_reply_to_user_id&exclude=replies,retweets`,void 0,e);return(s==null?void 0:s.data)||[]}async function Xe(e,t,a,s,n,i){const r=new URL(`${Ja}${t}`);s&&Object.entries(s).forEach(([m,h])=>r.searchParams.set(m,h));const d=r.toString(),o={};if(n&&!i)for(const[m,h]of Object.entries(n))o[m]=String(h);const l=await zt(e,d,a,o),c={method:e.toUpperCase(),headers:{authorization:l}};i?c.body=i:n&&(c.body=Object.entries(n).map(([m,h])=>`${encodeURIComponent(m)}=${encodeURIComponent(String(h))}`).join("&"),c.headers["content-type"]="application/x-www-form-urlencoded");const u=await fetch(d,c);if(!u.ok){const m=await u.text();throw new j(`X Upload ${e} ${t} failed: ${u.status} ${m.slice(0,300)}`,u.status,"media_upload_failed")}return u.status===204?{}:u.json()}async function jn(e,t,a){const s=t instanceof Uint8Array?t:new Uint8Array(t),n=new FormData;n.append("media",new Blob([s],{type:a}));const i=await Xe("POST","/media/upload.json",e,null,null,n);return{media_id:i.media_id_string||String(i.media_id),size:i.size}}async function Bn(e,t,a){var c;const s=t instanceof Uint8Array?t:new Uint8Array(t),n=s.length,i=await Xe("POST","/media/upload.json",e,null,{command:"INIT",total_bytes:n,media_type:a,media_category:"tweet_video"},null),r=i.media_id_string||String(i.media_id),d=4*1024*1024;let o=0;for(let u=0;u<n;u+=d){const m=s.slice(u,Math.min(u+d,n)),h=new FormData;h.append("command","APPEND"),h.append("media_id",r),h.append("segment_index",String(o)),h.append("media",new Blob([m],{type:a})),await Xe("POST","/media/upload.json",e,null,null,h),o++}const l=await Xe("POST","/media/upload.json",e,null,{command:"FINALIZE",media_id:r},null);if(l.processing_info){let u=0;for(;u<30;){await new Promise(_=>setTimeout(_,(l.processing_info.check_after_secs||5)*1e3));const h=(await Xe("GET","/media/upload.json",e,{command:"STATUS",media_id:r},null,null)).processing_info;if(!h||h.state==="succeeded")break;if(h.state==="failed")throw new j("動画処理失敗: "+(((c=h.error)==null?void 0:c.message)||""),0,"video_process_failed");u++}}return{media_id:r,size:n}}async function Tt(e,t,a){var d,o;const s=((a==null?void 0:a.apiKey)??e.X_API_KEY??"").trim(),n=((a==null?void 0:a.apiSecret)??e.X_API_SECRET??"").trim();if(!s||!n)throw new j("X API Key/Secret 未設定",0,"no_api_key");if(!((d=t==null?void 0:t.access_token)!=null&&d.trim()))throw new j("Access Token 未設定",0,"no_token");if(!((o=t==null?void 0:t.access_token_secret)!=null&&o.trim()))throw new j("Access Token Secret 未設定",0,"no_token_secret");let i,r;try{i=await tt(t.access_token,e.ENCRYPTION_KEY)}catch{throw new j("Access Token の復号に失敗",0,"decrypt_failed")}try{r=await tt(t.access_token_secret,e.ENCRYPTION_KEY)}catch{throw new j("Access Token Secret の復号に失敗",0,"decrypt_failed")}if(!i.trim())throw new j("Access Token が空",0,"decrypt_failed");if(!r.trim())throw new j("Access Token Secret が空",0,"decrypt_failed");return{consumerKey:s,consumerSecret:n,accessToken:i,accessTokenSecret:r}}const Cn=Object.freeze(Object.defineProperty({__proto__:null,XApiError:j,XApiRateLimitError:St,X_API_BASE:Ka,X_UPLOAD_BASE:Ja,buildCredentialsFromAccount:Tt,buildOAuth1Header:zt,deleteTweet:On,getMe:Va,getUserRecentTweets:Rn,percentEncode:se,postToX:Yt,postToXWithMedia:Kt,uploadImage:jn,uploadVideo:Bn},Symbol.toStringTag,{value:"Module"}));async function ra(e,t){if(!e)return"";try{return await tt(e,t)}catch{return""}}const be=new D;be.get("/api/admin/accounts",f,async e=>{const t=e.get("user"),{results:a}=await e.env.DB.prepare(`SELECT id, account_name, x_user_id, x_username,
            daily_post_count, daily_post_limit, last_posted_at,
            account_health_score, health_status, is_active, is_current, created_at
       FROM x_accounts WHERE user_id = ? ORDER BY id DESC`).bind(t.id).all();return e.json({accounts:a||[]})});be.post("/api/admin/accounts",f,async e=>{var r,d;const t=e.get("user"),a=await e.req.json();if(!a.account_name)return e.json({error:"account_name required"},400);if(!((r=a.access_token)!=null&&r.trim())||!((d=a.access_token_secret)!=null&&d.trim()))return e.json({error:"access_token and access_token_secret required"},400);const s=await ee(a.access_token.trim(),e.env.ENCRYPTION_KEY),n=await ee(a.access_token_secret.trim(),e.env.ENCRYPTION_KEY),i=await e.env.DB.prepare(`INSERT INTO x_accounts
       (user_id, account_name, access_token, access_token_secret, daily_post_limit, is_active)
     VALUES (?, ?, ?, ?, ?, 1)`).bind(t.id,a.account_name,s,n,a.daily_post_limit??5).run();return e.json({success:!0,id:i.meta.last_row_id})});be.post("/api/admin/accounts/:id/test",f,async e=>{const t=e.get("user"),a=parseInt(e.req.param("id"),10),s=await e.env.DB.prepare("SELECT * FROM x_accounts WHERE id=? AND user_id=?").bind(a,t.id).first();if(!s)return e.json({success:!1,error:"not_found"},404);try{const n=await e.env.DB.prepare("SELECT api_key, api_secret FROM x_api_settings WHERE user_id=? LIMIT 1").bind(t.id).first(),i=n!=null&&n.api_key?{apiKey:await ra(n.api_key,e.env.ENCRYPTION_KEY),apiSecret:await ra(n.api_secret||"",e.env.ENCRYPTION_KEY)}:void 0,r=await Tt(e.env,s,i),d=await Va(r);return d!=null&&d.id&&await e.env.DB.prepare(`UPDATE x_accounts SET x_user_id=?, x_username=?, is_active=1,
           ...
           updated_at=? WHERE id=?`).bind(d.id,d.username||null,v(),a).run(),e.json({success:!0,me:d})}catch(n){const i=n instanceof j?n.statusCode:0;return e.json({success:!1,error:n.message,status_code:i,error_type:n==null?void 0:n.errorType})}});be.post("/api/admin/accounts/:id/current",f,async e=>{const t=e.get("user"),a=parseInt(e.req.param("id"),10);return await e.env.DB.batch([e.env.DB.prepare("UPDATE x_accounts SET is_current=0 WHERE user_id=?").bind(t.id),e.env.DB.prepare("UPDATE x_accounts SET is_current=1, updated_at=? WHERE id=? AND user_id=?").bind(v(),a,t.id)]),e.json({success:!0})});be.post("/api/admin/accounts/:id/toggle",f,async e=>{const t=e.get("user"),a=parseInt(e.req.param("id"),10);return await e.env.DB.prepare("UPDATE x_accounts SET is_active = 1 - is_active, updated_at = ? WHERE id=? AND user_id=?").bind(v(),a,t.id).run(),e.json({success:!0})});be.put("/api/admin/accounts/:id",f,async e=>{var r,d;const t=e.get("user"),a=parseInt(e.req.param("id"),10),s=await e.req.json(),n=[],i=[];if(s.account_name&&(n.push("account_name=?"),i.push(s.account_name)),s.daily_post_limit!==void 0&&(n.push("daily_post_limit=?"),i.push(s.daily_post_limit)),(r=s.access_token)!=null&&r.trim()){const o=await ee(s.access_token.trim(),e.env.ENCRYPTION_KEY);n.push("access_token=?"),i.push(o)}if((d=s.access_token_secret)!=null&&d.trim()){const o=await ee(s.access_token_secret.trim(),e.env.ENCRYPTION_KEY);n.push("access_token_secret=?"),i.push(o)}return n.length===0?e.json({success:!1,error:"no_fields"}):(n.push("updated_at=?"),i.push(v(),a,t.id),await e.env.DB.prepare(`UPDATE x_accounts SET ${n.join(", ")} WHERE id=? AND user_id=?`).bind(...i).run(),e.json({success:!0}))});be.delete("/api/admin/accounts/:id",f,async e=>{const t=e.get("user");return await e.env.DB.prepare("DELETE FROM x_accounts WHERE id=? AND user_id=?").bind(parseInt(e.req.param("id"),10),t.id).run(),e.json({success:!0})});const Ln=["20代","30代","40代","50代"],Nn=["男性","女性"],Mn=["美容","健康","副業","投資","AI活用","ダイエット","お金"],$n={美容:"老化・肌荒れ・見た目の変化",健康:"疲れやすい・体力低下・不調",副業:"時間がない・何から始めるか不明",投資:"勝てない・資産が増えない",AI活用:"手作業が多い・効率が悪い",ダイエット:"リバウンド・続かない",お金:"貯まらない・将来不安"},Fn={美容:"若々しくなりたい",健康:"元気に過ごしたい",副業:"収益化したい",投資:"安定して利益を出したい",AI活用:"業務を自動化したい",ダイエット:"理想の体型になりたい",お金:"経済的自由を得たい"},Xa=[];for(const e of Ln)for(const t of Nn)for(const a of Mn)Xa.push({key:`${e}_${t}_${a}`,label:`${e}${t}/${a}`,gender:t,age_range:e,genre:a,problem:$n[a]||`${a}に悩んでいる`,goal:Fn[a]||`${a}で成果を出したい`,knowledge:"一般"});const Pn=[{key:"authority",label:"権威型",instruction:"専門家として断定的に、簡潔に、根拠を示して書く。"},{key:"empathy",label:"共感型",instruction:"読者の悩みに寄り添い、共感を起点に語りかけるように書く。"},{key:"provocative",label:"煽り型",instruction:"問題を鋭く突き、危機感を持たせる書き方にする。"},{key:"story",label:"ストーリー型",instruction:"体験談や変化の流れを感じさせる構成で書く。"},{key:"problem_raise",label:"問題提起型",instruction:"最初に課題を提示し、その原因と解決策を示す。"}],$t={problem:{name:"問題提起型",instruction:`【問題提起型】
1.冒頭で読者の痛みを突く質問
2.具体的な3つの「あるある」
3.「実はそれ○○が原因」と核心
4.解決の方向性
...
3.なぜその数字か
4.読者が同じ結果を得る条件
5.CTA`}};async function Ga(e,t){var r,d,o;const a=t.model||"gpt-4o-mini",s=t.maxTokens||4e3,n=t.temperature??.7,i=t.baseUrl||"https://api.openai.com/v1";for(let l=1;l<=3;l++)try{const c=await fetch(`${i}/chat/completions`,{method:"POST",headers:{authorization:`Bearer ${t.apiKey}`,"content-type":"application/json"},body:JSON.stringify({model:a,messages:e,max_tokens:s,temperature:n}),signal:AbortSignal.timeout(12e4)});if(!c.ok){const m=await c.text();if(c.status>=500&&l<3){await new Promise(h=>setTimeout(h,2e3*l));continue}throw new Error(`OpenAI API error: ${c.status} ${m.slice(0,500)}`)}const u=await c.json();return((o=(d=(r=u==null?void 0:u.choices)==null?void 0:r[0])==null?void 0:d.message)==null?void 0:o.content)||""}catch(c){if(((c==null?void 0:c.name)==="TimeoutError"||(c==null?void 0:c.name)==="AbortError")&&l<3){await new Promise(m=>setTimeout(m,2e3*l));continue}throw c}return""}function Za(e){let t=`以下のルールを厳守してX(Twitter)投稿文を生成してください。
...
`}const a=`
Markdown記号(#,##)禁止。見出しは「■」。番号リスト禁止。自然な文章で。箇条書きは「・」のみ。`;let s="";e.patternType&&$t[e.patternType]&&(s=`
【投稿パターン（構造のみ）】
${$t[e.patternType].instruction}`);let n=`テーマ: ${e.theme||""}${e.keywords?`
...
`),t.trim()}async function Qa(e,t,a,s,n,i="body"){const{messages:r}=Za({theme:t,keywords:a,brandVoice:n,targetDna:s,postMode:i||"body"}),d=await Ga(r,{apiKey:e,temperature:.8});return At(d,i)}async function es(e,t,a,s,n,i,r="body"){if(!$t[t])throw new Error(`未対応のパターン: ${t}`);const{messages:d}=Za({theme:a,keywords:s,brandVoice:i,targetDna:n,patternType:t,postMode:r||"body"}),o=await Ga(d,{apiKey:e,temperature:.8});return At(o,r)}function At(e,t){if(!e)return"";let a=e.replace(/^#{1,4}\s*/gm,"").replace(/^[▪️■●•\-\*]+\s*/gm,"").replace(/^\d+\.\s/gm,"").replace(/^(Step\d+)[:\s]/gim,"").replace(/^[①②③④⑤⑥⑦⑧⑨⑩]\s*/gm,"・").replace(/\*\*([^*]+)\*\*/g,"$1").replace(/\n{3,}/g,`

`).trim();return a=Hn(a),t==="140"&&a.length>140&&(a=a.slice(0,137)+"..."),a}function Hn(e){if(!e)return"";const t=e.split(`
`).length,a=e.replace(/\n/g,"").length;if(t>3||a<40)return e;const s=e.split(new RegExp("(?<=[。！？!?\\n])","g")).filter(r=>r.trim());if(s.length<=1)return e;let n="",i=0;for(let r=0;r<s.length;r++){const d=s[r].trim();if(d){if(/^https?:\/\//.test(d)||/^#/.test(d)||/^@/.test(d)){n&&!n.endsWith(`
`)&&(n+=`
`),n+=d,i=0;continue}n+=d,i++,i>=2&&r<s.length-1?(n+=`

`,i=0):r<s.length-1&&!d.endsWith(`
`)&&(n+=`
`)}}return n.replace(/\n{3,}/g,`

`).trim()}const Un=new TextEncoder;async function De(e){const t=await crypto.subtle.digest("SHA-256",Un.encode(e||""));return[...new Uint8Array(t)].slice(0,8).map(s=>s.toString(16).padStart(2,"0")).join("")}function Ft(e){const t=(e||"").replace(/\s+/g,"").slice(0,2e3),a=new Set;for(let s=0;s<t.length-1;s++)a.add(t.slice(s,s+2));return a}function ts(e,t){const a=Ft(e),s=Ft(t);if(a.size===0&&s.size===0)return 0;let n=0;for(const r of a)s.has(r)&&n++;const i=a.size+s.size-n;return i===0?0:n/i}const Wn=120*1e3;async function as(e,t){const a=new Date().toISOString(),s=new Date(Date.now()-Wn).toISOString(),n=await e.DB.prepare("SELECT account_id, locked_at FROM post_locks WHERE account_id = ?").bind(t).first();return n&&n.locked_at>s?!1:(await e.DB.prepare(`INSERT INTO post_locks (account_id, locked_at) VALUES (?, ?)
     ON CONFLICT(account_id) DO UPDATE SET locked_at = excluded.locked_at`).bind(t,a).run(),!0)}async function ss(e,t){await e.DB.prepare("DELETE FROM post_locks WHERE account_id = ?").bind(t).run()}async function ns(e,t,a,s,n){const i={ok:!0,errors:[],warnings:[]},r=await e.DB.prepare("SELECT daily_post_count, daily_post_limit, last_posted_at, last_daily_reset_date, health_status FROM x_accounts WHERE id = ?").bind(t).first();if(!r)return i.ok=!1,i.errors.push({code:"account_not_found",message:"アカウントが存在しません"}),i;const d=new Date(Date.now()+9*3600*1e3).toISOString().slice(0,10);let o=r.daily_post_count||0;if(r.last_daily_reset_date!==d&&(o=0),o>=(r.daily_post_limit||5)&&i.errors.push({code:"daily_limit_reached",message:`日次投稿上限 (${r.daily_post_limit}) に達しています`}),r.last_posted_at){const c=Date.parse(r.last_posted_at.replace(" ","T")+"+09:00");if(!Number.isNaN(c)){const u=(Date.now()-c)/6e4;u<15&&i.errors.push({code:"too_frequent",message:`前回投稿から ${Math.floor(u)} 分しか経過していません（最低 15 分）`,overridable:!0})}}const{results:l}=await e.DB.prepare(`SELECT id, body FROM post_queue
       WHERE account_id = ? AND status IN ('posted','approved','publishing')
       ORDER BY COALESCE(posted_at, scheduled_at, created_at) DESC
       LIMIT 5`).bind(t).all();for(const c of l||[]){const u=ts(a,c.body||"");if(u>=.7){i.errors.push({code:"too_similar",message:`過去投稿 (ID: ${c.id}) と類似度 ${u.toFixed(2)} で重複`});break}}if(s){const c=await e.DB.prepare(`SELECT COUNT(*) AS n FROM post_queue
        WHERE account_id = ? AND link_url = ? AND status IN ('posted','approved','publishing')
          AND DATE(COALESCE(posted_at, scheduled_at, created_at)) >= DATE('now','+9 hours','-7 days')`).bind(t,s).first();((c==null?void 0:c.n)??0)>=3&&i.errors.push({code:"link_spam",message:`同一リンクを過去7日で${c==null?void 0:c.n}回使用しています`})}if(n){const c=oa(n);if(c.size>0){const{results:u}=await e.DB.prepare(`SELECT hashtags FROM post_queue
           WHERE account_id = ? AND status IN ('posted','approved','publishing') AND hashtags IS NOT NULL AND hashtags != ''
           ORDER BY COALESCE(posted_at, scheduled_at, created_at) DESC LIMIT 3`).bind(t).all();(u||[]).length>=3&&(u||[]).every(h=>{const E=[...oa(h.hashtags||"")].filter(A=>c.has(A)).length;return(c.size===0?0:E/c.size)>=.8})&&i.errors.push({code:"hashtag_spam",message:"同一ハッシュタグセットが 3 回連続で 80%以上一致しています"})}}return r.health_status==="risk"&&i.errors.push({code:"health_risk",message:"アカウント健全性スコアが危険域です。投稿を控えてください。"}),i.ok=i.errors.length===0,i}function oa(e){return new Set((e||"").split(/[\s,]+/).map(t=>t.trim().replace(/^#/,"").toLowerCase()).filter(Boolean))}async function xt(e,t,a,s,n){const i=await e.DB.prepare("SELECT account_health_score FROM x_accounts WHERE id = ?").bind(t).first();if(!i)return{score_after:100,status_after:"healthy"};let r=Math.max(0,Math.min(100,(i.account_health_score??100)+s));const d=r>=80?"healthy":r>=60?"caution":"risk";return await e.DB.prepare("UPDATE x_accounts SET account_health_score = ?, health_status = ?, updated_at = datetime('now','+9 hours') WHERE id = ?").bind(r,d,t).run(),await e.DB.prepare(`INSERT INTO account_health_events (account_id, event_type, delta, score_after, status_after, metadata)
     VALUES (?, ?, ?, ?, ?, ?)`).bind(t,a,s,r,d,n?JSON.stringify(n):null).run(),{score_after:r,status_after:d}}function da(e){if(!e)return Date.now();const t=e.replace(" ","T")+"+09:00",a=Date.parse(t);return Number.isNaN(a)?Date.now():a}function la(e){return new Date(e+324e5).toISOString().replace("T"," ").slice(0,19)}async function zn(e,t,a){const s=a.jitter_enabled!==!1,n=a.jitter_minutes??5,i=a.collision_avoidance_enabled!==!1,r=a.min_spacing_seconds??90;let d=da(t),o=0,l=0;if(s&&n>0){const m=Math.floor((Math.random()*2-1)*n*60);o=m,d+=m*1e3}if(i&&a.account_id){const m=la(d),h=[a.account_id,m,m];let _=`
      SELECT COALESCE(effective_scheduled_at, scheduled_at) AS sat
       ...
       WHERE account_id = ?
         ...
         AND datetime(COALESCE(effective_scheduled_at, scheduled_at)) <= datetime(?, '+1 hours')`;a.exclude_id&&(_+=" AND id != ?",h.push(a.exclude_id)),_+=" ORDER BY sat ASC";const{results:E}=await e.DB.prepare(_).bind(...h).all();let w=!0,A=0;for(;w&&A<30;){w=!1;for(const x of E||[]){const B=da(x.sat),C=Math.abs(d-B)/1e3;if(C<r){const L=(r-C+1)*1e3*(d>=B?1:-1);d+=L,l+=Math.floor(L/1e3),w=!0}}A++}}const c=la(d);return{effective_at:c,audit:{base_at:t,effective_at:c,jitter_applied_seconds:o,collision_adjusted_seconds:l,ruleset:{jitter_enabled:s,jitter_minutes:n,collision_avoidance_enabled:i,min_spacing_seconds:r}}}}async function Yn(e,t,a,s){await e.DB.prepare("INSERT INTO schedule_audits (post_id, account_id, audit_json) VALUES (?, ?, ?)").bind(t,a??null,JSON.stringify(s)).run()}const Kn=.7;async function Jn(e){const t=[...Ft(e)].slice(0,200),a=await De(e);return JSON.stringify({bigrams:t,content_hash:a})}async function Vn(e,t,a,s){await e.DB.prepare("INSERT INTO post_fingerprints (post_id, account_id, fingerprint) VALUES (?, ?, ?)").bind(t,a??null,s).run()}async function Xn(e,t,a,s={}){const n={pass:!0,blocked_reason:null,scores:[]};if(!t||!a)return n;const i=[a];let r=`SELECT id, body FROM post_queue
              WHERE account_id = ? AND body IS NOT NULL AND body != ''
                AND status IN ('posted','approved','publishing')`;s.post_id&&(r+=" AND id != ?",i.push(s.post_id)),r+=" ORDER BY COALESCE(posted_at, scheduled_at, created_at) DESC LIMIT 5";const{results:d}=await e.DB.prepare(r).bind(...i).all();for(const o of d||[]){const l=ts(t,o.body||"");if(n.scores.push({post_id:o.id,similarity:l}),l>=Kn){n.pass=!1,n.blocked_reason=`過去投稿(ID:${o.id})と類似度 ${l.toFixed(2)} で重複`;break}}return n}const q=new D;async function Gn(e,t,a){const s=String(a??"default");let n=await e.DB.prepare("SELECT * FROM target_templates WHERE account_id = ? AND (user_id = ? OR user_id IS NULL) LIMIT 1").bind(s,t).first();n||(n=await e.DB.prepare("SELECT * FROM target_templates WHERE user_id = ? OR user_id IS NULL ORDER BY is_default DESC, id ASC LIMIT 1").bind(t).first());let i=await e.DB.prepare("SELECT * FROM brand_voice WHERE account_id = ? AND (user_id = ? OR user_id IS NULL) LIMIT 1").bind(s,t).first();return i||(i=await e.DB.prepare("SELECT * FROM brand_voice WHERE user_id = ? OR user_id IS NULL ORDER BY is_default DESC, id ASC LIMIT 1").bind(t).first()),{target:n,voice:i}}async function Zn(e,t){if(!(!e.TELEGRAM_BOT_TOKEN||!e.TELEGRAM_CHAT_ID))try{await fetch(`https://api.telegram.org/bot${e.TELEGRAM_BOT_TOKEN}/sendMessage`,{method:"POST",headers:{"content-type":"application/json"},body:JSON.stringify({chat_id:e.TELEGRAM_CHAT_ID,text:t,parse_mode:"HTML"})})}catch{}}async function ca(e,t){try{await e.DB.prepare(`INSERT INTO post_logs
     ...
     VALUES ('x', ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?,
             ...
             ?, ?, ?, ?,
             ?, ?, ?, ?, ?,
             ?, ?)`).bind(t.id,a.account_id??null,a.body,a.link_url??null,a.hashtags??null,a.post_mode??"body",a.status??"pending",a.scheduled_at??null,n,a.generation_type??null,a.source_type??"manual_post",a.recurrence_type??null,a.recurrence_rule??null,a.recurrence_end_at??null,a.next_run_at??null,a.recycle_rule??null,a.source_post_id??null,a.min_engagement_score??0,a.rewrite_mode??null,a.thread_parent_id??null,a.thread_order??0,a.thread_count??0,a.media_type??null,a.media_file_path??null,s,s).run();return e.json({success:!0,id:i.meta.last_row_id})});q.post("/api/admin/posts/generate",f,async e=>{const t=e.get("user"),{theme:a,keywords:s,count:n,pattern_type:i,post_mode:r,link_url:d,hashtags:o,footer_text:l,account_id:c,generation_type:u}=await e.req.json();if(!a)return e.json({error:"theme required"},400);let m=e.env.OPENAI_API_KEY||"";try{const x=await e.env.DB.prepare("SELECT value FROM system_settings WHERE key='openai_api_key' LIMIT 1").first();if(x!=null&&x.value){const{aesDecrypt:B}=await Promise.resolve().then(()=>lt),C=await B(x.value,e.env.ENCRYPTION_KEY);C&&(m=C)}}catch{}if(!m)return e.json({error:"OpenAI APIキーが設定されていません。API設定画面から設定してください。"},400);let h=c??null;if(!h){const x=await e.env.DB.prepare("SELECT id FROM x_accounts WHERE user_id=? AND is_active=1 ORDER BY id ASC LIMIT 1").bind(t.id).first();h=(x==null?void 0:x.id)??null}const{target:_,voice:E}=await Gn(e.env,t.id,h),w=v(),A=[];try{const x=Math.min(n||1,10);for(let B=0;B<x;B++){const C=r||"body";let L;i?L=await es(m,i,a,s||"",_,E,C):L=await Qa(m,a,s||"",_,E,C),L=qn(L),l&&(L=L.trimEnd()+`

`+l.trim());const mt=await De(L),Q=await e.env.DB.prepare(`INSERT INTO post_queue
         ...
         VALUES ('x', ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, 'pending', ?, ?)`).bind(t.id,h,a,s||"",L,d||null,o||null,C,i||null,mt,u||i||"general",i?"pattern_generated_post":"ai_generated_post",w,w).run();A.push({id:Q.meta.last_row_id,body:L,link_url:d||"",post_mode:C});try{await e.env.DB.prepare(`INSERT INTO generation_logs
             (user_id, account_id, brand_voice_id, target_setting_id, post_mode, generation_type, output_text)
           VALUES (?, ?, ?, ?, ?, ?, ?)`).bind(t.id,h,(E==null?void 0:E.id)??null,(_==null?void 0:_.id)??null,C,i||"general",L.slice(0,500)).run()}catch{}}return e.json({success:!0,generated:A,count:A.length})}catch(x){return e.json({error:"AI error: "+x.message},500)}});q.post("/api/admin/posts/:id/approve",f,async e=>{const t=e.get("user");return await e.env.DB.prepare("UPDATE post_queue SET status='approved', updated_at=? WHERE id=? AND user_id=?").bind(v(),parseInt(e.req.param("id"),10),t.id).run(),e.json({success:!0})});q.post("/api/admin/posts/:id/reject",f,async e=>{const t=e.get("user");return await e.env.DB.prepare("UPDATE post_queue SET status='rejected', updated_at=? WHERE id=? AND user_id=?").bind(v(),parseInt(e.req.param("id"),10),t.id).run(),e.json({success:!0})});q.post("/api/admin/posts/:id/schedule",f,async e=>{const t=e.get("user"),a=parseInt(e.req.param("id"),10),{scheduled_at:s,jitter_enabled:n=!0,jitter_minutes:i=5,collision_avoidance_enabled:r=!0,min_spacing_seconds:d=90}=await e.req.json();if(!s)return e.json({error:"scheduled_at required"},400);const o=await e.env.DB.prepare("SELECT * FROM post_queue WHERE id=? AND user_id=?").bind(a,t.id).first();if(!o)return e.json({success:!1,error:"Not found"},404);const l=await Xn(e.env,o.body||"",o.account_id??null,{post_id:o.id});if(!l.pass)return e.json({success:!1,error:"類似: "+l.blocked_reason,similarity_blocked:!0,scores:l.scores});const{effective_at:c,audit:u}=await zn(e.env,s,{jitter_enabled:n,jitter_minutes:i,collision_avoidance_enabled:r,min_spacing_seconds:d,account_id:o.account_id,exclude_id:o.id}),m=await Jn(o.body||"");return await Vn(e.env,o.id,o.account_id,m),await e.env.DB.prepare(`UPDATE post_queue SET
     ...
     WHERE id=?`).bind(s,c,c,n?1:0,i,r?1:0,d,JSON.stringify(u),v(),a).run(),await Yn(e.env,o.id,o.account_id,u),e.json({success:!0,base_scheduled_at:s,effective_scheduled_at:c,scheduled_at:c,audit:u})});q.post("/api/admin/posts/:id/post-now",f,async e=>{const t=e.get("user"),a=parseInt(e.req.param("id"),10),s=(await e.req.json().catch(()=>({}))).force_override===!0,n=await e.env.DB.prepare("SELECT * FROM post_queue WHERE id=? AND user_id=?").bind(a,t.id).first();if(!n)return e.json({success:!1,error:"Not found"},404);let i=null;if(n.account_id&&(i=await e.env.DB.prepare("SELECT * FROM x_accounts WHERE id=? AND user_id=?").bind(n.account_id,t.id).first()),i||(i=await e.env.DB.prepare("SELECT * FROM x_accounts WHERE user_id=? AND is_active=1 ORDER BY id ASC LIMIT 1").bind(t.id).first(),i&&await e.env.DB.prepare("UPDATE post_queue SET account_id=? WHERE id=?").bind(i.id,a).run()),!i)return e.json({success:!1,error:"No active X account"});const r=await ns(e.env,i.id,n.body||"",n.link_url,n.hashtags),d=r.errors.filter(o=>!(s&&o.overridable));if(d.length>0){const o=r.errors.find(l=>l.overridable);return o&&!s?e.json({success:!1,error:o.message,overridable:!0,cooldown_override:!0}):e.json({success:!1,error:"Safety: "+d.map(l=>l.message).join("; ")})}if(!await as(e.env,i.id))return e.json({success:!1,error:"Account busy"});try{await e.env.DB.prepare("UPDATE post_queue SET status='publishing', updated_at=? WHERE id=?").bind(v(),a).run();let o;try{const h=await e.env.DB.prepare("SELECT api_key, api_secret FROM x_api_settings WHERE user_id=? LIMIT 1").bind(t.id).first();if(h!=null&&h.api_key){const{aesDecrypt:_}=await Promise.resolve().then(()=>lt);o={apiKey:await _(h.api_key,e.env.ENCRYPTION_KEY),apiSecret:h.api_secret?await _(h.api_secret,e.env.ENCRYPTION_KEY):""}}}catch{}const l=await Tt(e.env,i,o);let c=At(n.body||"",n.post_mode);n.link_url&&(c+=`
`+n.link_url),n.hashtags&&(c+=`
`+n.hashtags);const u=[];if(n.media_json)try{const h=JSON.parse(n.media_json);for(const _ of(h||[]).slice(0,4)){const E=await e.env.DB.prepare("SELECT * FROM media_assets WHERE id=? AND user_id=?").bind(_,t.id).first();E!=null&&E.x_media_id&&u.push(E.x_media_id)}}catch{}const m=u.length>0?await Kt(l,c,u,null):await Yt(l,c);return await e.env.DB.prepare("UPDATE post_queue SET status='posted', external_post_id=?, posted_at=?, updated_at=? WHERE id=?").bind(m.id||"",v(),v(),a).run(),await e.env.DB.prepare(`UPDATE x_accounts SET last_posted_at=?, daily_post_count=daily_post_count+1,
         last_daily_reset_date = DATE('now','+9 hours'), updated_at=? WHERE id=?`).bind(v(),v(),i.id).run(),await ca(e.env,{record_id:a,account_id:i.id,user_id:t.id,account_name:i.account_name,source_type:n.source_type||"manual_post",generation_type:n.generation_type,post_mode:n.post_mode,content:n.body||"",content_hash:n.content_hash||"",link_url:n.link_url,posted_at:v(),status:"posted",api_response_summary:JSON.stringify({tweet_id:m.id})}),e.json({success:!0,tweet_id:m.id})}catch(o){return await e.env.DB.prepare("UPDATE post_queue SET status='failed', error_message=?, updated_at=? WHERE id=?").bind(o.message,v(),a).run(),await ca(e.env,{record_id:a,account_id:i.id,user_id:t.id,account_name:i.account_name,source_type:n.source_type,post_mode:n.post_mode,content:n.body||"",content_hash:n.content_hash||"",status:"failed",error_message:o.message}),o instanceof St?await xt(e.env,i.id,"rate_limit",-15):await xt(e.env,i.id,"error",-5,{message:o.message}),await Zn(e.env,`X post FAILED #${a} ${o.message}`),e.json({success:!1,error:o.message})}finally{await ss(e.env,i.id)}});q.put("/api/admin/posts/:id",f,async e=>{const t=e.get("user"),a=parseInt(e.req.param("id"),10),s=await e.req.json(),n=v(),i=s.body?await De(s.body):null;return s.media_json!==void 0&&s.body===void 0?(await e.env.DB.prepare("UPDATE post_queue SET media_json=?, updated_at=? WHERE id=? AND user_id=?").bind(s.media_json,n,a,t.id).run(),e.json({success:!0})):s.account_id!==void 0&&s.body===void 0?(await e.env.DB.prepare("UPDATE post_queue SET account_id=?, updated_at=? WHERE id=? AND user_id=?").bind(s.account_id,n,a,t.id).run(),e.json({success:!0})):(await e.env.DB.prepare(`UPDATE post_queue SET
       ...
       updated_at=?
     WHERE id=? AND user_id=?`).bind(s.body,s.link_url??null,s.hashtags??null,s.scheduled_at??null,s.post_mode??"body",s.media_json??null,i,s.recurrence_type??null,s.recurrence_rule??null,s.next_run_at??null,s.recurrence_end_at??null,n,a,t.id).run(),e.json({success:!0}))});q.delete("/api/admin/posts/:id",f,async e=>{const t=e.get("user");return await e.env.DB.prepare("DELETE FROM post_queue WHERE id=? AND user_id=?").bind(parseInt(e.req.param("id"),10),t.id).run(),e.json({success:!0})});q.post("/api/admin/posts/:id/cancel",f,async e=>{const t=e.get("user");return await e.env.DB.prepare("UPDATE post_queue SET status='cancelled', updated_at=? WHERE id=? AND user_id=?").bind(v(),parseInt(e.req.param("id"),10),t.id).run(),e.json({success:!0})});q.get("/api/admin/posts-scheduled",f,async e=>{const t=e.get("user"),a=e.req.query("account_id"),s=[t.id];let n="WHERE pq.platform='x' AND pq.user_id=? AND (pq.scheduled_at IS NOT NULL OR pq.status='pending') AND pq.status NOT IN ('cancelled','rejected','posted')";a&&(n+=" AND pq.account_id=?",s.push(Number(a)));const{results:i}=await e.env.DB.prepare(`SELECT pq.*, xa.account_name
       FROM post_queue pq LEFT JOIN x_accounts xa ON pq.account_id=xa.id
       ${n} ORDER BY pq.scheduled_at ASC`).bind(...s).all(),r=[t.id];let d="WHERE aj.user_id=? AND aj.status NOT IN ('cancelled','error') AND aj.publish_at IS NOT NULL";a&&(d+=" AND aj.account_id=?",r.push(Number(a)));const{results:o}=await e.env.DB.prepare(`SELECT aj.id, aj.account_id, aj.theme AS body, aj.publish_at AS scheduled_at, aj.status,
     ...
     VALUES ('x', ?, ?, ?, ?, 'thread', ?, ?, 'manual_post', 'pending', ?, ?)`).bind(t.id,n??null,a[0].body,a[0].link_url??s??null,a.length,r,i,i).run()).meta.last_row_id,l=[o];for(let c=1;c<a.length;c++){const u=await De(a[c].body),m=await e.env.DB.prepare(`INSERT INTO post_queue
       ...
       VALUES ('x', ?, ?, ?, ?, 'thread', ?, ?, ?, 'manual_post', 'pending', ?, ?)`).bind(t.id,n??null,a[c].body,a[c].link_url??null,o,c,u,i,i).run();l.push(m.meta.last_row_id)}return e.json({success:!0,parent_id:o,ids:l})});const is=new D,Qn=5;is.post("/cron/tick",async e=>{const t=v(),{results:a}=await e.env.DB.prepare(`SELECT * FROM post_queue
      WHERE platform='x'
      ...
      LIMIT ?`).bind(Qn).all();let s=0,n=0,i=0;for(const r of a||[]){const d=await e.env.DB.prepare("UPDATE post_queue SET status='publishing', updated_at=? WHERE id=? AND status IN ('pending','approved')").bind(t,r.id).run();if(!(!d.success||d.meta.changes===0)){s++;try{if(!r.account_id)throw new Error("account_id is null");const o=await e.env.DB.prepare("SELECT * FROM x_accounts WHERE id=?").bind(r.account_id).first();if(!o)throw new Error("account_not_found");const l=await ns(e.env,o.id,r.body||"",r.link_url,r.hashtags);if(!l.ok)throw new Error("safety: "+l.errors.map(c=>c.message).join("; "));if(!await as(e.env,o.id))throw new Error("account_busy");try{const c=await Tt(e.env,o);let u=At(r.body||"",r.post_mode);r.link_url&&(u+=`
`+r.link_url),r.hashtags&&(u+=`
`+r.hashtags);const m=[];if(r.media_json)try{const _=JSON.parse(r.media_json);for(const E of(_||[]).slice(0,4)){const w=await e.env.DB.prepare("SELECT x_media_id FROM media_assets WHERE id=?").bind(E).first();w!=null&&w.x_media_id&&m.push(w.x_media_id)}}catch{}const h=m.length>0?await Kt(c,u,m,null):await Yt(c,u);await e.env.DB.prepare("UPDATE post_queue SET status='posted', external_post_id=?, posted_at=?, updated_at=? WHERE id=?").bind(h.id||"",v(),v(),r.id).run(),await e.env.DB.prepare(`UPDATE x_accounts SET
             last_posted_at = ?,
             ...
             updated_at = ?
           WHERE id = ?`).bind(v(),v(),o.id).run(),await e.env.DB.prepare(`INSERT INTO post_logs
           ...
           VALUES (?, ?, ?, ?, 'x', ?, ?, ?, ?, ?, ?, ?, ?, 'posted', ?)`).bind(r.id,o.id,r.user_id,o.account_name,r.source_type,r.generation_type,r.post_mode,r.body||"",r.content_hash||"",r.link_url||"",v(),v(),JSON.stringify({tweet_id:h.id})).run(),await e.env.DB.prepare(`INSERT INTO kpi_metrics (account_id, user_id, metric_date, posts_sent)
           VALUES (?, ?, date('now','+9 hours'), 1)
           ON CONFLICT(account_id, metric_date) DO UPDATE SET
             posts_sent = posts_sent + 1,
             updated_at = datetime('now','+9 hours')`).bind(o.id,r.user_id).run(),n++}finally{await ss(e.env,o.id)}}catch(o){const l=(o==null?void 0:o.message)||"unknown_error";await e.env.DB.prepare("UPDATE post_queue SET status='failed', error_message=?, updated_at=? WHERE id=?").bind(l,v(),r.id).run(),await e.env.DB.prepare(`INSERT INTO post_logs
           (record_id, account_id, user_id, platform, source_type, post_mode, content, content_hash,
            status, error_message, executed_at)
         VALUES (?, ?, ?, 'x', ?, ?, ?, ?, 'failed', ?, ?)`).bind(r.id,r.account_id,r.user_id,r.source_type,r.post_mode,r.body||"",r.content_hash||"",l,v()).run(),r.account_id&&(o instanceof St?await xt(e.env,r.account_id,"rate_limit",-15):await xt(e.env,r.account_id,"error",-5,{message:l})),r.account_id&&await e.env.DB.prepare(`INSERT INTO kpi_metrics (account_id, user_id, metric_date, posts_failed)
           VALUES (?, ?, date('now','+9 hours'), 1)
           ON CONFLICT(account_id, metric_date) DO UPDATE SET
             posts_failed = posts_failed + 1,
             updated_at = datetime('now','+9 hours')`).bind(r.account_id,r.user_id).run(),i++}}}return e.json({ok:!0,processed:s,success:n,failed:i,now:t})});const ve=new D;ve.get("/api/admin/autopilot/jobs",f,async e=>{const t=e.get("user"),{results:a}=await e.env.DB.prepare(`SELECT aj.*, xa.account_name
       FROM autopilot_jobs aj LEFT JOIN x_accounts xa ON aj.account_id = xa.id
      WHERE aj.user_id = ?
      ORDER BY COALESCE(aj.generate_at, aj.publish_at, aj.created_at) DESC LIMIT 100`).bind(t.id).all(),{results:s}=await e.env.DB.prepare("SELECT id, account_name FROM x_accounts WHERE user_id = ? AND is_active = 1").bind(t.id).all();return e.json({jobs:a||[],accounts:s||[]})});ve.get("/api/admin/autopilot/jobs/:id",f,async e=>{const t=e.get("user"),a=await e.env.DB.prepare("SELECT * FROM autopilot_jobs WHERE id=? AND user_id=?").bind(parseInt(e.req.param("id"),10),t.id).first();return a?e.json(a):e.json({error:"not found"})});ve.post("/api/admin/autopilot/jobs",f,async e=>{var u;const t=e.get("user"),a=await e.req.json(),s=v(),n=(a.publish_at||a.generate_at||s).slice(0,10),i=await e.env.DB.prepare(`SELECT COUNT(*) AS cnt FROM autopilot_jobs
       WHERE user_id=? AND account_id=?
         AND SUBSTR(COALESCE(publish_at, generate_at, created_at), 1, 10)=?
         AND status NOT IN ('cancelled')`).bind(t.id,a.account_id||0,n).first();if(((i==null?void 0:i.cnt)??0)>=10)return e.json({success:!1,error:"この日は既に10件の予約があります"});const r=await e.env.DB.prepare("SELECT MAX(CAST(reservation_no AS INTEGER)) AS mx FROM autopilot_jobs").first(),d=String(((r==null?void 0:r.mx)??0)+1).padStart(4,"0");let o=a.generate_at??null;if(a.publish_at&&!a.generate_at)try{const m=new Date(a.publish_at.replace(" ","T"));m.setMinutes(m.getMinutes()-2),o=m.toISOString().replace("T"," ").slice(0,19)}catch{}const l=o||a.publish_at?"configured":"draft",c=await e.env.DB.prepare(`INSERT INTO autopilot_jobs
...
`)}function Y(e,t){return new Response(e,{headers:{"content-type":"text/csv; charset=utf-8","content-disposition":`attachment; filename="${t}"`,"cache-control":"no-store"}})}function rs(e,t){return new Response(JSON.stringify(e,null,2),{headers:{"content-type":"application/json; charset=utf-8","content-disposition":`attachment; filename="${t}"`,"cache-control":"no-store"}})}function H(){const e=new Date,t=a=>String(a).padStart(2,"0");return`${e.getFullYear()}${t(e.getMonth()+1)}${t(e.getDate())}_${t(e.getHours())}${t(e.getMinutes())}`}$.get("/api/admin/export/posts",f,async e=>{const t=e.get("user"),a=e.req.query("status"),s=e.req.query("month");let n="WHERE pq.platform='x' AND pq.user_id = ?";const i=[t.id];a&&a!=="all"&&(n+=" AND pq.status = ?",i.push(a)),s&&(n+=" AND strftime('%Y-%m', COALESCE(pq.posted_at, pq.scheduled_at, pq.created_at)) = ?",i.push(s));const{results:r}=await e.env.DB.prepare(`SELECT pq.id, pq.body, pq.link_url, pq.hashtags, pq.post_mode, pq.status,
       ...
       WHERE aj.user_id = ?
       ORDER BY aj.id DESC LIMIT 10000`).bind(t.id).all(),n=z(["id","reservation_no","account_id","account_name","x_username","channel_type","content_mode","theme","keywords","prompt_text","title_memo","link_url","generate_at","publish_at","status","generated_post_id","external_post_id","error_message","created_at","updated_at"],a||[]);return Y(n,`ge365x_autopilot_${H()}.csv`)});$.get("/api/admin/export/drafts",f,async e=>{const t=e.get("user"),{results:a}=await e.env.DB.prepare(`SELECT id, account_id, title, body, link_url, hashtags, post_mode, created_at, updated_at
       FROM drafts WHERE user_id = ? ORDER BY id DESC LIMIT 5000`).bind(t.id).all(),n=z(["id","account_id","title","body","link_url","hashtags","post_mode","created_at","updated_at"],a||[]);return Y(n,`ge365x_drafts_${H()}.csv`)});$.get("/api/admin/export/kpi",f,async e=>{const t=e.get("user"),{results:a}=await e.env.DB.prepare(`SELECT km.id, km.account_id, xa.account_name, xa.x_username,
       ...
       WHERE km.user_id = ?
       ORDER BY km.metric_date DESC, km.account_id ASC LIMIT 10000`).bind(t.id).all(),n=z(["id","account_id","account_name","x_username","metric_date","posts_sent","posts_failed","impressions","engagements","followers_gained","created_at","updated_at"],a||[]);return Y(n,`ge365x_kpi_${H()}.csv`)});$.get("/api/admin/export/accounts",f,async e=>{const t=e.get("user"),{results:a}=await e.env.DB.prepare(`SELECT id, account_name, x_user_id, x_username,
            daily_post_count, daily_post_limit, last_posted_at,
            account_health_score, health_status, is_active, is_current,
            last_daily_reset_date, created_at, updated_at
       FROM x_accounts WHERE user_id = ? ORDER BY id DESC`).bind(t.id).all(),n=z(["id","account_name","x_user_id","x_username","daily_post_count","daily_post_limit","last_posted_at","account_health_score","health_status","is_active","is_current","last_daily_reset_date","created_at","updated_at"],a||[]);return Y(n,`ge365x_accounts_${H()}.csv`)});$.get("/api/admin/export/targets",f,async e=>{const t=e.get("user"),{results:a}=await e.env.DB.prepare(`SELECT id, account_id, template_key, label, age_range, gender, genre, occupation,
            pains, desires, purchase_triggers, problem, goal, knowledge, is_default
       FROM target_templates WHERE user_id = ? ORDER BY id DESC`).bind(t.id).all(),n=z(["id","account_id","template_key","label","age_range","gender","genre","occupation","pains","desires","purchase_triggers","problem","goal","knowledge","is_default"],a||[]);return Y(n,`ge365x_targets_${H()}.csv`)});$.get("/api/admin/export/voices",f,async e=>{const t=e.get("user"),{results:a}=await e.env.DB.prepare(`SELECT id, account_id, voice_key, label, tone, worldview, personal_story,
            prohibited_words, sample_posts, is_default
       FROM brand_voice WHERE user_id = ? ORDER BY id DESC`).bind(t.id).all(),n=z(["id","account_id","voice_key","label","tone","worldview","personal_story","prohibited_words","sample_posts","is_default"],a||[]);return Y(n,`ge365x_voices_${H()}.csv`)});$.get("/api/admin/export/all",f,async e=>{const t=e.get("user"),a=t.id,[s,n,i,r,d,o,l,c,u]=await Promise.all([e.env.DB.prepare(`SELECT pq.*, xa.account_name, xa.x_username
         FROM post_queue pq LEFT JOIN x_accounts xa ON pq.account_id = xa.id
       ...
       FROM auth_logs ORDER BY id DESC LIMIT 10000`).all(),s=z(["id","user_id","email","event_type","ip_address","user_agent","metadata","created_at"],t||[]);return Y(s,`ge365x_admin_audit_${H()}.csv`)});$.get("/api/admin/export/admin/all",f,I,async e=>{const[t,a,s,n,i,r,d]=await Promise.all([e.env.DB.prepare(`SELECT id, email, is_approved, is_admin, trial_start, trial_end, created_at, updated_at
         ...
         FROM x_accounts ORDER BY id DESC LIMIT 10000`).all()]),o={exported_at:new Date().toISOString(),users:t.results||[],user_subscriptions:a.results||[],licenses:s.results||[],auth_logs:n.results||[],post_queue:i.results||[],post_logs:r.results||[],x_accounts:d.results||[]};return rs(o,`ge365x_admin_all_${H()}.json`)});const T=new D;T.use("/static/*",en({root:"./",manifest:{}}));T.get("/healthz",e=>e.json({ok:!0,service:"ge365x-web",time:new Date().toISOString()}));T.route("/",Ma);T.route("/",U);T.route("/",P);T.route("/",te);T.route("/",_e);T.route("/",be);T.route("/",q);T.route("/",is);T.route("/",ve);T.route("/",ze);T.route("/",ut);T.route("/",pt);T.route("/",Vt);T.route("/",Dt);T.route("/",It);T.route("/",Ot);T.route("/",Ie);T.route("/",$);T.notFound(e=>e.json({error:"not_found",path:e.req.path},404));T.onError((e,t)=>(console.error("[ge365x-web] error:",e),t.json({error:"internal_error",message:e.message},500)));const ei={fetch:T.fetch,async scheduled(e,t,a){const s=e.cron;(!s||s==="*/1 * * * *")&&a.waitUntil(T.fetch(new Request("https://internal/cron/tick",{method:"POST"}),t,a).catch(n=>console.error("[tick]",n))),s==="*/5 * * * *"&&a.waitUntil(T.fetch(new Request("https://internal/cron/autopilot-tick",{method:"POST"}),t,a).catch(n=>console.error("[autopilot-tick]",n)))}},ma=new D,ti=Object.assign({"/src/index.tsx":ei});let os=!1;for(const[,e]of Object.entries(ti))e&&(ma.all("*",t=>{let a;try{a=t.executionCtx}catch{}return e.fetch(t.req.raw,t.env,a)}),ma.notFound(t=>{let a;try{a=t.executionCtx}catch{}return e.fetch(t.req.raw,t.env,a)}),os=!0);if(!os)throw new Error("Can't import modules from ['/src/index.ts','/src/index.tsx','/app/server.ts']");export{ma as default};
