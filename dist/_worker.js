...
{title:"初回セットアップ",keywords:["初回","セットアップ","はじめて","登録","ログイン"],answer:`最初にログインまたは無料トライアル登録をします。管理者が承認制にしている場合は承認後に使えます。ログイン後、API設定、Xアカウント管理、ターゲット設定、ブランドボイスの順に設定してください。最低限必要なのはX API設定とXアカウント管理です。`},
...
{title:"トライアルとライセンス",keywords:["トライアル","ライセンス","期限","7日","登録フォーム"],answer:`無料トライアル登録では、管理画面のシステム設定にあるトライアル日数が使われます。7日に設定すると、登録日から7日後に利用期限が切れます。管理者がtrialライセンスを発行するときに有効期限を省略した場合も、同じトライアル日数から期限を自動設定します。期限切れ後はログインとAPI利用が止まります。`}
