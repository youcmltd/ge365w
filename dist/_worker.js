var aa=Object.defineProperty;var Jt=e=>{throw TypeError(e)};var na=(e,t,s)=>t in e?aa(e,t,{enumerable:!0,configurable:!0,writable:!0,value:s}):e[t]=s;var h=(e,t,s)=>na(e,typeof t!="symbol"?t+"":t,s),Tt=(e,t,s)=>t.has(e)||Jt("Cannot "+s);var u=(e,t,s)=>(Tt(e,t,"read from private field"),s?s.call(e):t.get(e)),y=(e,t,s)=>t.has(e)?Jt("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,s),_=(e,t,s,a)=>(Tt(e,t,"write to private field"),a?a.call(e,s):t.set(e,s),s),w=(e,t,s)=>(Tt(e,t,"access private method"),s);var Kt=(e,t,s,a)=>({set _(n){_(e,t,n,s)},get _(){return u(e,t,a)}});var Vt=(e,t,s)=>(a,n)=>{let i=-1;return r(0);async function r(o){if(o<=i)throw new Error("next() called multiple times");i=o;let l,d=!1,c;if(e[o]?(c=e[o][0][0],a.req.routeIndex=o):c=o===e.length&&n||void 0,c)try{l=await c(a,()=>r(o+1))}catch(p){if(p instanceof Error&&t)a.error=p,l=await t(p,a),d=!0;else throw p}else a.finalized===!1&&s&&(l=await s(a));return l&&(a.finalized===!1||d)&&(a.res=l),a}},ia=Symbol(),ra=async(e,t=Object.create(null))=>{const{all:s=!1,dot:a=!1}=t,i=(e instanceof xs?e.raw.headers:e.headers).get("Content-Type");return i!=null&&i.startsWith("multipart/form-data")||i!=null&&i.startsWith("application/x-www-form-urlencoded")?oa(e,{all:s,dot:a}):{}};async function oa(e,t){const s=await e.formData();return s?la(s,t):{}}function la(e,t){const s=Object.create(null);return e.forEach((a,n)=>{t.all||n.endsWith("[]")?da(s,n,a):s[n]=a}),t.dot&&Object.entries(s).forEach(([a,n])=>{a.includes(".")&&(ca(s,a,n),delete s[a])}),s}var da=(e,t,s)=>{e[t]!==void 0?Array.isArray(e[t])?e[t].push(s):e[t]=[e[t],s]:t.endsWith("[]")?e[t]=[s]:e[t]=s},ca=(e,t,s)=>{if(/(?:^|\.)__proto__\./.test(t))return;let a=e;const n=t.split(".");n.forEach((i,r)=>{r===n.length-1?a[i]=s:((!a[i]||typeof a[i]!="object"||Array.isArray(a[i])||a[i]instanceof File)&&(a[i]=Object.create(null)),a=a[i])})},_s=e=>{const t=e.split("/");return t[0]===""&&t.shift(),t},ua=e=>{const{groups:t,path:s}=pa(e),a=_s(s);return ma(a,t)},pa=e=>{const t=[];return e=e.replace(/\{[^}]+\}/g,(s,a)=>{const n=`@${a}`;return t.push([n,s]),n}),{groups:t,path:e}},ma=(e,t)=>{for(let s=t.length-1;s>=0;s--){const[a]=t[s];for(let n=e.length-1;n>=0;n--)if(e[n].includes(a)){e[n]=e[n].replace(a,t[s][1]);break}}return e},ot={},fa=(e,t)=>{if(e==="*")return"*";const s=e.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);if(s){const a=`${e}#${t}`;return ot[a]||(s[2]?ot[a]=t&&t[0]!==":"&&t[0]!=="*"?[a,s[1],new RegExp(`^${s[2]}(?=/${t})`)]:[e,s[1],new RegExp(`^${s[2]}$`)]:ot[a]=[e,s[1],!0]),ot[a]}return null},Lt=(e,t)=>{try{return t(e)}catch{return e.replace(/(?:%[0-9A-Fa-f]{2})+/g,s=>{try{return t(s)}catch{return s}})}},gs=e=>Lt(e,decodeURI),bs=e=>{const t=e.url,s=t.indexOf("/",t.indexOf(":")+4);let a=s;for(;a<t.length;a++){const n=t.charCodeAt(a);if(n===37){const i=t.indexOf("?",a),r=t.indexOf("#",a),o=i===-1?r===-1?void 0:r:r===-1?i:Math.min(i,r),l=t.slice(s,o);return gs(l.includes("%25")?l.replace(/%25/g,"%2525"):l)}else if(n===63||n===35)break}return t.slice(s,a)},ha=e=>{const t=bs(e);return t.length>1&&t.at(-1)==="/"?t.slice(0,-1):t},Be=(e,t,...s)=>(s.length&&(t=Be(t,...s)),`${(e==null?void 0:e[0])==="/"?"":"/"}${e}${t==="/"?"":`${(e==null?void 0:e.at(-1))==="/"?"":"/"}${(t==null?void 0:t[0])==="/"?t.slice(1):t}`}`),vs=e=>{if(e.charCodeAt(e.length-1)!==63||!e.includes(":"))return null;const t=e.split("/"),s=[];let a="";return t.forEach(n=>{if(n!==""&&!/\:/.test(n))a+="/"+n;else if(/\:/.test(n))if(/\?/.test(n)){s.length===0&&a===""?s.push("/"):s.push(a);const i=n.replace("?","");a+="/"+i,s.push(a)}else a+="/"+n}),s.filter((n,i,r)=>r.indexOf(n)===i)},At=e=>/[%+]/.test(e)?(e.indexOf("+")!==-1&&(e=e.replace(/\+/g," ")),e.indexOf("%")!==-1?Lt(e,Es):e):e,ys=(e,t,s)=>{let a;if(!s&&t&&!/[%+]/.test(t)){let r=e.indexOf("?",8);if(r===-1)return;for(e.startsWith(t,r+1)||(r=e.indexOf(`&${t}`,r+1));r!==-1;){const o=e.charCodeAt(r+t.length+1);if(o===61){const l=r+t.length+2,d=e.indexOf("&",l);return At(e.slice(l,d===-1?void 0:d))}else if(o==38||isNaN(o))return"";r=e.indexOf(`&${t}`,r+1)}if(a=/[%+]/.test(e),!a)return}const n={};a??(a=/[%+]/.test(e));let i=e.indexOf("?",8);for(;i!==-1;){const r=e.indexOf("&",i+1);let o=e.indexOf("=",i);o>r&&r!==-1&&(o=-1);let l=e.slice(i+1,o===-1?r===-1?void 0:r:o);if(a&&(l=At(l)),i=r,l==="")continue;let d;o===-1?d="":(d=e.slice(o+1,r===-1?void 0:r),a&&(d=At(d))),s?(n[l]&&Array.isArray(n[l])||(n[l]=[]),n[l].push(d)):n[l]??(n[l]=d)}return t?n[t]:n},_a=ys,ga=(e,t)=>ys(e,t,!0),Es=decodeURIComponent,Xt=e=>Lt(e,Es),Ne,z,oe,ws,ks,Ot,de,cs,xs=(cs=class{constructor(e,t="/",s=[[]]){y(this,oe);h(this,"raw");y(this,Ne);y(this,z);h(this,"routeIndex",0);h(this,"path");h(this,"bodyCache",{});y(this,de,e=>{const{bodyCache:t,raw:s}=this,a=t[e];if(a)return a;const n=Object.keys(t)[0];return n?t[n].then(i=>(n==="json"&&(i=JSON.stringify(i)),new Response(i)[e]())):t[e]=s[e]()});this.raw=e,this.path=t,_(this,z,s),_(this,Ne,{})}param(e){return e?w(this,oe,ws).call(this,e):w(this,oe,ks).call(this)}query(e){return _a(this.url,e)}queries(e){return ga(this.url,e)}header(e){if(e)return this.raw.headers.get(e)??void 0;const t={};return this.raw.headers.forEach((s,a)=>{t[a]=s}),t}async parseBody(e){return ra(this,e)}json(){return u(this,de).call(this,"text").then(e=>JSON.parse(e))}text(){return u(this,de).call(this,"text")}arrayBuffer(){return u(this,de).call(this,"arrayBuffer")}blob(){return u(this,de).call(this,"blob")}formData(){return u(this,de).call(this,"formData")}addValidatedData(e,t){u(this,Ne)[e]=t}valid(e){return u(this,Ne)[e]}get url(){return this.raw.url}get method(){return this.raw.method}get[ia](){return u(this,z)}get matchedRoutes(){return u(this,z)[0].map(([[,e]])=>e)}get routePath(){return u(this,z)[0].map(([[,e]])=>e)[this.routeIndex].path}},Ne=new WeakMap,z=new WeakMap,oe=new WeakSet,ws=function(e){const t=u(this,z)[0][this.routeIndex][1][e],s=w(this,oe,Ot).call(this,t);return s&&/\%/.test(s)?Xt(s):s},ks=function(){const e={},t=Object.keys(u(this,z)[0][this.routeIndex][1]);for(const s of t){const a=w(this,oe,Ot).call(this,u(this,z)[0][this.routeIndex][1][s]);a!==void 0&&(e[s]=/\%/.test(a)?Xt(a):a)}return e},Ot=function(e){return u(this,z)[1]?u(this,z)[1][e]:e},de=new WeakMap,cs),ba={Stringify:1},Ss=async(e,t,s,a,n)=>{typeof e=="object"&&!(e instanceof String)&&(e instanceof Promise||(e=e.toString()),e instanceof Promise&&(e=await e));const i=e.callbacks;return i!=null&&i.length?(n?n[0]+=e:n=[e],Promise.all(i.map(o=>o({phase:t,buffer:n,context:a}))).then(o=>Promise.all(o.filter(Boolean).map(l=>Ss(l,t,!1,a,n))).then(()=>n[0]))):Promise.resolve(e)},va="text/plain; charset=UTF-8",Dt=(e,t)=>({"Content-Type":e,...t}),Ye=(e,t)=>new Response(e,t),Ge,Ze,te,Me,se,M,Qe,$e,Fe,xe,et,tt,ce,Ce,us,ya=(us=class{constructor(e,t){y(this,ce);y(this,Ge);y(this,Ze);h(this,"env",{});y(this,te);h(this,"finalized",!1);h(this,"error");y(this,Me);y(this,se);y(this,M);y(this,Qe);y(this,$e);y(this,Fe);y(this,xe);y(this,et);y(this,tt);h(this,"render",(...e)=>(u(this,$e)??_(this,$e,t=>this.html(t)),u(this,$e).call(this,...e)));h(this,"setLayout",e=>_(this,Qe,e));h(this,"getLayout",()=>u(this,Qe));h(this,"setRenderer",e=>{_(this,$e,e)});h(this,"header",(e,t,s)=>{this.finalized&&_(this,M,Ye(u(this,M).body,u(this,M)));const a=u(this,M)?u(this,M).headers:u(this,xe)??_(this,xe,new Headers);t===void 0?a.delete(e):s!=null&&s.append?a.append(e,t):a.set(e,t)});h(this,"status",e=>{_(this,Me,e)});h(this,"set",(e,t)=>{u(this,te)??_(this,te,new Map),u(this,te).set(e,t)});h(this,"get",e=>u(this,te)?u(this,te).get(e):void 0);h(this,"newResponse",(...e)=>w(this,ce,Ce).call(this,...e));h(this,"body",(e,t,s)=>w(this,ce,Ce).call(this,e,t,s));h(this,"text",(e,t,s)=>!u(this,xe)&&!u(this,Me)&&!t&&!s&&!this.finalized?new Response(e):w(this,ce,Ce).call(this,e,t,Dt(va,s)));h(this,"json",(e,t,s)=>w(this,ce,Ce).call(this,JSON.stringify(e),t,Dt("application/json",s)));h(this,"html",(e,t,s)=>{const a=n=>w(this,ce,Ce).call(this,n,t,Dt("text/html; charset=UTF-8",s));return typeof e=="object"?Ss(e,ba.Stringify,!1,{}).then(a):a(e)});h(this,"redirect",(e,t)=>{const s=String(e);return this.header("Location",/[^\x00-\xFF]/.test(s)?encodeURI(s):s),this.newResponse(null,t??302)});h(this,"notFound",()=>(u(this,Fe)??_(this,Fe,()=>Ye()),u(this,Fe).call(this,this)));_(this,Ge,e),t&&(_(this,se,t.executionCtx),this.env=t.env,_(this,Fe,t.notFoundHandler),_(this,tt,t.path),_(this,et,t.matchResult))}get req(){return u(this,Ze)??_(this,Ze,new xs(u(this,Ge),u(this,tt),u(this,et))),u(this,Ze)}get event(){if(u(this,se)&&"respondWith"in u(this,se))return u(this,se);throw Error("This context has no FetchEvent")}get executionCtx(){if(u(this,se))return u(this,se);throw Error("This context has no ExecutionContext")}get res(){return u(this,M)||_(this,M,Ye(null,{headers:u(this,xe)??_(this,xe,new Headers)}))}set res(e){if(u(this,M)&&e){e=Ye(e.body,e);for(const[t,s]of u(this,M).headers.entries())if(t!=="content-type")if(t==="set-cookie"){const a=u(this,M).headers.getSetCookie();e.headers.delete("set-cookie");for(const n of a)e.headers.append("set-cookie",n)}else e.headers.set(t,s)}_(this,M,e),this.finalized=!0}get var(){return u(this,te)?Object.fromEntries(u(this,te)):{}}},Ge=new WeakMap,Ze=new WeakMap,te=new WeakMap,Me=new WeakMap,se=new WeakMap,M=new WeakMap,Qe=new WeakMap,$e=new WeakMap,Fe=new WeakMap,xe=new WeakMap,et=new WeakMap,tt=new WeakMap,ce=new WeakSet,Ce=function(e,t,s){const a=u(this,M)?new Headers(u(this,M).headers):u(this,xe)??new Headers;if(typeof t=="object"&&"headers"in t){const i=t.headers instanceof Headers?t.headers:new Headers(t.headers);for(const[r,o]of i)r.toLowerCase()==="set-cookie"?a.append(r,o):a.set(r,o)}if(s)for(const[i,r]of Object.entries(s))if(typeof r=="string")a.set(i,r);else{a.delete(i);for(const o of r)a.append(i,o)}const n=typeof t=="number"?t:(t==null?void 0:t.status)??u(this,Me);return Ye(e,{status:n,headers:a})},us),O="ALL",Ea="all",xa=["get","post","put","delete","options","patch"],Ts="Can not add a route since the matcher is already built.",As=class extends Error{},wa="__COMPOSED_HANDLER",ka=e=>e.text("404 Not Found",404),Gt=(e,t)=>{if("getResponse"in e){const s=e.getResponse();return t.newResponse(s.body,s)}return console.error(e),t.text("Internal Server Error",500)},K,I,Ds,V,ye,lt,dt,Pe,Sa=(Pe=class{constructor(t={}){y(this,I);h(this,"get");h(this,"post");h(this,"put");h(this,"delete");h(this,"options");h(this,"patch");h(this,"all");h(this,"on");h(this,"use");h(this,"router");h(this,"getPath");h(this,"_basePath","/");y(this,K,"/");h(this,"routes",[]);y(this,V,ka);h(this,"errorHandler",Gt);h(this,"onError",t=>(this.errorHandler=t,this));h(this,"notFound",t=>(_(this,V,t),this));h(this,"fetch",(t,...s)=>w(this,I,dt).call(this,t,s[1],s[0],t.method));h(this,"request",(t,s,a,n)=>t instanceof Request?this.fetch(s?new Request(t,s):t,a,n):(t=t.toString(),this.fetch(new Request(/^https?:\/\//.test(t)?t:`http://localhost${Be("/",t)}`,s),a,n)));h(this,"fire",()=>{addEventListener("fetch",t=>{t.respondWith(w(this,I,dt).call(this,t.request,t,void 0,t.request.method))})});[...xa,Ea].forEach(i=>{this[i]=(r,...o)=>(typeof r=="string"?_(this,K,r):w(this,I,ye).call(this,i,u(this,K),r),o.forEach(l=>{w(this,I,ye).call(this,i,u(this,K),l)}),this)}),this.on=(i,r,...o)=>{for(const l of[r].flat()){_(this,K,l);for(const d of[i].flat())o.map(c=>{w(this,I,ye).call(this,d.toUpperCase(),u(this,K),c)})}return this},this.use=(i,...r)=>(typeof i=="string"?_(this,K,i):(_(this,K,"*"),r.unshift(i)),r.forEach(o=>{w(this,I,ye).call(this,O,u(this,K),o)}),this);const{strict:a,...n}=t;Object.assign(this,n),this.getPath=a??!0?t.getPath??bs:ha}route(t,s){const a=this.basePath(t);return s.routes.map(n=>{var r;let i;s.errorHandler===Gt?i=n.handler:(i=async(o,l)=>(await Vt([],s.errorHandler)(o,()=>n.handler(o,l))).res,i[wa]=n.handler),w(r=a,I,ye).call(r,n.method,n.path,i)}),this}basePath(t){const s=w(this,I,Ds).call(this);return s._basePath=Be(this._basePath,t),s}mount(t,s,a){let n,i;a&&(typeof a=="function"?i=a:(i=a.optionHandler,a.replaceRequest===!1?n=l=>l:n=a.replaceRequest));const r=i?l=>{const d=i(l);return Array.isArray(d)?d:[d]}:l=>{let d;try{d=l.executionCtx}catch{}return[l.env,d]};n||(n=(()=>{const l=Be(this._basePath,t),d=l==="/"?0:l.length;return c=>{const p=new URL(c.url);return p.pathname=p.pathname.slice(d)||"/",new Request(p,c)}})());const o=async(l,d)=>{const c=await s(n(l.req.raw),...r(l));if(c)return c;await d()};return w(this,I,ye).call(this,O,Be(t,"*"),o),this}},K=new WeakMap,I=new WeakSet,Ds=function(){const t=new Pe({router:this.router,getPath:this.getPath});return t.errorHandler=this.errorHandler,_(t,V,u(this,V)),t.routes=this.routes,t},V=new WeakMap,ye=function(t,s,a){t=t.toUpperCase(),s=Be(this._basePath,s);const n={basePath:this._basePath,path:s,method:t,handler:a};this.router.add(t,s,[a,n]),this.routes.push(n)},lt=function(t,s){if(t instanceof Error)return this.errorHandler(t,s);throw t},dt=function(t,s,a,n){if(n==="HEAD")return(async()=>new Response(null,await w(this,I,dt).call(this,t,s,a,"GET")))();const i=this.getPath(t,{env:a}),r=this.router.match(n,i),o=new ya(t,{path:i,matchResult:r,env:a,executionCtx:s,notFoundHandler:u(this,V)});if(r[0].length===1){let d;try{d=r[0][0][0][0](o,async()=>{o.res=await u(this,V).call(this,o)})}catch(c){return w(this,I,lt).call(this,c,o)}return d instanceof Promise?d.then(c=>c||(o.finalized?o.res:u(this,V).call(this,o))).catch(c=>w(this,I,lt).call(this,c,o)):d??u(this,V).call(this,o)}const l=Vt(r[0],this.errorHandler,u(this,V));return(async()=>{try{const d=await l(o);if(!d.finalized)throw new Error("Context is not finalized. Did you forget to return a Response object or `await next()`?");return d.res}catch(d){return w(this,I,lt).call(this,d,o)}})()},Pe),Rs=[];function Ta(e,t){const s=this.buildAllMatchers(),a=((n,i)=>{const r=s[n]||s[O],o=r[2][i];if(o)return o;const l=i.match(r[0]);if(!l)return[[],Rs];const d=l.indexOf("",1);return[r[1][d],l]});return this.match=a,a(e,t)}var mt="[^/]+",Je=".*",Ke="(?:|/.*)",Le=Symbol(),Aa=new Set(".\\+*[^]$()");function Da(e,t){return e.length===1?t.length===1?e<t?-1:1:-1:t.length===1||e===Je||e===Ke?1:t===Je||t===Ke?-1:e===mt?1:t===mt?-1:e.length===t.length?e<t?-1:1:t.length-e.length}var we,ke,X,Ae,Ra=(Ae=class{constructor(){y(this,we);y(this,ke);y(this,X,Object.create(null))}insert(t,s,a,n,i){if(t.length===0){if(u(this,we)!==void 0)throw Le;if(i)return;_(this,we,s);return}const[r,...o]=t,l=r==="*"?o.length===0?["","",Je]:["","",mt]:r==="/*"?["","",Ke]:r.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);let d;if(l){const c=l[1];let p=l[2]||mt;if(c&&l[2]&&(p===".*"||(p=p.replace(/^\((?!\?:)(?=[^)]+\)$)/,"(?:"),/\((?!\?:)/.test(p))))throw Le;if(d=u(this,X)[p],!d){if(Object.keys(u(this,X)).some(f=>f!==Je&&f!==Ke))throw Le;if(i)return;d=u(this,X)[p]=new Ae,c!==""&&_(d,ke,n.varIndex++)}!i&&c!==""&&a.push([c,u(d,ke)])}else if(d=u(this,X)[r],!d){if(Object.keys(u(this,X)).some(c=>c.length>1&&c!==Je&&c!==Ke))throw Le;if(i)return;d=u(this,X)[r]=new Ae}d.insert(o,s,a,n,i)}buildRegExpStr(){const s=Object.keys(u(this,X)).sort(Da).map(a=>{const n=u(this,X)[a];return(typeof u(n,ke)=="number"?`(${a})@${u(n,ke)}`:Aa.has(a)?`\\${a}`:a)+n.buildRegExpStr()});return typeof u(this,we)=="number"&&s.unshift(`#${u(this,we)}`),s.length===0?"":s.length===1?s[0]:"(?:"+s.join("|")+")"}},we=new WeakMap,ke=new WeakMap,X=new WeakMap,Ae),gt,st,ps,Oa=(ps=class{constructor(){y(this,gt,{varIndex:0});y(this,st,new Ra)}insert(e,t,s){const a=[],n=[];for(let r=0;;){let o=!1;if(e=e.replace(/\{[^}]+\}/g,l=>{const d=`@\\${r}`;return n[r]=[d,l],r++,o=!0,d}),!o)break}const i=e.match(/(?::[^\/]+)|(?:\/\*$)|./g)||[];for(let r=n.length-1;r>=0;r--){const[o]=n[r];for(let l=i.length-1;l>=0;l--)if(i[l].indexOf(o)!==-1){i[l]=i[l].replace(o,n[r][1]);break}}return u(this,st).insert(i,t,a,u(this,gt),s),a}buildRegExp(){let e=u(this,st).buildRegExpStr();if(e==="")return[/^$/,[],[]];let t=0;const s=[],a=[];return e=e.replace(/#(\d+)|@(\d+)|\.\*\$/g,(n,i,r)=>i!==void 0?(s[++t]=Number(i),"$()"):(r!==void 0&&(a[Number(r)]=++t),"")),[new RegExp(`^${e}`),s,a]}},gt=new WeakMap,st=new WeakMap,ps),Ia=[/^$/,[],Object.create(null)],ct=Object.create(null);function Os(e){return ct[e]??(ct[e]=new RegExp(e==="*"?"":`^${e.replace(/\/\*$|([.\\+*[^\]$()])/g,(t,s)=>s?`\\${s}`:"(?:|/.*)")}$`))}function ja(){ct=Object.create(null)}function Ba(e){var d;const t=new Oa,s=[];if(e.length===0)return Ia;const a=e.map(c=>[!/\*|\/:/.test(c[0]),...c]).sort(([c,p],[f,b])=>c?1:f?-1:p.length-b.length),n=Object.create(null);for(let c=0,p=-1,f=a.length;c<f;c++){const[b,v,T]=a[c];b?n[v]=[T.map(([A])=>[A,Object.create(null)]),Rs]:p++;let x;try{x=t.insert(v,p,b)}catch(A){throw A===Le?new As(v):A}b||(s[p]=T.map(([A,k])=>{const L=Object.create(null);for(k-=1;k>=0;k--){const[q,N]=x[k];L[q]=N}return[A,L]}))}const[i,r,o]=t.buildRegExp();for(let c=0,p=s.length;c<p;c++)for(let f=0,b=s[c].length;f<b;f++){const v=(d=s[c][f])==null?void 0:d[1];if(!v)continue;const T=Object.keys(v);for(let x=0,A=T.length;x<A;x++)v[T[x]]=o[v[T[x]]]}const l=[];for(const c in r)l[c]=s[r[c]];return[i,l,n]}function je(e,t){if(e){for(const s of Object.keys(e).sort((a,n)=>n.length-a.length))if(Os(s).test(t))return[...e[s]]}}var ue,pe,bt,Is,ms,Ca=(ms=class{constructor(){y(this,bt);h(this,"name","RegExpRouter");y(this,ue);y(this,pe);h(this,"match",Ta);_(this,ue,{[O]:Object.create(null)}),_(this,pe,{[O]:Object.create(null)})}add(e,t,s){var o;const a=u(this,ue),n=u(this,pe);if(!a||!n)throw new Error(Ts);a[e]||[a,n].forEach(l=>{l[e]=Object.create(null),Object.keys(l[O]).forEach(d=>{l[e][d]=[...l[O][d]]})}),t==="/*"&&(t="*");const i=(t.match(/\/:/g)||[]).length;if(/\*$/.test(t)){const l=Os(t);e===O?Object.keys(a).forEach(d=>{var c;(c=a[d])[t]||(c[t]=je(a[d],t)||je(a[O],t)||[])}):(o=a[e])[t]||(o[t]=je(a[e],t)||je(a[O],t)||[]),Object.keys(a).forEach(d=>{(e===O||e===d)&&Object.keys(a[d]).forEach(c=>{l.test(c)&&a[d][c].push([s,i])})}),Object.keys(n).forEach(d=>{(e===O||e===d)&&Object.keys(n[d]).forEach(c=>l.test(c)&&n[d][c].push([s,i]))});return}const r=vs(t)||[t];for(let l=0,d=r.length;l<d;l++){const c=r[l];Object.keys(n).forEach(p=>{var f;(e===O||e===p)&&((f=n[p])[c]||(f[c]=[...je(a[p],c)||je(a[O],c)||[]]),n[p][c].push([s,i-d+l+1]))})}}buildAllMatchers(){const e=Object.create(null);return Object.keys(u(this,pe)).concat(Object.keys(u(this,ue))).forEach(t=>{e[t]||(e[t]=w(this,bt,Is).call(this,t))}),_(this,ue,_(this,pe,void 0)),ja(),e}},ue=new WeakMap,pe=new WeakMap,bt=new WeakSet,Is=function(e){const t=[];let s=e===O;return[u(this,ue),u(this,pe)].forEach(a=>{const n=a[e]?Object.keys(a[e]).map(i=>[i,a[e][i]]):[];n.length!==0?(s||(s=!0),t.push(...n)):e!==O&&t.push(...Object.keys(a[O]).map(i=>[i,a[O][i]]))}),s?Ba(t):null},ms),me,ae,fs,La=(fs=class{constructor(e){h(this,"name","SmartRouter");y(this,me,[]);y(this,ae,[]);_(this,me,e.routers)}add(e,t,s){if(!u(this,ae))throw new Error(Ts);u(this,ae).push([e,t,s])}match(e,t){if(!u(this,ae))throw new Error("Fatal error");const s=u(this,me),a=u(this,ae),n=s.length;let i=0,r;for(;i<n;i++){const o=s[i];try{for(let l=0,d=a.length;l<d;l++)o.add(...a[l]);r=o.match(e,t)}catch(l){if(l instanceof As)continue;throw l}this.match=o.match.bind(o),_(this,me,[o]),_(this,ae,void 0);break}if(i===n)throw new Error("Fatal error");return this.name=`SmartRouter + ${this.activeRouter.name}`,r}get activeRouter(){if(u(this,ae)||u(this,me).length!==1)throw new Error("No active router has been determined yet.");return u(this,me)[0]}},me=new WeakMap,ae=new WeakMap,fs),ze=Object.create(null),Na=e=>{for(const t in e)return!0;return!1},fe,B,Se,qe,j,ne,Ee,He,Ma=(He=class{constructor(t,s,a){y(this,ne);y(this,fe);y(this,B);y(this,Se);y(this,qe,0);y(this,j,ze);if(_(this,B,a||Object.create(null)),_(this,fe,[]),t&&s){const n=Object.create(null);n[t]={handler:s,possibleKeys:[],score:0},_(this,fe,[n])}_(this,Se,[])}insert(t,s,a){_(this,qe,++Kt(this,qe)._);let n=this;const i=ua(s),r=[];for(let o=0,l=i.length;o<l;o++){const d=i[o],c=i[o+1],p=fa(d,c),f=Array.isArray(p)?p[0]:d;if(f in u(n,B)){n=u(n,B)[f],p&&r.push(p[1]);continue}u(n,B)[f]=new He,p&&(u(n,Se).push(p),r.push(p[1])),n=u(n,B)[f]}return u(n,fe).push({[t]:{handler:a,possibleKeys:r.filter((o,l,d)=>d.indexOf(o)===l),score:u(this,qe)}}),n}search(t,s){var c;const a=[];_(this,j,ze);let i=[this];const r=_s(s),o=[],l=r.length;let d=null;for(let p=0;p<l;p++){const f=r[p],b=p===l-1,v=[];for(let x=0,A=i.length;x<A;x++){const k=i[x],L=u(k,B)[f];L&&(_(L,j,u(k,j)),b?(u(L,B)["*"]&&w(this,ne,Ee).call(this,a,u(L,B)["*"],t,u(k,j)),w(this,ne,Ee).call(this,a,L,t,u(k,j))):v.push(L));for(let q=0,N=u(k,Se).length;q<N;q++){const rt=u(k,Se)[q],Q=u(k,j)===ze?{}:{...u(k,j)};if(rt==="*"){const Oe=u(k,B)["*"];Oe&&(w(this,ne,Ee).call(this,a,Oe,t,u(k,j)),_(Oe,j,Q),v.push(Oe));continue}const[sa,zt,Ue]=rt;if(!f&&!(Ue instanceof RegExp))continue;const ee=u(k,B)[sa];if(Ue instanceof RegExp){if(d===null){d=new Array(l);let Ie=s[0]==="/"?1:0;for(let We=0;We<l;We++)d[We]=Ie,Ie+=r[We].length+1}const Oe=s.substring(d[p]),St=Ue.exec(Oe);if(St){if(Q[zt]=St[0],w(this,ne,Ee).call(this,a,ee,t,u(k,j),Q),Na(u(ee,B))){_(ee,j,Q);const Ie=((c=St[0].match(/\//))==null?void 0:c.length)??0;(o[Ie]||(o[Ie]=[])).push(ee)}continue}}(Ue===!0||Ue.test(f))&&(Q[zt]=f,b?(w(this,ne,Ee).call(this,a,ee,t,Q,u(k,j)),u(ee,B)["*"]&&w(this,ne,Ee).call(this,a,u(ee,B)["*"],t,Q,u(k,j))):(_(ee,j,Q),v.push(ee)))}}const T=o.shift();i=T?v.concat(T):v}return a.length>1&&a.sort((p,f)=>p.score-f.score),[a.map(({handler:p,params:f})=>[p,f])]}},fe=new WeakMap,B=new WeakMap,Se=new WeakMap,qe=new WeakMap,j=new WeakMap,ne=new WeakSet,Ee=function(t,s,a,n,i){for(let r=0,o=u(s,fe).length;r<o;r++){const l=u(s,fe)[r],d=l[a]||l[O],c={};if(d!==void 0&&(d.params=Object.create(null),t.push(d),n!==ze||i&&i!==ze))for(let p=0,f=d.possibleKeys.length;p<f;p++){const b=d.possibleKeys[p],v=c[d.score];d.params[b]=i!=null&&i[b]&&!v?i[b]:n[b]??(i==null?void 0:i[b]),c[d.score]=!0}}},He),Te,hs,$a=(hs=class{constructor(){h(this,"name","TrieRouter");y(this,Te);_(this,Te,new Ma)}add(e,t,s){const a=vs(t);if(a){for(let n=0,i=a.length;n<i;n++)u(this,Te).insert(e,a[n],s);return}u(this,Te).insert(e,t,s)}match(e,t){return u(this,Te).search(e,t)}},Te=new WeakMap,hs),D=class extends Sa{constructor(e={}){super(e),this.router=e.router??new La({routers:[new Ca,new $a]})}},Fa=/^\s*(?:text\/(?!event-stream(?:[;\s]|$))[^;\s]+|application\/(?:javascript|json|xml|xml-dtd|ecmascript|dart|postscript|rtf|tar|toml|vnd\.dart|vnd\.ms-fontobject|vnd\.ms-opentype|wasm|x-httpd-php|x-javascript|x-ns-proxy-autoconfig|x-sh|x-tar|x-virtualbox-hdd|x-virtualbox-ova|x-virtualbox-ovf|x-virtualbox-vbox|x-virtualbox-vdi|x-virtualbox-vhd|x-virtualbox-vmdk|x-www-form-urlencoded)|font\/(?:otf|ttf)|image\/(?:bmp|vnd\.adobe\.photoshop|vnd\.microsoft\.icon|vnd\.ms-dds|x-icon|x-ms-bmp)|message\/rfc822|model\/gltf-binary|x-shader\/x-fragment|x-shader\/x-vertex|[^;\s]+?\+(?:json|text|xml|yaml))(?:[;\s]|$)/i,Zt=(e,t=qa)=>{const s=/\.([a-zA-Z0-9]+?)$/,a=e.match(s);if(!a)return;let n=t[a[1].toLowerCase()];return n&&n.startsWith("text")&&(n+="; charset=utf-8"),n},Pa={aac:"audio/aac",avi:"video/x-msvideo",avif:"image/avif",av1:"video/av1",bin:"application/octet-stream",bmp:"image/bmp",css:"text/css",csv:"text/csv",eot:"application/vnd.ms-fontobject",epub:"application/epub+zip",gif:"image/gif",gz:"application/gzip",htm:"text/html",html:"text/html",ico:"image/x-icon",ics:"text/calendar",jpeg:"image/jpeg",jpg:"image/jpeg",js:"text/javascript",json:"application/json",jsonld:"application/ld+json",map:"application/json",mid:"audio/x-midi",midi:"audio/x-midi",mjs:"text/javascript",mp3:"audio/mpeg",mp4:"video/mp4",mpeg:"video/mpeg",oga:"audio/ogg",ogv:"video/ogg",ogx:"application/ogg",opus:"audio/opus",otf:"font/otf",pdf:"application/pdf",png:"image/png",rtf:"application/rtf",svg:"image/svg+xml",tif:"image/tiff",tiff:"image/tiff",ts:"video/mp2t",ttf:"font/ttf",txt:"text/plain",wasm:"application/wasm",webm:"video/webm",weba:"audio/webm",webmanifest:"application/manifest+json",webp:"image/webp",woff:"font/woff",woff2:"font/woff2",xhtml:"application/xhtml+xml",xml:"application/xml",zip:"application/zip","3gp":"video/3gpp","3g2":"video/3gpp2",gltf:"model/gltf+json",glb:"model/gltf-binary"},qa=Pa,Ha=(...e)=>{let t=e.filter(n=>n!=="").join("/");t=t.replace(new RegExp("(?<=\\/)\\/+","g"),"");const s=t.split("/"),a=[];for(const n of s)n===".."&&a.length>0&&a.at(-1)!==".."?a.pop():n!=="."&&a.push(n);return a.join("/")||"."},js={br:".br",zstd:".zst",gzip:".gz"},Ua=Object.keys(js),Wa="index.html",Ya=e=>{const t=e.root??"./",s=e.path,a=e.join??Ha;return async(n,i)=>{var c,p,f,b;if(n.finalized)return i();let r;if(e.path)r=e.path;else try{if(r=gs(n.req.path),/(?:^|[\/\\])\.{1,2}(?:$|[\/\\])|[\/\\]{2,}/.test(r))throw new Error}catch{return await((c=e.onNotFound)==null?void 0:c.call(e,n.req.path,n)),i()}let o=a(t,!s&&e.rewriteRequestPath?e.rewriteRequestPath(r):r);e.isDir&&await e.isDir(o)&&(o=a(o,Wa));const l=e.getContent;let d=await l(o,n);if(d instanceof Response)return n.newResponse(d.body,d);if(d){const v=e.mimes&&Zt(o,e.mimes)||Zt(o);if(n.header("Content-Type",v||"application/octet-stream"),e.precompressed&&(!v||Fa.test(v))){const T=new Set((p=n.req.header("Accept-Encoding"))==null?void 0:p.split(",").map(x=>x.trim()));for(const x of Ua){if(!T.has(x))continue;const A=await l(o+js[x],n);if(A){d=A,n.header("Content-Encoding",x),n.header("Vary","Accept-Encoding",{append:!0});break}}}return await((f=e.onFound)==null?void 0:f.call(e,o,n)),n.body(d)}await((b=e.onNotFound)==null?void 0:b.call(e,o,n)),await i()}},za=async(e,t)=>{let s;t&&t.manifest?typeof t.manifest=="string"?s=JSON.parse(t.manifest):s=t.manifest:typeof __STATIC_CONTENT_MANIFEST=="string"?s=JSON.parse(__STATIC_CONTENT_MANIFEST):s=__STATIC_CONTENT_MANIFEST;let a;t&&t.namespace?a=t.namespace:a=__STATIC_CONTENT;const n=s[e];if(!n)return null;const i=await a.get(n,{type:"stream"});return i||null},Ja=e=>async function(s,a){return Ya({...e,getContent:async i=>za(i,{manifest:e.manifest,namespace:e.namespace?e.namespace:s.env?s.env.__STATIC_CONTENT:void 0})})(s,a)},Ka=e=>Ja(e);const G={name:"Growth-engine365X",version:"ver1.00",tagline:"X (Twitter) 自動投稿プラットフォーム",longName:"X (Twitter) 自動投稿プラットフォーム",icon:"fa-bolt"},Va=`
<meta charset="utf-8">
...
.nav-item{
  ...
  font-size:.82rem;font-weight:500;color:#A7B6CE;
...
/* ===== 使用例ボタン ===== */
.example-btn{display:inline-flex;align-items:center;gap:.375rem;padding:.4rem .875rem;border-radius:.375rem;background:var(--accent-light);color:var(--accent-hover);border:1px solid var(--accent-light);font-size:.82rem;font-weight:600;font-family:inherit;cursor:pointer;transition:background .15s}
...
`,Xa="bg-paper text-ink min-h-screen font-sans antialiased";function Nt(e,t,s={}){return`<!DOCTYPE html>
<html lang="ja">
<head>
${Va}
<title>${e} — ${G.name}</title>
</head>
<body class="${s.bodyClass??Xa}">
${t}
</body>
...
(function(){
  ...
  if (document.readyState !== 'loading') buildCalendar();
})();
...
<\/script>`}const H=new D;async function vn(e,t){const{results:s}=await e.env.DB.prepare(`SELECT id, account_name, x_username, is_current
       FROM x_accounts WHERE user_id = ? AND is_active = 1 ORDER BY id`).bind(t.id).all(),a=(s||[]).map(i=>({id:i.id,account_name:i.account_name,x_username:i.x_username})),n=(s||[]).find(i=>i.is_current===1);return{accounts:a,currentAccountId:(n==null?void 0:n.id)??null}}H.get("/",e=>e.redirect("/login"));async function J(e,t,s){const a=e.get("user"),{accounts:n,currentAccountId:i}=await vn(e,a),r=n.length>0&&i!==null,o=await Promise.resolve(s({user:a,hasAccount:r,accounts:n,currentAccountId:i})),l=nn({active:t,user:a,accounts:n,currentAccountId:i,pageBody:o});return e.html(Nt("GE365x",l))}H.get("/dashboard",m,async e=>J(e,"dashboard",async({user:t,hasAccount:s})=>{const a=await e.env.DB.prepare("SELECT COUNT(*) AS n FROM x_accounts WHERE user_id=?").bind(t.id).first(),n=await e.env.DB.prepare("SELECT COUNT(*) AS n FROM post_logs WHERE user_id=? AND DATE(created_at)=DATE('now','+9 hours') AND status='posted'").bind(t.id).first(),i=await e.env.DB.prepare("SELECT COUNT(*) AS n FROM post_queue WHERE user_id=? AND status IN ('pending','approved')").bind(t.id).first(),r=await e.env.DB.prepare("SELECT COUNT(*) AS n FROM post_logs WHERE user_id=? AND status='failed' AND DATE(created_at)=DATE('now','+9 hours')").bind(t.id).first(),{results:o}=await e.env.DB.prepare(`SELECT id, account_name, x_username, account_health_score, health_status, is_active
        ...
        ORDER BY COALESCE(aj.publish_at, aj.generate_at, aj.created_at) DESC LIMIT 50`).bind(t.id).all();return hn({hasAccount:s,noAccountAlert:he,accounts:a,jobs:n||[]})}));H.get("/dashboard/accounts",m,async e=>J(e,"accounts",async({user:t})=>{const{results:s}=await e.env.DB.prepare(`SELECT id, account_name, x_username, account_health_score, health_status,
         ...
         FROM x_accounts WHERE user_id = ? ORDER BY id DESC`).bind(t.id).all();return _n({accounts:s||[]})}));H.get("/dashboard/api",m,async e=>J(e,"api",async({user:t})=>{const{results:s}=await e.env.DB.prepare("SELECT setting_key, setting_value FROM x_api_settings WHERE user_id = ?").bind(t.id).all(),a={};for(const n of s||[])a[n.setting_key]=n.setting_value;return bn({settings:a})}));H.get("/dashboard/export",m,async e=>J(e,"export",({user:t})=>gn({isAdmin:t.is_admin})));const F=new D;F.get("/admin",m,R,e=>{const t=`
...
showSection('users');
<\/script>
`;return e.html(Nt("管理画面",t))});F.get("/api/admin/users",m,R,async e=>{const t=e.req.query("filter")||"all",s=[];t==="pending"&&s.push("u.is_approved = 0"),t==="approved"&&s.push("u.is_approved = 1"),t==="admin"&&s.push("u.is_admin = 1");const a=`
...
追加指示: ${e.userInput}`);const i=t+a+s;return{messages:[{role:"system",content:i},{role:"user",content:n}],systemPrompt:i,userPrompt:n}}async function Js(e,t,s,a,n,i="body"){const{messages:r}=zs({theme:t,keywords:s,brandVoice:n,targetDna:a,postMode:i||"body"}),o=await Ys(r,{apiKey:e,temperature:.8});return Et(o,i)}async function Ks(e,t,s,a,n,i,r="body"){if(!Bt[t])throw new Error(`未対応のパターン: ${t}`);const{messages:o}=zs({theme:s,keywords:a,brandVoice:i,targetDna:n,patternType:t,postMode:r||"body"}),l=await Ys(o,{apiKey:e,temperature:.8});return Et(l,r)}function Et(e,t){if(!e)return"";let s=e.replace(/^#{1,4}\s*/gm,"").replace(/^[▪️■●•\-\*]+\s*/gm,"").replace(/^\d+\.\s/gm,"").replace(/^(Step\d+)[:\s]/gim,"").replace(/^[①②③④⑤⑥⑦⑧⑨⑩]\s*/gm,"・").replace(/\*\*([^*]+)\*\*/g,"$1").replace(/\n{3,}/g,`
...
`+n.hashtags);const c=[];if(n.media_json)try{const f=JSON.parse(n.media_json);for(const b of(f||[]).slice(0,4)){const v=await e.env.DB.prepare("SELECT * FROM media_assets WHERE id=? AND user_id=?").bind(b,t.id).first();v!=null&&v.x_media_id&&c.push(v.x_media_id)}}catch{}const p=c.length>0?await Us(l,d,c,null):await Hs(l,d);return await e.env.DB.prepare("UPDATE post_queue SET status='posted', external_post_id=?, posted_at=?, updated_at=? WHERE id=?").bind(p.id||"",g(),g(),s).run(),await e.env.DB.prepare(`UPDATE x_accounts SET last_posted_at=?, daily_post_count=daily_post_count+1,
     ...
     VALUES ('x', ?, ?, ?, ?, 'thread', ?, ?, 'manual_post', 'pending', ?, ?)`).bind(t.id,n??null,s[0].body,s[0].link_url??a??null,s.length,r,i,i).run()).meta.last_row_id,d=[l];for(let c=1;c<s.length;c++){const p=await De(s[c].body),f=await e.env.DB.prepare(`INSERT INTO post_queue
       ...
       VALUES ('x', ?, ?, ?, ?, 'thread', ?, ?, ?, 'manual_post', 'pending', ?, ?)`).bind(t.id,n??null,s[c].body,s[c].link_url??null,l,c,p,i,i).run();d.push(f.meta.last_row_id)}return e.json({success:!0,parent_id:l,ids:d})});const Qs=new D,Hn=5;Qs.post("/cron/tick",async e=>{const t=g(),{results:s}=await e.env.DB.prepare(`SELECT * FROM post_queue
      WHERE platform='x'
...
`+r.hashtags);const f=[];if(r.media_json)try{const v=JSON.parse(r.media_json);for(const T of(v||[]).slice(0,4)){const x=await e.env.DB.prepare("SELECT x_media_id FROM media_assets WHERE id=?").bind(T).first();x!=null&&x.x_media_id&&f.push(x.x_media_id)}}catch{}const b=f.length>0?await Us(c,p,f,null):await Hs(c,p);await e.env.DB.prepare("UPDATE post_queue SET status='posted', external_post_id=?, posted_at=?, updated_at=? WHERE id=?").bind(b.id||"",g(),g(),r.id).run(),await e.env.DB.prepare(`UPDATE x_accounts SET
           ...
           ON CONFLICT(account_id, metric_date) DO UPDATE SET
             ...
             updated_at = datetime('now','+9 hours')`).bind(l.id,r.user_id).run(),n++}finally{await Gs(e.env,l.id)}}catch(l){const d=(l==null?void 0:l.message)||"unknown_error";await e.env.DB.prepare("UPDATE post_queue SET status='failed', error_message=?, updated_at=? WHERE id=?").bind(d,g(),r.id).run(),await e.env.DB.prepare(`INSERT INTO post_logs
...
`)}function Y(e,t){return new Response(e,{headers:{"content-type":"text/csv; charset=utf-8","content-disposition":`attachment; filename="${t}"`,"cache-control":"no-store"}})}function ea(e,t){return new Response(JSON.stringify(e,null,2),{headers:{"content-type":"application/json; charset=utf-8","content-disposition":`attachment; filename="${t}"`,"cache-control":"no-store"}})}function P(){const e=new Date,t=s=>String(s).padStart(2,"0");return`${e.getFullYear()}${t(e.getMonth()+1)}${t(e.getDate())}_${t(e.getHours())}${t(e.getMinutes())}`}C.get("/api/admin/export/posts",m,async e=>{const t=e.get("user"),s=e.req.query("status"),a=e.req.query("month");let n="WHERE pq.platform='x' AND pq.user_id = ?";const i=[t.id];s&&s!=="all"&&(n+=" AND pq.status = ?",i.push(s)),a&&(n+=" AND strftime('%Y-%m', COALESCE(pq.posted_at, pq.scheduled_at, pq.created_at)) = ?",i.push(a));const{results:r}=await e.env.DB.prepare(`SELECT pq.id, pq.body, pq.link_url, pq.hashtags, pq.post_mode, pq.status,
       ...
       FROM auth_logs ORDER BY id DESC LIMIT 10000`).all(),a=W(["id","user_id","email","event_type","ip_address","user_agent","metadata","created_at"],t||[]);return Y(a,`ge365x_admin_audit_${P()}.csv`)});C.get("/api/admin/export/admin/all",m,R,async e=>{const[t,s,a,n,i,r,o]=await Promise.all([e.env.DB.prepare(`SELECT id, email, is_approved, is_admin, trial_start, trial_end, created_at, updated_at
         ...
         FROM x_accounts ORDER BY id DESC LIMIT 10000`).all()]),l={exported_at:new Date().toISOString(),users:t.results||[],user_subscriptions:s.results||[],licenses:a.results||[],auth_logs:n.results||[],post_queue:i.results||[],post_logs:r.results||[],x_accounts:o.results||[]};return ea(l,`ge365x_admin_all_${P()}.json`)});const S=new D;S.use("/static/*",Ka({root:"./",manifest:{}}));S.get("/healthz",e=>e.json({ok:!0,service:"ge365x-web",time:new Date().toISOString()}));S.route("/",Bs);S.route("/",H);S.route("/",F);S.route("/",_e);S.route("/",ge);S.route("/",be);S.route("/",U);S.route("/",Qs);S.route("/",ve);S.route("/",at);S.route("/",nt);S.route("/",it);S.route("/",Yt);S.route("/",xt);S.route("/",wt);S.route("/",kt);S.route("/",Re);S.route("/",C);S.notFound(e=>e.json({error:"not_found",path:e.req.path},404));S.onError((e,t)=>(console.error("[ge365x-web] error:",e),t.json({error:"internal_error",message:e.message},500)));const Un={fetch:S.fetch,async scheduled(e,t,s){const a=e.cron;(!a||a==="*/1 * * * *")&&s.waitUntil(S.fetch(new Request("https://internal/cron/tick",{method:"POST"}),t,s).catch(n=>console.error("[tick]",n))),a==="*/5 * * * *"&&s.waitUntil(S.fetch(new Request("https://internal/cron/autopilot-tick",{method:"POST"}),t,s).catch(n=>console.error("[autopilot-tick]",n)))}},ds=new D,Wn=Object.assign({"/src/index.tsx":Un});let ta=!1;for(const[,e]of Object.entries(Wn))e&&(ds.all("*",t=>{let s;try{s=t.executionCtx}catch{}return e.fetch(t.req.raw,t.env,s)}),ds.notFound(t=>{let s;try{s=t.executionCtx}catch{}return e.fetch(t.req.raw,t.env,s)}),ta=!0);if(!ta)throw new Error("Can't import modules from ['/src/index.ts','/src/index.tsx','/app/server.ts']");export{ds as default};
