var Zs=Object.defineProperty;var Ut=e=>{throw TypeError(e)};var Qs=(e,t,s)=>t in e?Zs(e,t,{enumerable:!0,configurable:!0,writable:!0,value:s}):e[t]=s;var h=(e,t,s)=>Qs(e,typeof t!="symbol"?t+"":t,s),xt=(e,t,s)=>t.has(e)||Ut("Cannot "+s);var u=(e,t,s)=>(xt(e,t,"read from private field"),s?s.call(e):t.get(e)),E=(e,t,s)=>t.has(e)?Ut("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,s),f=(e,t,s,a)=>(xt(e,t,"write to private field"),a?a.call(e,s):t.set(e,s),s),x=(e,t,s)=>(xt(e,t,"access private method"),s);var Wt=(e,t,s,a)=>({set _(n){f(e,t,n,s)},get _(){return u(e,t,a)}});var Yt=(e,t,s)=>(a,n)=>{let i=-1;return r(0);async function r(o){if(o<=i)throw new Error("next() called multiple times");i=o;let c,d=!1,l;if(e[o]?(l=e[o][0][0],a.req.routeIndex=o):l=o===e.length&&n||void 0,l)try{c=await l(a,()=>r(o+1))}catch(p){if(p instanceof Error&&t)a.error=p,c=await t(p,a),d=!0;else throw p}else a.finalized===!1&&s&&(c=await s(a));return c&&(a.finalized===!1||d)&&(a.res=c),a}},ea=Symbol(),ta=async(e,t=Object.create(null))=>{const{all:s=!1,dot:a=!1}=t,i=(e instanceof Es?e.raw.headers:e.headers).get("Content-Type");return i!=null&&i.startsWith("multipart/form-data")||i!=null&&i.startsWith("application/x-www-form-urlencoded")?sa(e,{all:s,dot:a}):{}};async function sa(e,t){const s=await e.formData();return s?aa(s,t):{}}function aa(e,t){const s=Object.create(null);return e.forEach((a,n)=>{t.all||n.endsWith("[]")?na(s,n,a):s[n]=a}),t.dot&&Object.entries(s).forEach(([a,n])=>{a.includes(".")&&(ia(s,a,n),delete s[a])}),s}var na=(e,t,s)=>{e[t]!==void 0?Array.isArray(e[t])?e[t].push(s):e[t]=[e[t],s]:t.endsWith("[]")?e[t]=[s]:e[t]=s},ia=(e,t,s)=>{if(/(?:^|\.)__proto__\./.test(t))return;let a=e;const n=t.split(".");n.forEach((i,r)=>{r===n.length-1?a[i]=s:((!a[i]||typeof a[i]!="object"||Array.isArray(a[i])||a[i]instanceof File)&&(a[i]=Object.create(null)),a=a[i])})},ms=e=>{const t=e.split("/");return t[0]===""&&t.shift(),t},ra=e=>{const{groups:t,path:s}=oa(e),a=ms(s);return ca(a,t)},oa=e=>{const t=[];return e=e.replace(/\{[^}]+\}/g,(s,a)=>{const n=`@${a}`;return t.push([n,s]),n}),{groups:t,path:e}},ca=(e,t)=>{for(let s=t.length-1;s>=0;s--){const[a]=t[s];for(let n=e.length-1;n>=0;n--)if(e[n].includes(a)){e[n]=e[n].replace(a,t[s][1]);break}}return e},it={},da=(e,t)=>{if(e==="*")return"*";const s=e.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);if(s){const a=`${e}#${t}`;return it[a]||(s[2]?it[a]=t&&t[0]!==":"&&t[0]!=="*"?[a,s[1],new RegExp(`^${s[2]}(?=/${t})`)]:[e,s[1],new RegExp(`^${s[2]}$`)]:it[a]=[e,s[1],!0]),it[a]}return null},jt=(e,t)=>{try{return t(e)}catch{return e.replace(/(?:%[0-9A-Fa-f]{2})+/g,s=>{try{return t(s)}catch{return s}})}},hs=e=>jt(e,decodeURI),fs=e=>{const t=e.url,s=t.indexOf("/",t.indexOf(":")+4);let a=s;for(;a<t.length;a++){const n=t.charCodeAt(a);if(n===37){const i=t.indexOf("?",a),r=t.indexOf("#",a),o=i===-1?r===-1?void 0:r:r===-1?i:Math.min(i,r),c=t.slice(s,o);return hs(c.includes("%25")?c.replace(/%25/g,"%2525"):c)}else if(n===63||n===35)break}return t.slice(s,a)},la=e=>{const t=fs(e);return t.length>1&&t.at(-1)==="/"?t.slice(0,-1):t},Ie=(e,t,...s)=>(s.length&&(t=Ie(t,...s)),`${(e==null?void 0:e[0])==="/"?"":"/"}${e}${t==="/"?"":`${(e==null?void 0:e.at(-1))==="/"?"":"/"}${(t==null?void 0:t[0])==="/"?t.slice(1):t}`}`),bs=e=>{if(e.charCodeAt(e.length-1)!==63||!e.includes(":"))return null;const t=e.split("/"),s=[];let a="";return t.forEach(n=>{if(n!==""&&!/\:/.test(n))a+="/"+n;else if(/\:/.test(n))if(/\?/.test(n)){s.length===0&&a===""?s.push("/"):s.push(a);const i=n.replace("?","");a+="/"+i,s.push(a)}else a+="/"+n}),s.filter((n,i,r)=>r.indexOf(n)===i)},wt=e=>/[%+]/.test(e)?(e.indexOf("+")!==-1&&(e=e.replace(/\+/g," ")),e.indexOf("%")!==-1?jt(e,vs):e):e,gs=(e,t,s)=>{let a;if(!s&&t&&!/[%+]/.test(t)){let r=e.indexOf("?",8);if(r===-1)return;for(e.startsWith(t,r+1)||(r=e.indexOf(`&${t}`,r+1));r!==-1;){const o=e.charCodeAt(r+t.length+1);if(o===61){const c=r+t.length+2,d=e.indexOf("&",c);return wt(e.slice(c,d===-1?void 0:d))}else if(o==38||isNaN(o))return"";r=e.indexOf(`&${t}`,r+1)}if(a=/[%+]/.test(e),!a)return}const n={};a??(a=/[%+]/.test(e));let i=e.indexOf("?",8);for(;i!==-1;){const r=e.indexOf("&",i+1);let o=e.indexOf("=",i);o>r&&r!==-1&&(o=-1);let c=e.slice(i+1,o===-1?r===-1?void 0:r:o);if(a&&(c=wt(c)),i=r,c==="")continue;let d;o===-1?d="":(d=e.slice(o+1,r===-1?void 0:r),a&&(d=wt(d))),s?(n[c]&&Array.isArray(n[c])||(n[c]=[]),n[c].push(d)):n[c]??(n[c]=d)}return t?n[t]:n},ua=gs,pa=(e,t)=>gs(e,t,!0),vs=decodeURIComponent,Jt=e=>jt(e,vs),Ce,J,re,ys,xs,At,ce,cs,Es=(cs=class{constructor(e,t="/",s=[[]]){E(this,re);h(this,"raw");E(this,Ce);E(this,J);h(this,"routeIndex",0);h(this,"path");h(this,"bodyCache",{});E(this,ce,e=>{const{bodyCache:t,raw:s}=this,a=t[e];if(a)return a;const n=Object.keys(t)[0];return n?t[n].then(i=>(n==="json"&&(i=JSON.stringify(i)),new Response(i)[e]())):t[e]=s[e]()});this.raw=e,this.path=t,f(this,J,s),f(this,Ce,{})}param(e){return e?x(this,re,ys).call(this,e):x(this,re,xs).call(this)}query(e){return ua(this.url,e)}queries(e){return pa(this.url,e)}header(e){if(e)return this.raw.headers.get(e)??void 0;const t={};return this.raw.headers.forEach((s,a)=>{t[a]=s}),t}async parseBody(e){return ta(this,e)}json(){return u(this,ce).call(this,"text").then(e=>JSON.parse(e))}text(){return u(this,ce).call(this,"text")}arrayBuffer(){return u(this,ce).call(this,"arrayBuffer")}blob(){return u(this,ce).call(this,"blob")}formData(){return u(this,ce).call(this,"formData")}addValidatedData(e,t){u(this,Ce)[e]=t}valid(e){return u(this,Ce)[e]}get url(){return this.raw.url}get method(){return this.raw.method}get[ea](){return u(this,J)}get matchedRoutes(){return u(this,J)[0].map(([[,e]])=>e)}get routePath(){return u(this,J)[0].map(([[,e]])=>e)[this.routeIndex].path}},Ce=new WeakMap,J=new WeakMap,re=new WeakSet,ys=function(e){const t=u(this,J)[0][this.routeIndex][1][e],s=x(this,re,At).call(this,t);return s&&/\%/.test(s)?Jt(s):s},xs=function(){const e={},t=Object.keys(u(this,J)[0][this.routeIndex][1]);for(const s of t){const a=x(this,re,At).call(this,u(this,J)[0][this.routeIndex][1][s]);a!==void 0&&(e[s]=/\%/.test(a)?Jt(a):a)}return e},At=function(e){return u(this,J)[1]?u(this,J)[1][e]:e},ce=new WeakMap,cs),_a={Stringify:1},ws=async(e,t,s,a,n)=>{typeof e=="object"&&!(e instanceof String)&&(e instanceof Promise||(e=e.toString()),e instanceof Promise&&(e=await e));const i=e.callbacks;return i!=null&&i.length?(n?n[0]+=e:n=[e],Promise.all(i.map(o=>o({phase:t,buffer:n,context:a}))).then(o=>Promise.all(o.filter(Boolean).map(c=>ws(c,t,!1,a,n))).then(()=>n[0]))):Promise.resolve(e)},ma="text/plain; charset=UTF-8",St=(e,t)=>({"Content-Type":e,...t}),Ye=(e,t)=>new Response(e,t),Xe,Ge,te,Be,se,$,ze,$e,Me,xe,Ze,Qe,de,Le,ds,ha=(ds=class{constructor(e,t){E(this,de);E(this,Xe);E(this,Ge);h(this,"env",{});E(this,te);h(this,"finalized",!1);h(this,"error");E(this,Be);E(this,se);E(this,$);E(this,ze);E(this,$e);E(this,Me);E(this,xe);E(this,Ze);E(this,Qe);h(this,"render",(...e)=>(u(this,$e)??f(this,$e,t=>this.html(t)),u(this,$e).call(this,...e)));h(this,"setLayout",e=>f(this,ze,e));h(this,"getLayout",()=>u(this,ze));h(this,"setRenderer",e=>{f(this,$e,e)});h(this,"header",(e,t,s)=>{this.finalized&&f(this,$,Ye(u(this,$).body,u(this,$)));const a=u(this,$)?u(this,$).headers:u(this,xe)??f(this,xe,new Headers);t===void 0?a.delete(e):s!=null&&s.append?a.append(e,t):a.set(e,t)});h(this,"status",e=>{f(this,Be,e)});h(this,"set",(e,t)=>{u(this,te)??f(this,te,new Map),u(this,te).set(e,t)});h(this,"get",e=>u(this,te)?u(this,te).get(e):void 0);h(this,"newResponse",(...e)=>x(this,de,Le).call(this,...e));h(this,"body",(e,t,s)=>x(this,de,Le).call(this,e,t,s));h(this,"text",(e,t,s)=>!u(this,xe)&&!u(this,Be)&&!t&&!s&&!this.finalized?new Response(e):x(this,de,Le).call(this,e,t,St(ma,s)));h(this,"json",(e,t,s)=>x(this,de,Le).call(this,JSON.stringify(e),t,St("application/json",s)));h(this,"html",(e,t,s)=>{const a=n=>x(this,de,Le).call(this,n,t,St("text/html; charset=UTF-8",s));return typeof e=="object"?ws(e,_a.Stringify,!1,{}).then(a):a(e)});h(this,"redirect",(e,t)=>{const s=String(e);return this.header("Location",/[^\x00-\xFF]/.test(s)?encodeURI(s):s),this.newResponse(null,t??302)});h(this,"notFound",()=>(u(this,Me)??f(this,Me,()=>Ye()),u(this,Me).call(this,this)));f(this,Xe,e),t&&(f(this,se,t.executionCtx),this.env=t.env,f(this,Me,t.notFoundHandler),f(this,Qe,t.path),f(this,Ze,t.matchResult))}get req(){return u(this,Ge)??f(this,Ge,new Es(u(this,Xe),u(this,Qe),u(this,Ze))),u(this,Ge)}get event(){if(u(this,se)&&"respondWith"in u(this,se))return u(this,se);throw Error("This context has no FetchEvent")}get executionCtx(){if(u(this,se))return u(this,se);throw Error("This context has no ExecutionContext")}get res(){return u(this,$)||f(this,$,Ye(null,{headers:u(this,xe)??f(this,xe,new Headers)}))}set res(e){if(u(this,$)&&e){e=Ye(e.body,e);for(const[t,s]of u(this,$).headers.entries())if(t!=="content-type")if(t==="set-cookie"){const a=u(this,$).headers.getSetCookie();e.headers.delete("set-cookie");for(const n of a)e.headers.append("set-cookie",n)}else e.headers.set(t,s)}f(this,$,e),this.finalized=!0}get var(){return u(this,te)?Object.fromEntries(u(this,te)):{}}},Xe=new WeakMap,Ge=new WeakMap,te=new WeakMap,Be=new WeakMap,se=new WeakMap,$=new WeakMap,ze=new WeakMap,$e=new WeakMap,Me=new WeakMap,xe=new WeakMap,Ze=new WeakMap,Qe=new WeakMap,de=new WeakSet,Le=function(e,t,s){const a=u(this,$)?new Headers(u(this,$).headers):u(this,xe)??new Headers;if(typeof t=="object"&&"headers"in t){const i=t.headers instanceof Headers?t.headers:new Headers(t.headers);for(const[r,o]of i)r.toLowerCase()==="set-cookie"?a.append(r,o):a.set(r,o)}if(s)for(const[i,r]of Object.entries(s))if(typeof r=="string")a.set(i,r);else{a.delete(i);for(const o of r)a.append(i,o)}const n=typeof t=="number"?t:(t==null?void 0:t.status)??u(this,Be);return Ye(e,{status:n,headers:a})},ds),O="ALL",fa="all",ba=["get","post","put","delete","options","patch"],Ss="Can not add a route since the matcher is already built.",Ts=class extends Error{},ga="__COMPOSED_HANDLER",va=e=>e.text("404 Not Found",404),Kt=(e,t)=>{if("getResponse"in e){const s=e.getResponse();return t.newResponse(s.body,s)}return console.error(e),t.text("Internal Server Error",500)},V,j,ks,X,Ee,rt,ot,qe,Ea=(qe=class{constructor(t={}){E(this,j);h(this,"get");h(this,"post");h(this,"put");h(this,"delete");h(this,"options");h(this,"patch");h(this,"all");h(this,"on");h(this,"use");h(this,"router");h(this,"getPath");h(this,"_basePath","/");E(this,V,"/");h(this,"routes",[]);E(this,X,va);h(this,"errorHandler",Kt);h(this,"onError",t=>(this.errorHandler=t,this));h(this,"notFound",t=>(f(this,X,t),this));h(this,"fetch",(t,...s)=>x(this,j,ot).call(this,t,s[1],s[0],t.method));h(this,"request",(t,s,a,n)=>t instanceof Request?this.fetch(s?new Request(t,s):t,a,n):(t=t.toString(),this.fetch(new Request(/^https?:\/\//.test(t)?t:`http://localhost${Ie("/",t)}`,s),a,n)));h(this,"fire",()=>{addEventListener("fetch",t=>{t.respondWith(x(this,j,ot).call(this,t.request,t,void 0,t.request.method))})});[...ba,fa].forEach(i=>{this[i]=(r,...o)=>(typeof r=="string"?f(this,V,r):x(this,j,Ee).call(this,i,u(this,V),r),o.forEach(c=>{x(this,j,Ee).call(this,i,u(this,V),c)}),this)}),this.on=(i,r,...o)=>{for(const c of[r].flat()){f(this,V,c);for(const d of[i].flat())o.map(l=>{x(this,j,Ee).call(this,d.toUpperCase(),u(this,V),l)})}return this},this.use=(i,...r)=>(typeof i=="string"?f(this,V,i):(f(this,V,"*"),r.unshift(i)),r.forEach(o=>{x(this,j,Ee).call(this,O,u(this,V),o)}),this);const{strict:a,...n}=t;Object.assign(this,n),this.getPath=a??!0?t.getPath??fs:la}route(t,s){const a=this.basePath(t);return s.routes.map(n=>{var r;let i;s.errorHandler===Kt?i=n.handler:(i=async(o,c)=>(await Yt([],s.errorHandler)(o,()=>n.handler(o,c))).res,i[ga]=n.handler),x(r=a,j,Ee).call(r,n.method,n.path,i)}),this}basePath(t){const s=x(this,j,ks).call(this);return s._basePath=Ie(this._basePath,t),s}mount(t,s,a){let n,i;a&&(typeof a=="function"?i=a:(i=a.optionHandler,a.replaceRequest===!1?n=c=>c:n=a.replaceRequest));const r=i?c=>{const d=i(c);return Array.isArray(d)?d:[d]}:c=>{let d;try{d=c.executionCtx}catch{}return[c.env,d]};n||(n=(()=>{const c=Ie(this._basePath,t),d=c==="/"?0:c.length;return l=>{const p=new URL(l.url);return p.pathname=p.pathname.slice(d)||"/",new Request(p,l)}})());const o=async(c,d)=>{const l=await s(n(c.req.raw),...r(c));if(l)return l;await d()};return x(this,j,Ee).call(this,O,Ie(t,"*"),o),this}},V=new WeakMap,j=new WeakSet,ks=function(){const t=new qe({router:this.router,getPath:this.getPath});return t.errorHandler=this.errorHandler,f(t,X,u(this,X)),t.routes=this.routes,t},X=new WeakMap,Ee=function(t,s,a){t=t.toUpperCase(),s=Ie(this._basePath,s);const n={basePath:this._basePath,path:s,method:t,handler:a};this.router.add(t,s,[a,n]),this.routes.push(n)},rt=function(t,s){if(t instanceof Error)return this.errorHandler(t,s);throw t},ot=function(t,s,a,n){if(n==="HEAD")return(async()=>new Response(null,await x(this,j,ot).call(this,t,s,a,"GET")))();const i=this.getPath(t,{env:a}),r=this.router.match(n,i),o=new ha(t,{path:i,matchResult:r,env:a,executionCtx:s,notFoundHandler:u(this,X)});if(r[0].length===1){let d;try{d=r[0][0][0][0](o,async()=>{o.res=await u(this,X).call(this,o)})}catch(l){return x(this,j,rt).call(this,l,o)}return d instanceof Promise?d.then(l=>l||(o.finalized?o.res:u(this,X).call(this,o))).catch(l=>x(this,j,rt).call(this,l,o)):d??u(this,X).call(this,o)}const c=Yt(r[0],this.errorHandler,u(this,X));return(async()=>{try{const d=await c(o);if(!d.finalized)throw new Error("Context is not finalized. Did you forget to return a Response object or `await next()`?");return d.res}catch(d){return x(this,j,rt).call(this,d,o)}})()},qe),As=[];function ya(e,t){const s=this.buildAllMatchers(),a=((n,i)=>{const r=s[n]||s[O],o=r[2][i];if(o)return o;const c=i.match(r[0]);if(!c)return[[],As];const d=c.indexOf("",1);return[r[1][d],c]});return this.match=a,a(e,t)}var lt="[^/]+",Ke=".*",Ve="(?:|/.*)",Ne=Symbol(),xa=new Set(".\\+*[^]$()");function wa(e,t){return e.length===1?t.length===1?e<t?-1:1:-1:t.length===1||e===Ke||e===Ve?1:t===Ke||t===Ve?-1:e===lt?1:t===lt?-1:e.length===t.length?e<t?-1:1:t.length-e.length}var we,Se,G,Ae,Sa=(Ae=class{constructor(){E(this,we);E(this,Se);E(this,G,Object.create(null))}insert(t,s,a,n,i){if(t.length===0){if(u(this,we)!==void 0)throw Ne;if(i)return;f(this,we,s);return}const[r,...o]=t,c=r==="*"?o.length===0?["","",Ke]:["","",lt]:r==="/*"?["","",Ve]:r.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);let d;if(c){const l=c[1];let p=c[2]||lt;if(l&&c[2]&&(p===".*"||(p=p.replace(/^\((?!\?:)(?=[^)]+\)$)/,"(?:"),/\((?!\?:)/.test(p))))throw Ne;if(d=u(this,G)[p],!d){if(Object.keys(u(this,G)).some(m=>m!==Ke&&m!==Ve))throw Ne;if(i)return;d=u(this,G)[p]=new Ae,l!==""&&f(d,Se,n.varIndex++)}!i&&l!==""&&a.push([l,u(d,Se)])}else if(d=u(this,G)[r],!d){if(Object.keys(u(this,G)).some(l=>l.length>1&&l!==Ke&&l!==Ve))throw Ne;if(i)return;d=u(this,G)[r]=new Ae}d.insert(o,s,a,n,i)}buildRegExpStr(){const s=Object.keys(u(this,G)).sort(wa).map(a=>{const n=u(this,G)[a];return(typeof u(n,Se)=="number"?`(${a})@${u(n,Se)}`:xa.has(a)?`\\${a}`:a)+n.buildRegExpStr()});return typeof u(this,we)=="number"&&s.unshift(`#${u(this,we)}`),s.length===0?"":s.length===1?s[0]:"(?:"+s.join("|")+")"}},we=new WeakMap,Se=new WeakMap,G=new WeakMap,Ae),ht,et,ls,Ta=(ls=class{constructor(){E(this,ht,{varIndex:0});E(this,et,new Sa)}insert(e,t,s){const a=[],n=[];for(let r=0;;){let o=!1;if(e=e.replace(/\{[^}]+\}/g,c=>{const d=`@\\${r}`;return n[r]=[d,c],r++,o=!0,d}),!o)break}const i=e.match(/(?::[^\/]+)|(?:\/\*$)|./g)||[];for(let r=n.length-1;r>=0;r--){const[o]=n[r];for(let c=i.length-1;c>=0;c--)if(i[c].indexOf(o)!==-1){i[c]=i[c].replace(o,n[r][1]);break}}return u(this,et).insert(i,t,a,u(this,ht),s),a}buildRegExp(){let e=u(this,et).buildRegExpStr();if(e==="")return[/^$/,[],[]];let t=0;const s=[],a=[];return e=e.replace(/#(\d+)|@(\d+)|\.\*\$/g,(n,i,r)=>i!==void 0?(s[++t]=Number(i),"$()"):(r!==void 0&&(a[Number(r)]=++t),"")),[new RegExp(`^${e}`),s,a]}},ht=new WeakMap,et=new WeakMap,ls),ka=[/^$/,[],Object.create(null)],ct=Object.create(null);function Ds(e){return ct[e]??(ct[e]=new RegExp(e==="*"?"":`^${e.replace(/\/\*$|([.\\+*[^\]$()])/g,(t,s)=>s?`\\${s}`:"(?:|/.*)")}$`))}function Aa(){ct=Object.create(null)}function Da(e){var d;const t=new Ta,s=[];if(e.length===0)return ka;const a=e.map(l=>[!/\*|\/:/.test(l[0]),...l]).sort(([l,p],[m,b])=>l?1:m?-1:p.length-b.length),n=Object.create(null);for(let l=0,p=-1,m=a.length;l<m;l++){const[b,v,k]=a[l];b?n[v]=[k.map(([A])=>[A,Object.create(null)]),As]:p++;let y;try{y=t.insert(v,p,b)}catch(A){throw A===Ne?new Ts(v):A}b||(s[p]=k.map(([A,S])=>{const C=Object.create(null);for(S-=1;S>=0;S--){const[F,B]=y[S];C[F]=B}return[A,C]}))}const[i,r,o]=t.buildRegExp();for(let l=0,p=s.length;l<p;l++)for(let m=0,b=s[l].length;m<b;m++){const v=(d=s[l][m])==null?void 0:d[1];if(!v)continue;const k=Object.keys(v);for(let y=0,A=k.length;y<A;y++)v[k[y]]=o[v[k[y]]]}const c=[];for(const l in r)c[l]=s[r[l]];return[i,c,n]}function je(e,t){if(e){for(const s of Object.keys(e).sort((a,n)=>n.length-a.length))if(Ds(s).test(t))return[...e[s]]}}var le,ue,ft,Rs,us,Ra=(us=class{constructor(){E(this,ft);h(this,"name","RegExpRouter");E(this,le);E(this,ue);h(this,"match",ya);f(this,le,{[O]:Object.create(null)}),f(this,ue,{[O]:Object.create(null)})}add(e,t,s){var o;const a=u(this,le),n=u(this,ue);if(!a||!n)throw new Error(Ss);a[e]||[a,n].forEach(c=>{c[e]=Object.create(null),Object.keys(c[O]).forEach(d=>{c[e][d]=[...c[O][d]]})}),t==="/*"&&(t="*");const i=(t.match(/\/:/g)||[]).length;if(/\*$/.test(t)){const c=Ds(t);e===O?Object.keys(a).forEach(d=>{var l;(l=a[d])[t]||(l[t]=je(a[d],t)||je(a[O],t)||[])}):(o=a[e])[t]||(o[t]=je(a[e],t)||je(a[O],t)||[]),Object.keys(a).forEach(d=>{(e===O||e===d)&&Object.keys(a[d]).forEach(l=>{c.test(l)&&a[d][l].push([s,i])})}),Object.keys(n).forEach(d=>{(e===O||e===d)&&Object.keys(n[d]).forEach(l=>c.test(l)&&n[d][l].push([s,i]))});return}const r=bs(t)||[t];for(let c=0,d=r.length;c<d;c++){const l=r[c];Object.keys(n).forEach(p=>{var m;(e===O||e===p)&&((m=n[p])[l]||(m[l]=[...je(a[p],l)||je(a[O],l)||[]]),n[p][l].push([s,i-d+c+1]))})}}buildAllMatchers(){const e=Object.create(null);return Object.keys(u(this,ue)).concat(Object.keys(u(this,le))).forEach(t=>{e[t]||(e[t]=x(this,ft,Rs).call(this,t))}),f(this,le,f(this,ue,void 0)),Aa(),e}},le=new WeakMap,ue=new WeakMap,ft=new WeakSet,Rs=function(e){const t=[];let s=e===O;return[u(this,le),u(this,ue)].forEach(a=>{const n=a[e]?Object.keys(a[e]).map(i=>[i,a[e][i]]):[];n.length!==0?(s||(s=!0),t.push(...n)):e!==O&&t.push(...Object.keys(a[O]).map(i=>[i,a[O][i]]))}),s?Da(t):null},us),pe,ae,ps,Oa=(ps=class{constructor(e){h(this,"name","SmartRouter");E(this,pe,[]);E(this,ae,[]);f(this,pe,e.routers)}add(e,t,s){if(!u(this,ae))throw new Error(Ss);u(this,ae).push([e,t,s])}match(e,t){if(!u(this,ae))throw new Error("Fatal error");const s=u(this,pe),a=u(this,ae),n=s.length;let i=0,r;for(;i<n;i++){const o=s[i];try{for(let c=0,d=a.length;c<d;c++)o.add(...a[c]);r=o.match(e,t)}catch(c){if(c instanceof Ts)continue;throw c}this.match=o.match.bind(o),f(this,pe,[o]),f(this,ae,void 0);break}if(i===n)throw new Error("Fatal error");return this.name=`SmartRouter + ${this.activeRouter.name}`,r}get activeRouter(){if(u(this,ae)||u(this,pe).length!==1)throw new Error("No active router has been determined yet.");return u(this,pe)[0]}},pe=new WeakMap,ae=new WeakMap,ps),Je=Object.create(null),ja=e=>{for(const t in e)return!0;return!1},_e,L,Te,Pe,I,ne,ye,Fe,Ia=(Fe=class{constructor(t,s,a){E(this,ne);E(this,_e);E(this,L);E(this,Te);E(this,Pe,0);E(this,I,Je);if(f(this,L,a||Object.create(null)),f(this,_e,[]),t&&s){const n=Object.create(null);n[t]={handler:s,possibleKeys:[],score:0},f(this,_e,[n])}f(this,Te,[])}insert(t,s,a){f(this,Pe,++Wt(this,Pe)._);let n=this;const i=ra(s),r=[];for(let o=0,c=i.length;o<c;o++){const d=i[o],l=i[o+1],p=da(d,l),m=Array.isArray(p)?p[0]:d;if(m in u(n,L)){n=u(n,L)[m],p&&r.push(p[1]);continue}u(n,L)[m]=new Fe,p&&(u(n,Te).push(p),r.push(p[1])),n=u(n,L)[m]}return u(n,_e).push({[t]:{handler:a,possibleKeys:r.filter((o,c,d)=>d.indexOf(o)===c),score:u(this,Pe)}}),n}search(t,s){var l;const a=[];f(this,I,Je);let i=[this];const r=ms(s),o=[],c=r.length;let d=null;for(let p=0;p<c;p++){const m=r[p],b=p===c-1,v=[];for(let y=0,A=i.length;y<A;y++){const S=i[y],C=u(S,L)[m];C&&(f(C,I,u(S,I)),b?(u(C,L)["*"]&&x(this,ne,ye).call(this,a,u(C,L)["*"],t,u(S,I)),x(this,ne,ye).call(this,a,C,t,u(S,I))):v.push(C));for(let F=0,B=u(S,Te).length;F<B;F++){const nt=u(S,Te)[F],Q=u(S,I)===Je?{}:{...u(S,I)};if(nt==="*"){const Re=u(S,L)["*"];Re&&(x(this,ne,ye).call(this,a,Re,t,u(S,I)),f(Re,I,Q),v.push(Re));continue}const[zs,Ht,Ue]=nt;if(!m&&!(Ue instanceof RegExp))continue;const ee=u(S,L)[zs];if(Ue instanceof RegExp){if(d===null){d=new Array(c);let Oe=s[0]==="/"?1:0;for(let We=0;We<c;We++)d[We]=Oe,Oe+=r[We].length+1}const Re=s.substring(d[p]),yt=Ue.exec(Re);if(yt){if(Q[Ht]=yt[0],x(this,ne,ye).call(this,a,ee,t,u(S,I),Q),ja(u(ee,L))){f(ee,I,Q);const Oe=((l=yt[0].match(/\//))==null?void 0:l.length)??0;(o[Oe]||(o[Oe]=[])).push(ee)}continue}}(Ue===!0||Ue.test(m))&&(Q[Ht]=m,b?(x(this,ne,ye).call(this,a,ee,t,Q,u(S,I)),u(ee,L)["*"]&&x(this,ne,ye).call(this,a,u(ee,L)["*"],t,Q,u(S,I))):(f(ee,I,Q),v.push(ee)))}}const k=o.shift();i=k?v.concat(k):v}return a.length>1&&a.sort((p,m)=>p.score-m.score),[a.map(({handler:p,params:m})=>[p,m])]}},_e=new WeakMap,L=new WeakMap,Te=new WeakMap,Pe=new WeakMap,I=new WeakMap,ne=new WeakSet,ye=function(t,s,a,n,i){for(let r=0,o=u(s,_e).length;r<o;r++){const c=u(s,_e)[r],d=c[a]||c[O],l={};if(d!==void 0&&(d.params=Object.create(null),t.push(d),n!==Je||i&&i!==Je))for(let p=0,m=d.possibleKeys.length;p<m;p++){const b=d.possibleKeys[p],v=l[d.score];d.params[b]=i!=null&&i[b]&&!v?i[b]:n[b]??(i==null?void 0:i[b]),l[d.score]=!0}}},Fe),ke,_s,La=(_s=class{constructor(){h(this,"name","TrieRouter");E(this,ke);f(this,ke,new Ia)}add(e,t,s){const a=bs(t);if(a){for(let n=0,i=a.length;n<i;n++)u(this,ke).insert(e,a[n],s);return}u(this,ke).insert(e,t,s)}match(e,t){return u(this,ke).search(e,t)}},ke=new WeakMap,_s),D=class extends Ea{constructor(e={}){super(e),this.router=e.router??new Oa({routers:[new Ra,new La]})}},Na=/^\s*(?:text\/(?!event-stream(?:[;\s]|$))[^;\s]+|application\/(?:javascript|json|xml|xml-dtd|ecmascript|dart|postscript|rtf|tar|toml|vnd\.dart|vnd\.ms-fontobject|vnd\.ms-opentype|wasm|x-httpd-php|x-javascript|x-ns-proxy-autoconfig|x-sh|x-tar|x-virtualbox-hdd|x-virtualbox-ova|x-virtualbox-ovf|x-virtualbox-vbox|x-virtualbox-vdi|x-virtualbox-vhd|x-virtualbox-vmdk|x-www-form-urlencoded)|font\/(?:otf|ttf)|image\/(?:bmp|vnd\.adobe\.photoshop|vnd\.microsoft\.icon|vnd\.ms-dds|x-icon|x-ms-bmp)|message\/rfc822|model\/gltf-binary|x-shader\/x-fragment|x-shader\/x-vertex|[^;\s]+?\+(?:json|text|xml|yaml))(?:[;\s]|$)/i,Vt=(e,t=Ba)=>{const s=/\.([a-zA-Z0-9]+?)$/,a=e.match(s);if(!a)return;let n=t[a[1].toLowerCase()];return n&&n.startsWith("text")&&(n+="; charset=utf-8"),n},Ca={aac:"audio/aac",avi:"video/x-msvideo",avif:"image/avif",av1:"video/av1",bin:"application/octet-stream",bmp:"image/bmp",css:"text/css",csv:"text/csv",eot:"application/vnd.ms-fontobject",epub:"application/epub+zip",gif:"image/gif",gz:"application/gzip",htm:"text/html",html:"text/html",ico:"image/x-icon",ics:"text/calendar",jpeg:"image/jpeg",jpg:"image/jpeg",js:"text/javascript",json:"application/json",jsonld:"application/ld+json",map:"application/json",mid:"audio/x-midi",midi:"audio/x-midi",mjs:"text/javascript",mp3:"audio/mpeg",mp4:"video/mp4",mpeg:"video/mpeg",oga:"audio/ogg",ogv:"video/ogg",ogx:"application/ogg",opus:"audio/opus",otf:"font/otf",pdf:"application/pdf",png:"image/png",rtf:"application/rtf",svg:"image/svg+xml",tif:"image/tiff",tiff:"image/tiff",ts:"video/mp2t",ttf:"font/ttf",txt:"text/plain",wasm:"application/wasm",webm:"video/webm",weba:"audio/webm",webmanifest:"application/manifest+json",webp:"image/webp",woff:"font/woff",woff2:"font/woff2",xhtml:"application/xhtml+xml",xml:"application/xml",zip:"application/zip","3gp":"video/3gpp","3g2":"video/3gpp2",gltf:"model/gltf+json",glb:"model/gltf-binary"},Ba=Ca,$a=(...e)=>{let t=e.filter(n=>n!=="").join("/");t=t.replace(new RegExp("(?<=\\/)\\/+","g"),"");const s=t.split("/"),a=[];for(const n of s)n===".."&&a.length>0&&a.at(-1)!==".."?a.pop():n!=="."&&a.push(n);return a.join("/")||"."},Os={br:".br",zstd:".zst",gzip:".gz"},Ma=Object.keys(Os),qa="index.html",Pa=e=>{const t=e.root??"./",s=e.path,a=e.join??$a;return async(n,i)=>{var l,p,m,b;if(n.finalized)return i();let r;if(e.path)r=e.path;else try{if(r=hs(n.req.path),/(?:^|[\/\\])\.{1,2}(?:$|[\/\\])|[\/\\]{2,}/.test(r))throw new Error}catch{return await((l=e.onNotFound)==null?void 0:l.call(e,n.req.path,n)),i()}let o=a(t,!s&&e.rewriteRequestPath?e.rewriteRequestPath(r):r);e.isDir&&await e.isDir(o)&&(o=a(o,qa));const c=e.getContent;let d=await c(o,n);if(d instanceof Response)return n.newResponse(d.body,d);if(d){const v=e.mimes&&Vt(o,e.mimes)||Vt(o);if(n.header("Content-Type",v||"application/octet-stream"),e.precompressed&&(!v||Na.test(v))){const k=new Set((p=n.req.header("Accept-Encoding"))==null?void 0:p.split(",").map(y=>y.trim()));for(const y of Ma){if(!k.has(y))continue;const A=await c(o+Os[y],n);if(A){d=A,n.header("Content-Encoding",y),n.header("Vary","Accept-Encoding",{append:!0});break}}}return await((m=e.onFound)==null?void 0:m.call(e,o,n)),n.body(d)}await((b=e.onNotFound)==null?void 0:b.call(e,o,n)),await i()}},Fa=async(e,t)=>{let s;t&&t.manifest?typeof t.manifest=="string"?s=JSON.parse(t.manifest):s=t.manifest:typeof __STATIC_CONTENT_MANIFEST=="string"?s=JSON.parse(__STATIC_CONTENT_MANIFEST):s=__STATIC_CONTENT_MANIFEST;let a;t&&t.namespace?a=t.namespace:a=__STATIC_CONTENT;const n=s[e];if(!n)return null;const i=await a.get(n,{type:"stream"});return i||null},Ha=e=>async function(s,a){return Pa({...e,getContent:async i=>Fa(i,{manifest:e.manifest,namespace:e.namespace?e.namespace:s.env?s.env.__STATIC_CONTENT:void 0})})(s,a)},Ua=e=>Ha(e);const z={name:"Growth-engine365X",version:"ver1.00",tagline:"X (Twitter) 自動投稿プラットフォーム",longName:"X (Twitter) 自動投稿プラットフォーム",icon:"fa-bolt"},Wa=`
<meta charset="utf-8">
...
<p>URLに正しい token を付けてください。<br>例: /setup?token=（ADMIN_PASSWORDの値）</p></div></body></html>`,403);const a="admin@ge365x.local",i=await Nt("Ge365x@Admin!"),r=await e.env.DB.prepare("SELECT id FROM users WHERE email = ?").bind(a).first();if(r)await e.env.DB.prepare("UPDATE users SET password_hash=?, is_admin=1, is_approved=1, updated_at=datetime('now','+9 hours') WHERE id=?").bind(i,r.id).run(),await e.env.DB.prepare("UPDATE user_subscriptions SET plan_code='ge365x_pro', status='active', current_period_end='2099-12-31 23:59:59' WHERE user_id=?").bind(r.id).run();else{const c=(await e.env.DB.prepare(`INSERT INTO users (email, password_hash, is_approved, is_admin, trial_start, trial_end)
       ...
       VALUES (?, 'ge365x_pro', 'active', datetime('now','+9 hours'), '2099-12-31 23:59:59')`).bind(c).run()}return e.html(`<!DOCTYPE html><html lang="ja"><head><meta charset="utf-8">
...
<div class="warn">⚠️ ログイン後すぐにパスワードを変更してください<br>このURLは設定後も有効なため、token を知らない人には教えないでください</div>
      ...
      WHERE is_active = 1
      ORDER BY sort_order ASC`).all(),s=(t||[]).map(a=>({...a,features:a.features?JSON.parse(a.features):[]}));return e.json({plans:s})});be.get("/api/subscription/me",_,async e=>{const t=e.get("user"),s=await e.env.DB.prepare(`SELECT s.plan_code, s.status, s.started_at, s.current_period_end, s.cancel_at_period_end,
     ...
     ON CONFLICT(account_id) DO UPDATE SET locked_at = excluded.locked_at`).bind(t,s).run(),!0)}async function Js(e,t){await e.DB.prepare("DELETE FROM post_locks WHERE account_id = ?").bind(t).run()}async function Ks(e,t,s,a,n){const i={ok:!0,errors:[],warnings:[]},r=await e.DB.prepare("SELECT daily_post_count, daily_post_limit, last_posted_at, last_daily_reset_date, health_status FROM x_accounts WHERE id = ?").bind(t).first();if(!r)return i.ok=!1,i.errors.push({code:"account_not_found",message:"アカウントが存在しません"}),i;const o=new Date(Date.now()+9*3600*1e3).toISOString().slice(0,10);let c=r.daily_post_count||0;if(r.last_daily_reset_date!==o&&(c=0),c>=(r.daily_post_limit||5)&&i.errors.push({code:"daily_limit_reached",message:`日次投稿上限 (${r.daily_post_limit}) に達しています`}),r.last_posted_at){const l=Date.parse(r.last_posted_at.replace(" ","T")+"+09:00");if(!Number.isNaN(l)){const p=(Date.now()-l)/6e4;p<15&&i.errors.push({code:"too_frequent",message:`前回投稿から ${Math.floor(p)} 分しか経過していません（最低 15 分）`,overridable:!0})}}const{results:d}=await e.DB.prepare(`SELECT id, body FROM post_queue
       ...
       LIMIT 5`).bind(t).all();for(const l of d||[]){const p=Ws(s,l.body||"");if(p>=.7){i.errors.push({code:"too_similar",message:`過去投稿 (ID: ${l.id}) と類似度 ${p.toFixed(2)} で重複`});break}}if(a){const l=await e.DB.prepare(`SELECT COUNT(*) AS n FROM post_queue
        WHERE account_id = ? AND link_url = ? AND status IN ('posted','approved','publishing')
          AND DATE(COALESCE(posted_at, scheduled_at, created_at)) >= DATE('now','+9 hours','-7 days')`).bind(t,a).first();((l==null?void 0:l.n)??0)>=3&&i.errors.push({code:"link_spam",message:`同一リンクを過去7日で${l==null?void 0:l.n}回使用しています`})}if(n){const l=es(n);if(l.size>0){const{results:p}=await e.DB.prepare(`SELECT hashtags FROM post_queue
           WHERE account_id = ? AND status IN ('posted','approved','publishing') AND hashtags IS NOT NULL AND hashtags != ''
           ORDER BY COALESCE(posted_at, scheduled_at, created_at) DESC LIMIT 3`).bind(t).all();(p||[]).length>=3&&(p||[]).every(b=>{const k=[...es(b.hashtags||"")].filter(A=>l.has(A)).length;return(l.size===0?0:k/l.size)>=.8})&&i.errors.push({code:"hashtag_spam",message:"同一ハッシュタグセットが 3 回連続で 80%以上一致しています"})}}return r.health_status==="risk"&&i.errors.push({code:"health_risk",message:"アカウント健全性スコアが危険域です。投稿を控えてください。"}),i.ok=i.errors.length===0,i}function es(e){return new Set((e||"").split(/[\s,]+/).map(t=>t.trim().replace(/^#/,"").toLowerCase()).filter(Boolean))}async function _t(e,t,s,a,n){const i=await e.DB.prepare("SELECT account_health_score FROM x_accounts WHERE id = ?").bind(t).first();if(!i)return{score_after:100,status_after:"healthy"};let r=Math.max(0,Math.min(100,(i.account_health_score??100)+a));const o=r>=80?"healthy":r>=60?"caution":"risk";return await e.DB.prepare("UPDATE x_accounts SET account_health_score = ?, health_status = ?, updated_at = datetime('now','+9 hours') WHERE id = ?").bind(r,o,t).run(),await e.DB.prepare(`INSERT INTO account_health_events (account_id, event_type, delta, score_after, status_after, metadata)
     VALUES (?, ?, ?, ?, ?, ?)`).bind(t,s,a,r,o,n?JSON.stringify(n):null).run(),{score_after:r,status_after:o}}function ts(e){if(!e)return Date.now();const t=e.replace(" ","T")+"+09:00",s=Date.parse(t);return Number.isNaN(s)?Date.now():s}function ss(e){return new Date(e+324e5).toISOString().replace("T"," ").slice(0,19)}async function Nn(e,t,s){const a=s.jitter_enabled!==!1,n=s.jitter_minutes??5,i=s.collision_avoidance_enabled!==!1,r=s.min_spacing_seconds??90;let o=ts(t),c=0,d=0;if(a&&n>0){const m=Math.floor((Math.random()*2-1)*n*60);c=m,o+=m*1e3}if(i&&s.account_id){const m=ss(o),b=[s.account_id,m,m];let v=`
...
`+l.trim());const nt=await De(B),Q=await e.env.DB.prepare(`INSERT INTO post_queue
...
`+r.hashtags);const m=[];if(r.media_json)try{const v=JSON.parse(r.media_json);for(const k of(v||[]).slice(0,4)){const y=await e.env.DB.prepare("SELECT x_media_id FROM media_assets WHERE id=?").bind(k).first();y!=null&&y.x_media_id&&m.push(y.x_media_id)}}catch{}const b=m.length>0?await Ms(l,p,m,null):await $s(l,p);await e.env.DB.prepare("UPDATE post_queue SET status='posted', external_post_id=?, posted_at=?, updated_at=? WHERE id=?").bind(b.id||"",g(),g(),r.id).run(),await e.env.DB.prepare(`UPDATE x_accounts SET
         ...
         VALUES (?, ?, ?, 'x', ?, ?, ?, ?, 'failed', ?, ?)`).bind(r.id,r.account_id,r.user_id,r.source_type,r.post_mode,r.body||"",r.content_hash||"",d,g()).run(),r.account_id&&(c instanceof $t?await _t(e.env,r.account_id,"rate_limit",-15):await _t(e.env,r.account_id,"error",-5,{message:d})),r.account_id&&await e.env.DB.prepare(`INSERT INTO kpi_metrics (account_id, user_id, metric_date, posts_failed)
           VALUES (?, ?, date('now','+9 hours'), 1)
           ON CONFLICT(account_id, metric_date) DO UPDATE SET
             posts_failed = posts_failed + 1,
             updated_at = datetime('now','+9 hours')`).bind(r.account_id,r.user_id).run(),i++}}}return e.json({ok:!0,processed:a,success:n,failed:i,now:t})});const ve=new D;ve.get("/api/admin/autopilot/jobs",_,async e=>{const t=e.get("user"),{results:s}=await e.env.DB.prepare(`SELECT aj.*, xa.account_name
       FROM autopilot_jobs aj LEFT JOIN x_accounts xa ON aj.account_id = xa.id
      WHERE aj.user_id = ?
      ORDER BY COALESCE(aj.generate_at, aj.publish_at, aj.created_at) DESC LIMIT 100`).bind(t.id).all(),{results:a}=await e.env.DB.prepare("SELECT id, account_name FROM x_accounts WHERE user_id = ? AND is_active = 1").bind(t.id).all();return e.json({jobs:s||[],accounts:a||[]})});ve.get("/api/admin/autopilot/jobs/:id",_,async e=>{const t=e.get("user"),s=await e.env.DB.prepare("SELECT * FROM autopilot_jobs WHERE id=? AND user_id=?").bind(parseInt(e.req.param("id"),10),t.id).first();return s?e.json(s):e.json({error:"not found"})});ve.post("/api/admin/autopilot/jobs",_,async e=>{const t=e.get("user"),s=await e.req.json(),a=g(),n=(s.publish_at||s.generate_at||a).slice(0,10),i=await e.env.DB.prepare(`SELECT COUNT(*) AS cnt FROM autopilot_jobs
     ...
     VALUES (?, ?, ?, datetime('now','+9 hours'))
     ON CONFLICT(key) DO UPDATE SET value=excluded.value, updated_at=datetime('now','+9 hours')`).bind(t,s,a).run()}async function kt(e,t){const s=await e.env.DB.prepare("SELECT value FROM system_settings WHERE key = ?").bind(t).first();return(s==null?void 0:s.value)||null}async function dt(e,t){try{return await Dt(e,t)}catch{return""}}const N=new D;function rs(e){if(e==null)return"";const t=String(e);return t.includes(",")||t.includes('"')||t.includes(`
