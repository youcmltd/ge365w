var ls=Object.defineProperty;var Vt=e=>{throw TypeError(e)};var ds=(e,t,a)=>t in e?ls(e,t,{enumerable:!0,configurable:!0,writable:!0,value:a}):e[t]=a;var g=(e,t,a)=>ds(e,typeof t!="symbol"?t+"":t,a),Ot=(e,t,a)=>t.has(e)||Vt("Cannot "+a);var p=(e,t,a)=>(Ot(e,t,"read from private field"),a?a.call(e):t.get(e)),y=(e,t,a)=>t.has(e)?Vt("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,a),b=(e,t,a,s)=>(Ot(e,t,"write to private field"),s?s.call(e,a):t.set(e,a),a),k=(e,t,a)=>(Ot(e,t,"access private method"),a);var Xt=(e,t,a,s)=>({set _(n){b(e,t,n,a)},get _(){return p(e,t,s)}});var Gt=(e,t,a)=>(s,n)=>{let i=-1;return r(0);async function r(l){if(l<=i)throw new Error("next() called multiple times");i=l;let o,d=!1,c;if(e[l]?(c=e[l][0][0],s.req.routeIndex=l):c=l===e.length&&n||void 0,c)try{o=await c(s,()=>r(l+1))}catch(u){if(u instanceof Error&&t)s.error=u,o=await t(u,s),d=!0;else throw u}else s.finalized===!1&&a&&(o=await a(s));return o&&(s.finalized===!1||d)&&(s.res=o),s}},cs=Symbol(),us=async(e,t=Object.create(null))=>{const{all:a=!1,dot:s=!1}=t,i=(e instanceof ka?e.raw.headers:e.headers).get("Content-Type");return i!=null&&i.startsWith("multipart/form-data")||i!=null&&i.startsWith("application/x-www-form-urlencoded")?ps(e,{all:a,dot:s}):{}};async function ps(e,t){const a=await e.formData();return a?ms(a,t):{}}function ms(e,t){const a=Object.create(null);return e.forEach((s,n)=>{t.all||n.endsWith("[]")?fs(a,n,s):a[n]=s}),t.dot&&Object.entries(a).forEach(([s,n])=>{s.includes(".")&&(hs(a,s,n),delete a[s])}),a}var fs=(e,t,a)=>{e[t]!==void 0?Array.isArray(e[t])?e[t].push(a):e[t]=[e[t],a]:t.endsWith("[]")?e[t]=[a]:e[t]=a},hs=(e,t,a)=>{if(/(?:^|\.)__proto__\./.test(t))return;let s=e;const n=t.split(".");n.forEach((i,r)=>{r===n.length-1?s[i]=a:((!s[i]||typeof s[i]!="object"||Array.isArray(s[i])||s[i]instanceof File)&&(s[i]=Object.create(null)),s=s[i])})},ba=e=>{const t=e.split("/");return t[0]===""&&t.shift(),t},gs=e=>{const{groups:t,path:a}=_s(e),s=ba(a);return bs(s,t)},_s=e=>{const t=[];return e=e.replace(/\{[^}]+\}/g,(a,s)=>{const n=`@${s}`;return t.push([n,a]),n}),{groups:t,path:e}},bs=(e,t)=>{for(let a=t.length-1;a>=0;a--){const[s]=t[a];for(let n=e.length-1;n>=0;n--)if(e[n].includes(s)){e[n]=e[n].replace(s,t[a][1]);break}}return e},mt={},vs=(e,t)=>{if(e==="*")return"*";const a=e.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);if(a){const s=`${e}#${t}`;return mt[s]||(a[2]?mt[s]=t&&t[0]!==":"&&t[0]!=="*"?[s,a[1],new RegExp(`^${a[2]}(?=/${t})`)]:[e,a[1],new RegExp(`^${a[2]}$`)]:mt[s]=[e,a[1],!0]),mt[s]}return null},$t=(e,t)=>{try{return t(e)}catch{return e.replace(/(?:%[0-9A-Fa-f]{2})+/g,a=>{try{return t(a)}catch{return a}})}},va=e=>$t(e,decodeURI),ya=e=>{const t=e.url,a=t.indexOf("/",t.indexOf(":")+4);let s=a;for(;s<t.length;s++){const n=t.charCodeAt(s);if(n===37){const i=t.indexOf("?",s),r=t.indexOf("#",s),l=i===-1?r===-1?void 0:r:r===-1?i:Math.min(i,r),o=t.slice(a,l);return va(o.includes("%25")?o.replace(/%25/g,"%2525"):o)}else if(n===63||n===35)break}return t.slice(a,s)},ys=e=>{const t=ya(e);return t.length>1&&t.at(-1)==="/"?t.slice(0,-1):t},Re=(e,t,...a)=>(a.length&&(t=Re(t,...a)),`${(e==null?void 0:e[0])==="/"?"":"/"}${e}${t==="/"?"":`${(e==null?void 0:e.at(-1))==="/"?"":"/"}${(t==null?void 0:t[0])==="/"?t.slice(1):t}`}`),xa=e=>{if(e.charCodeAt(e.length-1)!==63||!e.includes(":"))return null;const t=e.split("/"),a=[];let s="";return t.forEach(n=>{if(n!==""&&!/\:/.test(n))s+="/"+n;else if(/\:/.test(n))if(/\?/.test(n)){a.length===0&&s===""?a.push("/"):a.push(s);const i=n.replace("?","");s+="/"+i,a.push(s)}else s+="/"+n}),a.filter((n,i,r)=>r.indexOf(n)===i)},Rt=e=>/[%+]/.test(e)?(e.indexOf("+")!==-1&&(e=e.replace(/\+/g," ")),e.indexOf("%")!==-1?$t(e,wa):e):e,Ea=(e,t,a)=>{let s;if(!a&&t&&!/[%+]/.test(t)){let r=e.indexOf("?",8);if(r===-1)return;for(e.startsWith(t,r+1)||(r=e.indexOf(`&${t}`,r+1));r!==-1;){const l=e.charCodeAt(r+t.length+1);if(l===61){const o=r+t.length+2,d=e.indexOf("&",o);return Rt(e.slice(o,d===-1?void 0:d))}else if(l==38||isNaN(l))return"";r=e.indexOf(`&${t}`,r+1)}if(s=/[%+]/.test(e),!s)return}const n={};s??(s=/[%+]/.test(e));let i=e.indexOf("?",8);for(;i!==-1;){const r=e.indexOf("&",i+1);let l=e.indexOf("=",i);l>r&&r!==-1&&(l=-1);let o=e.slice(i+1,l===-1?r===-1?void 0:r:l);if(s&&(o=Rt(o)),i=r,o==="")continue;let d;l===-1?d="":(d=e.slice(l+1,r===-1?void 0:r),s&&(d=Rt(d))),a?(n[o]&&Array.isArray(n[o])||(n[o]=[]),n[o].push(d)):n[o]??(n[o]=d)}return t?n[t]:n},xs=Ea,Es=(e,t)=>Ea(e,t,!0),wa=decodeURIComponent,Zt=e=>$t(e,wa),Le,z,oe,Sa,Ta,Ct,le,pa,ka=(pa=class{constructor(e,t="/",a=[[]]){y(this,oe);g(this,"raw");y(this,Le);y(this,z);g(this,"routeIndex",0);g(this,"path");g(this,"bodyCache",{});y(this,le,e=>{const{bodyCache:t,raw:a}=this,s=t[e];if(s)return s;const n=Object.keys(t)[0];return n?t[n].then(i=>(n==="json"&&(i=JSON.stringify(i)),new Response(i)[e]())):t[e]=a[e]()});this.raw=e,this.path=t,b(this,z,a),b(this,Le,{})}param(e){return e?k(this,oe,Sa).call(this,e):k(this,oe,Ta).call(this)}query(e){return xs(this.url,e)}queries(e){return Es(this.url,e)}header(e){if(e)return this.raw.headers.get(e)??void 0;const t={};return this.raw.headers.forEach((a,s)=>{t[s]=a}),t}async parseBody(e){return us(this,e)}json(){return p(this,le).call(this,"text").then(e=>JSON.parse(e))}text(){return p(this,le).call(this,"text")}arrayBuffer(){return p(this,le).call(this,"arrayBuffer")}blob(){return p(this,le).call(this,"blob")}formData(){return p(this,le).call(this,"formData")}addValidatedData(e,t){p(this,Le)[e]=t}valid(e){return p(this,Le)[e]}get url(){return this.raw.url}get method(){return this.raw.method}get[cs](){return p(this,z)}get matchedRoutes(){return p(this,z)[0].map(([[,e]])=>e)}get routePath(){return p(this,z)[0].map(([[,e]])=>e)[this.routeIndex].path}},Le=new WeakMap,z=new WeakMap,oe=new WeakSet,Sa=function(e){const t=p(this,z)[0][this.routeIndex][1][e],a=k(this,oe,Ct).call(this,t);return a&&/\%/.test(a)?Zt(a):a},Ta=function(){const e={},t=Object.keys(p(this,z)[0][this.routeIndex][1]);for(const a of t){const s=k(this,oe,Ct).call(this,p(this,z)[0][this.routeIndex][1][a]);s!==void 0&&(e[a]=/\%/.test(s)?Zt(s):s)}return e},Ct=function(e){return p(this,z)[1]?p(this,z)[1][e]:e},le=new WeakMap,pa),ws={Stringify:1},Aa=async(e,t,a,s,n)=>{typeof e=="object"&&!(e instanceof String)&&(e instanceof Promise||(e=e.toString()),e instanceof Promise&&(e=await e));const i=e.callbacks;return i!=null&&i.length?(n?n[0]+=e:n=[e],Promise.all(i.map(l=>l({phase:t,buffer:n,context:s}))).then(l=>Promise.all(l.filter(Boolean).map(o=>Aa(o,t,!1,s,n))).then(()=>n[0]))):Promise.resolve(e)},ks="text/plain; charset=UTF-8",Bt=(e,t)=>({"Content-Type":e,...t}),Ke=(e,t)=>new Response(e,t),tt,at,te,Me,ae,$,st,$e,Fe,ve,nt,it,de,Be,ma,Ss=(ma=class{constructor(e,t){y(this,de);y(this,tt);y(this,at);g(this,"env",{});y(this,te);g(this,"finalized",!1);g(this,"error");y(this,Me);y(this,ae);y(this,$);y(this,st);y(this,$e);y(this,Fe);y(this,ve);y(this,nt);y(this,it);g(this,"render",(...e)=>(p(this,$e)??b(this,$e,t=>this.html(t)),p(this,$e).call(this,...e)));g(this,"setLayout",e=>b(this,st,e));g(this,"getLayout",()=>p(this,st));g(this,"setRenderer",e=>{b(this,$e,e)});g(this,"header",(e,t,a)=>{this.finalized&&b(this,$,Ke(p(this,$).body,p(this,$)));const s=p(this,$)?p(this,$).headers:p(this,ve)??b(this,ve,new Headers);t===void 0?s.delete(e):a!=null&&a.append?s.append(e,t):s.set(e,t)});g(this,"status",e=>{b(this,Me,e)});g(this,"set",(e,t)=>{p(this,te)??b(this,te,new Map),p(this,te).set(e,t)});g(this,"get",e=>p(this,te)?p(this,te).get(e):void 0);g(this,"newResponse",(...e)=>k(this,de,Be).call(this,...e));g(this,"body",(e,t,a)=>k(this,de,Be).call(this,e,t,a));g(this,"text",(e,t,a)=>!p(this,ve)&&!p(this,Me)&&!t&&!a&&!this.finalized?new Response(e):k(this,de,Be).call(this,e,t,Bt(ks,a)));g(this,"json",(e,t,a)=>k(this,de,Be).call(this,JSON.stringify(e),t,Bt("application/json",a)));g(this,"html",(e,t,a)=>{const s=n=>k(this,de,Be).call(this,n,t,Bt("text/html; charset=UTF-8",a));return typeof e=="object"?Aa(e,ws.Stringify,!1,{}).then(s):s(e)});g(this,"redirect",(e,t)=>{const a=String(e);return this.header("Location",/[^\x00-\xFF]/.test(a)?encodeURI(a):a),this.newResponse(null,t??302)});g(this,"notFound",()=>(p(this,Fe)??b(this,Fe,()=>Ke()),p(this,Fe).call(this,this)));b(this,tt,e),t&&(b(this,ae,t.executionCtx),this.env=t.env,b(this,Fe,t.notFoundHandler),b(this,it,t.path),b(this,nt,t.matchResult))}get req(){return p(this,at)??b(this,at,new ka(p(this,tt),p(this,it),p(this,nt))),p(this,at)}get event(){if(p(this,ae)&&"respondWith"in p(this,ae))return p(this,ae);throw Error("This context has no FetchEvent")}get executionCtx(){if(p(this,ae))return p(this,ae);throw Error("This context has no ExecutionContext")}get res(){return p(this,$)||b(this,$,Ke(null,{headers:p(this,ve)??b(this,ve,new Headers)}))}set res(e){if(p(this,$)&&e){e=Ke(e.body,e);for(const[t,a]of p(this,$).headers.entries())if(t!=="content-type")if(t==="set-cookie"){const s=p(this,$).headers.getSetCookie();e.headers.delete("set-cookie");for(const n of s)e.headers.append("set-cookie",n)}else e.headers.set(t,a)}b(this,$,e),this.finalized=!0}get var(){return p(this,te)?Object.fromEntries(p(this,te)):{}}},tt=new WeakMap,at=new WeakMap,te=new WeakMap,Me=new WeakMap,ae=new WeakMap,$=new WeakMap,st=new WeakMap,$e=new WeakMap,Fe=new WeakMap,ve=new WeakMap,nt=new WeakMap,it=new WeakMap,de=new WeakSet,Be=function(e,t,a){const s=p(this,$)?new Headers(p(this,$).headers):p(this,ve)??new Headers;if(typeof t=="object"&&"headers"in t){const i=t.headers instanceof Headers?t.headers:new Headers(t.headers);for(const[r,l]of i)r.toLowerCase()==="set-cookie"?s.append(r,l):s.set(r,l)}if(a)for(const[i,r]of Object.entries(a))if(typeof r=="string")s.set(i,r);else{s.delete(i);for(const l of r)s.append(i,l)}const n=typeof t=="number"?t:(t==null?void 0:t.status)??p(this,Me);return Ke(e,{status:n,headers:s})},ma),D="ALL",Ts="all",As=["get","post","put","delete","options","patch"],Ia="Can not add a route since the matcher is already built.",Da=class extends Error{},Is="__COMPOSED_HANDLER",Ds=e=>e.text("404 Not Found",404),Qt=(e,t)=>{if("getResponse"in e){const a=e.getResponse();return t.newResponse(a.body,a)}return console.error(e),t.text("Internal Server Error",500)},K,j,ja,J,_e,ht,gt,Pe,js=(Pe=class{constructor(t={}){y(this,j);g(this,"get");g(this,"post");g(this,"put");g(this,"delete");g(this,"options");g(this,"patch");g(this,"all");g(this,"on");g(this,"use");g(this,"router");g(this,"getPath");g(this,"_basePath","/");y(this,K,"/");g(this,"routes",[]);y(this,J,Ds);g(this,"errorHandler",Qt);g(this,"onError",t=>(this.errorHandler=t,this));g(this,"notFound",t=>(b(this,J,t),this));g(this,"fetch",(t,...a)=>k(this,j,gt).call(this,t,a[1],a[0],t.method));g(this,"request",(t,a,s,n)=>t instanceof Request?this.fetch(a?new Request(t,a):t,s,n):(t=t.toString(),this.fetch(new Request(/^https?:\/\//.test(t)?t:`http://localhost${Re("/",t)}`,a),s,n)));g(this,"fire",()=>{addEventListener("fetch",t=>{t.respondWith(k(this,j,gt).call(this,t.request,t,void 0,t.request.method))})});[...As,Ts].forEach(i=>{this[i]=(r,...l)=>(typeof r=="string"?b(this,K,r):k(this,j,_e).call(this,i,p(this,K),r),l.forEach(o=>{k(this,j,_e).call(this,i,p(this,K),o)}),this)}),this.on=(i,r,...l)=>{for(const o of[r].flat()){b(this,K,o);for(const d of[i].flat())l.map(c=>{k(this,j,_e).call(this,d.toUpperCase(),p(this,K),c)})}return this},this.use=(i,...r)=>(typeof i=="string"?b(this,K,i):(b(this,K,"*"),r.unshift(i)),r.forEach(l=>{k(this,j,_e).call(this,D,p(this,K),l)}),this);const{strict:s,...n}=t;Object.assign(this,n),this.getPath=s??!0?t.getPath??ya:ys}route(t,a){const s=this.basePath(t);return a.routes.map(n=>{var r;let i;a.errorHandler===Qt?i=n.handler:(i=async(l,o)=>(await Gt([],a.errorHandler)(l,()=>n.handler(l,o))).res,i[Is]=n.handler),k(r=s,j,_e).call(r,n.method,n.path,i)}),this}basePath(t){const a=k(this,j,ja).call(this);return a._basePath=Re(this._basePath,t),a}mount(t,a,s){let n,i;s&&(typeof s=="function"?i=s:(i=s.optionHandler,s.replaceRequest===!1?n=o=>o:n=s.replaceRequest));const r=i?o=>{const d=i(o);return Array.isArray(d)?d:[d]}:o=>{let d;try{d=o.executionCtx}catch{}return[o.env,d]};n||(n=(()=>{const o=Re(this._basePath,t),d=o==="/"?0:o.length;return c=>{const u=new URL(c.url);return u.pathname=u.pathname.slice(d)||"/",new Request(u,c)}})());const l=async(o,d)=>{const c=await a(n(o.req.raw),...r(o));if(c)return c;await d()};return k(this,j,_e).call(this,D,Re(t,"*"),l),this}},K=new WeakMap,j=new WeakSet,ja=function(){const t=new Pe({router:this.router,getPath:this.getPath});return t.errorHandler=this.errorHandler,b(t,J,p(this,J)),t.routes=this.routes,t},J=new WeakMap,_e=function(t,a,s){t=t.toUpperCase(),a=Re(this._basePath,a);const n={basePath:this._basePath,path:a,method:t,handler:s};this.router.add(t,a,[s,n]),this.routes.push(n)},ht=function(t,a){if(t instanceof Error)return this.errorHandler(t,a);throw t},gt=function(t,a,s,n){if(n==="HEAD")return(async()=>new Response(null,await k(this,j,gt).call(this,t,a,s,"GET")))();const i=this.getPath(t,{env:s}),r=this.router.match(n,i),l=new Ss(t,{path:i,matchResult:r,env:s,executionCtx:a,notFoundHandler:p(this,J)});if(r[0].length===1){let d;try{d=r[0][0][0][0](l,async()=>{l.res=await p(this,J).call(this,l)})}catch(c){return k(this,j,ht).call(this,c,l)}return d instanceof Promise?d.then(c=>c||(l.finalized?l.res:p(this,J).call(this,l))).catch(c=>k(this,j,ht).call(this,c,l)):d??p(this,J).call(this,l)}const o=Gt(r[0],this.errorHandler,p(this,J));return(async()=>{try{const d=await o(l);if(!d.finalized)throw new Error("Context is not finalized. Did you forget to return a Response object or `await next()`?");return d.res}catch(d){return k(this,j,ht).call(this,d,l)}})()},Pe),Oa=[];function Os(e,t){const a=this.buildAllMatchers(),s=((n,i)=>{const r=a[n]||a[D],l=r[2][i];if(l)return l;const o=i.match(r[0]);if(!o)return[[],Oa];const d=o.indexOf("",1);return[r[1][d],o]});return this.match=s,s(e,t)}var vt="[^/]+",Xe=".*",Ge="(?:|/.*)",Ce=Symbol(),Rs=new Set(".\\+*[^]$()");function Bs(e,t){return e.length===1?t.length===1?e<t?-1:1:-1:t.length===1||e===Xe||e===Ge?1:t===Xe||t===Ge?-1:e===vt?1:t===vt?-1:e.length===t.length?e<t?-1:1:t.length-e.length}var ye,xe,V,ke,Cs=(ke=class{constructor(){y(this,ye);y(this,xe);y(this,V,Object.create(null))}insert(t,a,s,n,i){if(t.length===0){if(p(this,ye)!==void 0)throw Ce;if(i)return;b(this,ye,a);return}const[r,...l]=t,o=r==="*"?l.length===0?["","",Xe]:["","",vt]:r==="/*"?["","",Ge]:r.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);let d;if(o){const c=o[1];let u=o[2]||vt;if(c&&o[2]&&(u===".*"||(u=u.replace(/^\((?!\?:)(?=[^)]+\)$)/,"(?:"),/\((?!\?:)/.test(u))))throw Ce;if(d=p(this,V)[u],!d){if(Object.keys(p(this,V)).some(m=>m!==Xe&&m!==Ge))throw Ce;if(i)return;d=p(this,V)[u]=new ke,c!==""&&b(d,xe,n.varIndex++)}!i&&c!==""&&s.push([c,p(d,xe)])}else if(d=p(this,V)[r],!d){if(Object.keys(p(this,V)).some(c=>c.length>1&&c!==Xe&&c!==Ge))throw Ce;if(i)return;d=p(this,V)[r]=new ke}d.insert(l,a,s,n,i)}buildRegExpStr(){const a=Object.keys(p(this,V)).sort(Bs).map(s=>{const n=p(this,V)[s];return(typeof p(n,xe)=="number"?`(${s})@${p(n,xe)}`:Rs.has(s)?`\\${s}`:s)+n.buildRegExpStr()});return typeof p(this,ye)=="number"&&a.unshift(`#${p(this,ye)}`),a.length===0?"":a.length===1?a[0]:"(?:"+a.join("|")+")"}},ye=new WeakMap,xe=new WeakMap,V=new WeakMap,ke),xt,rt,fa,Ns=(fa=class{constructor(){y(this,xt,{varIndex:0});y(this,rt,new Cs)}insert(e,t,a){const s=[],n=[];for(let r=0;;){let l=!1;if(e=e.replace(/\{[^}]+\}/g,o=>{const d=`@\\${r}`;return n[r]=[d,o],r++,l=!0,d}),!l)break}const i=e.match(/(?::[^\/]+)|(?:\/\*$)|./g)||[];for(let r=n.length-1;r>=0;r--){const[l]=n[r];for(let o=i.length-1;o>=0;o--)if(i[o].indexOf(l)!==-1){i[o]=i[o].replace(l,n[r][1]);break}}return p(this,rt).insert(i,t,s,p(this,xt),a),s}buildRegExp(){let e=p(this,rt).buildRegExpStr();if(e==="")return[/^$/,[],[]];let t=0;const a=[],s=[];return e=e.replace(/#(\d+)|@(\d+)|\.\*\$/g,(n,i,r)=>i!==void 0?(a[++t]=Number(i),"$()"):(r!==void 0&&(s[Number(r)]=++t),"")),[new RegExp(`^${e}`),a,s]}},xt=new WeakMap,rt=new WeakMap,fa),Ls=[/^$/,[],Object.create(null)],_t=Object.create(null);function Ra(e){return _t[e]??(_t[e]=new RegExp(e==="*"?"":`^${e.replace(/\/\*$|([.\\+*[^\]$()])/g,(t,a)=>a?`\\${a}`:"(?:|/.*)")}$`))}function Ms(){_t=Object.create(null)}function $s(e){var d;const t=new Ns,a=[];if(e.length===0)return Ls;const s=e.map(c=>[!/\*|\/:/.test(c[0]),...c]).sort(([c,u],[m,h])=>c?1:m?-1:u.length-h.length),n=Object.create(null);for(let c=0,u=-1,m=s.length;c<m;c++){const[h,_,E]=s[c];h?n[_]=[E.map(([A])=>[A,Object.create(null)]),Oa]:u++;let w;try{w=t.insert(_,u,h)}catch(A){throw A===Ce?new Da(_):A}h||(a[u]=E.map(([A,x])=>{const R=Object.create(null);for(x-=1;x>=0;x--){const[B,C]=w[x];R[B]=C}return[A,R]}))}const[i,r,l]=t.buildRegExp();for(let c=0,u=a.length;c<u;c++)for(let m=0,h=a[c].length;m<h;m++){const _=(d=a[c][m])==null?void 0:d[1];if(!_)continue;const E=Object.keys(_);for(let w=0,A=E.length;w<A;w++)_[E[w]]=l[_[E[w]]]}const o=[];for(const c in r)o[c]=a[r[c]];return[i,o,n]}function Oe(e,t){if(e){for(const a of Object.keys(e).sort((s,n)=>n.length-s.length))if(Ra(a).test(t))return[...e[a]]}}var ce,ue,Et,Ba,ha,Fs=(ha=class{constructor(){y(this,Et);g(this,"name","RegExpRouter");y(this,ce);y(this,ue);g(this,"match",Os);b(this,ce,{[D]:Object.create(null)}),b(this,ue,{[D]:Object.create(null)})}add(e,t,a){var l;const s=p(this,ce),n=p(this,ue);if(!s||!n)throw new Error(Ia);s[e]||[s,n].forEach(o=>{o[e]=Object.create(null),Object.keys(o[D]).forEach(d=>{o[e][d]=[...o[D][d]]})}),t==="/*"&&(t="*");const i=(t.match(/\/:/g)||[]).length;if(/\*$/.test(t)){const o=Ra(t);e===D?Object.keys(s).forEach(d=>{var c;(c=s[d])[t]||(c[t]=Oe(s[d],t)||Oe(s[D],t)||[])}):(l=s[e])[t]||(l[t]=Oe(s[e],t)||Oe(s[D],t)||[]),Object.keys(s).forEach(d=>{(e===D||e===d)&&Object.keys(s[d]).forEach(c=>{o.test(c)&&s[d][c].push([a,i])})}),Object.keys(n).forEach(d=>{(e===D||e===d)&&Object.keys(n[d]).forEach(c=>o.test(c)&&n[d][c].push([a,i]))});return}const r=xa(t)||[t];for(let o=0,d=r.length;o<d;o++){const c=r[o];Object.keys(n).forEach(u=>{var m;(e===D||e===u)&&((m=n[u])[c]||(m[c]=[...Oe(s[u],c)||Oe(s[D],c)||[]]),n[u][c].push([a,i-d+o+1]))})}}buildAllMatchers(){const e=Object.create(null);return Object.keys(p(this,ue)).concat(Object.keys(p(this,ce))).forEach(t=>{e[t]||(e[t]=k(this,Et,Ba).call(this,t))}),b(this,ce,b(this,ue,void 0)),Ms(),e}},ce=new WeakMap,ue=new WeakMap,Et=new WeakSet,Ba=function(e){const t=[];let a=e===D;return[p(this,ce),p(this,ue)].forEach(s=>{const n=s[e]?Object.keys(s[e]).map(i=>[i,s[e][i]]):[];n.length!==0?(a||(a=!0),t.push(...n)):e!==D&&t.push(...Object.keys(s[D]).map(i=>[i,s[D][i]]))}),a?$s(t):null},ha),pe,se,ga,Ps=(ga=class{constructor(e){g(this,"name","SmartRouter");y(this,pe,[]);y(this,se,[]);b(this,pe,e.routers)}add(e,t,a){if(!p(this,se))throw new Error(Ia);p(this,se).push([e,t,a])}match(e,t){if(!p(this,se))throw new Error("Fatal error");const a=p(this,pe),s=p(this,se),n=a.length;let i=0,r;for(;i<n;i++){const l=a[i];try{for(let o=0,d=s.length;o<d;o++)l.add(...s[o]);r=l.match(e,t)}catch(o){if(o instanceof Da)continue;throw o}this.match=l.match.bind(l),b(this,pe,[l]),b(this,se,void 0);break}if(i===n)throw new Error("Fatal error");return this.name=`SmartRouter + ${this.activeRouter.name}`,r}get activeRouter(){if(p(this,se)||p(this,pe).length!==1)throw new Error("No active router has been determined yet.");return p(this,pe)[0]}},pe=new WeakMap,se=new WeakMap,ga),Je=Object.create(null),qs=e=>{for(const t in e)return!0;return!1},me,L,Ee,qe,N,ne,be,He,Hs=(He=class{constructor(t,a,s){y(this,ne);y(this,me);y(this,L);y(this,Ee);y(this,qe,0);y(this,N,Je);if(b(this,L,s||Object.create(null)),b(this,me,[]),t&&a){const n=Object.create(null);n[t]={handler:a,possibleKeys:[],score:0},b(this,me,[n])}b(this,Ee,[])}insert(t,a,s){b(this,qe,++Xt(this,qe)._);let n=this;const i=gs(a),r=[];for(let l=0,o=i.length;l<o;l++){const d=i[l],c=i[l+1],u=vs(d,c),m=Array.isArray(u)?u[0]:d;if(m in p(n,L)){n=p(n,L)[m],u&&r.push(u[1]);continue}p(n,L)[m]=new He,u&&(p(n,Ee).push(u),r.push(u[1])),n=p(n,L)[m]}return p(n,me).push({[t]:{handler:s,possibleKeys:r.filter((l,o,d)=>d.indexOf(l)===o),score:p(this,qe)}}),n}search(t,a){var c;const s=[];b(this,N,Je);let i=[this];const r=ba(a),l=[],o=r.length;let d=null;for(let u=0;u<o;u++){const m=r[u],h=u===o-1,_=[];for(let w=0,A=i.length;w<A;w++){const x=i[w],R=p(x,L)[m];R&&(b(R,N,p(x,N)),h?(p(R,L)["*"]&&k(this,ne,be).call(this,s,p(R,L)["*"],t,p(x,N)),k(this,ne,be).call(this,s,R,t,p(x,N))):_.push(R));for(let B=0,C=p(x,Ee).length;B<C;B++){const pt=p(x,Ee)[B],X=p(x,N)===Je?{}:{...p(x,N)};if(pt==="*"){const De=p(x,L)["*"];De&&(k(this,ne,be).call(this,s,De,t,p(x,N)),b(De,N,X),_.push(De));continue}const[os,Jt,ze]=pt;if(!m&&!(ze instanceof RegExp))continue;const Q=p(x,L)[os];if(ze instanceof RegExp){if(d===null){d=new Array(o);let je=a[0]==="/"?1:0;for(let Ye=0;Ye<o;Ye++)d[Ye]=je,je+=r[Ye].length+1}const De=a.substring(d[u]),jt=ze.exec(De);if(jt){if(X[Jt]=jt[0],k(this,ne,be).call(this,s,Q,t,p(x,N),X),qs(p(Q,L))){b(Q,N,X);const je=((c=jt[0].match(/\//))==null?void 0:c.length)??0;(l[je]||(l[je]=[])).push(Q)}continue}}(ze===!0||ze.test(m))&&(X[Jt]=m,h?(k(this,ne,be).call(this,s,Q,t,X,p(x,N)),p(Q,L)["*"]&&k(this,ne,be).call(this,s,p(Q,L)["*"],t,X,p(x,N))):(b(Q,N,X),_.push(Q)))}}const E=l.shift();i=E?_.concat(E):_}return s.length>1&&s.sort((u,m)=>u.score-m.score),[s.map(({handler:u,params:m})=>[u,m])]}},me=new WeakMap,L=new WeakMap,Ee=new WeakMap,qe=new WeakMap,N=new WeakMap,ne=new WeakSet,be=function(t,a,s,n,i){for(let r=0,l=p(a,me).length;r<l;r++){const o=p(a,me)[r],d=o[s]||o[D],c={};if(d!==void 0&&(d.params=Object.create(null),t.push(d),n!==Je||i&&i!==Je))for(let u=0,m=d.possibleKeys.length;u<m;u++){const h=d.possibleKeys[u],_=c[d.score];d.params[h]=i!=null&&i[h]&&!_?i[h]:n[h]??(i==null?void 0:i[h]),c[d.score]=!0}}},He),we,_a,Us=(_a=class{constructor(){g(this,"name","TrieRouter");y(this,we);b(this,we,new Hs)}add(e,t,a){const s=xa(t);if(s){for(let n=0,i=s.length;n<i;n++)p(this,we).insert(e,s[n],a);return}p(this,we).insert(e,t,a)}match(e,t){return p(this,we).search(e,t)}},we=new WeakMap,_a),I=class extends js{constructor(e={}){super(e),this.router=e.router??new Ps({routers:[new Fs,new Us]})}},Ws=/^\s*(?:text\/(?!event-stream(?:[;\s]|$))[^;\s]+|application\/(?:javascript|json|xml|xml-dtd|ecmascript|dart|postscript|rtf|tar|toml|vnd\.dart|vnd\.ms-fontobject|vnd\.ms-opentype|wasm|x-httpd-php|x-javascript|x-ns-proxy-autoconfig|x-sh|x-tar|x-virtualbox-hdd|x-virtualbox-ova|x-virtualbox-ovf|x-virtualbox-vbox|x-virtualbox-vdi|x-virtualbox-vhd|x-virtualbox-vmdk|x-www-form-urlencoded)|font\/(?:otf|ttf)|image\/(?:bmp|vnd\.adobe\.photoshop|vnd\.microsoft\.icon|vnd\.ms-dds|x-icon|x-ms-bmp)|message\/rfc822|model\/gltf-binary|x-shader\/x-fragment|x-shader\/x-vertex|[^;\s]+?\+(?:json|text|xml|yaml))(?:[;\s]|$)/i,ea=(e,t=Ys)=>{const a=/\.([a-zA-Z0-9]+?)$/,s=e.match(a);if(!s)return;let n=t[s[1].toLowerCase()];return n&&n.startsWith("text")&&(n+="; charset=utf-8"),n},zs={aac:"audio/aac",avi:"video/x-msvideo",avif:"image/avif",av1:"video/av1",bin:"application/octet-stream",bmp:"image/bmp",css:"text/css",csv:"text/csv",eot:"application/vnd.ms-fontobject",epub:"application/epub+zip",gif:"image/gif",gz:"application/gzip",htm:"text/html",html:"text/html",ico:"image/x-icon",ics:"text/calendar",jpeg:"image/jpeg",jpg:"image/jpeg",js:"text/javascript",json:"application/json",jsonld:"application/ld+json",map:"application/json",mid:"audio/x-midi",midi:"audio/x-midi",mjs:"text/javascript",mp3:"audio/mpeg",mp4:"video/mp4",mpeg:"video/mpeg",oga:"audio/ogg",ogv:"video/ogg",ogx:"application/ogg",opus:"audio/opus",otf:"font/otf",pdf:"application/pdf",png:"image/png",rtf:"application/rtf",svg:"image/svg+xml",tif:"image/tiff",tiff:"image/tiff",ts:"video/mp2t",ttf:"font/ttf",txt:"text/plain",wasm:"application/wasm",webm:"video/webm",weba:"audio/webm",webmanifest:"application/manifest+json",webp:"image/webp",woff:"font/woff",woff2:"font/woff2",xhtml:"application/xhtml+xml",xml:"application/xml",zip:"application/zip","3gp":"video/3gpp","3g2":"video/3gpp2",gltf:"model/gltf+json",glb:"model/gltf-binary"},Ys=zs,Ks=(...e)=>{let t=e.filter(n=>n!=="").join("/");t=t.replace(new RegExp("(?<=\\/)\\/+","g"),"");const a=t.split("/"),s=[];for(const n of a)n===".."&&s.length>0&&s.at(-1)!==".."?s.pop():n!=="."&&s.push(n);return s.join("/")||"."},Ca={br:".br",zstd:".zst",gzip:".gz"},Js=Object.keys(Ca),Vs="index.html",Xs=e=>{const t=e.root??"./",a=e.path,s=e.join??Ks;return async(n,i)=>{var c,u,m,h;if(n.finalized)return i();let r;if(e.path)r=e.path;else try{if(r=va(n.req.path),/(?:^|[\/\\])\.{1,2}(?:$|[\/\\])|[\/\\]{2,}/.test(r))throw new Error}catch{return await((c=e.onNotFound)==null?void 0:c.call(e,n.req.path,n)),i()}let l=s(t,!a&&e.rewriteRequestPath?e.rewriteRequestPath(r):r);e.isDir&&await e.isDir(l)&&(l=s(l,Vs));const o=e.getContent;let d=await o(l,n);if(d instanceof Response)return n.newResponse(d.body,d);if(d){const _=e.mimes&&ea(l,e.mimes)||ea(l);if(n.header("Content-Type",_||"application/octet-stream"),e.precompressed&&(!_||Ws.test(_))){const E=new Set((u=n.req.header("Accept-Encoding"))==null?void 0:u.split(",").map(w=>w.trim()));for(const w of Js){if(!E.has(w))continue;const A=await o(l+Ca[w],n);if(A){d=A,n.header("Content-Encoding",w),n.header("Vary","Accept-Encoding",{append:!0});break}}}return await((m=e.onFound)==null?void 0:m.call(e,l,n)),n.body(d)}await((h=e.onNotFound)==null?void 0:h.call(e,l,n)),await i()}},Gs=async(e,t)=>{let a;t&&t.manifest?typeof t.manifest=="string"?a=JSON.parse(t.manifest):a=t.manifest:typeof __STATIC_CONTENT_MANIFEST=="string"?a=JSON.parse(__STATIC_CONTENT_MANIFEST):a=__STATIC_CONTENT_MANIFEST;let s;t&&t.namespace?s=t.namespace:s=__STATIC_CONTENT;const n=a[e];if(!n)return null;const i=await s.get(n,{type:"stream"});return i||null},Zs=e=>async function(a,s){return Xs({...e,getContent:async i=>Gs(i,{manifest:e.manifest,namespace:e.namespace?e.namespace:a.env?a.env.__STATIC_CONTENT:void 0})})(a,s)},Qs=e=>Zs(e);const H={name:"Growth-engine365X",version:"ver1.00",tagline:"X (Twitter) 自動投稿プラットフォーム",longName:"X (Twitter) 自動投稿プラットフォーム",icon:"fa-bolt"},en=`
<meta charset="utf-8">
...
`,tn="bg-paper text-ink min-h-screen font-sans antialiased";function Ft(e,t,a={}){return`<!DOCTYPE html>
<html lang="ja">
<head>
${en}
<title>${e} — ${H.name}</title>
</head>
<body class="${a.bodyClass??tn}">
${t}
</body>
</html>`}const Na=new I;Na.get("/login",e=>{const t=`
...
<\/script>
`;return e.html(Ft("ログイン",t))});const re=new TextEncoder,La=new TextDecoder;function Ze(e){let t="";for(let a=0;a<e.length;a++)t+=String.fromCharCode(e[a]);return btoa(t)}function Qe(e){const t=atob(e),a=new Uint8Array(t.length);for(let s=0;s<t.length;s++)a[s]=t.charCodeAt(s);return a}function bt(e){return Ze(e).replace(/\+/g,"-").replace(/\//g,"_").replace(/=+$/,"")}function Nt(e){const t="=".repeat((4-e.length%4)%4);return Qe((e+t).replace(/-/g,"+").replace(/_/g,"/"))}function ot(e){const t=new Uint8Array(e);return crypto.getRandomValues(t),t}function an(e){return[...ot(e)].map(t=>t.toString(16).padStart(2,"0")).join("")}const ta=1e5,sn=32;async function wt(e){const t=ot(16),a=await crypto.subtle.importKey("raw",re.encode(e),{name:"PBKDF2"},!1,["deriveBits"]),s=await crypto.subtle.deriveBits({name:"PBKDF2",salt:t,iterations:ta,hash:"SHA-256"},a,sn*8);return`pbkdf2$${ta}$${Ze(t)}$${Ze(new Uint8Array(s))}`}async function Pt(e,t){try{const[a,s,n,i]=t.split("$");if(a!=="pbkdf2")return!1;const r=parseInt(s,10),l=Qe(n),o=Qe(i),d=await crypto.subtle.importKey("raw",re.encode(e),{name:"PBKDF2"},!1,["deriveBits"]),c=new Uint8Array(await crypto.subtle.deriveBits({name:"PBKDF2",salt:l,iterations:r,hash:"SHA-256"},d,o.length*8));return Ma(c,o)}catch{return!1}}function Ma(e,t){if(e.length!==t.length)return!1;let a=0;for(let s=0;s<e.length;s++)a|=e[s]^t[s];return a===0}async function $a(e){return crypto.subtle.importKey("raw",re.encode(e),{name:"HMAC",hash:"SHA-256"},!1,["sign","verify"])}async function Fa(e,t,a=3600*24*7){const s=Math.floor(Date.now()/1e3),n={iat:s,exp:s+a,...e},i=bt(re.encode(JSON.stringify({alg:"HS256",typ:"JWT"}))),r=bt(re.encode(JSON.stringify(n))),l=`${i}.${r}`,o=await $a(t),d=new Uint8Array(await crypto.subtle.sign("HMAC",o,re.encode(l)));return`${l}.${bt(d)}`}async function Pa(e,t){try{const[a,s,n]=e.split(".");if(!a||!s||!n)return null;const i=await $a(t);if(!await crypto.subtle.verify("HMAC",i,Nt(n),re.encode(`${a}.${s}`)))return null;const l=JSON.parse(La.decode(Nt(s)));return l.exp&&l.exp<Math.floor(Date.now()/1e3)?null:l}catch{return null}}async function qa(e){const t=re.encode(e),a=t.length>=32?t.slice(0,32):new Uint8Array(await crypto.subtle.digest("SHA-256",t));return crypto.subtle.importKey("raw",a,{name:"AES-GCM"},!1,["encrypt","decrypt"])}async function G(e,t){const a=ot(12),s=await qa(t),n=new Uint8Array(await crypto.subtle.encrypt({name:"AES-GCM",iv:a},s,re.encode(e))),i=new Uint8Array(a.length+n.length);return i.set(a),i.set(n,a.length),Ze(i)}async function et(e,t){const a=Qe(e),s=a.slice(0,12),n=a.slice(12),i=await qa(t),r=await crypto.subtle.decrypt({name:"AES-GCM",iv:s},i,n);return La.decode(r)}const aa="ABCDEFGHJKLMNPQRSTUVWXYZ23456789";function nn(e="VPS-GE365X"){const t=ot(8);let a="";for(let s=0;s<8;s++)a+=aa[t[s]%aa.length];return`${e}-${a}`}function Ha(e){return/^VPS-GE365X-[A-Z0-9]{6,12}$/i.test(e.trim())}function v(){return new Date(Date.now()+324e5).toISOString().replace("T"," ").slice(0,19)}function rn(e,t){return new Response(JSON.stringify(e),{...t,headers:{"content-type":"application/json; charset=utf-8",...(t==null?void 0:t.headers)||{}}})}function Ua(e,t){const s=(e.headers.get("cookie")||"").split(";").map(n=>n.trim()).find(n=>n.startsWith(t+"="));return s?decodeURIComponent(s.slice(t.length+1)):null}function qt(e,t,a={}){const s=[`${e}=${encodeURIComponent(t)}`];return s.push(`Path=${a.path??"/"}`),a.maxAge!==void 0&&s.push(`Max-Age=${a.maxAge}`),a.httpOnly!==!1&&s.push("HttpOnly"),a.secure!==!1&&s.push("Secure"),s.push(`SameSite=${a.sameSite??"Lax"}`),s.join("; ")}const lt=Object.freeze(Object.defineProperty({__proto__:null,aesDecrypt:et,aesEncrypt:G,b64decode:Qe,b64encode:Ze,b64urlDecode:Nt,b64urlEncode:bt,buildSetCookie:qt,generateLicenseKey:nn,getCookie:Ua,hashPassword:wt,isValidLicenseKeyFormat:Ha,json:rn,nowJst:v,randomBytes:ot,randomHex:an,signJWT:Fa,timingSafeEqual:Ma,verifyJWT:Pa,verifyPassword:Pt},Symbol.toStringTag,{value:"Module"})),Ht="ge365x_session";function on(e){const t=e.req.header("Authorization")||e.req.header("authorization");return t&&t.startsWith("Bearer ")?t.slice(7):Ua(e.req.raw,Ht)}async function f(e,t){const a=on(e);if(!a)return e.json({error:"unauthenticated"},401);const s=await Pa(a,e.env.JWT_SECRET);if(!(s!=null&&s.uid))return e.json({error:"invalid_token"},401);const n=await e.env.DB.prepare("SELECT id,email,is_approved,is_admin,trial_start,trial_end FROM users WHERE id = ?").bind(s.uid).first();if(!n)return e.json({error:"user_not_found"},401);if(n.is_approved===0)return e.json({error:"not_approved"},403);if(n.is_admin===0&&n.trial_end){const l=new Date,o=new Date(n.trial_end.replace(" ","T")+(n.trial_end.includes("+")?"":"+09:00"));if(!await e.env.DB.prepare("SELECT status FROM user_subscriptions WHERE user_id = ? AND status='active' LIMIT 1").bind(n.id).first()&&l>o)return e.json({error:"trial_expired",message:"無料お試し期間が終了いたしました。"},403)}const i=await e.env.DB.prepare("SELECT plan_code,status FROM user_subscriptions WHERE user_id = ?").bind(n.id).first(),r={id:n.id,email:n.email,is_admin:n.is_admin===1,is_approved:n.is_approved===1,plan_code:i==null?void 0:i.plan_code,subscription_status:i==null?void 0:i.status};e.set("user",r),await t()}async function Te(e,t){const a=e.get("user");if(!a)return e.json({error:"unauthenticated"},401);if(!a.is_admin)return e.json({error:"forbidden"},403);await t()}async function ie(e,t,a={}){const s=e.req.header("cf-connecting-ip")||e.req.header("x-forwarded-for")||"",n=e.req.header("user-agent")||"";await e.env.DB.prepare(`INSERT INTO auth_logs (user_id, email, event_type, ip_address, user_agent, metadata)
     VALUES (?, ?, ?, ?, ?, ?)`).bind(a.userId??null,a.email??null,t,s,n,a.metadata?JSON.stringify(a.metadata):null).run()}const ln=[{key:"dashboard",label:"ダッシュボード",icon:"fa-gauge-high",path:"/dashboard"},{key:"target",label:"ターゲット設定",icon:"fa-bullseye",path:"/dashboard/target"},{key:"voice",label:"ブランドボイス",icon:"fa-palette",path:"/dashboard/voice"},{key:"pattern",label:"パターン別AI生成",icon:"fa-wand-magic-sparkles",path:"/dashboard/pattern"},{key:"generate",label:"AI生成2",icon:"fa-robot",path:"/dashboard/generate"},{key:"posts",label:"X投稿管理",icon:"fa-brands fa-x-twitter",path:"/dashboard/posts"},{key:"thread",label:"ツリー投稿",icon:"fa-reply",path:"/dashboard/thread"},{key:"scheduled",label:"予約状況",icon:"fa-calendar",path:"/dashboard/scheduled"},{key:"autopilot",label:"オートパイロット",icon:"fa-plane-departure",path:"/dashboard/autopilot"},{key:"accounts",label:"アカウント管理",icon:"fa-users-gear",path:"/dashboard/accounts"},{key:"api",label:"API設定",icon:"fa-key",path:"/dashboard/api"},{key:"export",label:"一括ダウンロード",icon:"fa-download",path:"/dashboard/export"}];function dn(e,t){return`
...
`;function S(e){return(e||"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}function Wa(e){return{pending:'<span class="pill pill-warn">未承認</span>',approved:'<span class="pill pill-blue">承認済</span>',publishing:'<span class="pill pill-blue">送信中</span>',posted:'<span class="pill pill-ok">投稿済</span>',failed:'<span class="pill pill-err">失敗</span>',cancelled:'<span class="pill pill-soft">キャンセル</span>'}[e||""]||`<span class="pill pill-soft">${e||"—"}</span>`}function mn(e){const{stats:t,health:a,recentLogs:s}=e;return`
<div class="space-y-4">
  <div>
        ...
        <div style="display:grid;grid-template-columns:repeat(5,1fr);gap:.5rem" id="patt-grid">
          ${t.map(([i,r,l],o)=>`
            <div onclick="selectPatt(this,'${i}')" data-val="${i}"
              ...
              <i class="fas ${l}" style="font-size:1.1rem"></i>
...
<\/script>`}const q=new I;async function Tn(e,t){const{results:a}=await e.env.DB.prepare(`SELECT id, account_name, x_username, is_current
       FROM x_accounts WHERE user_id = ? AND is_active = 1 ORDER BY id`).bind(t.id).all(),s=(a||[]).map(i=>({id:i.id,account_name:i.account_name,x_username:i.x_username})),n=(a||[]).find(i=>i.is_current===1)||(a||[])[0];return{accounts:s,currentAccountId:(n==null?void 0:n.id)??null}}q.get("/",e=>e.redirect("/login"));async function Y(e,t,a){const s=e.get("user"),{accounts:n,currentAccountId:i}=await Tn(e,s),r=n.length>0,l=await Promise.resolve(a({user:s,hasAccount:r,accounts:n,currentAccountId:i})),o=pn({active:t,user:s,accounts:n,currentAccountId:i,pageBody:l});return e.html(Ft("GE365x",o))}q.get("/dashboard",f,async e=>Y(e,"dashboard",async({user:t,hasAccount:a})=>{const s=await e.env.DB.prepare("SELECT COUNT(*) AS n FROM x_accounts WHERE user_id=?").bind(t.id).first(),n=await e.env.DB.prepare("SELECT COUNT(*) AS n FROM post_logs WHERE user_id=? AND DATE(created_at)=DATE('now','+9 hours') AND status='posted'").bind(t.id).first(),i=await e.env.DB.prepare("SELECT COUNT(*) AS n FROM post_queue WHERE user_id=? AND status IN ('pending','approved')").bind(t.id).first(),r=await e.env.DB.prepare("SELECT COUNT(*) AS n FROM post_logs WHERE user_id=? AND status='failed' AND DATE(created_at)=DATE('now','+9 hours')").bind(t.id).first(),{results:l}=await e.env.DB.prepare(`SELECT id, account_name, x_username, account_health_score, health_status, is_active
        ...
        ORDER BY pq.id DESC LIMIT 200`).bind(t.id,n).all(),o=(l||[]).length,d=(l||[]).filter(m=>m.status==="pending"||m.status==="approved").length,c=(l||[]).filter(m=>m.status==="posted").length,u=(l||[]).filter(m=>m.status==="failed").length;return bn({hasAccount:a,noAccountAlert:Ae,month:n,y:i,m:parseInt(r,10),posts:l||[],stats:{total:o,pending:d,posted:c,failed:u}})}));q.get("/dashboard/thread",f,async e=>Y(e,"thread",async({user:t,hasAccount:a})=>{const{results:s}=await e.env.DB.prepare(`SELECT pq.id, pq.body, pq.status, pq.posted_at, pq.created_at, pq.thread_parent_id
         FROM post_queue pq
        WHERE pq.user_id = ? AND pq.post_mode = 'thread' AND pq.thread_parent_id IS NOT NULL
        ORDER BY pq.id DESC LIMIT 30`).bind(t.id).all();return vn({hasAccount:a,noAccountAlert:Ae,history:s||[]})}));q.get("/dashboard/scheduled",f,async e=>Y(e,"scheduled",async({user:t})=>{const{results:a}=await e.env.DB.prepare(`SELECT pq.id, pq.body, pq.scheduled_at, pq.status, xa.x_username
         FROM post_queue pq LEFT JOIN x_accounts xa ON xa.id = pq.account_id
        WHERE pq.user_id = ? AND pq.scheduled_at IS NOT NULL
          AND pq.status NOT IN ('cancelled','rejected')
        ORDER BY pq.scheduled_at ASC LIMIT 100`).bind(t.id).all();return xn()}));q.get("/dashboard/autopilot",f,async e=>Y(e,"autopilot",async({user:t,hasAccount:a,accounts:s})=>{const{results:n}=await e.env.DB.prepare(`SELECT aj.*, xa.x_username FROM autopilot_jobs aj
         LEFT JOIN x_accounts xa ON xa.id = aj.account_id
        WHERE aj.user_id = ?
        ORDER BY COALESCE(aj.publish_at, aj.generate_at, aj.created_at) DESC LIMIT 50`).bind(t.id).all();return En({hasAccount:a,noAccountAlert:Ae,accounts:s,jobs:n||[]})}));q.get("/dashboard/accounts",f,async e=>Y(e,"accounts",async({user:t})=>{const{results:a}=await e.env.DB.prepare(`SELECT id, account_name, x_username, account_health_score, health_status,
              daily_post_count, daily_post_limit, last_posted_at, is_active
         FROM x_accounts WHERE user_id = ? ORDER BY id DESC`).bind(t.id).all();return wn({accounts:a||[]})}));q.get("/dashboard/api",f,async e=>Y(e,"api",async({user:t})=>{const{aesDecrypt:a}=await Promise.resolve().then(()=>lt),s=async _=>{const E=await e.env.DB.prepare("SELECT value FROM system_settings WHERE key=?").bind(_).first();if(!(E!=null&&E.value))return"";try{return await a(E.value,e.env.ENCRYPTION_KEY)}catch{return""}},n=await e.env.DB.prepare("SELECT api_key, api_secret FROM x_api_settings WHERE user_id = ? LIMIT 1").bind(t.id).first();let i="",r="";if(n!=null&&n.api_key)try{const _=await a(n.api_key,e.env.ENCRYPTION_KEY);i=_?_.slice(0,6)+"••••":""}catch{}if(n!=null&&n.api_secret)try{const _=await a(n.api_secret,e.env.ENCRYPTION_KEY);r=_?_.slice(0,4)+"••••":""}catch{}const l=await s("openai_api_key"),o=await s("openai_model"),d=await s("gemini_api_key"),c=await s("gemini_model"),u=await s("telegram_bot_token"),m=await s("telegram_chat_id");return Sn({settings:{api_key:i,api_secret:r,openai_api_key:!!l,openai_model:o||"gpt-4o-mini",gemini_api_key:!!d,gemini_model:c||"gemini-1.5-flash",telegram_bot_token:!!u,telegram_chat_id:m||""}})}));q.get("/dashboard/export",f,async e=>Y(e,"export",({user:t})=>kn({isAdmin:t.is_admin})));const za=new I;za.get("/admin",f,Te,e=>{const t=`
...
<div class="warn">⚠️ ログイン後すぐにパスワードを変更してください<br>このURLは設定後も有効なため、token を知らない人には教えないでください</div>
</div></body></html>`)});const fe=new I;fe.get("/api/subscription/plans",async e=>{const{results:t}=await e.env.DB.prepare(`SELECT code, name, description, monthly_price_jpy, yearly_price_jpy,
     ...
     WHERE user_id = ?`).bind(t.id).run(),e.json({ok:!0})});fe.get("/api/subscription/payments",f,async e=>{const t=e.get("user"),{results:a}=await e.env.DB.prepare(`SELECT id, amount_jpy, currency, provider, external_id, status, plan_code, paid_at, created_at
      ...
      LIMIT 50`).bind(t.id).all();return e.json({payments:a||[]})});fe.post("/api/subscription/stripe/checkout",f,async e=>e.env.STRIPE_SECRET_KEY?e.json({error:"not_implemented_yet"},501):e.json({error:"stripe_not_configured"},501));fe.post("/api/subscription/webhook/stripe",async e=>e.json({received:!0}));const sa=new TextEncoder,Ya="https://api.x.com/2",Ka="https://upload.x.com/1.1";class O extends Error{constructor(a,s=0,n="api_error"){super(a);g(this,"statusCode");g(this,"errorType");this.name="XApiError",this.statusCode=s,this.errorType=n}}class kt extends O{constructor(a){super("Rate limited by X API (429)",429,"rate_limit");g(this,"resetAtEpoch");this.name="XApiRateLimitError",this.resetAtEpoch=a}}function ee(e){return encodeURIComponent(e).replace(/[!'()*]/g,t=>"%"+t.charCodeAt(0).toString(16).toUpperCase())}function An(e){const t=new Uint8Array(e);return crypto.getRandomValues(t),[...t].map(a=>a.toString(16).padStart(2,"0")).join("")}function In(){return An(16)}async function Dn(e,t){const a=await crypto.subtle.importKey("raw",sa.encode(e),{name:"HMAC",hash:"SHA-1"},!1,["sign"]),s=await crypto.subtle.sign("HMAC",a,sa.encode(t)),n=new Uint8Array(s);let i="";for(let r=0;r<n.length;r++)i+=String.fromCharCode(n[r]);return btoa(i)}async function Ut(e,t,a,s){const n={oauth_consumer_key:a.consumerKey,oauth_nonce:In(),oauth_signature_method:"HMAC-SHA1",oauth_timestamp:Math.floor(Date.now()/1e3).toString(),oauth_token:a.accessToken,oauth_version:"1.0"},i=new URL(t),r={...n};if(i.searchParams.forEach((m,h)=>{r[h]=m}),s)for(const[m,h]of Object.entries(s))h!=null&&(r[m]=String(h));const l=Object.keys(r).sort().map(m=>`${ee(m)}=${ee(r[m])}`).join("&"),o=[e.toUpperCase(),ee(`${i.origin}${i.pathname}`),ee(l)].join("&"),d=`${ee(a.consumerSecret)}&${ee(a.accessTokenSecret)}`,c=await Dn(d,o);return n.oauth_signature=c,`OAuth ${Object.keys(n).sort().map(m=>`${ee(m)}="${ee(n[m])}"`).join(", ")}`}async function dt(e,t,a,s){const n=`${Ya}${t}`,i=await Ut(e,n,s),r={method:e,headers:{authorization:i,"content-type":"application/json"},signal:AbortSignal.timeout(3e4)};a!==void 0&&(r.body=JSON.stringify(a));const l=await fetch(n,r);if(l.status===429){const o=l.headers.get("x-rate-limit-reset");throw new kt(o?Number(o):void 0)}if(!l.ok){const o=await l.text();throw new O(`X API ${e} ${t} failed: ${l.status} ${o.slice(0,500)}`,l.status,"api_error")}return l.status===204?{}:l.json()}async function Wt(e,t){var s,n;const a=await dt("POST","/tweets",{text:t},e);return{id:((s=a==null?void 0:a.data)==null?void 0:s.id)||"",text:((n=a==null?void 0:a.data)==null?void 0:n.text)||t}}async function zt(e,t,a,s){var r,l;const n={text:t};a&&a.length&&(n.media={media_ids:a.slice(0,4)}),s&&(n.reply={in_reply_to_tweet_id:s});const i=await dt("POST","/tweets",n,e);return{id:((r=i==null?void 0:i.data)==null?void 0:r.id)||"",text:((l=i==null?void 0:i.data)==null?void 0:l.text)||t}}async function jn(e,t){await dt("DELETE",`/tweets/${t}`,void 0,e)}async function Ja(e){var a,s,n,i;if(!e)throw new O("credentials未設定",0,"missing_credentials");if(!((a=e.consumerKey)!=null&&a.trim()))throw new O("API Key未設定",0,"missing_credentials");if(!((s=e.consumerSecret)!=null&&s.trim()))throw new O("API Secret未設定",0,"missing_credentials");if(!((n=e.accessToken)!=null&&n.trim()))throw new O("Access Token未設定",0,"missing_token");if(!((i=e.accessTokenSecret)!=null&&i.trim()))throw new O("Access Token Secret未設定",0,"missing_token");const t=await dt("GET","/users/me?user.fields=profile_image_url,public_metrics",void 0,e);return t==null?void 0:t.data}async function On(e,t,a=20){const s=await dt("GET",`/users/${t}/tweets?max_results=${a}&tweet.fields=created_at,text,in_reply_to_user_id&exclude=replies,retweets`,void 0,e);return(s==null?void 0:s.data)||[]}async function Ve(e,t,a,s,n,i){const r=new URL(`${Ka}${t}`);s&&Object.entries(s).forEach(([m,h])=>r.searchParams.set(m,h));const l=r.toString(),o={};if(n&&!i)for(const[m,h]of Object.entries(n))o[m]=String(h);const d=await Ut(e,l,a,o),c={method:e.toUpperCase(),headers:{authorization:d}};i?c.body=i:n&&(c.body=Object.entries(n).map(([m,h])=>`${encodeURIComponent(m)}=${encodeURIComponent(String(h))}`).join("&"),c.headers["content-type"]="application/x-www-form-urlencoded");const u=await fetch(l,c);if(!u.ok){const m=await u.text();throw new O(`X Upload ${e} ${t} failed: ${u.status} ${m.slice(0,300)}`,u.status,"media_upload_failed")}return u.status===204?{}:u.json()}async function Rn(e,t,a){const s=t instanceof Uint8Array?t:new Uint8Array(t),n=new FormData;n.append("media",new Blob([s],{type:a}));const i=await Ve("POST","/media/upload.json",e,null,null,n);return{media_id:i.media_id_string||String(i.media_id),size:i.size}}async function Bn(e,t,a){var c;const s=t instanceof Uint8Array?t:new Uint8Array(t),n=s.length,i=await Ve("POST","/media/upload.json",e,null,{command:"INIT",total_bytes:n,media_type:a,media_category:"tweet_video"},null),r=i.media_id_string||String(i.media_id),l=4*1024*1024;let o=0;for(let u=0;u<n;u+=l){const m=s.slice(u,Math.min(u+l,n)),h=new FormData;h.append("command","APPEND"),h.append("media_id",r),h.append("segment_index",String(o)),h.append("media",new Blob([m],{type:a})),await Ve("POST","/media/upload.json",e,null,null,h),o++}const d=await Ve("POST","/media/upload.json",e,null,{command:"FINALIZE",media_id:r},null);if(d.processing_info){let u=0;for(;u<30;){await new Promise(_=>setTimeout(_,(d.processing_info.check_after_secs||5)*1e3));const h=(await Ve("GET","/media/upload.json",e,{command:"STATUS",media_id:r},null,null)).processing_info;if(!h||h.state==="succeeded")break;if(h.state==="failed")throw new O("動画処理失敗: "+(((c=h.error)==null?void 0:c.message)||""),0,"video_process_failed");u++}}return{media_id:r,size:n}}async function St(e,t,a){var l,o;const s=((a==null?void 0:a.apiKey)??e.X_API_KEY??"").trim(),n=((a==null?void 0:a.apiSecret)??e.X_API_SECRET??"").trim();if(!s||!n)throw new O("X API Key/Secret 未設定",0,"no_api_key");if(!((l=t==null?void 0:t.access_token)!=null&&l.trim()))throw new O("Access Token 未設定",0,"no_token");if(!((o=t==null?void 0:t.access_token_secret)!=null&&o.trim()))throw new O("Access Token Secret 未設定",0,"no_token_secret");let i,r;try{i=await et(t.access_token,e.ENCRYPTION_KEY)}catch{throw new O("Access Token の復号に失敗",0,"decrypt_failed")}try{r=await et(t.access_token_secret,e.ENCRYPTION_KEY)}catch{throw new O("Access Token Secret の復号に失敗",0,"decrypt_failed")}if(!i.trim())throw new O("Access Token が空",0,"decrypt_failed");if(!r.trim())throw new O("Access Token Secret が空",0,"decrypt_failed");return{consumerKey:s,consumerSecret:n,accessToken:i,accessTokenSecret:r}}const Cn=Object.freeze(Object.defineProperty({__proto__:null,XApiError:O,XApiRateLimitError:kt,X_API_BASE:Ya,X_UPLOAD_BASE:Ka,buildCredentialsFromAccount:St,buildOAuth1Header:Ut,deleteTweet:jn,getMe:Ja,getUserRecentTweets:On,percentEncode:ee,postToX:Wt,postToXWithMedia:zt,uploadImage:Rn,uploadVideo:Bn},Symbol.toStringTag,{value:"Module"}));async function na(e,t){if(!e)return"";try{return await et(e,t)}catch{return""}}const he=new I;he.get("/api/admin/accounts",f,async e=>{const t=e.get("user"),{results:a}=await e.env.DB.prepare(`SELECT id, account_name, x_user_id, x_username,
            daily_post_count, daily_post_limit, last_posted_at,
            account_health_score, health_status, is_active, is_current, created_at
       FROM x_accounts WHERE user_id = ? ORDER BY id DESC`).bind(t.id).all();return e.json({accounts:a||[]})});he.post("/api/admin/accounts",f,async e=>{var o,d;const t=e.get("user"),a=await e.req.json();if(!a.account_name)return e.json({error:"account_name required"},400);if(!((o=a.access_token)!=null&&o.trim())||!((d=a.access_token_secret)!=null&&d.trim()))return e.json({error:"access_token and access_token_secret required"},400);const s=await G(a.access_token.trim(),e.env.ENCRYPTION_KEY),n=await G(a.access_token_secret.trim(),e.env.ENCRYPTION_KEY),i=await e.env.DB.prepare("SELECT COUNT(*) AS cnt FROM x_accounts WHERE user_id=? AND is_active=1").bind(t.id).first(),r=((i==null?void 0:i.cnt)??0)===0?1:0;r&&await e.env.DB.prepare("UPDATE x_accounts SET is_current=0 WHERE user_id=?").bind(t.id).run();const l=await e.env.DB.prepare(`INSERT INTO x_accounts
...
3.なぜその数字か
4.読者が同じ結果を得る条件
5.CTA`}};async function Xa(e,t){var r,l,o;const a=t.model||"gpt-4o-mini",s=t.maxTokens||4e3,n=t.temperature??.7,i=t.baseUrl||"https://api.openai.com/v1";for(let d=1;d<=3;d++)try{const c=await fetch(`${i}/chat/completions`,{method:"POST",headers:{authorization:`Bearer ${t.apiKey}`,"content-type":"application/json"},body:JSON.stringify({model:a,messages:e,max_tokens:s,temperature:n}),signal:AbortSignal.timeout(12e4)});if(!c.ok){const m=await c.text();if(c.status>=500&&d<3){await new Promise(h=>setTimeout(h,2e3*d));continue}throw new Error(`OpenAI API error: ${c.status} ${m.slice(0,500)}`)}const u=await c.json();return((o=(l=(r=u==null?void 0:u.choices)==null?void 0:r[0])==null?void 0:l.message)==null?void 0:o.content)||""}catch(c){if(((c==null?void 0:c.name)==="TimeoutError"||(c==null?void 0:c.name)==="AbortError")&&d<3){await new Promise(m=>setTimeout(m,2e3*d));continue}throw c}return""}function Ga(e){let t=`以下のルールを厳守してX(Twitter)投稿文を生成してください。
...
`),t.trim()}async function Za(e,t,a,s,n,i="body"){const{messages:r}=Ga({theme:t,keywords:a,brandVoice:n,targetDna:s,postMode:i||"body"}),l=await Xa(r,{apiKey:e,temperature:.8});return Tt(l,i)}async function Qa(e,t,a,s,n,i,r="body"){if(!Lt[t])throw new Error(`未対応のパターン: ${t}`);const{messages:l}=Ga({theme:a,keywords:s,brandVoice:i,targetDna:n,patternType:t,postMode:r||"body"}),o=await Xa(l,{apiKey:e,temperature:.8});return Tt(o,r)}function Tt(e,t){if(!e)return"";let a=e.replace(/^#{1,4}\s*/gm,"").replace(/^[▪️■●•\-\*]+\s*/gm,"").replace(/^\d+\.\s/gm,"").replace(/^(Step\d+)[:\s]/gim,"").replace(/^[①②③④⑤⑥⑦⑧⑨⑩]\s*/gm,"・").replace(/\*\*([^*]+)\*\*/g,"$1").replace(/\n{3,}/g,`
...
`+d.trim());const pt=await Se(C),X=await e.env.DB.prepare(`INSERT INTO post_queue
         ...
         VALUES ('x', ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, 'pending', ?, ?)`).bind(t.id,h,a,s||"",C,l||null,o||null,B,i||null,pt,u||i||"general",i?"pattern_generated_post":"ai_generated_post",w,w).run();A.push({id:X.meta.last_row_id,body:C,link_url:l||"",post_mode:B});try{await e.env.DB.prepare(`INSERT INTO generation_logs
             (user_id, account_id, brand_voice_id, target_setting_id, post_mode, generation_type, output_text)
           VALUES (?, ?, ?, ?, ?, ?, ?)`).bind(t.id,h,(E==null?void 0:E.id)??null,(_==null?void 0:_.id)??null,B,i||"general",C.slice(0,500)).run()}catch{}}return e.json({success:!0,generated:A,count:A.length})}catch(x){return e.json({error:"AI error: "+x.message},500)}});F.post("/api/admin/posts/:id/approve",f,async e=>{const t=e.get("user");return await e.env.DB.prepare("UPDATE post_queue SET status='approved', updated_at=? WHERE id=? AND user_id=?").bind(v(),parseInt(e.req.param("id"),10),t.id).run(),e.json({success:!0})});F.post("/api/admin/posts/:id/reject",f,async e=>{const t=e.get("user");return await e.env.DB.prepare("UPDATE post_queue SET status='rejected', updated_at=? WHERE id=? AND user_id=?").bind(v(),parseInt(e.req.param("id"),10),t.id).run(),e.json({success:!0})});F.post("/api/admin/posts/:id/schedule",f,async e=>{const t=e.get("user"),a=parseInt(e.req.param("id"),10),{scheduled_at:s,jitter_enabled:n=!0,jitter_minutes:i=5,collision_avoidance_enabled:r=!0,min_spacing_seconds:l=90}=await e.req.json();if(!s)return e.json({error:"scheduled_at required"},400);const o=await e.env.DB.prepare("SELECT * FROM post_queue WHERE id=? AND user_id=?").bind(a,t.id).first();if(!o)return e.json({success:!1,error:"Not found"},404);const d=await Xn(e.env,o.body||"",o.account_id??null,{post_id:o.id});if(!d.pass)return e.json({success:!1,error:"類似: "+d.blocked_reason,similarity_blocked:!0,scores:d.scores});const{effective_at:c,audit:u}=await zn(e.env,s,{jitter_enabled:n,jitter_minutes:i,collision_avoidance_enabled:r,min_spacing_seconds:l,account_id:o.account_id,exclude_id:o.id}),m=await Jn(o.body||"");return await Vn(e.env,o.id,o.account_id,m),await e.env.DB.prepare(`UPDATE post_queue SET
...
`+n.hashtags);const u=[];if(n.media_json)try{const h=JSON.parse(n.media_json);for(const _ of(h||[]).slice(0,4)){const E=await e.env.DB.prepare("SELECT * FROM media_assets WHERE id=? AND user_id=?").bind(_,t.id).first();E!=null&&E.x_media_id&&u.push(E.x_media_id)}}catch{}const m=u.length>0?await zt(d,c,u,null):await Wt(d,c);return await e.env.DB.prepare("UPDATE post_queue SET status='posted', external_post_id=?, posted_at=?, updated_at=? WHERE id=?").bind(m.id||"",v(),v(),a).run(),await e.env.DB.prepare(`UPDATE x_accounts SET last_posted_at=?, daily_post_count=daily_post_count+1,
     ...
     VALUES ('x', ?, ?, ?, ?, 'thread', ?, ?, 'manual_post', 'pending', ?, ?)`).bind(t.id,n??null,a[0].body,a[0].link_url??s??null,a.length,r,i,i).run()).meta.last_row_id,d=[o];for(let c=1;c<a.length;c++){const u=await Se(a[c].body),m=await e.env.DB.prepare(`INSERT INTO post_queue
       ...
       VALUES ('x', ?, ?, ?, ?, 'thread', ?, ?, ?, 'manual_post', 'pending', ?, ?)`).bind(t.id,n??null,a[c].body,a[c].link_url??null,o,c,u,i,i).run();d.push(m.meta.last_row_id)}return e.json({success:!0,parent_id:o,ids:d})});const ns=new I,Qn=5;ns.post("/cron/tick",async e=>{const t=v(),{results:a}=await e.env.DB.prepare(`SELECT * FROM post_queue
      WHERE platform='x'
...
`+r.hashtags);const m=[];if(r.media_json)try{const _=JSON.parse(r.media_json);for(const E of(_||[]).slice(0,4)){const w=await e.env.DB.prepare("SELECT x_media_id FROM media_assets WHERE id=?").bind(E).first();w!=null&&w.x_media_id&&m.push(w.x_media_id)}}catch{}const h=m.length>0?await zt(c,u,m,null):await Wt(c,u);await e.env.DB.prepare("UPDATE post_queue SET status='posted', external_post_id=?, posted_at=?, updated_at=? WHERE id=?").bind(h.id||"",v(),v(),r.id).run(),await e.env.DB.prepare(`UPDATE x_accounts SET
           ...
           ON CONFLICT(account_id, metric_date) DO UPDATE SET
             ...
             updated_at = datetime('now','+9 hours')`).bind(o.id,r.user_id).run(),n++}finally{await as(e.env,o.id)}}catch(o){const d=(o==null?void 0:o.message)||"unknown_error";await e.env.DB.prepare("UPDATE post_queue SET status='failed', error_message=?, updated_at=? WHERE id=?").bind(d,v(),r.id).run(),await e.env.DB.prepare(`INSERT INTO post_logs
           (record_id, account_id, user_id, platform, source_type, post_mode, content, content_hash,
            status, error_message, executed_at)
         VALUES (?, ?, ?, 'x', ?, ?, ?, ?, 'failed', ?, ?)`).bind(r.id,r.account_id,r.user_id,r.source_type,r.post_mode,r.body||"",r.content_hash||"",d,v()).run(),r.account_id&&(o instanceof kt?await yt(e.env,r.account_id,"rate_limit",-15):await yt(e.env,r.account_id,"error",-5,{message:d})),r.account_id&&await e.env.DB.prepare(`INSERT INTO kpi_metrics (account_id, user_id, metric_date, posts_failed)
           VALUES (?, ?, date('now','+9 hours'), 1)
           ON CONFLICT(account_id, metric_date) DO UPDATE SET
             posts_failed = posts_failed + 1,
             updated_at = datetime('now','+9 hours')`).bind(r.account_id,r.user_id).run(),i++}}}return e.json({ok:!0,processed:s,success:n,failed:i,now:t})});const ge=new I;ge.get("/api/admin/autopilot/jobs",f,async e=>{const t=e.get("user"),{results:a}=await e.env.DB.prepare(`SELECT aj.*, xa.account_name
       FROM autopilot_jobs aj LEFT JOIN x_accounts xa ON aj.account_id = xa.id
      WHERE aj.user_id = ?
      ORDER BY COALESCE(aj.generate_at, aj.publish_at, aj.created_at) DESC LIMIT 100`).bind(t.id).all(),{results:s}=await e.env.DB.prepare("SELECT id, account_name FROM x_accounts WHERE user_id = ? AND is_active = 1").bind(t.id).all();return e.json({jobs:a||[],accounts:s||[]})});ge.get("/api/admin/autopilot/jobs/:id",f,async e=>{const t=e.get("user"),a=await e.env.DB.prepare("SELECT * FROM autopilot_jobs WHERE id=? AND user_id=?").bind(parseInt(e.req.param("id"),10),t.id).first();return a?e.json(a):e.json({error:"not found"})});ge.post("/api/admin/autopilot/jobs",f,async e=>{var u;const t=e.get("user"),a=await e.req.json(),s=v(),n=(a.publish_at||a.generate_at||s).slice(0,10),i=await e.env.DB.prepare(`SELECT COUNT(*) AS cnt FROM autopilot_jobs
     ...
     VALUES (?, ?, ?, 'x', ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)`).bind(l,t.id,a.account_id??null,a.content_mode||"problem",a.theme||"",a.keywords||"",a.prompt_text||"",JSON.stringify({...a.options_json?typeof a.options_json=="string"?JSON.parse(a.options_json):a.options_json:{},...a.footer_text?{footer_text:a.footer_text}:{},...(u=a.media_images)!=null&&u.length?{media_images:a.media_images}:{},...a.media_video?{media_video:a.media_video,media_video_name:a.media_video_name,media_video_type:a.media_video_type}:{}}),a.title_memo||"",a.link_url||"",o,a.publish_at||null,d,s,s).run();return e.json({success:!0,id:c.meta.last_row_id,reservation_no:l})});ge.put("/api/admin/autopilot/jobs/:id",f,async e=>{const t=e.get("user"),a=parseInt(e.req.param("id"),10),s=await e.req.json(),n=v();let i=s.generate_at??null;if(s.publish_at&&!s.generate_at)try{const l=new Date(s.publish_at.replace(" ","T"));l.setMinutes(l.getMinutes()-2),i=l.toISOString().replace("T"," ").slice(0,19)}catch{}const r=i||s.publish_at?"configured":"draft";return await e.env.DB.prepare(`UPDATE autopilot_jobs SET
...
`)}function W(e,t){return new Response(e,{headers:{"content-type":"text/csv; charset=utf-8","content-disposition":`attachment; filename="${t}"`,"cache-control":"no-store"}})}function is(e,t){return new Response(JSON.stringify(e,null,2),{headers:{"content-type":"application/json; charset=utf-8","content-disposition":`attachment; filename="${t}"`,"cache-control":"no-store"}})}function P(){const e=new Date,t=a=>String(a).padStart(2,"0");return`${e.getFullYear()}${t(e.getMonth()+1)}${t(e.getDate())}_${t(e.getHours())}${t(e.getMinutes())}`}M.get("/api/admin/export/posts",f,async e=>{const t=e.get("user"),a=e.req.query("status"),s=e.req.query("month");let n="WHERE pq.platform='x' AND pq.user_id = ?";const i=[t.id];a&&a!=="all"&&(n+=" AND pq.status = ?",i.push(a)),s&&(n+=" AND strftime('%Y-%m', COALESCE(pq.posted_at, pq.scheduled_at, pq.created_at)) = ?",i.push(s));const{results:r}=await e.env.DB.prepare(`SELECT pq.id, pq.body, pq.link_url, pq.hashtags, pq.post_mode, pq.status,
       ...
       FROM auth_logs ORDER BY id DESC LIMIT 10000`).all(),s=U(["id","user_id","email","event_type","ip_address","user_agent","metadata","created_at"],t||[]);return W(s,`ge365x_admin_audit_${P()}.csv`)});M.get("/api/admin/export/admin/all",f,Te,async e=>{const[t,a,s,n,i,r,l]=await Promise.all([e.env.DB.prepare(`SELECT id, email, is_approved, is_admin, trial_start, trial_end, created_at, updated_at
         ...
         FROM x_accounts ORDER BY id DESC LIMIT 10000`).all()]),o={exported_at:new Date().toISOString(),users:t.results||[],user_subscriptions:a.results||[],licenses:s.results||[],auth_logs:n.results||[],post_queue:i.results||[],post_logs:r.results||[],x_accounts:l.results||[]};return is(o,`ge365x_admin_all_${P()}.json`)});const T=new I;T.use("/static/*",Qs({root:"./",manifest:{}}));T.get("/healthz",e=>e.json({ok:!0,service:"ge365x-web",time:new Date().toISOString()}));T.route("/",Na);T.route("/",q);T.route("/",za);T.route("/",Z);T.route("/",fe);T.route("/",he);T.route("/",F);T.route("/",ns);T.route("/",ge);T.route("/",We);T.route("/",ct);T.route("/",ut);T.route("/",Kt);T.route("/",At);T.route("/",It);T.route("/",Dt);T.route("/",Ie);T.route("/",M);T.notFound(e=>e.json({error:"not_found",path:e.req.path},404));T.onError((e,t)=>(console.error("[ge365x-web] error:",e),t.json({error:"internal_error",message:e.message},500)));const ei={fetch:T.fetch,async scheduled(e,t,a){const s=e.cron;(!s||s==="*/1 * * * *")&&a.waitUntil(T.fetch(new Request("https://internal/cron/tick",{method:"POST"}),t,a).catch(n=>console.error("[tick]",n))),s==="*/5 * * * *"&&a.waitUntil(T.fetch(new Request("https://internal/cron/autopilot-tick",{method:"POST"}),t,a).catch(n=>console.error("[autopilot-tick]",n)))}},ua=new I,ti=Object.assign({"/src/index.tsx":ei});let rs=!1;for(const[,e]of Object.entries(ti))e&&(ua.all("*",t=>{let a;try{a=t.executionCtx}catch{}return e.fetch(t.req.raw,t.env,a)}),ua.notFound(t=>{let a;try{a=t.executionCtx}catch{}return e.fetch(t.req.raw,t.env,a)}),rs=!0);if(!rs)throw new Error("Can't import modules from ['/src/index.ts','/src/index.tsx','/app/server.ts']");export{ua as default};
