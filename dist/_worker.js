var is=Object.defineProperty;var Yt=e=>{throw TypeError(e)};var rs=(e,t,a)=>t in e?is(e,t,{enumerable:!0,configurable:!0,writable:!0,value:a}):e[t]=a;var h=(e,t,a)=>rs(e,typeof t!="symbol"?t+"":t,a),At=(e,t,a)=>t.has(e)||Yt("Cannot "+a);var u=(e,t,a)=>(At(e,t,"read from private field"),a?a.call(e):t.get(e)),y=(e,t,a)=>t.has(e)?Yt("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,a),g=(e,t,a,s)=>(At(e,t,"write to private field"),s?s.call(e,a):t.set(e,a),a),w=(e,t,a)=>(At(e,t,"access private method"),a);var Jt=(e,t,a,s)=>({set _(n){g(e,t,n,a)},get _(){return u(e,t,s)}});var Kt=(e,t,a)=>(s,n)=>{let i=-1;return r(0);async function r(o){if(o<=i)throw new Error("next() called multiple times");i=o;let l,d=!1,c;if(e[o]?(c=e[o][0][0],s.req.routeIndex=o):c=o===e.length&&n||void 0,c)try{l=await c(s,()=>r(o+1))}catch(p){if(p instanceof Error&&t)s.error=p,l=await t(p,s),d=!0;else throw p}else s.finalized===!1&&a&&(l=await a(s));return l&&(s.finalized===!1||d)&&(s.res=l),s}},os=Symbol(),ls=async(e,t=Object.create(null))=>{const{all:a=!1,dot:s=!1}=t,i=(e instanceof Ea?e.raw.headers:e.headers).get("Content-Type");return i!=null&&i.startsWith("multipart/form-data")||i!=null&&i.startsWith("application/x-www-form-urlencoded")?ds(e,{all:a,dot:s}):{}};async function ds(e,t){const a=await e.formData();return a?cs(a,t):{}}function cs(e,t){const a=Object.create(null);return e.forEach((s,n)=>{t.all||n.endsWith("[]")?us(a,n,s):a[n]=s}),t.dot&&Object.entries(a).forEach(([s,n])=>{s.includes(".")&&(ps(a,s,n),delete a[s])}),a}var us=(e,t,a)=>{e[t]!==void 0?Array.isArray(e[t])?e[t].push(a):e[t]=[e[t],a]:t.endsWith("[]")?e[t]=[a]:e[t]=a},ps=(e,t,a)=>{if(/(?:^|\.)__proto__\./.test(t))return;let s=e;const n=t.split(".");n.forEach((i,r)=>{r===n.length-1?s[i]=a:((!s[i]||typeof s[i]!="object"||Array.isArray(s[i])||s[i]instanceof File)&&(s[i]=Object.create(null)),s=s[i])})},ga=e=>{const t=e.split("/");return t[0]===""&&t.shift(),t},ms=e=>{const{groups:t,path:a}=fs(e),s=ga(a);return hs(s,t)},fs=e=>{const t=[];return e=e.replace(/\{[^}]+\}/g,(a,s)=>{const n=`@${s}`;return t.push([n,a]),n}),{groups:t,path:e}},hs=(e,t)=>{for(let a=t.length-1;a>=0;a--){const[s]=t[a];for(let n=e.length-1;n>=0;n--)if(e[n].includes(s)){e[n]=e[n].replace(s,t[a][1]);break}}return e},ct={},gs=(e,t)=>{if(e==="*")return"*";const a=e.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);if(a){const s=`${e}#${t}`;return ct[s]||(a[2]?ct[s]=t&&t[0]!==":"&&t[0]!=="*"?[s,a[1],new RegExp(`^${a[2]}(?=/${t})`)]:[e,a[1],new RegExp(`^${a[2]}$`)]:ct[s]=[e,a[1],!0]),ct[s]}return null},Lt=(e,t)=>{try{return t(e)}catch{return e.replace(/(?:%[0-9A-Fa-f]{2})+/g,a=>{try{return t(a)}catch{return a}})}},_a=e=>Lt(e,decodeURI),ba=e=>{const t=e.url,a=t.indexOf("/",t.indexOf(":")+4);let s=a;for(;s<t.length;s++){const n=t.charCodeAt(s);if(n===37){const i=t.indexOf("?",s),r=t.indexOf("#",s),o=i===-1?r===-1?void 0:r:r===-1?i:Math.min(i,r),l=t.slice(a,o);return _a(l.includes("%25")?l.replace(/%25/g,"%2525"):l)}else if(n===63||n===35)break}return t.slice(a,s)},_s=e=>{const t=ba(e);return t.length>1&&t.at(-1)==="/"?t.slice(0,-1):t},Be=(e,t,...a)=>(a.length&&(t=Be(t,...a)),`${(e==null?void 0:e[0])==="/"?"":"/"}${e}${t==="/"?"":`${(e==null?void 0:e.at(-1))==="/"?"":"/"}${(t==null?void 0:t[0])==="/"?t.slice(1):t}`}`),va=e=>{if(e.charCodeAt(e.length-1)!==63||!e.includes(":"))return null;const t=e.split("/"),a=[];let s="";return t.forEach(n=>{if(n!==""&&!/\:/.test(n))s+="/"+n;else if(/\:/.test(n))if(/\?/.test(n)){a.length===0&&s===""?a.push("/"):a.push(s);const i=n.replace("?","");s+="/"+i,a.push(s)}else s+="/"+n}),a.filter((n,i,r)=>r.indexOf(n)===i)},Dt=e=>/[%+]/.test(e)?(e.indexOf("+")!==-1&&(e=e.replace(/\+/g," ")),e.indexOf("%")!==-1?Lt(e,xa):e):e,ya=(e,t,a)=>{let s;if(!a&&t&&!/[%+]/.test(t)){let r=e.indexOf("?",8);if(r===-1)return;for(e.startsWith(t,r+1)||(r=e.indexOf(`&${t}`,r+1));r!==-1;){const o=e.charCodeAt(r+t.length+1);if(o===61){const l=r+t.length+2,d=e.indexOf("&",l);return Dt(e.slice(l,d===-1?void 0:d))}else if(o==38||isNaN(o))return"";r=e.indexOf(`&${t}`,r+1)}if(s=/[%+]/.test(e),!s)return}const n={};s??(s=/[%+]/.test(e));let i=e.indexOf("?",8);for(;i!==-1;){const r=e.indexOf("&",i+1);let o=e.indexOf("=",i);o>r&&r!==-1&&(o=-1);let l=e.slice(i+1,o===-1?r===-1?void 0:r:o);if(s&&(l=Dt(l)),i=r,l==="")continue;let d;o===-1?d="":(d=e.slice(o+1,r===-1?void 0:r),s&&(d=Dt(d))),a?(n[l]&&Array.isArray(n[l])||(n[l]=[]),n[l].push(d)):n[l]??(n[l]=d)}return t?n[t]:n},bs=ya,vs=(e,t)=>ya(e,t,!0),xa=decodeURIComponent,Vt=e=>Lt(e,xa),Ne,J,le,wa,ka,Ot,ce,ca,Ea=(ca=class{constructor(e,t="/",a=[[]]){y(this,le);h(this,"raw");y(this,Ne);y(this,J);h(this,"routeIndex",0);h(this,"path");h(this,"bodyCache",{});y(this,ce,e=>{const{bodyCache:t,raw:a}=this,s=t[e];if(s)return s;const n=Object.keys(t)[0];return n?t[n].then(i=>(n==="json"&&(i=JSON.stringify(i)),new Response(i)[e]())):t[e]=a[e]()});this.raw=e,this.path=t,g(this,J,a),g(this,Ne,{})}param(e){return e?w(this,le,wa).call(this,e):w(this,le,ka).call(this)}query(e){return bs(this.url,e)}queries(e){return vs(this.url,e)}header(e){if(e)return this.raw.headers.get(e)??void 0;const t={};return this.raw.headers.forEach((a,s)=>{t[s]=a}),t}async parseBody(e){return ls(this,e)}json(){return u(this,ce).call(this,"text").then(e=>JSON.parse(e))}text(){return u(this,ce).call(this,"text")}arrayBuffer(){return u(this,ce).call(this,"arrayBuffer")}blob(){return u(this,ce).call(this,"blob")}formData(){return u(this,ce).call(this,"formData")}addValidatedData(e,t){u(this,Ne)[e]=t}valid(e){return u(this,Ne)[e]}get url(){return this.raw.url}get method(){return this.raw.method}get[os](){return u(this,J)}get matchedRoutes(){return u(this,J)[0].map(([[,e]])=>e)}get routePath(){return u(this,J)[0].map(([[,e]])=>e)[this.routeIndex].path}},Ne=new WeakMap,J=new WeakMap,le=new WeakSet,wa=function(e){const t=u(this,J)[0][this.routeIndex][1][e],a=w(this,le,Ot).call(this,t);return a&&/\%/.test(a)?Vt(a):a},ka=function(){const e={},t=Object.keys(u(this,J)[0][this.routeIndex][1]);for(const a of t){const s=w(this,le,Ot).call(this,u(this,J)[0][this.routeIndex][1][a]);s!==void 0&&(e[a]=/\%/.test(s)?Vt(s):s)}return e},Ot=function(e){return u(this,J)[1]?u(this,J)[1][e]:e},ce=new WeakMap,ca),ys={Stringify:1},Sa=async(e,t,a,s,n)=>{typeof e=="object"&&!(e instanceof String)&&(e instanceof Promise||(e=e.toString()),e instanceof Promise&&(e=await e));const i=e.callbacks;return i!=null&&i.length?(n?n[0]+=e:n=[e],Promise.all(i.map(o=>o({phase:t,buffer:n,context:s}))).then(o=>Promise.all(o.filter(Boolean).map(l=>Sa(l,t,!1,s,n))).then(()=>n[0]))):Promise.resolve(e)},xs="text/plain; charset=UTF-8",It=(e,t)=>({"Content-Type":e,...t}),Je=(e,t)=>new Response(e,t),tt,at,se,Me,ne,M,st,$e,Fe,Ee,nt,it,ue,Ce,ua,Es=(ua=class{constructor(e,t){y(this,ue);y(this,tt);y(this,at);h(this,"env",{});y(this,se);h(this,"finalized",!1);h(this,"error");y(this,Me);y(this,ne);y(this,M);y(this,st);y(this,$e);y(this,Fe);y(this,Ee);y(this,nt);y(this,it);h(this,"render",(...e)=>(u(this,$e)??g(this,$e,t=>this.html(t)),u(this,$e).call(this,...e)));h(this,"setLayout",e=>g(this,st,e));h(this,"getLayout",()=>u(this,st));h(this,"setRenderer",e=>{g(this,$e,e)});h(this,"header",(e,t,a)=>{this.finalized&&g(this,M,Je(u(this,M).body,u(this,M)));const s=u(this,M)?u(this,M).headers:u(this,Ee)??g(this,Ee,new Headers);t===void 0?s.delete(e):a!=null&&a.append?s.append(e,t):s.set(e,t)});h(this,"status",e=>{g(this,Me,e)});h(this,"set",(e,t)=>{u(this,se)??g(this,se,new Map),u(this,se).set(e,t)});h(this,"get",e=>u(this,se)?u(this,se).get(e):void 0);h(this,"newResponse",(...e)=>w(this,ue,Ce).call(this,...e));h(this,"body",(e,t,a)=>w(this,ue,Ce).call(this,e,t,a));h(this,"text",(e,t,a)=>!u(this,Ee)&&!u(this,Me)&&!t&&!a&&!this.finalized?new Response(e):w(this,ue,Ce).call(this,e,t,It(xs,a)));h(this,"json",(e,t,a)=>w(this,ue,Ce).call(this,JSON.stringify(e),t,It("application/json",a)));h(this,"html",(e,t,a)=>{const s=n=>w(this,ue,Ce).call(this,n,t,It("text/html; charset=UTF-8",a));return typeof e=="object"?Sa(e,ys.Stringify,!1,{}).then(s):s(e)});h(this,"redirect",(e,t)=>{const a=String(e);return this.header("Location",/[^\x00-\xFF]/.test(a)?encodeURI(a):a),this.newResponse(null,t??302)});h(this,"notFound",()=>(u(this,Fe)??g(this,Fe,()=>Je()),u(this,Fe).call(this,this)));g(this,tt,e),t&&(g(this,ne,t.executionCtx),this.env=t.env,g(this,Fe,t.notFoundHandler),g(this,it,t.path),g(this,nt,t.matchResult))}get req(){return u(this,at)??g(this,at,new Ea(u(this,tt),u(this,it),u(this,nt))),u(this,at)}get event(){if(u(this,ne)&&"respondWith"in u(this,ne))return u(this,ne);throw Error("This context has no FetchEvent")}get executionCtx(){if(u(this,ne))return u(this,ne);throw Error("This context has no ExecutionContext")}get res(){return u(this,M)||g(this,M,Je(null,{headers:u(this,Ee)??g(this,Ee,new Headers)}))}set res(e){if(u(this,M)&&e){e=Je(e.body,e);for(const[t,a]of u(this,M).headers.entries())if(t!=="content-type")if(t==="set-cookie"){const s=u(this,M).headers.getSetCookie();e.headers.delete("set-cookie");for(const n of s)e.headers.append("set-cookie",n)}else e.headers.set(t,a)}g(this,M,e),this.finalized=!0}get var(){return u(this,se)?Object.fromEntries(u(this,se)):{}}},tt=new WeakMap,at=new WeakMap,se=new WeakMap,Me=new WeakMap,ne=new WeakMap,M=new WeakMap,st=new WeakMap,$e=new WeakMap,Fe=new WeakMap,Ee=new WeakMap,nt=new WeakMap,it=new WeakMap,ue=new WeakSet,Ce=function(e,t,a){const s=u(this,M)?new Headers(u(this,M).headers):u(this,Ee)??new Headers;if(typeof t=="object"&&"headers"in t){const i=t.headers instanceof Headers?t.headers:new Headers(t.headers);for(const[r,o]of i)r.toLowerCase()==="set-cookie"?s.append(r,o):s.set(r,o)}if(a)for(const[i,r]of Object.entries(a))if(typeof r=="string")s.set(i,r);else{s.delete(i);for(const o of r)s.append(i,o)}const n=typeof t=="number"?t:(t==null?void 0:t.status)??u(this,Me);return Je(e,{status:n,headers:s})},ua),O="ALL",ws="all",ks=["get","post","put","delete","options","patch"],Ta="Can not add a route since the matcher is already built.",Aa=class extends Error{},Ss="__COMPOSED_HANDLER",Ts=e=>e.text("404 Not Found",404),Xt=(e,t)=>{if("getResponse"in e){const a=e.getResponse();return t.newResponse(a.body,a)}return console.error(e),t.text("Internal Server Error",500)},V,R,Da,X,ye,pt,mt,Pe,As=(Pe=class{constructor(t={}){y(this,R);h(this,"get");h(this,"post");h(this,"put");h(this,"delete");h(this,"options");h(this,"patch");h(this,"all");h(this,"on");h(this,"use");h(this,"router");h(this,"getPath");h(this,"_basePath","/");y(this,V,"/");h(this,"routes",[]);y(this,X,Ts);h(this,"errorHandler",Xt);h(this,"onError",t=>(this.errorHandler=t,this));h(this,"notFound",t=>(g(this,X,t),this));h(this,"fetch",(t,...a)=>w(this,R,mt).call(this,t,a[1],a[0],t.method));h(this,"request",(t,a,s,n)=>t instanceof Request?this.fetch(a?new Request(t,a):t,s,n):(t=t.toString(),this.fetch(new Request(/^https?:\/\//.test(t)?t:`http://localhost${Be("/",t)}`,a),s,n)));h(this,"fire",()=>{addEventListener("fetch",t=>{t.respondWith(w(this,R,mt).call(this,t.request,t,void 0,t.request.method))})});[...ks,ws].forEach(i=>{this[i]=(r,...o)=>(typeof r=="string"?g(this,V,r):w(this,R,ye).call(this,i,u(this,V),r),o.forEach(l=>{w(this,R,ye).call(this,i,u(this,V),l)}),this)}),this.on=(i,r,...o)=>{for(const l of[r].flat()){g(this,V,l);for(const d of[i].flat())o.map(c=>{w(this,R,ye).call(this,d.toUpperCase(),u(this,V),c)})}return this},this.use=(i,...r)=>(typeof i=="string"?g(this,V,i):(g(this,V,"*"),r.unshift(i)),r.forEach(o=>{w(this,R,ye).call(this,O,u(this,V),o)}),this);const{strict:s,...n}=t;Object.assign(this,n),this.getPath=s??!0?t.getPath??ba:_s}route(t,a){const s=this.basePath(t);return a.routes.map(n=>{var r;let i;a.errorHandler===Xt?i=n.handler:(i=async(o,l)=>(await Kt([],a.errorHandler)(o,()=>n.handler(o,l))).res,i[Ss]=n.handler),w(r=s,R,ye).call(r,n.method,n.path,i)}),this}basePath(t){const a=w(this,R,Da).call(this);return a._basePath=Be(this._basePath,t),a}mount(t,a,s){let n,i;s&&(typeof s=="function"?i=s:(i=s.optionHandler,s.replaceRequest===!1?n=l=>l:n=s.replaceRequest));const r=i?l=>{const d=i(l);return Array.isArray(d)?d:[d]}:l=>{let d;try{d=l.executionCtx}catch{}return[l.env,d]};n||(n=(()=>{const l=Be(this._basePath,t),d=l==="/"?0:l.length;return c=>{const p=new URL(c.url);return p.pathname=p.pathname.slice(d)||"/",new Request(p,c)}})());const o=async(l,d)=>{const c=await a(n(l.req.raw),...r(l));if(c)return c;await d()};return w(this,R,ye).call(this,O,Be(t,"*"),o),this}},V=new WeakMap,R=new WeakSet,Da=function(){const t=new Pe({router:this.router,getPath:this.getPath});return t.errorHandler=this.errorHandler,g(t,X,u(this,X)),t.routes=this.routes,t},X=new WeakMap,ye=function(t,a,s){t=t.toUpperCase(),a=Be(this._basePath,a);const n={basePath:this._basePath,path:a,method:t,handler:s};this.router.add(t,a,[s,n]),this.routes.push(n)},pt=function(t,a){if(t instanceof Error)return this.errorHandler(t,a);throw t},mt=function(t,a,s,n){if(n==="HEAD")return(async()=>new Response(null,await w(this,R,mt).call(this,t,a,s,"GET")))();const i=this.getPath(t,{env:s}),r=this.router.match(n,i),o=new Es(t,{path:i,matchResult:r,env:s,executionCtx:a,notFoundHandler:u(this,X)});if(r[0].length===1){let d;try{d=r[0][0][0][0](o,async()=>{o.res=await u(this,X).call(this,o)})}catch(c){return w(this,R,pt).call(this,c,o)}return d instanceof Promise?d.then(c=>c||(o.finalized?o.res:u(this,X).call(this,o))).catch(c=>w(this,R,pt).call(this,c,o)):d??u(this,X).call(this,o)}const l=Kt(r[0],this.errorHandler,u(this,X));return(async()=>{try{const d=await l(o);if(!d.finalized)throw new Error("Context is not finalized. Did you forget to return a Response object or `await next()`?");return d.res}catch(d){return w(this,R,pt).call(this,d,o)}})()},Pe),Ia=[];function Ds(e,t){const a=this.buildAllMatchers(),s=((n,i)=>{const r=a[n]||a[O],o=r[2][i];if(o)return o;const l=i.match(r[0]);if(!l)return[[],Ia];const d=l.indexOf("",1);return[r[1][d],l]});return this.match=s,s(e,t)}var gt="[^/]+",Xe=".*",Ge="(?:|/.*)",Le=Symbol(),Is=new Set(".\\+*[^]$()");function Os(e,t){return e.length===1?t.length===1?e<t?-1:1:-1:t.length===1||e===Xe||e===Ge?1:t===Xe||t===Ge?-1:e===gt?1:t===gt?-1:e.length===t.length?e<t?-1:1:t.length-e.length}var we,ke,G,Ae,Rs=(Ae=class{constructor(){y(this,we);y(this,ke);y(this,G,Object.create(null))}insert(t,a,s,n,i){if(t.length===0){if(u(this,we)!==void 0)throw Le;if(i)return;g(this,we,a);return}const[r,...o]=t,l=r==="*"?o.length===0?["","",Xe]:["","",gt]:r==="/*"?["","",Ge]:r.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);let d;if(l){const c=l[1];let p=l[2]||gt;if(c&&l[2]&&(p===".*"||(p=p.replace(/^\((?!\?:)(?=[^)]+\)$)/,"(?:"),/\((?!\?:)/.test(p))))throw Le;if(d=u(this,G)[p],!d){if(Object.keys(u(this,G)).some(f=>f!==Xe&&f!==Ge))throw Le;if(i)return;d=u(this,G)[p]=new Ae,c!==""&&g(d,ke,n.varIndex++)}!i&&c!==""&&s.push([c,u(d,ke)])}else if(d=u(this,G)[r],!d){if(Object.keys(u(this,G)).some(c=>c.length>1&&c!==Xe&&c!==Ge))throw Le;if(i)return;d=u(this,G)[r]=new Ae}d.insert(o,a,s,n,i)}buildRegExpStr(){const a=Object.keys(u(this,G)).sort(Os).map(s=>{const n=u(this,G)[s];return(typeof u(n,ke)=="number"?`(${s})@${u(n,ke)}`:Is.has(s)?`\\${s}`:s)+n.buildRegExpStr()});return typeof u(this,we)=="number"&&a.unshift(`#${u(this,we)}`),a.length===0?"":a.length===1?a[0]:"(?:"+a.join("|")+")"}},we=new WeakMap,ke=new WeakMap,G=new WeakMap,Ae),bt,rt,pa,js=(pa=class{constructor(){y(this,bt,{varIndex:0});y(this,rt,new Rs)}insert(e,t,a){const s=[],n=[];for(let r=0;;){let o=!1;if(e=e.replace(/\{[^}]+\}/g,l=>{const d=`@\\${r}`;return n[r]=[d,l],r++,o=!0,d}),!o)break}const i=e.match(/(?::[^\/]+)|(?:\/\*$)|./g)||[];for(let r=n.length-1;r>=0;r--){const[o]=n[r];for(let l=i.length-1;l>=0;l--)if(i[l].indexOf(o)!==-1){i[l]=i[l].replace(o,n[r][1]);break}}return u(this,rt).insert(i,t,s,u(this,bt),a),s}buildRegExp(){let e=u(this,rt).buildRegExpStr();if(e==="")return[/^$/,[],[]];let t=0;const a=[],s=[];return e=e.replace(/#(\d+)|@(\d+)|\.\*\$/g,(n,i,r)=>i!==void 0?(a[++t]=Number(i),"$()"):(r!==void 0&&(s[Number(r)]=++t),"")),[new RegExp(`^${e}`),a,s]}},bt=new WeakMap,rt=new WeakMap,pa),Bs=[/^$/,[],Object.create(null)],ft=Object.create(null);function Oa(e){return ft[e]??(ft[e]=new RegExp(e==="*"?"":`^${e.replace(/\/\*$|([.\\+*[^\]$()])/g,(t,a)=>a?`\\${a}`:"(?:|/.*)")}$`))}function Cs(){ft=Object.create(null)}function Ls(e){var d;const t=new js,a=[];if(e.length===0)return Bs;const s=e.map(c=>[!/\*|\/:/.test(c[0]),...c]).sort(([c,p],[f,_])=>c?1:f?-1:p.length-_.length),n=Object.create(null);for(let c=0,p=-1,f=s.length;c<f;c++){const[_,v,T]=s[c];_?n[v]=[T.map(([A])=>[A,Object.create(null)]),Ia]:p++;let E;try{E=t.insert(v,p,_)}catch(A){throw A===Le?new Aa(v):A}_||(a[p]=T.map(([A,k])=>{const L=Object.create(null);for(k-=1;k>=0;k--){const[q,N]=E[k];L[q]=N}return[A,L]}))}const[i,r,o]=t.buildRegExp();for(let c=0,p=a.length;c<p;c++)for(let f=0,_=a[c].length;f<_;f++){const v=(d=a[c][f])==null?void 0:d[1];if(!v)continue;const T=Object.keys(v);for(let E=0,A=T.length;E<A;E++)v[T[E]]=o[v[T[E]]]}const l=[];for(const c in r)l[c]=a[r[c]];return[i,l,n]}function je(e,t){if(e){for(const a of Object.keys(e).sort((s,n)=>n.length-s.length))if(Oa(a).test(t))return[...e[a]]}}var pe,me,vt,Ra,ma,Ns=(ma=class{constructor(){y(this,vt);h(this,"name","RegExpRouter");y(this,pe);y(this,me);h(this,"match",Ds);g(this,pe,{[O]:Object.create(null)}),g(this,me,{[O]:Object.create(null)})}add(e,t,a){var o;const s=u(this,pe),n=u(this,me);if(!s||!n)throw new Error(Ta);s[e]||[s,n].forEach(l=>{l[e]=Object.create(null),Object.keys(l[O]).forEach(d=>{l[e][d]=[...l[O][d]]})}),t==="/*"&&(t="*");const i=(t.match(/\/:/g)||[]).length;if(/\*$/.test(t)){const l=Oa(t);e===O?Object.keys(s).forEach(d=>{var c;(c=s[d])[t]||(c[t]=je(s[d],t)||je(s[O],t)||[])}):(o=s[e])[t]||(o[t]=je(s[e],t)||je(s[O],t)||[]),Object.keys(s).forEach(d=>{(e===O||e===d)&&Object.keys(s[d]).forEach(c=>{l.test(c)&&s[d][c].push([a,i])})}),Object.keys(n).forEach(d=>{(e===O||e===d)&&Object.keys(n[d]).forEach(c=>l.test(c)&&n[d][c].push([a,i]))});return}const r=va(t)||[t];for(let l=0,d=r.length;l<d;l++){const c=r[l];Object.keys(n).forEach(p=>{var f;(e===O||e===p)&&((f=n[p])[c]||(f[c]=[...je(s[p],c)||je(s[O],c)||[]]),n[p][c].push([a,i-d+l+1]))})}}buildAllMatchers(){const e=Object.create(null);return Object.keys(u(this,me)).concat(Object.keys(u(this,pe))).forEach(t=>{e[t]||(e[t]=w(this,vt,Ra).call(this,t))}),g(this,pe,g(this,me,void 0)),Cs(),e}},pe=new WeakMap,me=new WeakMap,vt=new WeakSet,Ra=function(e){const t=[];let a=e===O;return[u(this,pe),u(this,me)].forEach(s=>{const n=s[e]?Object.keys(s[e]).map(i=>[i,s[e][i]]):[];n.length!==0?(a||(a=!0),t.push(...n)):e!==O&&t.push(...Object.keys(s[O]).map(i=>[i,s[O][i]]))}),a?Ls(t):null},ma),fe,ie,fa,Ms=(fa=class{constructor(e){h(this,"name","SmartRouter");y(this,fe,[]);y(this,ie,[]);g(this,fe,e.routers)}add(e,t,a){if(!u(this,ie))throw new Error(Ta);u(this,ie).push([e,t,a])}match(e,t){if(!u(this,ie))throw new Error("Fatal error");const a=u(this,fe),s=u(this,ie),n=a.length;let i=0,r;for(;i<n;i++){const o=a[i];try{for(let l=0,d=s.length;l<d;l++)o.add(...s[l]);r=o.match(e,t)}catch(l){if(l instanceof Aa)continue;throw l}this.match=o.match.bind(o),g(this,fe,[o]),g(this,ie,void 0);break}if(i===n)throw new Error("Fatal error");return this.name=`SmartRouter + ${this.activeRouter.name}`,r}get activeRouter(){if(u(this,ie)||u(this,fe).length!==1)throw new Error("No active router has been determined yet.");return u(this,fe)[0]}},fe=new WeakMap,ie=new WeakMap,fa),Ke=Object.create(null),$s=e=>{for(const t in e)return!0;return!1},he,B,Se,qe,j,re,xe,He,Fs=(He=class{constructor(t,a,s){y(this,re);y(this,he);y(this,B);y(this,Se);y(this,qe,0);y(this,j,Ke);if(g(this,B,s||Object.create(null)),g(this,he,[]),t&&a){const n=Object.create(null);n[t]={handler:a,possibleKeys:[],score:0},g(this,he,[n])}g(this,Se,[])}insert(t,a,s){g(this,qe,++Jt(this,qe)._);let n=this;const i=ms(a),r=[];for(let o=0,l=i.length;o<l;o++){const d=i[o],c=i[o+1],p=gs(d,c),f=Array.isArray(p)?p[0]:d;if(f in u(n,B)){n=u(n,B)[f],p&&r.push(p[1]);continue}u(n,B)[f]=new He,p&&(u(n,Se).push(p),r.push(p[1])),n=u(n,B)[f]}return u(n,he).push({[t]:{handler:s,possibleKeys:r.filter((o,l,d)=>d.indexOf(o)===l),score:u(this,qe)}}),n}search(t,a){var c;const s=[];g(this,j,Ke);let i=[this];const r=ga(a),o=[],l=r.length;let d=null;for(let p=0;p<l;p++){const f=r[p],_=p===l-1,v=[];for(let E=0,A=i.length;E<A;E++){const k=i[E],L=u(k,B)[f];L&&(g(L,j,u(k,j)),_?(u(L,B)["*"]&&w(this,re,xe).call(this,s,u(L,B)["*"],t,u(k,j)),w(this,re,xe).call(this,s,L,t,u(k,j))):v.push(L));for(let q=0,N=u(k,Se).length;q<N;q++){const dt=u(k,Se)[q],Q=u(k,j)===Ke?{}:{...u(k,j)};if(dt==="*"){const Oe=u(k,B)["*"];Oe&&(w(this,re,xe).call(this,s,Oe,t,u(k,j)),g(Oe,j,Q),v.push(Oe));continue}const[ns,zt,ze]=dt;if(!f&&!(ze instanceof RegExp))continue;const ae=u(k,B)[ns];if(ze instanceof RegExp){if(d===null){d=new Array(l);let Re=a[0]==="/"?1:0;for(let Ye=0;Ye<l;Ye++)d[Ye]=Re,Re+=r[Ye].length+1}const Oe=a.substring(d[p]),Tt=ze.exec(Oe);if(Tt){if(Q[zt]=Tt[0],w(this,re,xe).call(this,s,ae,t,u(k,j),Q),$s(u(ae,B))){g(ae,j,Q);const Re=((c=Tt[0].match(/\//))==null?void 0:c.length)??0;(o[Re]||(o[Re]=[])).push(ae)}continue}}(ze===!0||ze.test(f))&&(Q[zt]=f,_?(w(this,re,xe).call(this,s,ae,t,Q,u(k,j)),u(ae,B)["*"]&&w(this,re,xe).call(this,s,u(ae,B)["*"],t,Q,u(k,j))):(g(ae,j,Q),v.push(ae)))}}const T=o.shift();i=T?v.concat(T):v}return s.length>1&&s.sort((p,f)=>p.score-f.score),[s.map(({handler:p,params:f})=>[p,f])]}},he=new WeakMap,B=new WeakMap,Se=new WeakMap,qe=new WeakMap,j=new WeakMap,re=new WeakSet,xe=function(t,a,s,n,i){for(let r=0,o=u(a,he).length;r<o;r++){const l=u(a,he)[r],d=l[s]||l[O],c={};if(d!==void 0&&(d.params=Object.create(null),t.push(d),n!==Ke||i&&i!==Ke))for(let p=0,f=d.possibleKeys.length;p<f;p++){const _=d.possibleKeys[p],v=c[d.score];d.params[_]=i!=null&&i[_]&&!v?i[_]:n[_]??(i==null?void 0:i[_]),c[d.score]=!0}}},He),Te,ha,Ps=(ha=class{constructor(){h(this,"name","TrieRouter");y(this,Te);g(this,Te,new Fs)}add(e,t,a){const s=va(t);if(s){for(let n=0,i=s.length;n<i;n++)u(this,Te).insert(e,s[n],a);return}u(this,Te).insert(e,t,a)}match(e,t){return u(this,Te).search(e,t)}},Te=new WeakMap,ha),D=class extends As{constructor(e={}){super(e),this.router=e.router??new Ms({routers:[new Ns,new Ps]})}},qs=/^\s*(?:text\/(?!event-stream(?:[;\s]|$))[^;\s]+|application\/(?:javascript|json|xml|xml-dtd|ecmascript|dart|postscript|rtf|tar|toml|vnd\.dart|vnd\.ms-fontobject|vnd\.ms-opentype|wasm|x-httpd-php|x-javascript|x-ns-proxy-autoconfig|x-sh|x-tar|x-virtualbox-hdd|x-virtualbox-ova|x-virtualbox-ovf|x-virtualbox-vbox|x-virtualbox-vdi|x-virtualbox-vhd|x-virtualbox-vmdk|x-www-form-urlencoded)|font\/(?:otf|ttf)|image\/(?:bmp|vnd\.adobe\.photoshop|vnd\.microsoft\.icon|vnd\.ms-dds|x-icon|x-ms-bmp)|message\/rfc822|model\/gltf-binary|x-shader\/x-fragment|x-shader\/x-vertex|[^;\s]+?\+(?:json|text|xml|yaml))(?:[;\s]|$)/i,Gt=(e,t=Us)=>{const a=/\.([a-zA-Z0-9]+?)$/,s=e.match(a);if(!s)return;let n=t[s[1].toLowerCase()];return n&&n.startsWith("text")&&(n+="; charset=utf-8"),n},Hs={aac:"audio/aac",avi:"video/x-msvideo",avif:"image/avif",av1:"video/av1",bin:"application/octet-stream",bmp:"image/bmp",css:"text/css",csv:"text/csv",eot:"application/vnd.ms-fontobject",epub:"application/epub+zip",gif:"image/gif",gz:"application/gzip",htm:"text/html",html:"text/html",ico:"image/x-icon",ics:"text/calendar",jpeg:"image/jpeg",jpg:"image/jpeg",js:"text/javascript",json:"application/json",jsonld:"application/ld+json",map:"application/json",mid:"audio/x-midi",midi:"audio/x-midi",mjs:"text/javascript",mp3:"audio/mpeg",mp4:"video/mp4",mpeg:"video/mpeg",oga:"audio/ogg",ogv:"video/ogg",ogx:"application/ogg",opus:"audio/opus",otf:"font/otf",pdf:"application/pdf",png:"image/png",rtf:"application/rtf",svg:"image/svg+xml",tif:"image/tiff",tiff:"image/tiff",ts:"video/mp2t",ttf:"font/ttf",txt:"text/plain",wasm:"application/wasm",webm:"video/webm",weba:"audio/webm",webmanifest:"application/manifest+json",webp:"image/webp",woff:"font/woff",woff2:"font/woff2",xhtml:"application/xhtml+xml",xml:"application/xml",zip:"application/zip","3gp":"video/3gpp","3g2":"video/3gpp2",gltf:"model/gltf+json",glb:"model/gltf-binary"},Us=Hs,Ws=(...e)=>{let t=e.filter(n=>n!=="").join("/");t=t.replace(new RegExp("(?<=\\/)\\/+","g"),"");const a=t.split("/"),s=[];for(const n of a)n===".."&&s.length>0&&s.at(-1)!==".."?s.pop():n!=="."&&s.push(n);return s.join("/")||"."},ja={br:".br",zstd:".zst",gzip:".gz"},zs=Object.keys(ja),Ys="index.html",Js=e=>{const t=e.root??"./",a=e.path,s=e.join??Ws;return async(n,i)=>{var c,p,f,_;if(n.finalized)return i();let r;if(e.path)r=e.path;else try{if(r=_a(n.req.path),/(?:^|[\/\\])\.{1,2}(?:$|[\/\\])|[\/\\]{2,}/.test(r))throw new Error}catch{return await((c=e.onNotFound)==null?void 0:c.call(e,n.req.path,n)),i()}let o=s(t,!a&&e.rewriteRequestPath?e.rewriteRequestPath(r):r);e.isDir&&await e.isDir(o)&&(o=s(o,Ys));const l=e.getContent;let d=await l(o,n);if(d instanceof Response)return n.newResponse(d.body,d);if(d){const v=e.mimes&&Gt(o,e.mimes)||Gt(o);if(n.header("Content-Type",v||"application/octet-stream"),e.precompressed&&(!v||qs.test(v))){const T=new Set((p=n.req.header("Accept-Encoding"))==null?void 0:p.split(",").map(E=>E.trim()));for(const E of zs){if(!T.has(E))continue;const A=await l(o+ja[E],n);if(A){d=A,n.header("Content-Encoding",E),n.header("Vary","Accept-Encoding",{append:!0});break}}}return await((f=e.onFound)==null?void 0:f.call(e,o,n)),n.body(d)}await((_=e.onNotFound)==null?void 0:_.call(e,o,n)),await i()}},Ks=async(e,t)=>{let a;t&&t.manifest?typeof t.manifest=="string"?a=JSON.parse(t.manifest):a=t.manifest:typeof __STATIC_CONTENT_MANIFEST=="string"?a=JSON.parse(__STATIC_CONTENT_MANIFEST):a=__STATIC_CONTENT_MANIFEST;let s;t&&t.namespace?s=t.namespace:s=__STATIC_CONTENT;const n=a[e];if(!n)return null;const i=await s.get(n,{type:"stream"});return i||null},Vs=e=>async function(a,s){return Js({...e,getContent:async i=>Ks(i,{manifest:e.manifest,namespace:e.namespace?e.namespace:a.env?a.env.__STATIC_CONTENT:void 0})})(a,s)},Xs=e=>Vs(e);const W={name:"Growth-engine365X",version:"ver1.00",tagline:"X (Twitter) 自動投稿プラットフォーム",longName:"X (Twitter) 自動投稿プラットフォーム",icon:"fa-bolt"},Gs=`
<meta charset="utf-8">
...
`,Zs="bg-paper text-ink min-h-screen font-sans antialiased";function Nt(e,t,a={}){return`<!DOCTYPE html>
<html lang="ja">
<head>
${Gs}
...
<\/script>
`;return e.html(Nt("ログイン",t))});const oe=new TextEncoder,Ca=new TextDecoder;function Ze(e){let t="";for(let a=0;a<e.length;a++)t+=String.fromCharCode(e[a]);return btoa(t)}function Qe(e){const t=atob(e),a=new Uint8Array(t.length);for(let s=0;s<t.length;s++)a[s]=t.charCodeAt(s);return a}function ht(e){return Ze(e).replace(/\+/g,"-").replace(/\//g,"_").replace(/=+$/,"")}function Rt(e){const t="=".repeat((4-e.length%4)%4);return Qe((e+t).replace(/-/g,"+").replace(/_/g,"/"))}function yt(e){const t=new Uint8Array(e);return crypto.getRandomValues(t),t}const Zt=1e5,Qs=32;async function xt(e){const t=yt(16),a=await crypto.subtle.importKey("raw",oe.encode(e),{name:"PBKDF2"},!1,["deriveBits"]),s=await crypto.subtle.deriveBits({name:"PBKDF2",salt:t,iterations:Zt,hash:"SHA-256"},a,Qs*8);return`pbkdf2$${Zt}$${Ze(t)}$${Ze(new Uint8Array(s))}`}async function Mt(e,t){try{const[a,s,n,i]=t.split("$");if(a!=="pbkdf2")return!1;const r=parseInt(s,10),o=Qe(n),l=Qe(i),d=await crypto.subtle.importKey("raw",oe.encode(e),{name:"PBKDF2"},!1,["deriveBits"]),c=new Uint8Array(await crypto.subtle.deriveBits({name:"PBKDF2",salt:o,iterations:r,hash:"SHA-256"},d,l.length*8));return La(c,l)}catch{return!1}}function La(e,t){if(e.length!==t.length)return!1;let a=0;for(let s=0;s<e.length;s++)a|=e[s]^t[s];return a===0}async function Na(e){return crypto.subtle.importKey("raw",oe.encode(e),{name:"HMAC",hash:"SHA-256"},!1,["sign","verify"])}async function Ma(e,t,a=3600*24*7){const s=Math.floor(Date.now()/1e3),n={iat:s,exp:s+a,...e},i=ht(oe.encode(JSON.stringify({alg:"HS256",typ:"JWT"}))),r=ht(oe.encode(JSON.stringify(n))),o=`${i}.${r}`,l=await Na(t),d=new Uint8Array(await crypto.subtle.sign("HMAC",l,oe.encode(o)));return`${o}.${ht(d)}`}async function $a(e,t){try{const[a,s,n]=e.split(".");if(!a||!s||!n)return null;const i=await Na(t);if(!await crypto.subtle.verify("HMAC",i,Rt(n),oe.encode(`${a}.${s}`)))return null;const o=JSON.parse(Ca.decode(Rt(s)));return o.exp&&o.exp<Math.floor(Date.now()/1e3)?null:o}catch{return null}}async function Fa(e){const t=oe.encode(e),a=t.length>=32?t.slice(0,32):new Uint8Array(await crypto.subtle.digest("SHA-256",t));return crypto.subtle.importKey("raw",a,{name:"AES-GCM"},!1,["encrypt","decrypt"])}async function ee(e,t){const a=yt(12),s=await Fa(t),n=new Uint8Array(await crypto.subtle.encrypt({name:"AES-GCM",iv:a},s,oe.encode(e))),i=new Uint8Array(a.length+n.length);return i.set(a),i.set(n,a.length),Ze(i)}async function et(e,t){const a=Qe(e),s=a.slice(0,12),n=a.slice(12),i=await Fa(t),r=await crypto.subtle.decrypt({name:"AES-GCM",iv:s},i,n);return Ca.decode(r)}const Qt="ABCDEFGHJKLMNPQRSTUVWXYZ23456789";function jt(e="VPS-GE365X"){const t=yt(8);let a="";for(let s=0;s<8;s++)a+=Qt[t[s]%Qt.length];return`${e}-${a}`}function Pa(e){return/^VPS-GE365X-[A-Z0-9]{6,12}$/i.test(e.trim())}function b(){return new Date(Date.now()+324e5).toISOString().replace("T"," ").slice(0,19)}function qa(e,t){const s=(e.headers.get("cookie")||"").split(";").map(n=>n.trim()).find(n=>n.startsWith(t+"="));return s?decodeURIComponent(s.slice(t.length+1)):null}function $t(e,t,a={}){const s=[`${e}=${encodeURIComponent(t)}`];return s.push(`Path=${a.path??"/"}`),a.maxAge!==void 0&&s.push(`Max-Age=${a.maxAge}`),a.httpOnly!==!1&&s.push("HttpOnly"),a.secure!==!1&&s.push("Secure"),s.push(`SameSite=${a.sameSite??"Lax"}`),s.join("; ")}const Ha=Object.freeze(Object.defineProperty({__proto__:null,aesDecrypt:et,aesEncrypt:ee,b64decode:Qe,b64encode:Ze,b64urlDecode:Rt,b64urlEncode:ht,buildSetCookie:$t,generateLicenseKey:jt,getCookie:qa,hashPassword:xt,isValidLicenseKeyFormat:Pa,nowJst:b,randomBytes:yt,signJWT:Ma,timingSafeEqual:La,verifyJWT:$a,verifyPassword:Mt},Symbol.toStringTag,{value:"Module"})),Ft="ge365x_session";function en(e){const t=e.req.header("Authorization")||e.req.header("authorization");return t&&t.startsWith("Bearer ")?t.slice(7):qa(e.req.raw,Ft)}async function m(e,t){const a=en(e);if(!a)return e.json({error:"unauthenticated"},401);const s=await $a(a,e.env.JWT_SECRET);if(!(s!=null&&s.uid))return e.json({error:"invalid_token"},401);const n=await e.env.DB.prepare("SELECT id,email,is_approved,is_admin,trial_start,trial_end FROM users WHERE id = ?").bind(s.uid).first();if(!n)return e.json({error:"user_not_found"},401);if(n.is_approved===0)return e.json({error:"not_approved"},403);const i=await e.env.DB.prepare("SELECT plan_code,status FROM user_subscriptions WHERE user_id = ?").bind(n.id).first(),r={id:n.id,email:n.email,is_admin:n.is_admin===1,is_approved:n.is_approved===1,plan_code:i==null?void 0:i.plan_code,subscription_status:i==null?void 0:i.status};e.set("user",r),await t()}async function I(e,t){const a=e.get("user");if(!a)return e.json({error:"unauthenticated"},401);if(!a.is_admin)return e.json({error:"forbidden"},403);await t()}async function Z(e,t,a={}){const s=e.req.header("cf-connecting-ip")||e.req.header("x-forwarded-for")||"",n=e.req.header("user-agent")||"";await e.env.DB.prepare(`INSERT INTO auth_logs (user_id, email, event_type, ip_address, user_agent, metadata)
     VALUES (?, ?, ?, ?, ?, ?)`).bind(a.userId??null,a.email??null,t,s,n,a.metadata?JSON.stringify(a.metadata):null).run()}const tn=[{key:"dashboard",label:"ダッシュボード",icon:"fa-gauge-high",path:"/dashboard"},{key:"target",label:"ターゲット設定",icon:"fa-bullseye",path:"/dashboard/target"},{key:"voice",label:"ブランドボイス",icon:"fa-palette",path:"/dashboard/voice"},{key:"pattern",label:"パターン別AI生成",icon:"fa-wand-magic-sparkles",path:"/dashboard/pattern"},{key:"generate",label:"AI生成2",icon:"fa-robot",path:"/dashboard/generate"},{key:"posts",label:"X投稿管理",icon:"fa-brands fa-x-twitter",path:"/dashboard/posts"},{key:"thread",label:"ツリー投稿",icon:"fa-reply",path:"/dashboard/thread"},{key:"scheduled",label:"予約状況",icon:"fa-calendar",path:"/dashboard/scheduled"},{key:"autopilot",label:"オートパイロット",icon:"fa-plane-departure",path:"/dashboard/autopilot"},{key:"accounts",label:"アカウント管理",icon:"fa-users-gear",path:"/dashboard/accounts"},{key:"api",label:"API設定",icon:"fa-key",path:"/dashboard/api"},{key:"export",label:"一括ダウンロード",icon:"fa-download",path:"/dashboard/export"}];function an(e,t){return`
...
`;function x(e){return(e||"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}function Ua(e){return{pending:'<span class="pill pill-warn">未承認</span>',approved:'<span class="pill pill-blue">承認済</span>',publishing:'<span class="pill pill-blue">送信中</span>',posted:'<span class="pill pill-ok">投稿済</span>',failed:'<span class="pill pill-err">失敗</span>',cancelled:'<span class="pill pill-soft">キャンセル</span>'}[e||""]||`<span class="pill pill-soft">${e||"—"}</span>`}function on(e){const{stats:t,health:a,recentLogs:s}=e;return`
<div class="space-y-4">
  <div>
...
</div>`}function ln(e){const t=e.target||{};return`
<div class="space-y-4">
  <div>
...
<\/script>`}function cn(e){var a,s,n;const t=[["problem","問題提起型","fa-circle-question"],["before_after","ビフォーアフター型","fa-right-left"],["contrarian","逆張り型","fa-rotate-left"],["howto","HowTo実演型","fa-list-ol"],["numbers","数字インパクト型","fa-hashtag"]];return`
<div class="space-y-4">
  <div>
...
<\/script>`}function pn(e){const{month:t,y:a,m:s,posts:n,stats:i}=e;return`
<div class="space-y-4">
  ${e.hasAccount?"":e.noAccountAlert}
  <div>
...
<\/script>`}function fn(e){return`
    ...
    </div>`}function hn(e){return JSON.stringify(e.scheduled||[]).replace(/`/g,"\\`").replace(/<\/script>/gi,"<\\/script>"),`
<div class="space-y-4">
  ...
  <div id="sc-cal-view">
    ...
    <div style="background:#fff;border:1px solid var(--line);border-radius:.75rem;overflow:hidden">
      ...
      <div id="sc-cal-grid" style="display:grid;grid-template-columns:repeat(7,1fr);min-height:300px"><div style="grid-column:1/-1;text-align:center;padding:2rem;color:var(--ink-muted);font-size:.85rem">読込中...</div></div>
    </div>
  </div>
...
(function(){
  ...
  // Hono SSRでは DOMContentLoaded が既に発火済みの場合があるため両方対応
    return { init: buildCalendar, setView: setView };
})();
// カレンダー初期化 - DOMが確実に描画された後に実行
(function initCal() {
  var el = document.getElementById('sc-cal-grid');
  if (el) {
    _CAL.init();
  } else {
...
<\/script>`}function vn(e){const t=e.settings||{};return`
<div class="space-y-4">
  <div>
...
<\/script>`}const H=new D;async function yn(e,t){const{results:a}=await e.env.DB.prepare(`SELECT id, account_name, x_username, is_current
       FROM x_accounts WHERE user_id = ? AND is_active = 1 ORDER BY id`).bind(t.id).all(),s=(a||[]).map(i=>({id:i.id,account_name:i.account_name,x_username:i.x_username})),n=(a||[]).find(i=>i.is_current===1);return{accounts:s,currentAccountId:(n==null?void 0:n.id)??null}}H.get("/",e=>e.redirect("/login"));async function K(e,t,a){const s=e.get("user"),{accounts:n,currentAccountId:i}=await yn(e,s),r=n.length>0&&i!==null,o=await Promise.resolve(a({user:s,hasAccount:r,accounts:n,currentAccountId:i})),l=rn({active:t,user:s,accounts:n,currentAccountId:i,pageBody:o});return e.html(Nt("GE365x",l))}H.get("/dashboard",m,async e=>K(e,"dashboard",async({user:t,hasAccount:a})=>{const s=await e.env.DB.prepare("SELECT COUNT(*) AS n FROM x_accounts WHERE user_id=?").bind(t.id).first(),n=await e.env.DB.prepare("SELECT COUNT(*) AS n FROM post_logs WHERE user_id=? AND DATE(created_at)=DATE('now','+9 hours') AND status='posted'").bind(t.id).first(),i=await e.env.DB.prepare("SELECT COUNT(*) AS n FROM post_queue WHERE user_id=? AND status IN ('pending','approved')").bind(t.id).first(),r=await e.env.DB.prepare("SELECT COUNT(*) AS n FROM post_logs WHERE user_id=? AND status='failed' AND DATE(created_at)=DATE('now','+9 hours')").bind(t.id).first(),{results:o}=await e.env.DB.prepare(`SELECT id, account_name, x_username, account_health_score, health_status, is_active
        ...
        ORDER BY pq.id DESC LIMIT 200`).bind(t.id,n).all(),l=(o||[]).length,d=(o||[]).filter(f=>f.status==="pending"||f.status==="approved").length,c=(o||[]).filter(f=>f.status==="posted").length,p=(o||[]).filter(f=>f.status==="failed").length;return pn({hasAccount:a,noAccountAlert:ge,month:n,y:i,m:parseInt(r,10),posts:o||[],stats:{total:l,pending:d,posted:c,failed:p}})}));H.get("/dashboard/thread",m,async e=>K(e,"thread",async({user:t,hasAccount:a})=>{const{results:s}=await e.env.DB.prepare(`SELECT pq.id, pq.body, pq.status, pq.posted_at, pq.created_at, pq.thread_parent_id
         FROM post_queue pq
        WHERE pq.user_id = ? AND pq.post_mode = 'thread' AND pq.thread_parent_id IS NOT NULL
        ORDER BY pq.id DESC LIMIT 30`).bind(t.id).all();return mn({hasAccount:a,noAccountAlert:ge,history:s||[]})}));H.get("/dashboard/scheduled",m,async e=>K(e,"scheduled",async({user:t,hasAccount:a})=>{const{results:s}=await e.env.DB.prepare(`SELECT pq.id, pq.body, pq.scheduled_at, pq.status, xa.x_username
         FROM post_queue pq LEFT JOIN x_accounts xa ON xa.id = pq.account_id
        WHERE pq.user_id = ? AND pq.scheduled_at IS NOT NULL
          AND pq.status NOT IN ('cancelled','rejected')
        ORDER BY pq.scheduled_at ASC LIMIT 100`).bind(t.id).all();return hn({hasAccount:a,noAccountAlert:ge,scheduled:s||[]})}));H.get("/dashboard/autopilot",m,async e=>K(e,"autopilot",async({user:t,hasAccount:a,accounts:s})=>{const{results:n}=await e.env.DB.prepare(`SELECT aj.*, xa.x_username FROM autopilot_jobs aj
         LEFT JOIN x_accounts xa ON xa.id = aj.account_id
        WHERE aj.user_id = ?
        ORDER BY COALESCE(aj.publish_at, aj.generate_at, aj.created_at) DESC LIMIT 50`).bind(t.id).all();return gn({hasAccount:a,noAccountAlert:ge,accounts:s,jobs:n||[]})}));H.get("/dashboard/accounts",m,async e=>K(e,"accounts",async({user:t})=>{const{results:a}=await e.env.DB.prepare(`SELECT id, account_name, x_username, account_health_score, health_status,
              daily_post_count, daily_post_limit, last_posted_at, is_active
         FROM x_accounts WHERE user_id = ? ORDER BY id DESC`).bind(t.id).all();return _n({accounts:a||[]})}));H.get("/dashboard/api",m,async e=>K(e,"api",async({user:t})=>{const a=await e.env.DB.prepare("SELECT api_key, api_secret FROM x_api_settings WHERE user_id = ? LIMIT 1").bind(t.id).first(),s=async i=>{const r=await e.env.DB.prepare("SELECT value FROM system_settings WHERE key=?").bind(i).first();return!!(r!=null&&r.value)},n={api_key:a!=null&&a.api_key?"••••••":"",api_secret:a!=null&&a.api_secret?"••••••":"",openai_api_key:await s("openai_api_key_"+t.id),gemini_api_key:await s("gemini_api_key_"+t.id),telegram_bot_token:await s("telegram_bot_token_"+t.id),telegram_chat_id:""};return vn({settings:n})}));H.get("/dashboard/export",m,async e=>K(e,"export",({user:t})=>bn({isAdmin:t.is_admin})));const F=new D;F.get("/admin",m,I,e=>{const t=`
...
<div class="warn">⚠️ ログイン後すぐにパスワードを変更してください<br>このURLは設定後も有効なため、token を知らない人には教えないでください</div>
     ...
     WHERE user_id = ?`).bind(t.id).run(),e.json({ok:!0})});_e.get("/api/subscription/payments",m,async e=>{const t=e.get("user"),{results:a}=await e.env.DB.prepare(`SELECT id, amount_jpy, currency, provider, external_id, status, plan_code, paid_at, created_at
      ...
      LIMIT 50`).bind(t.id).all();return e.json({payments:a||[]})});_e.post("/api/subscription/stripe/checkout",m,async e=>e.env.STRIPE_SECRET_KEY?e.json({error:"not_implemented_yet"},501):e.json({error:"stripe_not_configured"},501));_e.post("/api/subscription/webhook/stripe",async e=>e.json({received:!0}));const ea=new TextEncoder,xn="https://api.x.com/2";class $ extends Error{constructor(a,s=0,n="api_error"){super(a);h(this,"statusCode");h(this,"errorType");this.name="XApiError",this.statusCode=s,this.errorType=n}}class Pt extends ${constructor(a){super("Rate limited by X API (429)",429,"rate_limit");h(this,"resetAtEpoch");this.name="XApiRateLimitError",this.resetAtEpoch=a}}function de(e){return encodeURIComponent(e).replace(/[!'()*]/g,t=>"%"+t.charCodeAt(0).toString(16).toUpperCase())}function En(e){const t=new Uint8Array(e);return crypto.getRandomValues(t),[...t].map(a=>a.toString(16).padStart(2,"0")).join("")}function wn(){return En(16)}async function kn(e,t){const a=await crypto.subtle.importKey("raw",ea.encode(e),{name:"HMAC",hash:"SHA-1"},!1,["sign"]),s=await crypto.subtle.sign("HMAC",a,ea.encode(t)),n=new Uint8Array(s);let i="";for(let r=0;r<n.length;r++)i+=String.fromCharCode(n[r]);return btoa(i)}async function Sn(e,t,a,s){const n={oauth_consumer_key:a.consumerKey,oauth_nonce:wn(),oauth_signature_method:"HMAC-SHA1",oauth_timestamp:Math.floor(Date.now()/1e3).toString(),oauth_token:a.accessToken,oauth_version:"1.0"},i=new URL(t),r={...n};i.searchParams.forEach((f,_)=>{r[_]=f});const o=Object.keys(r).sort().map(f=>`${de(f)}=${de(r[f])}`).join("&"),l=[e.toUpperCase(),de(`${i.origin}${i.pathname}`),de(o)].join("&"),d=`${de(a.consumerSecret)}&${de(a.accessTokenSecret)}`,c=await kn(d,l);return n.oauth_signature=c,`OAuth ${Object.keys(n).sort().map(f=>`${de(f)}="${de(n[f])}"`).join(", ")}`}async function qt(e,t,a,s){const n=`${xn}${t}`,i=await Sn(e,n,s),r={method:e,headers:{authorization:i,"content-type":"application/json"},signal:AbortSignal.timeout(3e4)};a!==void 0&&(r.body=JSON.stringify(a));const o=await fetch(n,r);if(o.status===429){const l=o.headers.get("x-rate-limit-reset");throw new Pt(l?Number(l):void 0)}if(!o.ok){const l=await o.text();throw new $(`X API ${e} ${t} failed: ${o.status} ${l.slice(0,500)}`,o.status,"api_error")}return o.status===204?{}:o.json()}async function Wa(e,t){var s,n;const a=await qt("POST","/tweets",{text:t},e);return{id:((s=a==null?void 0:a.data)==null?void 0:s.id)||"",text:((n=a==null?void 0:a.data)==null?void 0:n.text)||t}}async function za(e,t,a,s){var r,o;const n={text:t};a&&a.length&&(n.media={media_ids:a.slice(0,4)});const i=await qt("POST","/tweets",n,e);return{id:((r=i==null?void 0:i.data)==null?void 0:r.id)||"",text:((o=i==null?void 0:i.data)==null?void 0:o.text)||t}}async function Tn(e){var a,s,n,i;if(!e)throw new $("credentials未設定",0,"missing_credentials");if(!((a=e.consumerKey)!=null&&a.trim()))throw new $("API Key未設定",0,"missing_credentials");if(!((s=e.consumerSecret)!=null&&s.trim()))throw new $("API Secret未設定",0,"missing_credentials");if(!((n=e.accessToken)!=null&&n.trim()))throw new $("Access Token未設定",0,"missing_token");if(!((i=e.accessTokenSecret)!=null&&i.trim()))throw new $("Access Token Secret未設定",0,"missing_token");const t=await qt("GET","/users/me?user.fields=profile_image_url,public_metrics",void 0,e);return t==null?void 0:t.data}async function Ht(e,t,a){var o,l;const s=((a==null?void 0:a.apiKey)??e.X_API_KEY??"").trim(),n=((a==null?void 0:a.apiSecret)??e.X_API_SECRET??"").trim();if(!s||!n)throw new $("X API Key/Secret 未設定",0,"no_api_key");if(!((o=t==null?void 0:t.access_token)!=null&&o.trim()))throw new $("Access Token 未設定",0,"no_token");if(!((l=t==null?void 0:t.access_token_secret)!=null&&l.trim()))throw new $("Access Token Secret 未設定",0,"no_token_secret");let i,r;try{i=await et(t.access_token,e.ENCRYPTION_KEY)}catch{throw new $("Access Token の復号に失敗",0,"decrypt_failed")}try{r=await et(t.access_token_secret,e.ENCRYPTION_KEY)}catch{throw new $("Access Token Secret の復号に失敗",0,"decrypt_failed")}if(!i.trim())throw new $("Access Token が空",0,"decrypt_failed");if(!r.trim())throw new $("Access Token Secret が空",0,"decrypt_failed");return{consumerKey:s,consumerSecret:n,accessToken:i,accessTokenSecret:r}}async function ta(e,t){if(!e)return"";try{return await et(e,t)}catch{return""}}const be=new D;be.get("/api/admin/accounts",m,async e=>{const t=e.get("user"),{results:a}=await e.env.DB.prepare(`SELECT id, account_name, x_user_id, x_username,
...
3.なぜその数字か
4.読者が同じ結果を得る条件
5.CTA`}};async function Ja(e,t){var r,o,l;const a=t.model||"gpt-4o-mini",s=t.maxTokens||4e3,n=t.temperature??.7,i=t.baseUrl||"https://api.openai.com/v1";for(let d=1;d<=3;d++)try{const c=await fetch(`${i}/chat/completions`,{method:"POST",headers:{authorization:`Bearer ${t.apiKey}`,"content-type":"application/json"},body:JSON.stringify({model:a,messages:e,max_tokens:s,temperature:n}),signal:AbortSignal.timeout(12e4)});if(!c.ok){const f=await c.text();if(c.status>=500&&d<3){await new Promise(_=>setTimeout(_,2e3*d));continue}throw new Error(`OpenAI API error: ${c.status} ${f.slice(0,500)}`)}const p=await c.json();return((l=(o=(r=p==null?void 0:p.choices)==null?void 0:r[0])==null?void 0:o.message)==null?void 0:l.content)||""}catch(c){if(((c==null?void 0:c.name)==="TimeoutError"||(c==null?void 0:c.name)==="AbortError")&&d<3){await new Promise(f=>setTimeout(f,2e3*d));continue}throw c}return""}function Ka(e){let t=`以下のルールを厳守してX(Twitter)投稿文を生成してください。
...
追加指示: ${e.userInput}`);const i=t+s+a;return{messages:[{role:"system",content:i},{role:"user",content:n}],systemPrompt:i,userPrompt:n}}async function Va(e,t,a,s,n,i="body"){const{messages:r}=Ka({theme:t,keywords:a,brandVoice:n,targetDna:s,postMode:i||"body"}),o=await Ja(r,{apiKey:e,temperature:.8});return Et(o,i)}async function Xa(e,t,a,s,n,i,r="body"){if(!Bt[t])throw new Error(`未対応のパターン: ${t}`);const{messages:o}=Ka({theme:a,keywords:s,brandVoice:i,targetDna:n,patternType:t,postMode:r||"body"}),l=await Ja(o,{apiKey:e,temperature:.8});return Et(l,r)}function Et(e,t){if(!e)return"";let a=e.replace(/^#{1,4}\s*/gm,"").replace(/^[▪️■●•\-\*]+\s*/gm,"").replace(/^\d+\.\s/gm,"").replace(/^(Step\d+)[:\s]/gim,"").replace(/^[①②③④⑤⑥⑦⑧⑨⑩]\s*/gm,"・").replace(/\*\*([^*]+)\*\*/g,"$1").replace(/\n{3,}/g,`

`).trim();return a=Bn(a),t==="140"&&a.length>140&&(a=a.slice(0,137)+"..."),a}function Bn(e){if(!e)return"";const t=e.split(`
...
`).trim()}const Cn=new TextEncoder;async function De(e){const t=await crypto.subtle.digest("SHA-256",Cn.encode(e||""));return[...new Uint8Array(t)].slice(0,8).map(s=>s.toString(16).padStart(2,"0")).join("")}function Ct(e){const t=(e||"").replace(/\s+/g,"").slice(0,2e3),a=new Set;for(let s=0;s<t.length-1;s++)a.add(t.slice(s,s+2));return a}function Ga(e,t){const a=Ct(e),s=Ct(t);if(a.size===0&&s.size===0)return 0;let n=0;for(const r of a)s.has(r)&&n++;const i=a.size+s.size-n;return i===0?0:n/i}const Ln=120*1e3;async function Za(e,t){const a=new Date().toISOString(),s=new Date(Date.now()-Ln).toISOString(),n=await e.DB.prepare("SELECT account_id, locked_at FROM post_locks WHERE account_id = ?").bind(t).first();return n&&n.locked_at>s?!1:(await e.DB.prepare(`INSERT INTO post_locks (account_id, locked_at) VALUES (?, ?)
     ON CONFLICT(account_id) DO UPDATE SET locked_at = excluded.locked_at`).bind(t,a).run(),!0)}async function Qa(e,t){await e.DB.prepare("DELETE FROM post_locks WHERE account_id = ?").bind(t).run()}async function es(e,t,a,s,n){const i={ok:!0,errors:[],warnings:[]},r=await e.DB.prepare("SELECT daily_post_count, daily_post_limit, last_posted_at, last_daily_reset_date, health_status FROM x_accounts WHERE id = ?").bind(t).first();if(!r)return i.ok=!1,i.errors.push({code:"account_not_found",message:"アカウントが存在しません"}),i;const o=new Date(Date.now()+9*3600*1e3).toISOString().slice(0,10);let l=r.daily_post_count||0;if(r.last_daily_reset_date!==o&&(l=0),l>=(r.daily_post_limit||5)&&i.errors.push({code:"daily_limit_reached",message:`日次投稿上限 (${r.daily_post_limit}) に達しています`}),r.last_posted_at){const c=Date.parse(r.last_posted_at.replace(" ","T")+"+09:00");if(!Number.isNaN(c)){const p=(Date.now()-c)/6e4;p<15&&i.errors.push({code:"too_frequent",message:`前回投稿から ${Math.floor(p)} 分しか経過していません（最低 15 分）`,overridable:!0})}}const{results:d}=await e.DB.prepare(`SELECT id, body FROM post_queue
       ...
       LIMIT 5`).bind(t).all();for(const c of d||[]){const p=Ga(a,c.body||"");if(p>=.7){i.errors.push({code:"too_similar",message:`過去投稿 (ID: ${c.id}) と類似度 ${p.toFixed(2)} で重複`});break}}if(s){const c=await e.DB.prepare(`SELECT COUNT(*) AS n FROM post_queue
        WHERE account_id = ? AND link_url = ? AND status IN ('posted','approved','publishing')
          AND DATE(COALESCE(posted_at, scheduled_at, created_at)) >= DATE('now','+9 hours','-7 days')`).bind(t,s).first();((c==null?void 0:c.n)??0)>=3&&i.errors.push({code:"link_spam",message:`同一リンクを過去7日で${c==null?void 0:c.n}回使用しています`})}if(n){const c=aa(n);if(c.size>0){const{results:p}=await e.DB.prepare(`SELECT hashtags FROM post_queue
           ...
           ORDER BY COALESCE(posted_at, scheduled_at, created_at) DESC LIMIT 3`).bind(t).all();(p||[]).length>=3&&(p||[]).every(_=>{const T=[...aa(_.hashtags||"")].filter(A=>c.has(A)).length;return(c.size===0?0:T/c.size)>=.8})&&i.errors.push({code:"hashtag_spam",message:"同一ハッシュタグセットが 3 回連続で 80%以上一致しています"})}}return r.health_status==="risk"&&i.errors.push({code:"health_risk",message:"アカウント健全性スコアが危険域です。投稿を控えてください。"}),i.ok=i.errors.length===0,i}function aa(e){return new Set((e||"").split(/[\s,]+/).map(t=>t.trim().replace(/^#/,"").toLowerCase()).filter(Boolean))}async function _t(e,t,a,s,n){const i=await e.DB.prepare("SELECT account_health_score FROM x_accounts WHERE id = ?").bind(t).first();if(!i)return{score_after:100,status_after:"healthy"};let r=Math.max(0,Math.min(100,(i.account_health_score??100)+s));const o=r>=80?"healthy":r>=60?"caution":"risk";return await e.DB.prepare("UPDATE x_accounts SET account_health_score = ?, health_status = ?, updated_at = datetime('now','+9 hours') WHERE id = ?").bind(r,o,t).run(),await e.DB.prepare(`INSERT INTO account_health_events (account_id, event_type, delta, score_after, status_after, metadata)
     VALUES (?, ?, ?, ?, ?, ?)`).bind(t,a,s,r,o,n?JSON.stringify(n):null).run(),{score_after:r,status_after:o}}function sa(e){if(!e)return Date.now();const t=e.replace(" ","T")+"+09:00",a=Date.parse(t);return Number.isNaN(a)?Date.now():a}function na(e){return new Date(e+324e5).toISOString().replace("T"," ").slice(0,19)}async function Nn(e,t,a){const s=a.jitter_enabled!==!1,n=a.jitter_minutes??5,i=a.collision_avoidance_enabled!==!1,r=a.min_spacing_seconds??90;let o=sa(t),l=0,d=0;if(s&&n>0){const f=Math.floor((Math.random()*2-1)*n*60);l=f,o+=f*1e3}if(i&&a.account_id){const f=na(o),_=[a.account_id,f,f];let v=`
...
`+n.hashtags);const c=[];if(n.media_json)try{const f=JSON.parse(n.media_json);for(const _ of(f||[]).slice(0,4)){const v=await e.env.DB.prepare("SELECT * FROM media_assets WHERE id=? AND user_id=?").bind(_,t.id).first();v!=null&&v.x_media_id&&c.push(v.x_media_id)}}catch{}const p=c.length>0?await za(l,d,c,null):await Wa(l,d);return await e.env.DB.prepare("UPDATE post_queue SET status='posted', external_post_id=?, posted_at=?, updated_at=? WHERE id=?").bind(p.id||"",b(),b(),a).run(),await e.env.DB.prepare(`UPDATE x_accounts SET last_posted_at=?, daily_post_count=daily_post_count+1,
     ...
     WHERE id=? AND user_id=?`).bind(s.body,s.link_url??null,s.hashtags??null,s.scheduled_at??null,s.post_mode??"body",s.media_json??null,i,s.recurrence_type??null,s.recurrence_rule??null,s.next_run_at??null,s.recurrence_end_at??null,n,a,t.id).run(),e.json({success:!0}))});U.delete("/api/admin/posts/:id",m,async e=>{const t=e.get("user");return await e.env.DB.prepare("DELETE FROM post_queue WHERE id=? AND user_id=?").bind(parseInt(e.req.param("id"),10),t.id).run(),e.json({success:!0})});U.post("/api/admin/posts/:id/cancel",m,async e=>{const t=e.get("user");return await e.env.DB.prepare("UPDATE post_queue SET status='cancelled', updated_at=? WHERE id=? AND user_id=?").bind(b(),parseInt(e.req.param("id"),10),t.id).run(),e.json({success:!0})});U.get("/api/admin/posts-scheduled",m,async e=>{const t=e.get("user"),a=e.req.query("account_id"),s=[t.id];let n="WHERE pq.platform='x' AND pq.user_id=? AND pq.scheduled_at IS NOT NULL AND pq.status NOT IN ('cancelled','rejected')";a&&(n+=" AND pq.account_id=?",s.push(Number(a)));const{results:i}=await e.env.DB.prepare(`SELECT pq.*, xa.account_name
       ...
       ${o} ORDER BY aj.publish_at ASC`).bind(...r).all(),d=(l||[]).map(p=>({...p,post_mode:"body",id:"ap-"+p.id})),c=[...i||[],...d].sort((p,f)=>(p.scheduled_at||"").localeCompare(f.scheduled_at||""));return e.json({posts:c})});U.post("/api/admin/posts/thread",m,async e=>{const t=e.get("user"),{tweets:a,link_url:s,account_id:n}=await e.req.json();if(!a||!Array.isArray(a)||a.length<2)return e.json({error:"Thread requires 2+ tweets"},400);const i=b(),r=await De(a[0].body),l=(await e.env.DB.prepare(`INSERT INTO post_queue
     ...
     VALUES ('x', ?, ?, ?, ?, 'thread', ?, ?, 'manual_post', 'pending', ?, ?)`).bind(t.id,n??null,a[0].body,a[0].link_url??s??null,a.length,r,i,i).run()).meta.last_row_id,d=[l];for(let c=1;c<a.length;c++){const p=await De(a[c].body),f=await e.env.DB.prepare(`INSERT INTO post_queue
       ...
       VALUES ('x', ?, ?, ?, ?, 'thread', ?, ?, ?, 'manual_post', 'pending', ?, ?)`).bind(t.id,n??null,a[c].body,a[c].link_url??null,l,c,p,i,i).run();d.push(f.meta.last_row_id)}return e.json({success:!0,parent_id:l,ids:d})});const ts=new D,Un=5;ts.post("/cron/tick",async e=>{const t=b(),{results:a}=await e.env.DB.prepare(`SELECT * FROM post_queue
      WHERE platform='x'
      ...
      LIMIT ?`).bind(Un).all();let s=0,n=0,i=0;for(const r of a||[]){const o=await e.env.DB.prepare("UPDATE post_queue SET status='publishing', updated_at=? WHERE id=? AND status IN ('pending','approved')").bind(t,r.id).run();if(!(!o.success||o.meta.changes===0)){s++;try{if(!r.account_id)throw new Error("account_id is null");const l=await e.env.DB.prepare("SELECT * FROM x_accounts WHERE id=?").bind(r.account_id).first();if(!l)throw new Error("account_not_found");const d=await es(e.env,l.id,r.body||"",r.link_url,r.hashtags);if(!d.ok)throw new Error("safety: "+d.errors.map(c=>c.message).join("; "));if(!await Za(e.env,l.id))throw new Error("account_busy");try{const c=await Ht(e.env,l);let p=Et(r.body||"",r.post_mode);r.link_url&&(p+=`
`+r.link_url),r.hashtags&&(p+=`
`+r.hashtags);const f=[];if(r.media_json)try{const v=JSON.parse(r.media_json);for(const T of(v||[]).slice(0,4)){const E=await e.env.DB.prepare("SELECT x_media_id FROM media_assets WHERE id=?").bind(T).first();E!=null&&E.x_media_id&&f.push(E.x_media_id)}}catch{}const _=f.length>0?await za(c,p,f,null):await Wa(c,p);await e.env.DB.prepare("UPDATE post_queue SET status='posted', external_post_id=?, posted_at=?, updated_at=? WHERE id=?").bind(_.id||"",b(),b(),r.id).run(),await e.env.DB.prepare(`UPDATE x_accounts SET
             last_posted_at = ?,
             ...
             updated_at = ?
           WHERE id = ?`).bind(b(),b(),l.id).run(),await e.env.DB.prepare(`INSERT INTO post_logs
           ...
           VALUES (?, ?, ?, ?, 'x', ?, ?, ?, ?, ?, ?, ?, ?, 'posted', ?)`).bind(r.id,l.id,r.user_id,l.account_name,r.source_type,r.generation_type,r.post_mode,r.body||"",r.content_hash||"",r.link_url||"",b(),b(),JSON.stringify({tweet_id:_.id})).run(),await e.env.DB.prepare(`INSERT INTO kpi_metrics (account_id, user_id, metric_date, posts_sent)
           VALUES (?, ?, date('now','+9 hours'), 1)
           ON CONFLICT(account_id, metric_date) DO UPDATE SET
             posts_sent = posts_sent + 1,
             updated_at = datetime('now','+9 hours')`).bind(l.id,r.user_id).run(),n++}finally{await Qa(e.env,l.id)}}catch(l){const d=(l==null?void 0:l.message)||"unknown_error";await e.env.DB.prepare("UPDATE post_queue SET status='failed', error_message=?, updated_at=? WHERE id=?").bind(d,b(),r.id).run(),await e.env.DB.prepare(`INSERT INTO post_logs
           (record_id, account_id, user_id, platform, source_type, post_mode, content, content_hash,
            status, error_message, executed_at)
         VALUES (?, ?, ?, 'x', ?, ?, ?, ?, 'failed', ?, ?)`).bind(r.id,r.account_id,r.user_id,r.source_type,r.post_mode,r.body||"",r.content_hash||"",d,b()).run(),r.account_id&&(l instanceof Pt?await _t(e.env,r.account_id,"rate_limit",-15):await _t(e.env,r.account_id,"error",-5,{message:d})),r.account_id&&await e.env.DB.prepare(`INSERT INTO kpi_metrics (account_id, user_id, metric_date, posts_failed)
           VALUES (?, ?, date('now','+9 hours'), 1)
           ON CONFLICT(account_id, metric_date) DO UPDATE SET
     ...
     VALUES (?, ?, ?, ?, ?, ?, 'ready')`).bind(t.id,n,s.type,s.name,s.size,`/media/${i}`).run();return e.json({success:!0,id:r.meta.last_row_id,storage_path:`/media/${i}`})});lt.delete("/api/admin/media/:id",m,async e=>{var n;const t=e.get("user"),a=parseInt(e.req.param("id"),10),s=await e.env.DB.prepare("SELECT storage_path FROM media_assets WHERE id=? AND user_id=?").bind(a,t.id).first();if((n=s==null?void 0:s.storage_path)!=null&&n.startsWith("/media/")&&e.env.MEDIA_BUCKET){const i=s.storage_path.slice(7);await e.env.MEDIA_BUCKET.delete(i).catch(()=>{})}return await e.env.DB.prepare("DELETE FROM media_assets WHERE id=? AND user_id=?").bind(a,t.id).run(),e.json({success:!0})});lt.get("/media/*",async e=>{if(!e.env.MEDIA_BUCKET)return e.notFound();const t=e.req.path.replace(/^\/media\//,""),a=await e.env.MEDIA_BUCKET.get(t);if(!a)return e.notFound();const s=new Headers;return a.writeHttpMetadata(s),s.set("etag",a.httpEtag),new Response(a.body,{headers:s})});const Wt=new D;Wt.get("/api/admin/kpi",m,async e=>{const t=e.get("user"),a=e.req.query("account_id"),s=parseInt(e.req.query("days")||"30",10),n=[t.id,s];let i="WHERE km.user_id = ? AND km.metric_date >= date('now','+9 hours','-' || ? || ' days')";a&&(i+=" AND km.account_id = ?",n.push(Number(a)));const{results:r}=await e.env.DB.prepare(`SELECT km.*, xa.account_name
       ...
       FROM kpi_metrics WHERE user_id = ? AND metric_date >= date('now','+9 hours','-7 days')`).bind(t.id).first();return e.json({today:{sent:(a==null?void 0:a.sent)??0,failed:(a==null?void 0:a.failed)??0},week:{sent:(s==null?void 0:s.sent)??0,failed:(s==null?void 0:s.failed)??0}})});const wt=new D;wt.get("/api/admin/logs/posts",m,async e=>{const t=e.get("user"),a=e.req.query("status"),s=e.req.query("account_id"),n=[t.id];let i="WHERE pl.user_id = ?";a&&a!=="all"&&(i+=" AND pl.status = ?",n.push(a)),s&&(i+=" AND pl.account_id = ?",n.push(Number(s)));const{results:r}=await e.env.DB.prepare(`SELECT pl.*, xa.account_name AS joined_account_name
       FROM post_logs pl LEFT JOIN x_accounts xa ON pl.account_id = xa.id
       ${i} ORDER BY pl.id DESC LIMIT 300`).bind(...n).all();return e.json({logs:r||[]})});wt.get("/api/admin/logs/generations",m,async e=>{const t=e.get("user"),{results:a}=await e.env.DB.prepare(`SELECT gl.*, xa.account_name
       FROM generation_logs gl LEFT JOIN x_accounts xa ON gl.account_id = xa.id
       WHERE gl.user_id = ?
       ORDER BY gl.id DESC LIMIT 200`).bind(t.id).all();return e.json({logs:a||[]})});wt.get("/api/admin/logs/health",m,async e=>{const t=e.get("user"),{results:a}=await e.env.DB.prepare(`SELECT he.*, xa.account_name
       FROM account_health_events he LEFT JOIN x_accounts xa ON he.account_id = xa.id
       WHERE xa.user_id = ?
       ORDER BY he.id DESC LIMIT 200`).bind(t.id).all();return e.json({logs:a||[]})});const kt=new D;kt.get("/api/admin/target/presets",m,e=>e.json({templates:Ya}));kt.get("/api/admin/target",m,async e=>{const t=e.get("user"),a=e.req.query("account_id")||"default",s=await e.env.DB.prepare("SELECT * FROM target_templates WHERE account_id=? AND user_id=? LIMIT 1").bind(a,t.id).first();return e.json({target:s})});kt.post("/api/admin/target",m,async e=>{const t=e.get("user"),a=await e.req.json(),s=String(a.account_id??"default"),n=b(),i=await e.env.DB.prepare("SELECT id FROM target_templates WHERE account_id=? AND user_id=? LIMIT 1").bind(s,t.id).first();if(i)return await e.env.DB.prepare(`UPDATE target_templates SET
...
`)}function Y(e,t){return new Response(e,{headers:{"content-type":"text/csv; charset=utf-8","content-disposition":`attachment; filename="${t}"`,"cache-control":"no-store"}})}function as(e,t){return new Response(JSON.stringify(e,null,2),{headers:{"content-type":"application/json; charset=utf-8","content-disposition":`attachment; filename="${t}"`,"cache-control":"no-store"}})}function P(){const e=new Date,t=a=>String(a).padStart(2,"0");return`${e.getFullYear()}${t(e.getMonth()+1)}${t(e.getDate())}_${t(e.getHours())}${t(e.getMinutes())}`}C.get("/api/admin/export/posts",m,async e=>{const t=e.get("user"),a=e.req.query("status"),s=e.req.query("month");let n="WHERE pq.platform='x' AND pq.user_id = ?";const i=[t.id];a&&a!=="all"&&(n+=" AND pq.status = ?",i.push(a)),s&&(n+=" AND strftime('%Y-%m', COALESCE(pq.posted_at, pq.scheduled_at, pq.created_at)) = ?",i.push(s));const{results:r}=await e.env.DB.prepare(`SELECT pq.id, pq.body, pq.link_url, pq.hashtags, pq.post_mode, pq.status,
       ...
       FROM auth_logs ORDER BY id DESC LIMIT 10000`).all(),s=z(["id","user_id","email","event_type","ip_address","user_agent","metadata","created_at"],t||[]);return Y(s,`ge365x_admin_audit_${P()}.csv`)});C.get("/api/admin/export/admin/all",m,I,async e=>{const[t,a,s,n,i,r,o]=await Promise.all([e.env.DB.prepare(`SELECT id, email, is_approved, is_admin, trial_start, trial_end, created_at, updated_at
         ...
         FROM x_accounts ORDER BY id DESC LIMIT 10000`).all()]),l={exported_at:new Date().toISOString(),users:t.results||[],user_subscriptions:a.results||[],licenses:s.results||[],auth_logs:n.results||[],post_queue:i.results||[],post_logs:r.results||[],x_accounts:o.results||[]};return as(l,`ge365x_admin_all_${P()}.json`)});const S=new D;S.use("/static/*",Xs({root:"./",manifest:{}}));S.get("/healthz",e=>e.json({ok:!0,service:"ge365x-web",time:new Date().toISOString()}));S.route("/",Ba);S.route("/",H);S.route("/",F);S.route("/",te);S.route("/",_e);S.route("/",be);S.route("/",U);S.route("/",ts);S.route("/",ve);S.route("/",We);S.route("/",ot);S.route("/",lt);S.route("/",Wt);S.route("/",wt);S.route("/",kt);S.route("/",St);S.route("/",Ie);S.route("/",C);S.notFound(e=>e.json({error:"not_found",path:e.req.path},404));S.onError((e,t)=>(console.error("[ge365x-web] error:",e),t.json({error:"internal_error",message:e.message},500)));const Wn={fetch:S.fetch,async scheduled(e,t,a){const s=e.cron;(!s||s==="*/1 * * * *")&&a.waitUntil(S.fetch(new Request("https://internal/cron/tick",{method:"POST"}),t,a).catch(n=>console.error("[tick]",n))),s==="*/5 * * * *"&&a.waitUntil(S.fetch(new Request("https://internal/cron/autopilot-tick",{method:"POST"}),t,a).catch(n=>console.error("[autopilot-tick]",n)))}},da=new D,zn=Object.assign({"/src/index.tsx":Wn});let ss=!1;for(const[,e]of Object.entries(zn))e&&(da.all("*",t=>{let a;try{a=t.executionCtx}catch{}return e.fetch(t.req.raw,t.env,a)}),da.notFound(t=>{let a;try{a=t.executionCtx}catch{}return e.fetch(t.req.raw,t.env,a)}),ss=!0);if(!ss)throw new Error("Can't import modules from ['/src/index.ts','/src/index.tsx','/app/server.ts']");export{da as default};
