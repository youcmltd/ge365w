var is=Object.defineProperty;var Jt=e=>{throw TypeError(e)};var rs=(e,t,a)=>t in e?is(e,t,{enumerable:!0,configurable:!0,writable:!0,value:a}):e[t]=a;var h=(e,t,a)=>rs(e,typeof t!="symbol"?t+"":t,a),Dt=(e,t,a)=>t.has(e)||Jt("Cannot "+a);var u=(e,t,a)=>(Dt(e,t,"read from private field"),a?a.call(e):t.get(e)),y=(e,t,a)=>t.has(e)?Jt("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,a),g=(e,t,a,s)=>(Dt(e,t,"write to private field"),s?s.call(e,a):t.set(e,a),a),w=(e,t,a)=>(Dt(e,t,"access private method"),a);var Kt=(e,t,a,s)=>({set _(n){g(e,t,n,a)},get _(){return u(e,t,s)}});var Vt=(e,t,a)=>(s,n)=>{let i=-1;return r(0);async function r(o){if(o<=i)throw new Error("next() called multiple times");i=o;let d,l=!1,c;if(e[o]?(c=e[o][0][0],s.req.routeIndex=o):c=o===e.length&&n||void 0,c)try{d=await c(s,()=>r(o+1))}catch(p){if(p instanceof Error&&t)s.error=p,d=await t(p,s),l=!0;else throw p}else s.finalized===!1&&a&&(d=await a(s));return d&&(s.finalized===!1||l)&&(s.res=d),s}},os=Symbol(),ds=async(e,t=Object.create(null))=>{const{all:a=!1,dot:s=!1}=t,i=(e instanceof wa?e.raw.headers:e.headers).get("Content-Type");return i!=null&&i.startsWith("multipart/form-data")||i!=null&&i.startsWith("application/x-www-form-urlencoded")?ls(e,{all:a,dot:s}):{}};async function ls(e,t){const a=await e.formData();return a?cs(a,t):{}}function cs(e,t){const a=Object.create(null);return e.forEach((s,n)=>{t.all||n.endsWith("[]")?us(a,n,s):a[n]=s}),t.dot&&Object.entries(a).forEach(([s,n])=>{s.includes(".")&&(ps(a,s,n),delete a[s])}),a}var us=(e,t,a)=>{e[t]!==void 0?Array.isArray(e[t])?e[t].push(a):e[t]=[e[t],a]:t.endsWith("[]")?e[t]=[a]:e[t]=a},ps=(e,t,a)=>{if(/(?:^|\.)__proto__\./.test(t))return;let s=e;const n=t.split(".");n.forEach((i,r)=>{r===n.length-1?s[i]=a:((!s[i]||typeof s[i]!="object"||Array.isArray(s[i])||s[i]instanceof File)&&(s[i]=Object.create(null)),s=s[i])})},_a=e=>{const t=e.split("/");return t[0]===""&&t.shift(),t},ms=e=>{const{groups:t,path:a}=fs(e),s=_a(a);return hs(s,t)},fs=e=>{const t=[];return e=e.replace(/\{[^}]+\}/g,(a,s)=>{const n=`@${s}`;return t.push([n,a]),n}),{groups:t,path:e}},hs=(e,t)=>{for(let a=t.length-1;a>=0;a--){const[s]=t[a];for(let n=e.length-1;n>=0;n--)if(e[n].includes(s)){e[n]=e[n].replace(s,t[a][1]);break}}return e},ut={},gs=(e,t)=>{if(e==="*")return"*";const a=e.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);if(a){const s=`${e}#${t}`;return ut[s]||(a[2]?ut[s]=t&&t[0]!==":"&&t[0]!=="*"?[s,a[1],new RegExp(`^${a[2]}(?=/${t})`)]:[e,a[1],new RegExp(`^${a[2]}$`)]:ut[s]=[e,a[1],!0]),ut[s]}return null},Nt=(e,t)=>{try{return t(e)}catch{return e.replace(/(?:%[0-9A-Fa-f]{2})+/g,a=>{try{return t(a)}catch{return a}})}},ba=e=>Nt(e,decodeURI),va=e=>{const t=e.url,a=t.indexOf("/",t.indexOf(":")+4);let s=a;for(;s<t.length;s++){const n=t.charCodeAt(s);if(n===37){const i=t.indexOf("?",s),r=t.indexOf("#",s),o=i===-1?r===-1?void 0:r:r===-1?i:Math.min(i,r),d=t.slice(a,o);return ba(d.includes("%25")?d.replace(/%25/g,"%2525"):d)}else if(n===63||n===35)break}return t.slice(a,s)},_s=e=>{const t=va(e);return t.length>1&&t.at(-1)==="/"?t.slice(0,-1):t},Be=(e,t,...a)=>(a.length&&(t=Be(t,...a)),`${(e==null?void 0:e[0])==="/"?"":"/"}${e}${t==="/"?"":`${(e==null?void 0:e.at(-1))==="/"?"":"/"}${(t==null?void 0:t[0])==="/"?t.slice(1):t}`}`),ya=e=>{if(e.charCodeAt(e.length-1)!==63||!e.includes(":"))return null;const t=e.split("/"),a=[];let s="";return t.forEach(n=>{if(n!==""&&!/\:/.test(n))s+="/"+n;else if(/\:/.test(n))if(/\?/.test(n)){a.length===0&&s===""?a.push("/"):a.push(s);const i=n.replace("?","");s+="/"+i,a.push(s)}else s+="/"+n}),a.filter((n,i,r)=>r.indexOf(n)===i)},It=e=>/[%+]/.test(e)?(e.indexOf("+")!==-1&&(e=e.replace(/\+/g," ")),e.indexOf("%")!==-1?Nt(e,Ea):e):e,xa=(e,t,a)=>{let s;if(!a&&t&&!/[%+]/.test(t)){let r=e.indexOf("?",8);if(r===-1)return;for(e.startsWith(t,r+1)||(r=e.indexOf(`&${t}`,r+1));r!==-1;){const o=e.charCodeAt(r+t.length+1);if(o===61){const d=r+t.length+2,l=e.indexOf("&",d);return It(e.slice(d,l===-1?void 0:l))}else if(o==38||isNaN(o))return"";r=e.indexOf(`&${t}`,r+1)}if(s=/[%+]/.test(e),!s)return}const n={};s??(s=/[%+]/.test(e));let i=e.indexOf("?",8);for(;i!==-1;){const r=e.indexOf("&",i+1);let o=e.indexOf("=",i);o>r&&r!==-1&&(o=-1);let d=e.slice(i+1,o===-1?r===-1?void 0:r:o);if(s&&(d=It(d)),i=r,d==="")continue;let l;o===-1?l="":(l=e.slice(o+1,r===-1?void 0:r),s&&(l=It(l))),a?(n[d]&&Array.isArray(n[d])||(n[d]=[]),n[d].push(l)):n[d]??(n[d]=l)}return t?n[t]:n},bs=xa,vs=(e,t)=>xa(e,t,!0),Ea=decodeURIComponent,Xt=e=>Nt(e,Ea),Ne,J,de,ka,Sa,Rt,ce,ua,wa=(ua=class{constructor(e,t="/",a=[[]]){y(this,de);h(this,"raw");y(this,Ne);y(this,J);h(this,"routeIndex",0);h(this,"path");h(this,"bodyCache",{});y(this,ce,e=>{const{bodyCache:t,raw:a}=this,s=t[e];if(s)return s;const n=Object.keys(t)[0];return n?t[n].then(i=>(n==="json"&&(i=JSON.stringify(i)),new Response(i)[e]())):t[e]=a[e]()});this.raw=e,this.path=t,g(this,J,a),g(this,Ne,{})}param(e){return e?w(this,de,ka).call(this,e):w(this,de,Sa).call(this)}query(e){return bs(this.url,e)}queries(e){return vs(this.url,e)}header(e){if(e)return this.raw.headers.get(e)??void 0;const t={};return this.raw.headers.forEach((a,s)=>{t[s]=a}),t}async parseBody(e){return ds(this,e)}json(){return u(this,ce).call(this,"text").then(e=>JSON.parse(e))}text(){return u(this,ce).call(this,"text")}arrayBuffer(){return u(this,ce).call(this,"arrayBuffer")}blob(){return u(this,ce).call(this,"blob")}formData(){return u(this,ce).call(this,"formData")}addValidatedData(e,t){u(this,Ne)[e]=t}valid(e){return u(this,Ne)[e]}get url(){return this.raw.url}get method(){return this.raw.method}get[os](){return u(this,J)}get matchedRoutes(){return u(this,J)[0].map(([[,e]])=>e)}get routePath(){return u(this,J)[0].map(([[,e]])=>e)[this.routeIndex].path}},Ne=new WeakMap,J=new WeakMap,de=new WeakSet,ka=function(e){const t=u(this,J)[0][this.routeIndex][1][e],a=w(this,de,Rt).call(this,t);return a&&/\%/.test(a)?Xt(a):a},Sa=function(){const e={},t=Object.keys(u(this,J)[0][this.routeIndex][1]);for(const a of t){const s=w(this,de,Rt).call(this,u(this,J)[0][this.routeIndex][1][a]);s!==void 0&&(e[a]=/\%/.test(s)?Xt(s):s)}return e},Rt=function(e){return u(this,J)[1]?u(this,J)[1][e]:e},ce=new WeakMap,ua),ys={Stringify:1},Ta=async(e,t,a,s,n)=>{typeof e=="object"&&!(e instanceof String)&&(e instanceof Promise||(e=e.toString()),e instanceof Promise&&(e=await e));const i=e.callbacks;return i!=null&&i.length?(n?n[0]+=e:n=[e],Promise.all(i.map(o=>o({phase:t,buffer:n,context:s}))).then(o=>Promise.all(o.filter(Boolean).map(d=>Ta(d,t,!1,s,n))).then(()=>n[0]))):Promise.resolve(e)},xs="text/plain; charset=UTF-8",Ot=(e,t)=>({"Content-Type":e,...t}),Je=(e,t)=>new Response(e,t),tt,at,se,Me,ne,$,st,$e,Fe,Ee,nt,it,ue,Ce,pa,Es=(pa=class{constructor(e,t){y(this,ue);y(this,tt);y(this,at);h(this,"env",{});y(this,se);h(this,"finalized",!1);h(this,"error");y(this,Me);y(this,ne);y(this,$);y(this,st);y(this,$e);y(this,Fe);y(this,Ee);y(this,nt);y(this,it);h(this,"render",(...e)=>(u(this,$e)??g(this,$e,t=>this.html(t)),u(this,$e).call(this,...e)));h(this,"setLayout",e=>g(this,st,e));h(this,"getLayout",()=>u(this,st));h(this,"setRenderer",e=>{g(this,$e,e)});h(this,"header",(e,t,a)=>{this.finalized&&g(this,$,Je(u(this,$).body,u(this,$)));const s=u(this,$)?u(this,$).headers:u(this,Ee)??g(this,Ee,new Headers);t===void 0?s.delete(e):a!=null&&a.append?s.append(e,t):s.set(e,t)});h(this,"status",e=>{g(this,Me,e)});h(this,"set",(e,t)=>{u(this,se)??g(this,se,new Map),u(this,se).set(e,t)});h(this,"get",e=>u(this,se)?u(this,se).get(e):void 0);h(this,"newResponse",(...e)=>w(this,ue,Ce).call(this,...e));h(this,"body",(e,t,a)=>w(this,ue,Ce).call(this,e,t,a));h(this,"text",(e,t,a)=>!u(this,Ee)&&!u(this,Me)&&!t&&!a&&!this.finalized?new Response(e):w(this,ue,Ce).call(this,e,t,Ot(xs,a)));h(this,"json",(e,t,a)=>w(this,ue,Ce).call(this,JSON.stringify(e),t,Ot("application/json",a)));h(this,"html",(e,t,a)=>{const s=n=>w(this,ue,Ce).call(this,n,t,Ot("text/html; charset=UTF-8",a));return typeof e=="object"?Ta(e,ys.Stringify,!1,{}).then(s):s(e)});h(this,"redirect",(e,t)=>{const a=String(e);return this.header("Location",/[^\x00-\xFF]/.test(a)?encodeURI(a):a),this.newResponse(null,t??302)});h(this,"notFound",()=>(u(this,Fe)??g(this,Fe,()=>Je()),u(this,Fe).call(this,this)));g(this,tt,e),t&&(g(this,ne,t.executionCtx),this.env=t.env,g(this,Fe,t.notFoundHandler),g(this,it,t.path),g(this,nt,t.matchResult))}get req(){return u(this,at)??g(this,at,new wa(u(this,tt),u(this,it),u(this,nt))),u(this,at)}get event(){if(u(this,ne)&&"respondWith"in u(this,ne))return u(this,ne);throw Error("This context has no FetchEvent")}get executionCtx(){if(u(this,ne))return u(this,ne);throw Error("This context has no ExecutionContext")}get res(){return u(this,$)||g(this,$,Je(null,{headers:u(this,Ee)??g(this,Ee,new Headers)}))}set res(e){if(u(this,$)&&e){e=Je(e.body,e);for(const[t,a]of u(this,$).headers.entries())if(t!=="content-type")if(t==="set-cookie"){const s=u(this,$).headers.getSetCookie();e.headers.delete("set-cookie");for(const n of s)e.headers.append("set-cookie",n)}else e.headers.set(t,a)}g(this,$,e),this.finalized=!0}get var(){return u(this,se)?Object.fromEntries(u(this,se)):{}}},tt=new WeakMap,at=new WeakMap,se=new WeakMap,Me=new WeakMap,ne=new WeakMap,$=new WeakMap,st=new WeakMap,$e=new WeakMap,Fe=new WeakMap,Ee=new WeakMap,nt=new WeakMap,it=new WeakMap,ue=new WeakSet,Ce=function(e,t,a){const s=u(this,$)?new Headers(u(this,$).headers):u(this,Ee)??new Headers;if(typeof t=="object"&&"headers"in t){const i=t.headers instanceof Headers?t.headers:new Headers(t.headers);for(const[r,o]of i)r.toLowerCase()==="set-cookie"?s.append(r,o):s.set(r,o)}if(a)for(const[i,r]of Object.entries(a))if(typeof r=="string")s.set(i,r);else{s.delete(i);for(const o of r)s.append(i,o)}const n=typeof t=="number"?t:(t==null?void 0:t.status)??u(this,Me);return Je(e,{status:n,headers:s})},pa),O="ALL",ws="all",ks=["get","post","put","delete","options","patch"],Aa="Can not add a route since the matcher is already built.",Da=class extends Error{},Ss="__COMPOSED_HANDLER",Ts=e=>e.text("404 Not Found",404),Gt=(e,t)=>{if("getResponse"in e){const a=e.getResponse();return t.newResponse(a.body,a)}return console.error(e),t.text("Internal Server Error",500)},V,R,Ia,X,ye,mt,ft,Pe,As=(Pe=class{constructor(t={}){y(this,R);h(this,"get");h(this,"post");h(this,"put");h(this,"delete");h(this,"options");h(this,"patch");h(this,"all");h(this,"on");h(this,"use");h(this,"router");h(this,"getPath");h(this,"_basePath","/");y(this,V,"/");h(this,"routes",[]);y(this,X,Ts);h(this,"errorHandler",Gt);h(this,"onError",t=>(this.errorHandler=t,this));h(this,"notFound",t=>(g(this,X,t),this));h(this,"fetch",(t,...a)=>w(this,R,ft).call(this,t,a[1],a[0],t.method));h(this,"request",(t,a,s,n)=>t instanceof Request?this.fetch(a?new Request(t,a):t,s,n):(t=t.toString(),this.fetch(new Request(/^https?:\/\//.test(t)?t:`http://localhost${Be("/",t)}`,a),s,n)));h(this,"fire",()=>{addEventListener("fetch",t=>{t.respondWith(w(this,R,ft).call(this,t.request,t,void 0,t.request.method))})});[...ks,ws].forEach(i=>{this[i]=(r,...o)=>(typeof r=="string"?g(this,V,r):w(this,R,ye).call(this,i,u(this,V),r),o.forEach(d=>{w(this,R,ye).call(this,i,u(this,V),d)}),this)}),this.on=(i,r,...o)=>{for(const d of[r].flat()){g(this,V,d);for(const l of[i].flat())o.map(c=>{w(this,R,ye).call(this,l.toUpperCase(),u(this,V),c)})}return this},this.use=(i,...r)=>(typeof i=="string"?g(this,V,i):(g(this,V,"*"),r.unshift(i)),r.forEach(o=>{w(this,R,ye).call(this,O,u(this,V),o)}),this);const{strict:s,...n}=t;Object.assign(this,n),this.getPath=s??!0?t.getPath??va:_s}route(t,a){const s=this.basePath(t);return a.routes.map(n=>{var r;let i;a.errorHandler===Gt?i=n.handler:(i=async(o,d)=>(await Vt([],a.errorHandler)(o,()=>n.handler(o,d))).res,i[Ss]=n.handler),w(r=s,R,ye).call(r,n.method,n.path,i)}),this}basePath(t){const a=w(this,R,Ia).call(this);return a._basePath=Be(this._basePath,t),a}mount(t,a,s){let n,i;s&&(typeof s=="function"?i=s:(i=s.optionHandler,s.replaceRequest===!1?n=d=>d:n=s.replaceRequest));const r=i?d=>{const l=i(d);return Array.isArray(l)?l:[l]}:d=>{let l;try{l=d.executionCtx}catch{}return[d.env,l]};n||(n=(()=>{const d=Be(this._basePath,t),l=d==="/"?0:d.length;return c=>{const p=new URL(c.url);return p.pathname=p.pathname.slice(l)||"/",new Request(p,c)}})());const o=async(d,l)=>{const c=await a(n(d.req.raw),...r(d));if(c)return c;await l()};return w(this,R,ye).call(this,O,Be(t,"*"),o),this}},V=new WeakMap,R=new WeakSet,Ia=function(){const t=new Pe({router:this.router,getPath:this.getPath});return t.errorHandler=this.errorHandler,g(t,X,u(this,X)),t.routes=this.routes,t},X=new WeakMap,ye=function(t,a,s){t=t.toUpperCase(),a=Be(this._basePath,a);const n={basePath:this._basePath,path:a,method:t,handler:s};this.router.add(t,a,[s,n]),this.routes.push(n)},mt=function(t,a){if(t instanceof Error)return this.errorHandler(t,a);throw t},ft=function(t,a,s,n){if(n==="HEAD")return(async()=>new Response(null,await w(this,R,ft).call(this,t,a,s,"GET")))();const i=this.getPath(t,{env:s}),r=this.router.match(n,i),o=new Es(t,{path:i,matchResult:r,env:s,executionCtx:a,notFoundHandler:u(this,X)});if(r[0].length===1){let l;try{l=r[0][0][0][0](o,async()=>{o.res=await u(this,X).call(this,o)})}catch(c){return w(this,R,mt).call(this,c,o)}return l instanceof Promise?l.then(c=>c||(o.finalized?o.res:u(this,X).call(this,o))).catch(c=>w(this,R,mt).call(this,c,o)):l??u(this,X).call(this,o)}const d=Vt(r[0],this.errorHandler,u(this,X));return(async()=>{try{const l=await d(o);if(!l.finalized)throw new Error("Context is not finalized. Did you forget to return a Response object or `await next()`?");return l.res}catch(l){return w(this,R,mt).call(this,l,o)}})()},Pe),Oa=[];function Ds(e,t){const a=this.buildAllMatchers(),s=((n,i)=>{const r=a[n]||a[O],o=r[2][i];if(o)return o;const d=i.match(r[0]);if(!d)return[[],Oa];const l=d.indexOf("",1);return[r[1][l],d]});return this.match=s,s(e,t)}var _t="[^/]+",Xe=".*",Ge="(?:|/.*)",Le=Symbol(),Is=new Set(".\\+*[^]$()");function Os(e,t){return e.length===1?t.length===1?e<t?-1:1:-1:t.length===1||e===Xe||e===Ge?1:t===Xe||t===Ge?-1:e===_t?1:t===_t?-1:e.length===t.length?e<t?-1:1:t.length-e.length}var we,ke,G,Ae,Rs=(Ae=class{constructor(){y(this,we);y(this,ke);y(this,G,Object.create(null))}insert(t,a,s,n,i){if(t.length===0){if(u(this,we)!==void 0)throw Le;if(i)return;g(this,we,a);return}const[r,...o]=t,d=r==="*"?o.length===0?["","",Xe]:["","",_t]:r==="/*"?["","",Ge]:r.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);let l;if(d){const c=d[1];let p=d[2]||_t;if(c&&d[2]&&(p===".*"||(p=p.replace(/^\((?!\?:)(?=[^)]+\)$)/,"(?:"),/\((?!\?:)/.test(p))))throw Le;if(l=u(this,G)[p],!l){if(Object.keys(u(this,G)).some(f=>f!==Xe&&f!==Ge))throw Le;if(i)return;l=u(this,G)[p]=new Ae,c!==""&&g(l,ke,n.varIndex++)}!i&&c!==""&&s.push([c,u(l,ke)])}else if(l=u(this,G)[r],!l){if(Object.keys(u(this,G)).some(c=>c.length>1&&c!==Xe&&c!==Ge))throw Le;if(i)return;l=u(this,G)[r]=new Ae}l.insert(o,a,s,n,i)}buildRegExpStr(){const a=Object.keys(u(this,G)).sort(Os).map(s=>{const n=u(this,G)[s];return(typeof u(n,ke)=="number"?`(${s})@${u(n,ke)}`:Is.has(s)?`\\${s}`:s)+n.buildRegExpStr()});return typeof u(this,we)=="number"&&a.unshift(`#${u(this,we)}`),a.length===0?"":a.length===1?a[0]:"(?:"+a.join("|")+")"}},we=new WeakMap,ke=new WeakMap,G=new WeakMap,Ae),vt,rt,ma,js=(ma=class{constructor(){y(this,vt,{varIndex:0});y(this,rt,new Rs)}insert(e,t,a){const s=[],n=[];for(let r=0;;){let o=!1;if(e=e.replace(/\{[^}]+\}/g,d=>{const l=`@\\${r}`;return n[r]=[l,d],r++,o=!0,l}),!o)break}const i=e.match(/(?::[^\/]+)|(?:\/\*$)|./g)||[];for(let r=n.length-1;r>=0;r--){const[o]=n[r];for(let d=i.length-1;d>=0;d--)if(i[d].indexOf(o)!==-1){i[d]=i[d].replace(o,n[r][1]);break}}return u(this,rt).insert(i,t,s,u(this,vt),a),s}buildRegExp(){let e=u(this,rt).buildRegExpStr();if(e==="")return[/^$/,[],[]];let t=0;const a=[],s=[];return e=e.replace(/#(\d+)|@(\d+)|\.\*\$/g,(n,i,r)=>i!==void 0?(a[++t]=Number(i),"$()"):(r!==void 0&&(s[Number(r)]=++t),"")),[new RegExp(`^${e}`),a,s]}},vt=new WeakMap,rt=new WeakMap,ma),Bs=[/^$/,[],Object.create(null)],ht=Object.create(null);function Ra(e){return ht[e]??(ht[e]=new RegExp(e==="*"?"":`^${e.replace(/\/\*$|([.\\+*[^\]$()])/g,(t,a)=>a?`\\${a}`:"(?:|/.*)")}$`))}function Cs(){ht=Object.create(null)}function Ls(e){var l;const t=new js,a=[];if(e.length===0)return Bs;const s=e.map(c=>[!/\*|\/:/.test(c[0]),...c]).sort(([c,p],[f,b])=>c?1:f?-1:p.length-b.length),n=Object.create(null);for(let c=0,p=-1,f=s.length;c<f;c++){const[b,_,S]=s[c];b?n[_]=[S.map(([A])=>[A,Object.create(null)]),Oa]:p++;let E;try{E=t.insert(_,p,b)}catch(A){throw A===Le?new Da(_):A}b||(a[p]=S.map(([A,x])=>{const j=Object.create(null);for(x-=1;x>=0;x--){const[B,M]=E[x];j[B]=M}return[A,j]}))}const[i,r,o]=t.buildRegExp();for(let c=0,p=a.length;c<p;c++)for(let f=0,b=a[c].length;f<b;f++){const _=(l=a[c][f])==null?void 0:l[1];if(!_)continue;const S=Object.keys(_);for(let E=0,A=S.length;E<A;E++)_[S[E]]=o[_[S[E]]]}const d=[];for(const c in r)d[c]=a[r[c]];return[i,d,n]}function je(e,t){if(e){for(const a of Object.keys(e).sort((s,n)=>n.length-s.length))if(Ra(a).test(t))return[...e[a]]}}var pe,me,yt,ja,fa,Ns=(fa=class{constructor(){y(this,yt);h(this,"name","RegExpRouter");y(this,pe);y(this,me);h(this,"match",Ds);g(this,pe,{[O]:Object.create(null)}),g(this,me,{[O]:Object.create(null)})}add(e,t,a){var o;const s=u(this,pe),n=u(this,me);if(!s||!n)throw new Error(Aa);s[e]||[s,n].forEach(d=>{d[e]=Object.create(null),Object.keys(d[O]).forEach(l=>{d[e][l]=[...d[O][l]]})}),t==="/*"&&(t="*");const i=(t.match(/\/:/g)||[]).length;if(/\*$/.test(t)){const d=Ra(t);e===O?Object.keys(s).forEach(l=>{var c;(c=s[l])[t]||(c[t]=je(s[l],t)||je(s[O],t)||[])}):(o=s[e])[t]||(o[t]=je(s[e],t)||je(s[O],t)||[]),Object.keys(s).forEach(l=>{(e===O||e===l)&&Object.keys(s[l]).forEach(c=>{d.test(c)&&s[l][c].push([a,i])})}),Object.keys(n).forEach(l=>{(e===O||e===l)&&Object.keys(n[l]).forEach(c=>d.test(c)&&n[l][c].push([a,i]))});return}const r=ya(t)||[t];for(let d=0,l=r.length;d<l;d++){const c=r[d];Object.keys(n).forEach(p=>{var f;(e===O||e===p)&&((f=n[p])[c]||(f[c]=[...je(s[p],c)||je(s[O],c)||[]]),n[p][c].push([a,i-l+d+1]))})}}buildAllMatchers(){const e=Object.create(null);return Object.keys(u(this,me)).concat(Object.keys(u(this,pe))).forEach(t=>{e[t]||(e[t]=w(this,yt,ja).call(this,t))}),g(this,pe,g(this,me,void 0)),Cs(),e}},pe=new WeakMap,me=new WeakMap,yt=new WeakSet,ja=function(e){const t=[];let a=e===O;return[u(this,pe),u(this,me)].forEach(s=>{const n=s[e]?Object.keys(s[e]).map(i=>[i,s[e][i]]):[];n.length!==0?(a||(a=!0),t.push(...n)):e!==O&&t.push(...Object.keys(s[O]).map(i=>[i,s[O][i]]))}),a?Ls(t):null},fa),fe,ie,ha,Ms=(ha=class{constructor(e){h(this,"name","SmartRouter");y(this,fe,[]);y(this,ie,[]);g(this,fe,e.routers)}add(e,t,a){if(!u(this,ie))throw new Error(Aa);u(this,ie).push([e,t,a])}match(e,t){if(!u(this,ie))throw new Error("Fatal error");const a=u(this,fe),s=u(this,ie),n=a.length;let i=0,r;for(;i<n;i++){const o=a[i];try{for(let d=0,l=s.length;d<l;d++)o.add(...s[d]);r=o.match(e,t)}catch(d){if(d instanceof Da)continue;throw d}this.match=o.match.bind(o),g(this,fe,[o]),g(this,ie,void 0);break}if(i===n)throw new Error("Fatal error");return this.name=`SmartRouter + ${this.activeRouter.name}`,r}get activeRouter(){if(u(this,ie)||u(this,fe).length!==1)throw new Error("No active router has been determined yet.");return u(this,fe)[0]}},fe=new WeakMap,ie=new WeakMap,ha),Ke=Object.create(null),$s=e=>{for(const t in e)return!0;return!1},he,L,Se,qe,C,re,xe,He,Fs=(He=class{constructor(t,a,s){y(this,re);y(this,he);y(this,L);y(this,Se);y(this,qe,0);y(this,C,Ke);if(g(this,L,s||Object.create(null)),g(this,he,[]),t&&a){const n=Object.create(null);n[t]={handler:a,possibleKeys:[],score:0},g(this,he,[n])}g(this,Se,[])}insert(t,a,s){g(this,qe,++Kt(this,qe)._);let n=this;const i=ms(a),r=[];for(let o=0,d=i.length;o<d;o++){const l=i[o],c=i[o+1],p=gs(l,c),f=Array.isArray(p)?p[0]:l;if(f in u(n,L)){n=u(n,L)[f],p&&r.push(p[1]);continue}u(n,L)[f]=new He,p&&(u(n,Se).push(p),r.push(p[1])),n=u(n,L)[f]}return u(n,he).push({[t]:{handler:s,possibleKeys:r.filter((o,d,l)=>l.indexOf(o)===d),score:u(this,qe)}}),n}search(t,a){var c;const s=[];g(this,C,Ke);let i=[this];const r=_a(a),o=[],d=r.length;let l=null;for(let p=0;p<d;p++){const f=r[p],b=p===d-1,_=[];for(let E=0,A=i.length;E<A;E++){const x=i[E],j=u(x,L)[f];j&&(g(j,C,u(x,C)),b?(u(j,L)["*"]&&w(this,re,xe).call(this,s,u(j,L)["*"],t,u(x,C)),w(this,re,xe).call(this,s,j,t,u(x,C))):_.push(j));for(let B=0,M=u(x,Se).length;B<M;B++){const ct=u(x,Se)[B],Q=u(x,C)===Ke?{}:{...u(x,C)};if(ct==="*"){const Oe=u(x,L)["*"];Oe&&(w(this,re,xe).call(this,s,Oe,t,u(x,C)),g(Oe,C,Q),_.push(Oe));continue}const[ns,Yt,ze]=ct;if(!f&&!(ze instanceof RegExp))continue;const ae=u(x,L)[ns];if(ze instanceof RegExp){if(l===null){l=new Array(d);let Re=a[0]==="/"?1:0;for(let Ye=0;Ye<d;Ye++)l[Ye]=Re,Re+=r[Ye].length+1}const Oe=a.substring(l[p]),At=ze.exec(Oe);if(At){if(Q[Yt]=At[0],w(this,re,xe).call(this,s,ae,t,u(x,C),Q),$s(u(ae,L))){g(ae,C,Q);const Re=((c=At[0].match(/\//))==null?void 0:c.length)??0;(o[Re]||(o[Re]=[])).push(ae)}continue}}(ze===!0||ze.test(f))&&(Q[Yt]=f,b?(w(this,re,xe).call(this,s,ae,t,Q,u(x,C)),u(ae,L)["*"]&&w(this,re,xe).call(this,s,u(ae,L)["*"],t,Q,u(x,C))):(g(ae,C,Q),_.push(ae)))}}const S=o.shift();i=S?_.concat(S):_}return s.length>1&&s.sort((p,f)=>p.score-f.score),[s.map(({handler:p,params:f})=>[p,f])]}},he=new WeakMap,L=new WeakMap,Se=new WeakMap,qe=new WeakMap,C=new WeakMap,re=new WeakSet,xe=function(t,a,s,n,i){for(let r=0,o=u(a,he).length;r<o;r++){const d=u(a,he)[r],l=d[s]||d[O],c={};if(l!==void 0&&(l.params=Object.create(null),t.push(l),n!==Ke||i&&i!==Ke))for(let p=0,f=l.possibleKeys.length;p<f;p++){const b=l.possibleKeys[p],_=c[l.score];l.params[b]=i!=null&&i[b]&&!_?i[b]:n[b]??(i==null?void 0:i[b]),c[l.score]=!0}}},He),Te,ga,Ps=(ga=class{constructor(){h(this,"name","TrieRouter");y(this,Te);g(this,Te,new Fs)}add(e,t,a){const s=ya(t);if(s){for(let n=0,i=s.length;n<i;n++)u(this,Te).insert(e,s[n],a);return}u(this,Te).insert(e,t,a)}match(e,t){return u(this,Te).search(e,t)}},Te=new WeakMap,ga),D=class extends As{constructor(e={}){super(e),this.router=e.router??new Ms({routers:[new Ns,new Ps]})}},qs=/^\s*(?:text\/(?!event-stream(?:[;\s]|$))[^;\s]+|application\/(?:javascript|json|xml|xml-dtd|ecmascript|dart|postscript|rtf|tar|toml|vnd\.dart|vnd\.ms-fontobject|vnd\.ms-opentype|wasm|x-httpd-php|x-javascript|x-ns-proxy-autoconfig|x-sh|x-tar|x-virtualbox-hdd|x-virtualbox-ova|x-virtualbox-ovf|x-virtualbox-vbox|x-virtualbox-vdi|x-virtualbox-vhd|x-virtualbox-vmdk|x-www-form-urlencoded)|font\/(?:otf|ttf)|image\/(?:bmp|vnd\.adobe\.photoshop|vnd\.microsoft\.icon|vnd\.ms-dds|x-icon|x-ms-bmp)|message\/rfc822|model\/gltf-binary|x-shader\/x-fragment|x-shader\/x-vertex|[^;\s]+?\+(?:json|text|xml|yaml))(?:[;\s]|$)/i,Zt=(e,t=Us)=>{const a=/\.([a-zA-Z0-9]+?)$/,s=e.match(a);if(!s)return;let n=t[s[1].toLowerCase()];return n&&n.startsWith("text")&&(n+="; charset=utf-8"),n},Hs={aac:"audio/aac",avi:"video/x-msvideo",avif:"image/avif",av1:"video/av1",bin:"application/octet-stream",bmp:"image/bmp",css:"text/css",csv:"text/csv",eot:"application/vnd.ms-fontobject",epub:"application/epub+zip",gif:"image/gif",gz:"application/gzip",htm:"text/html",html:"text/html",ico:"image/x-icon",ics:"text/calendar",jpeg:"image/jpeg",jpg:"image/jpeg",js:"text/javascript",json:"application/json",jsonld:"application/ld+json",map:"application/json",mid:"audio/x-midi",midi:"audio/x-midi",mjs:"text/javascript",mp3:"audio/mpeg",mp4:"video/mp4",mpeg:"video/mpeg",oga:"audio/ogg",ogv:"video/ogg",ogx:"application/ogg",opus:"audio/opus",otf:"font/otf",pdf:"application/pdf",png:"image/png",rtf:"application/rtf",svg:"image/svg+xml",tif:"image/tiff",tiff:"image/tiff",ts:"video/mp2t",ttf:"font/ttf",txt:"text/plain",wasm:"application/wasm",webm:"video/webm",weba:"audio/webm",webmanifest:"application/manifest+json",webp:"image/webp",woff:"font/woff",woff2:"font/woff2",xhtml:"application/xhtml+xml",xml:"application/xml",zip:"application/zip","3gp":"video/3gpp","3g2":"video/3gpp2",gltf:"model/gltf+json",glb:"model/gltf-binary"},Us=Hs,Ws=(...e)=>{let t=e.filter(n=>n!=="").join("/");t=t.replace(new RegExp("(?<=\\/)\\/+","g"),"");const a=t.split("/"),s=[];for(const n of a)n===".."&&s.length>0&&s.at(-1)!==".."?s.pop():n!=="."&&s.push(n);return s.join("/")||"."},Ba={br:".br",zstd:".zst",gzip:".gz"},zs=Object.keys(Ba),Ys="index.html",Js=e=>{const t=e.root??"./",a=e.path,s=e.join??Ws;return async(n,i)=>{var c,p,f,b;if(n.finalized)return i();let r;if(e.path)r=e.path;else try{if(r=ba(n.req.path),/(?:^|[\/\\])\.{1,2}(?:$|[\/\\])|[\/\\]{2,}/.test(r))throw new Error}catch{return await((c=e.onNotFound)==null?void 0:c.call(e,n.req.path,n)),i()}let o=s(t,!a&&e.rewriteRequestPath?e.rewriteRequestPath(r):r);e.isDir&&await e.isDir(o)&&(o=s(o,Ys));const d=e.getContent;let l=await d(o,n);if(l instanceof Response)return n.newResponse(l.body,l);if(l){const _=e.mimes&&Zt(o,e.mimes)||Zt(o);if(n.header("Content-Type",_||"application/octet-stream"),e.precompressed&&(!_||qs.test(_))){const S=new Set((p=n.req.header("Accept-Encoding"))==null?void 0:p.split(",").map(E=>E.trim()));for(const E of zs){if(!S.has(E))continue;const A=await d(o+Ba[E],n);if(A){l=A,n.header("Content-Encoding",E),n.header("Vary","Accept-Encoding",{append:!0});break}}}return await((f=e.onFound)==null?void 0:f.call(e,o,n)),n.body(l)}await((b=e.onNotFound)==null?void 0:b.call(e,o,n)),await i()}},Ks=async(e,t)=>{let a;t&&t.manifest?typeof t.manifest=="string"?a=JSON.parse(t.manifest):a=t.manifest:typeof __STATIC_CONTENT_MANIFEST=="string"?a=JSON.parse(__STATIC_CONTENT_MANIFEST):a=__STATIC_CONTENT_MANIFEST;let s;t&&t.namespace?s=t.namespace:s=__STATIC_CONTENT;const n=a[e];if(!n)return null;const i=await s.get(n,{type:"stream"});return i||null},Vs=e=>async function(a,s){return Js({...e,getContent:async i=>Ks(i,{manifest:e.manifest,namespace:e.namespace?e.namespace:a.env?a.env.__STATIC_CONTENT:void 0})})(a,s)},Xs=e=>Vs(e);const W={name:"Growth-engine365X",version:"ver1.00",tagline:"X (Twitter) 自動投稿プラットフォーム",longName:"X (Twitter) 自動投稿プラットフォーム",icon:"fa-bolt"},Gs=`
<meta charset="utf-8">
...
`,Zs="bg-paper text-ink min-h-screen font-sans antialiased";function Mt(e,t,a={}){return`<!DOCTYPE html>
<html lang="ja">
<head>
${Gs}
<title>${e} — ${W.name}</title>
</head>
<body class="${a.bodyClass??Zs}">
${t}
</body>
</html>`}const Ca=new D;Ca.get("/login",e=>{const t=`
...
<\/script>
`;return e.html(Mt("ログイン",t))});const oe=new TextEncoder,La=new TextDecoder;function Ze(e){let t="";for(let a=0;a<e.length;a++)t+=String.fromCharCode(e[a]);return btoa(t)}function Qe(e){const t=atob(e),a=new Uint8Array(t.length);for(let s=0;s<t.length;s++)a[s]=t.charCodeAt(s);return a}function gt(e){return Ze(e).replace(/\+/g,"-").replace(/\//g,"_").replace(/=+$/,"")}function jt(e){const t="=".repeat((4-e.length%4)%4);return Qe((e+t).replace(/-/g,"+").replace(/_/g,"/"))}function ot(e){const t=new Uint8Array(e);return crypto.getRandomValues(t),t}function Qs(e){return[...ot(e)].map(t=>t.toString(16).padStart(2,"0")).join("")}const Qt=1e5,en=32;async function xt(e){const t=ot(16),a=await crypto.subtle.importKey("raw",oe.encode(e),{name:"PBKDF2"},!1,["deriveBits"]),s=await crypto.subtle.deriveBits({name:"PBKDF2",salt:t,iterations:Qt,hash:"SHA-256"},a,en*8);return`pbkdf2$${Qt}$${Ze(t)}$${Ze(new Uint8Array(s))}`}async function $t(e,t){try{const[a,s,n,i]=t.split("$");if(a!=="pbkdf2")return!1;const r=parseInt(s,10),o=Qe(n),d=Qe(i),l=await crypto.subtle.importKey("raw",oe.encode(e),{name:"PBKDF2"},!1,["deriveBits"]),c=new Uint8Array(await crypto.subtle.deriveBits({name:"PBKDF2",salt:o,iterations:r,hash:"SHA-256"},l,d.length*8));return Na(c,d)}catch{return!1}}function Na(e,t){if(e.length!==t.length)return!1;let a=0;for(let s=0;s<e.length;s++)a|=e[s]^t[s];return a===0}async function Ma(e){return crypto.subtle.importKey("raw",oe.encode(e),{name:"HMAC",hash:"SHA-256"},!1,["sign","verify"])}async function $a(e,t,a=3600*24*7){const s=Math.floor(Date.now()/1e3),n={iat:s,exp:s+a,...e},i=gt(oe.encode(JSON.stringify({alg:"HS256",typ:"JWT"}))),r=gt(oe.encode(JSON.stringify(n))),o=`${i}.${r}`,d=await Ma(t),l=new Uint8Array(await crypto.subtle.sign("HMAC",d,oe.encode(o)));return`${o}.${gt(l)}`}async function Fa(e,t){try{const[a,s,n]=e.split(".");if(!a||!s||!n)return null;const i=await Ma(t);if(!await crypto.subtle.verify("HMAC",i,jt(n),oe.encode(`${a}.${s}`)))return null;const o=JSON.parse(La.decode(jt(s)));return o.exp&&o.exp<Math.floor(Date.now()/1e3)?null:o}catch{return null}}async function Pa(e){const t=oe.encode(e),a=t.length>=32?t.slice(0,32):new Uint8Array(await crypto.subtle.digest("SHA-256",t));return crypto.subtle.importKey("raw",a,{name:"AES-GCM"},!1,["encrypt","decrypt"])}async function ee(e,t){const a=ot(12),s=await Pa(t),n=new Uint8Array(await crypto.subtle.encrypt({name:"AES-GCM",iv:a},s,oe.encode(e))),i=new Uint8Array(a.length+n.length);return i.set(a),i.set(n,a.length),Ze(i)}async function et(e,t){const a=Qe(e),s=a.slice(0,12),n=a.slice(12),i=await Pa(t),r=await crypto.subtle.decrypt({name:"AES-GCM",iv:s},i,n);return La.decode(r)}const ea="ABCDEFGHJKLMNPQRSTUVWXYZ23456789";function Bt(e="VPS-GE365X"){const t=ot(8);let a="";for(let s=0;s<8;s++)a+=ea[t[s]%ea.length];return`${e}-${a}`}function qa(e){return/^VPS-GE365X-[A-Z0-9]{6,12}$/i.test(e.trim())}function v(){return new Date(Date.now()+324e5).toISOString().replace("T"," ").slice(0,19)}function tn(e,t){return new Response(JSON.stringify(e),{...t,headers:{"content-type":"application/json; charset=utf-8",...(t==null?void 0:t.headers)||{}}})}function Ha(e,t){const s=(e.headers.get("cookie")||"").split(";").map(n=>n.trim()).find(n=>n.startsWith(t+"="));return s?decodeURIComponent(s.slice(t.length+1)):null}function Ft(e,t,a={}){const s=[`${e}=${encodeURIComponent(t)}`];return s.push(`Path=${a.path??"/"}`),a.maxAge!==void 0&&s.push(`Max-Age=${a.maxAge}`),a.httpOnly!==!1&&s.push("HttpOnly"),a.secure!==!1&&s.push("Secure"),s.push(`SameSite=${a.sameSite??"Lax"}`),s.join("; ")}const Et=Object.freeze(Object.defineProperty({__proto__:null,aesDecrypt:et,aesEncrypt:ee,b64decode:Qe,b64encode:Ze,b64urlDecode:jt,b64urlEncode:gt,buildSetCookie:Ft,generateLicenseKey:Bt,getCookie:Ha,hashPassword:xt,isValidLicenseKeyFormat:qa,json:tn,nowJst:v,randomBytes:ot,randomHex:Qs,signJWT:$a,timingSafeEqual:Na,verifyJWT:Fa,verifyPassword:$t},Symbol.toStringTag,{value:"Module"})),Pt="ge365x_session";function an(e){const t=e.req.header("Authorization")||e.req.header("authorization");return t&&t.startsWith("Bearer ")?t.slice(7):Ha(e.req.raw,Pt)}async function m(e,t){const a=an(e);if(!a)return e.json({error:"unauthenticated"},401);const s=await Fa(a,e.env.JWT_SECRET);if(!(s!=null&&s.uid))return e.json({error:"invalid_token"},401);const n=await e.env.DB.prepare("SELECT id,email,is_approved,is_admin,trial_start,trial_end FROM users WHERE id = ?").bind(s.uid).first();if(!n)return e.json({error:"user_not_found"},401);if(n.is_approved===0)return e.json({error:"not_approved"},403);const i=await e.env.DB.prepare("SELECT plan_code,status FROM user_subscriptions WHERE user_id = ?").bind(n.id).first(),r={id:n.id,email:n.email,is_admin:n.is_admin===1,is_approved:n.is_approved===1,plan_code:i==null?void 0:i.plan_code,subscription_status:i==null?void 0:i.status};e.set("user",r),await t()}async function I(e,t){const a=e.get("user");if(!a)return e.json({error:"unauthenticated"},401);if(!a.is_admin)return e.json({error:"forbidden"},403);await t()}async function Z(e,t,a={}){const s=e.req.header("cf-connecting-ip")||e.req.header("x-forwarded-for")||"",n=e.req.header("user-agent")||"";await e.env.DB.prepare(`INSERT INTO auth_logs (user_id, email, event_type, ip_address, user_agent, metadata)
     VALUES (?, ?, ?, ?, ?, ?)`).bind(a.userId??null,a.email??null,t,s,n,a.metadata?JSON.stringify(a.metadata):null).run()}const sn=[{key:"dashboard",label:"ダッシュボード",icon:"fa-gauge-high",path:"/dashboard"},{key:"target",label:"ターゲット設定",icon:"fa-bullseye",path:"/dashboard/target"},{key:"voice",label:"ブランドボイス",icon:"fa-palette",path:"/dashboard/voice"},{key:"pattern",label:"パターン別AI生成",icon:"fa-wand-magic-sparkles",path:"/dashboard/pattern"},{key:"generate",label:"AI生成2",icon:"fa-robot",path:"/dashboard/generate"},{key:"posts",label:"X投稿管理",icon:"fa-brands fa-x-twitter",path:"/dashboard/posts"},{key:"thread",label:"ツリー投稿",icon:"fa-reply",path:"/dashboard/thread"},{key:"scheduled",label:"予約状況",icon:"fa-calendar",path:"/dashboard/scheduled"},{key:"autopilot",label:"オートパイロット",icon:"fa-plane-departure",path:"/dashboard/autopilot"},{key:"accounts",label:"アカウント管理",icon:"fa-users-gear",path:"/dashboard/accounts"},{key:"api",label:"API設定",icon:"fa-key",path:"/dashboard/api"},{key:"export",label:"一括ダウンロード",icon:"fa-download",path:"/dashboard/export"}];function nn(e,t){return`
...
<div class="min-h-screen flex bg-paper">
  ...
  <main class="flex-1 min-w-0 flex flex-col">
    ${rn(e.accounts,e.currentAccountId)}
...
`;function k(e){return(e||"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}function Ua(e){return{pending:'<span class="pill pill-warn">未承認</span>',approved:'<span class="pill pill-blue">承認済</span>',publishing:'<span class="pill pill-blue">送信中</span>',posted:'<span class="pill pill-ok">投稿済</span>',failed:'<span class="pill pill-err">失敗</span>',cancelled:'<span class="pill pill-soft">キャンセル</span>'}[e||""]||`<span class="pill pill-soft">${e||"—"}</span>`}function ln(e){const{stats:t,health:a,recentLogs:s}=e;return`
<div class="space-y-4">
  <div>
    ...
    <div class="card">
      ...
      `:a.map(n=>`
        <div class="flex items-center justify-between py-2 border-b border-line/50 last:border-0">
          <div>
            <div class="text-sm font-semibold text-ink">@${k(n.x_username||n.account_name)}</div>
    ...
    <div class="card">
      ...
      `:s.map(n=>`
        <div class="py-2 border-b border-line/50 last:border-0">
          <div class="text-sm text-ink truncate">${k((n.content||"").slice(0,80))}...</div>
          <div class="text-xs text-ink-muted mt-0.5">@${k(n.x_username||"-")} · ${n.posted_at||"-"}</div>
        </div>
      `).join("")}
    </div>
  </div>
</div>`}function cn(e){const t=e.target||{};return`
<div class="space-y-4">
  <div>
  ...
  <div class="card">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
      <div>
        ...
        <input type="text" id="tg-age" class="inp" value="${k(t.age_range)}" placeholder="例: 25~40代">
      </div>
      <div>
      ...
      <div>
        ...
        <input type="text" id="tg-occ" class="inp" value="${k(t.occupation)}" placeholder="例: 会社員 / フリーランス">
      </div>
    </div>
    <div class="mb-4">
      <label class="field-label"><i class="fas fa-heart icon-red"></i>痛み・悩み</label>
      <textarea id="tg-pains" class="inp" placeholder="読者が抱えている具体的な悩み・痛みを書く">${k(t.pains)}</textarea>
    </div>
    <div class="mb-4">
      <label class="field-label"><i class="fas fa-star icon-yellow"></i>欲求・願望</label>
      <textarea id="tg-desires" class="inp" placeholder="読者が「こうなりたい」と思っている理想像">${k(t.desires)}</textarea>
    </div>
    <div class="mb-4">
      <label class="field-label"><i class="fas fa-bolt icon-yellow"></i>行動トリガー（反応するきっかけ）</label>
      <textarea id="tg-trigger" class="inp" placeholder="この読者がアクションを起こす瞬間・キーワード">${k(t.purchase_triggers)}</textarea>
    </div>
...
<\/script>`}function un(e){const t=e.voice||{},a=[{k:"authority",l:"権威型",t:"専門家として断定的に、簡潔に、根拠を示して書く。"},{k:"empathy",l:"共感型",t:"読者の悩みに寄り添い、共感を起点に語りかけるように書く。"},{k:"provocative",l:"煽り型",t:"問題を鋭く突き、危機感を持たせる書き方にする。"},{k:"story",l:"ストーリー型",t:"体験談や変化の流れを感じさせる構成で書く。"},{k:"problem_raise",l:"問題提起型",t:"最初に課題を提示し、その原因と解決策を示す。"}];return`
<div class="space-y-4">
  <div>
  ...
  <div class="card">
    ...
    <div class="mb-4">
      ...
      <input type="text" id="vc-tone" class="inp" value="${k(t.tone)}" placeholder="例: 専門家として断定的に、簡潔に、根拠を示して書く">
    </div>
    <div class="mb-4">
      <label class="field-label"><i class="fas fa-globe icon-green"></i>世界観</label>
      <textarea id="vc-world" class="inp" placeholder="あなたが見ている世界、伝えたい価値観">${k(t.worldview)}</textarea>
    </div>
    <div class="mb-4">
      <label class="field-label"><i class="fas fa-book icon-purple"></i>個人ストーリー（任意）</label>
      <textarea id="vc-story" class="inp" placeholder="過去の体験や転機。AI が自然に織り交ぜます">${k(t.personal_story)}</textarea>
    </div>
    <div class="mb-4">
      <label class="field-label"><i class="fas fa-ban icon-red"></i>禁止ワード（改行区切り）</label>
      <textarea id="vc-ng" class="inp" placeholder="絶対に使わないワード">${k(t.prohibited_words)}</textarea>
    </div>
...
<\/script>`}function pn(e){var a,s,n;const t=[["problem","問題提起型","fa-circle-question"],["before_after","ビフォーアフター型","fa-right-left"],["contrarian","逆張り型","fa-rotate-left"],["howto","HowTo実演型","fa-list-ol"],["numbers","数字インパクト型","fa-hashtag"]];return`
<div class="space-y-4">
  <div>
    ...
    <div class="card">
      ...
      <div class="space-y-2 text-sm">
        <div class="p-2 bg-paper-soft rounded-md">
          ...
          <div class="text-ink">${k(((a=e.target)==null?void 0:a.age_range)||"未設定")} / ${k(((s=e.target)==null?void 0:s.gender)||"-")}</div>
        </div>
        <div class="p-2 bg-paper-soft rounded-md">
          <div class="text-xs text-ink-muted">ブランドボイス</div>
          <div class="text-ink text-xs">${k((((n=e.voice)==null?void 0:n.tone)||"未設定").slice(0,50))}...</div>
        </div>
        <div class="p-2 bg-paper-soft rounded-md">
          <div class="text-xs text-ink-muted">投稿先アカウント</div>
          <div class="text-ink">${e.currentAcct?"@"+k(e.currentAcct.x_username||e.currentAcct.account_name):"未選択"}</div>
        </div>
      </div>
    </div>
  </div>
...
<\/script>`}function fn(e){const{month:t,y:a,m:s,posts:n,stats:i}=e;return`
<div class="space-y-4">
  ${e.hasAccount?"":e.noAccountAlert}
  <div>
      ...
      <tbody>
        ${n.length===0?'<tr><td colspan="7" class="text-center text-ink-muted py-10">この月の投稿データがありません</td></tr>':n.map(r=>`
            <tr>
              ...
              <td class="max-w-md"><div class="truncate">${k((r.body||"").slice(0,80))}</div></td>
              <td>${r.post_mode==="140"?"140文字":r.post_mode==="thread"?"スレッド":"フル文章"}</td>
              <td>${Ua(r.status)}</td>
              <td class="text-xs">@${k(r.x_username||"-")}</td>
              <td class="text-right">
  ...
  <div class="card">
    ...
    `:e.history.map(t=>`
      <div class="border border-line rounded-lg p-3 mb-2">
        <div class="text-xs text-ink-muted mb-1">Parent: <span class="font-mono text-accent">${t.thread_parent_id||"-"}</span> ${Ua(t.status)}</div>
        <div class="text-sm whitespace-pre-line">${k((t.body||"").slice(0,200))}</div>
      </div>
    `).join("")}
  </div>
</div>
...
(function(){
  ...
  async function load() {
    try {
      var r = await fetch('/api/admin/posts-scheduled');
      var j = await r.json();
      SC.data = j.posts || [];
      SC.loaded = true;
      ...
      <tbody>
        ${e.jobs.length===0?'<tr><td colspan="8" class="text-center text-ink-muted py-10">予約がまだありません</td></tr>':e.jobs.map((t,a)=>`
            <tr>
              ...
              <td class="text-xs">@${k(t.x_username||"-")}</td>
              <td><span class="pill pill-soft">${k(t.content_mode||"-")}</span></td>
              <td class="text-xs max-w-xs truncate">${k(t.theme||"—")}</td>
              <td><span class="pill ${t.status==="error"?"pill-err":t.status==="posted"?"pill-ok":"pill-blue"}">${k(t.status)}</span></td>
              <td class="text-right">
      ...
      <div class="space-y-3">
        <div>
          ...
          <select id="ap-account" class="inp">
            <option value="">—</option>
            ${e.accounts.map(t=>`<option value="${t.id}">@${k(t.x_username||t.account_name)}</option>`).join("")}
          </select>
        </div>
    ...
    <div class="card" style="padding:0">
      <table class="data">
        ...
        <tbody>
          ${e.accounts.map(t=>`
            <tr>
              <td class="font-semibold">${k(t.account_name)}</td>
              <td class="text-accent">@${k(t.x_username||"未認証")}</td>
...
<\/script>`}function xn(e){const t=e.settings||{};return`
<div class="space-y-4">
  <div>
  ...
  <div class="card space-y-4">
    ...
    <div>
      ...
      <input type="text" id="api-xk" class="inp input-mono" placeholder="未設定" value="${k(t.api_key||"")}">
    </div>
    <div>
      <label class="field-label"><i class="fas fa-key icon-yellow"></i>API Secret (Consumer Secret)</label>
      <input type="password" id="api-xs" class="inp input-mono" placeholder="未設定" value="${k(t.api_secret||"")}">
    </div>
  ...
  <div class="card space-y-4">
    ...
    <div style="display:grid;grid-template-columns:1fr 1fr;gap:1rem">
      ...
      <div>
        ...
        <input type="text" id="api-tg-chat" class="inp input-mono" placeholder="-100XXXXXXXXXX" value="${k(t.telegram_chat_id||"")}">
      </div>
    </div>
    <div style="display:flex;gap:.5rem;align-items:center;flex-wrap:wrap">
...
<\/script>`}const H=new D;async function En(e,t){const{results:a}=await e.env.DB.prepare(`SELECT id, account_name, x_username, is_current
       FROM x_accounts WHERE user_id = ? AND is_active = 1 ORDER BY id`).bind(t.id).all(),s=(a||[]).map(i=>({id:i.id,account_name:i.account_name,x_username:i.x_username})),n=(a||[]).find(i=>i.is_current===1);return{accounts:s,currentAccountId:(n==null?void 0:n.id)??null}}H.get("/",e=>e.redirect("/login"));async function K(e,t,a){const s=e.get("user"),{accounts:n,currentAccountId:i}=await En(e,s),r=n.length>0&&i!==null,o=await Promise.resolve(a({user:s,hasAccount:r,accounts:n,currentAccountId:i})),d=dn({active:t,user:s,accounts:n,currentAccountId:i,pageBody:o});return e.html(Mt("GE365x",d))}H.get("/dashboard",m,async e=>K(e,"dashboard",async({user:t,hasAccount:a})=>{const s=await e.env.DB.prepare("SELECT COUNT(*) AS n FROM x_accounts WHERE user_id=?").bind(t.id).first(),n=await e.env.DB.prepare("SELECT COUNT(*) AS n FROM post_logs WHERE user_id=? AND DATE(created_at)=DATE('now','+9 hours') AND status='posted'").bind(t.id).first(),i=await e.env.DB.prepare("SELECT COUNT(*) AS n FROM post_queue WHERE user_id=? AND status IN ('pending','approved')").bind(t.id).first(),r=await e.env.DB.prepare("SELECT COUNT(*) AS n FROM post_logs WHERE user_id=? AND status='failed' AND DATE(created_at)=DATE('now','+9 hours')").bind(t.id).first(),{results:o}=await e.env.DB.prepare(`SELECT id, account_name, x_username, account_health_score, health_status, is_active
         ...
         ORDER BY pl.id DESC LIMIT 5`).bind(t.id).all();return ln({stats:{accounts:(s==null?void 0:s.n)??0,today:(n==null?void 0:n.n)??0,pending:(i==null?void 0:i.n)??0,failed:(r==null?void 0:r.n)??0},health:o||[],recentLogs:d||[]})}));H.get("/dashboard/target",m,async e=>K(e,"target",async({user:t,currentAccountId:a,hasAccount:s})=>{const n=String(a??"default"),i=await e.env.DB.prepare("SELECT * FROM target_templates WHERE account_id=? AND user_id=? LIMIT 1").bind(n,t.id).first();return cn({target:i,hasAccount:s,noAccountAlert:ge})}));H.get("/dashboard/voice",m,async e=>K(e,"voice",async({user:t,currentAccountId:a,hasAccount:s})=>{const n=String(a??"default"),i=await e.env.DB.prepare("SELECT * FROM brand_voice WHERE account_id=? AND user_id=? LIMIT 1").bind(n,t.id).first();return un({voice:i,hasAccount:s,noAccountAlert:ge})}));H.get("/dashboard/pattern",m,async e=>K(e,"pattern",async({user:t,hasAccount:a,currentAccountId:s,accounts:n})=>{const i=String(s??"default"),r=await e.env.DB.prepare("SELECT age_range, gender FROM target_templates WHERE account_id=? AND user_id=? LIMIT 1").bind(i,t.id).first(),o=await e.env.DB.prepare("SELECT tone FROM brand_voice WHERE account_id=? AND user_id=? LIMIT 1").bind(i,t.id).first(),d=n.find(l=>l.id===s);return pn({hasAccount:a,noAccountAlert:ge,target:r,voice:o,currentAcct:d})}));H.get("/dashboard/generate",m,async e=>K(e,"generate",({hasAccount:t})=>mn({hasAccount:t,noAccountAlert:ge})));H.get("/dashboard/posts",m,async e=>K(e,"posts",async({user:t,hasAccount:a})=>{const n=e.req.query("month")||new Date().toISOString().slice(0,7),[i,r]=n.split("-"),{results:o}=await e.env.DB.prepare(`SELECT pq.id, pq.body, pq.post_mode, pq.status, pq.account_id, xa.x_username
        ...
        ORDER BY pq.id DESC LIMIT 200`).bind(t.id,n).all(),d=(o||[]).length,l=(o||[]).filter(f=>f.status==="pending"||f.status==="approved").length,c=(o||[]).filter(f=>f.status==="posted").length,p=(o||[]).filter(f=>f.status==="failed").length;return fn({hasAccount:a,noAccountAlert:ge,month:n,y:i,m:parseInt(r,10),posts:o||[],stats:{total:d,pending:l,posted:c,failed:p}})}));H.get("/dashboard/thread",m,async e=>K(e,"thread",async({user:t,hasAccount:a})=>{const{results:s}=await e.env.DB.prepare(`SELECT pq.id, pq.body, pq.status, pq.posted_at, pq.created_at, pq.thread_parent_id
         FROM post_queue pq
        WHERE pq.user_id = ? AND pq.post_mode = 'thread' AND pq.thread_parent_id IS NOT NULL
        ORDER BY pq.id DESC LIMIT 30`).bind(t.id).all();return hn({hasAccount:a,noAccountAlert:ge,history:s||[]})}));H.get("/dashboard/scheduled",m,async e=>K(e,"scheduled",async({user:t,hasAccount:a})=>{const{results:s}=await e.env.DB.prepare(`SELECT pq.id, pq.body, pq.scheduled_at, pq.status, xa.x_username
         FROM post_queue pq LEFT JOIN x_accounts xa ON xa.id = pq.account_id
        WHERE pq.user_id = ? AND pq.scheduled_at IS NOT NULL
          AND pq.status NOT IN ('cancelled','rejected')
        ORDER BY pq.scheduled_at ASC LIMIT 100`).bind(t.id).all();return _n({hasAccount:a,noAccountAlert:ge})}));H.get("/dashboard/autopilot",m,async e=>K(e,"autopilot",async({user:t,hasAccount:a,accounts:s})=>{const{results:n}=await e.env.DB.prepare(`SELECT aj.*, xa.x_username FROM autopilot_jobs aj
         LEFT JOIN x_accounts xa ON xa.id = aj.account_id
        WHERE aj.user_id = ?
        ORDER BY COALESCE(aj.publish_at, aj.generate_at, aj.created_at) DESC LIMIT 50`).bind(t.id).all();return bn({hasAccount:a,noAccountAlert:ge,accounts:s,jobs:n||[]})}));H.get("/dashboard/accounts",m,async e=>K(e,"accounts",async({user:t})=>{const{results:a}=await e.env.DB.prepare(`SELECT id, account_name, x_username, account_health_score, health_status,
              daily_post_count, daily_post_limit, last_posted_at, is_active
         FROM x_accounts WHERE user_id = ? ORDER BY id DESC`).bind(t.id).all();return vn({accounts:a||[]})}));H.get("/dashboard/api",m,async e=>K(e,"api",async({user:t})=>{const{aesDecrypt:a}=await Promise.resolve().then(()=>Et),s=async _=>{const S=await e.env.DB.prepare("SELECT value FROM system_settings WHERE key=?").bind(_).first();if(!(S!=null&&S.value))return"";try{return await a(S.value,e.env.ENCRYPTION_KEY)}catch{return""}},n=await e.env.DB.prepare("SELECT api_key, api_secret FROM x_api_settings WHERE user_id = ? LIMIT 1").bind(t.id).first();let i="",r="";if(n!=null&&n.api_key)try{const _=await a(n.api_key,e.env.ENCRYPTION_KEY);i=_?_.slice(0,6)+"••••":""}catch{}if(n!=null&&n.api_secret)try{const _=await a(n.api_secret,e.env.ENCRYPTION_KEY);r=_?_.slice(0,4)+"••••":""}catch{}const o=await s("openai_api_key"),d=await s("openai_model"),l=await s("gemini_api_key"),c=await s("gemini_model"),p=await s("telegram_bot_token"),f=await s("telegram_chat_id");return xn({settings:{api_key:i,api_secret:r,openai_api_key:!!o,openai_model:d||"gpt-4o-mini",gemini_api_key:!!l,gemini_model:c||"gemini-1.5-flash",telegram_bot_token:!!p,telegram_chat_id:f||""}})}));H.get("/dashboard/export",m,async e=>K(e,"export",({user:t})=>yn({isAdmin:t.is_admin})));const P=new D;P.get("/admin",m,I,e=>{const t=`
...
<div class="warn">⚠️ ログイン後すぐにパスワードを変更してください<br>このURLは設定後も有効なため、token を知らない人には教えないでください</div>
     ...
     WHERE user_id = ?`).bind(t.id).run(),e.json({ok:!0})});_e.get("/api/subscription/payments",m,async e=>{const t=e.get("user"),{results:a}=await e.env.DB.prepare(`SELECT id, amount_jpy, currency, provider, external_id, status, plan_code, paid_at, created_at
      ...
      LIMIT 50`).bind(t.id).all();return e.json({payments:a||[]})});_e.post("/api/subscription/stripe/checkout",m,async e=>e.env.STRIPE_SECRET_KEY?e.json({error:"not_implemented_yet"},501):e.json({error:"stripe_not_configured"},501));_e.post("/api/subscription/webhook/stripe",async e=>e.json({received:!0}));const ta=new TextEncoder,wn="https://api.x.com/2";class F extends Error{constructor(a,s=0,n="api_error"){super(a);h(this,"statusCode");h(this,"errorType");this.name="XApiError",this.statusCode=s,this.errorType=n}}class qt extends F{constructor(a){super("Rate limited by X API (429)",429,"rate_limit");h(this,"resetAtEpoch");this.name="XApiRateLimitError",this.resetAtEpoch=a}}function le(e){return encodeURIComponent(e).replace(/[!'()*]/g,t=>"%"+t.charCodeAt(0).toString(16).toUpperCase())}function kn(e){const t=new Uint8Array(e);return crypto.getRandomValues(t),[...t].map(a=>a.toString(16).padStart(2,"0")).join("")}function Sn(){return kn(16)}async function Tn(e,t){const a=await crypto.subtle.importKey("raw",ta.encode(e),{name:"HMAC",hash:"SHA-1"},!1,["sign"]),s=await crypto.subtle.sign("HMAC",a,ta.encode(t)),n=new Uint8Array(s);let i="";for(let r=0;r<n.length;r++)i+=String.fromCharCode(n[r]);return btoa(i)}async function An(e,t,a,s){const n={oauth_consumer_key:a.consumerKey,oauth_nonce:Sn(),oauth_signature_method:"HMAC-SHA1",oauth_timestamp:Math.floor(Date.now()/1e3).toString(),oauth_token:a.accessToken,oauth_version:"1.0"},i=new URL(t),r={...n};i.searchParams.forEach((f,b)=>{r[b]=f});const o=Object.keys(r).sort().map(f=>`${le(f)}=${le(r[f])}`).join("&"),d=[e.toUpperCase(),le(`${i.origin}${i.pathname}`),le(o)].join("&"),l=`${le(a.consumerSecret)}&${le(a.accessTokenSecret)}`,c=await Tn(l,d);return n.oauth_signature=c,`OAuth ${Object.keys(n).sort().map(f=>`${le(f)}="${le(n[f])}"`).join(", ")}`}async function Ht(e,t,a,s){const n=`${wn}${t}`,i=await An(e,n,s),r={method:e,headers:{authorization:i,"content-type":"application/json"},signal:AbortSignal.timeout(3e4)};a!==void 0&&(r.body=JSON.stringify(a));const o=await fetch(n,r);if(o.status===429){const d=o.headers.get("x-rate-limit-reset");throw new qt(d?Number(d):void 0)}if(!o.ok){const d=await o.text();throw new F(`X API ${e} ${t} failed: ${o.status} ${d.slice(0,500)}`,o.status,"api_error")}return o.status===204?{}:o.json()}async function Wa(e,t){var s,n;const a=await Ht("POST","/tweets",{text:t},e);return{id:((s=a==null?void 0:a.data)==null?void 0:s.id)||"",text:((n=a==null?void 0:a.data)==null?void 0:n.text)||t}}async function za(e,t,a,s){var r,o;const n={text:t};a&&a.length&&(n.media={media_ids:a.slice(0,4)});const i=await Ht("POST","/tweets",n,e);return{id:((r=i==null?void 0:i.data)==null?void 0:r.id)||"",text:((o=i==null?void 0:i.data)==null?void 0:o.text)||t}}async function Dn(e){var a,s,n,i;if(!e)throw new F("credentials未設定",0,"missing_credentials");if(!((a=e.consumerKey)!=null&&a.trim()))throw new F("API Key未設定",0,"missing_credentials");if(!((s=e.consumerSecret)!=null&&s.trim()))throw new F("API Secret未設定",0,"missing_credentials");if(!((n=e.accessToken)!=null&&n.trim()))throw new F("Access Token未設定",0,"missing_token");if(!((i=e.accessTokenSecret)!=null&&i.trim()))throw new F("Access Token Secret未設定",0,"missing_token");const t=await Ht("GET","/users/me?user.fields=profile_image_url,public_metrics",void 0,e);return t==null?void 0:t.data}async function Ut(e,t,a){var o,d;const s=((a==null?void 0:a.apiKey)??e.X_API_KEY??"").trim(),n=((a==null?void 0:a.apiSecret)??e.X_API_SECRET??"").trim();if(!s||!n)throw new F("X API Key/Secret 未設定",0,"no_api_key");if(!((o=t==null?void 0:t.access_token)!=null&&o.trim()))throw new F("Access Token 未設定",0,"no_token");if(!((d=t==null?void 0:t.access_token_secret)!=null&&d.trim()))throw new F("Access Token Secret 未設定",0,"no_token_secret");let i,r;try{i=await et(t.access_token,e.ENCRYPTION_KEY)}catch{throw new F("Access Token の復号に失敗",0,"decrypt_failed")}try{r=await et(t.access_token_secret,e.ENCRYPTION_KEY)}catch{throw new F("Access Token Secret の復号に失敗",0,"decrypt_failed")}if(!i.trim())throw new F("Access Token が空",0,"decrypt_failed");if(!r.trim())throw new F("Access Token Secret が空",0,"decrypt_failed");return{consumerKey:s,consumerSecret:n,accessToken:i,accessTokenSecret:r}}async function aa(e,t){if(!e)return"";try{return await et(e,t)}catch{return""}}const be=new D;be.get("/api/admin/accounts",m,async e=>{const t=e.get("user"),{results:a}=await e.env.DB.prepare(`SELECT id, account_name, x_user_id, x_username,
...
3.なぜその数字か
4.読者が同じ結果を得る条件
5.CTA`}};async function Ja(e,t){var r,o,d;const a=t.model||"gpt-4o-mini",s=t.maxTokens||4e3,n=t.temperature??.7,i=t.baseUrl||"https://api.openai.com/v1";for(let l=1;l<=3;l++)try{const c=await fetch(`${i}/chat/completions`,{method:"POST",headers:{authorization:`Bearer ${t.apiKey}`,"content-type":"application/json"},body:JSON.stringify({model:a,messages:e,max_tokens:s,temperature:n}),signal:AbortSignal.timeout(12e4)});if(!c.ok){const f=await c.text();if(c.status>=500&&l<3){await new Promise(b=>setTimeout(b,2e3*l));continue}throw new Error(`OpenAI API error: ${c.status} ${f.slice(0,500)}`)}const p=await c.json();return((d=(o=(r=p==null?void 0:p.choices)==null?void 0:r[0])==null?void 0:o.message)==null?void 0:d.content)||""}catch(c){if(((c==null?void 0:c.name)==="TimeoutError"||(c==null?void 0:c.name)==="AbortError")&&l<3){await new Promise(f=>setTimeout(f,2e3*l));continue}throw c}return""}function Ka(e){let t=`以下のルールを厳守してX(Twitter)投稿文を生成してください。
...
追加指示: ${e.userInput}`);const i=t+s+a;return{messages:[{role:"system",content:i},{role:"user",content:n}],systemPrompt:i,userPrompt:n}}async function Va(e,t,a,s,n,i="body"){const{messages:r}=Ka({theme:t,keywords:a,brandVoice:n,targetDna:s,postMode:i||"body"}),o=await Ja(r,{apiKey:e,temperature:.8});return wt(o,i)}async function Xa(e,t,a,s,n,i,r="body"){if(!Ct[t])throw new Error(`未対応のパターン: ${t}`);const{messages:o}=Ka({theme:a,keywords:s,brandVoice:i,targetDna:n,patternType:t,postMode:r||"body"}),d=await Ja(o,{apiKey:e,temperature:.8});return wt(d,r)}function wt(e,t){if(!e)return"";let a=e.replace(/^#{1,4}\s*/gm,"").replace(/^[▪️■●•\-\*]+\s*/gm,"").replace(/^\d+\.\s/gm,"").replace(/^(Step\d+)[:\s]/gim,"").replace(/^[①②③④⑤⑥⑦⑧⑨⑩]\s*/gm,"・").replace(/\*\*([^*]+)\*\*/g,"$1").replace(/\n{3,}/g,`
...
`+l.trim());const ct=await De(M),Q=await e.env.DB.prepare(`INSERT INTO post_queue
     ...
     WHERE id=?`).bind(s,c,c,n?1:0,i,r?1:0,o,JSON.stringify(p),v(),a).run(),await Fn(e.env,d.id,d.account_id,p),e.json({success:!0,base_scheduled_at:s,effective_scheduled_at:c,scheduled_at:c,audit:p})});U.post("/api/admin/posts/:id/post-now",m,async e=>{const t=e.get("user"),a=parseInt(e.req.param("id"),10),s=(await e.req.json().catch(()=>({}))).force_override===!0,n=await e.env.DB.prepare("SELECT * FROM post_queue WHERE id=? AND user_id=?").bind(a,t.id).first();if(!n)return e.json({success:!1,error:"Not found"},404);let i=null;if(n.account_id&&(i=await e.env.DB.prepare("SELECT * FROM x_accounts WHERE id=? AND user_id=?").bind(n.account_id,t.id).first()),i||(i=await e.env.DB.prepare("SELECT * FROM x_accounts WHERE user_id=? AND is_active=1 ORDER BY id ASC LIMIT 1").bind(t.id).first(),i&&await e.env.DB.prepare("UPDATE post_queue SET account_id=? WHERE id=?").bind(i.id,a).run()),!i)return e.json({success:!1,error:"No active X account"});const r=await es(e.env,i.id,n.body||"",n.link_url,n.hashtags),o=r.errors.filter(d=>!(s&&d.overridable));if(o.length>0){const d=r.errors.find(l=>l.overridable);return d&&!s?e.json({success:!1,error:d.message,overridable:!0,cooldown_override:!0}):e.json({success:!1,error:"Safety: "+o.map(l=>l.message).join("; ")})}if(!await Za(e.env,i.id))return e.json({success:!1,error:"Account busy"});try{await e.env.DB.prepare("UPDATE post_queue SET status='publishing', updated_at=? WHERE id=?").bind(v(),a).run();const d=await Ut(e.env,i);let l=wt(n.body||"",n.post_mode);n.link_url&&(l+=`
`+n.link_url),n.hashtags&&(l+=`
`+n.hashtags);const c=[];if(n.media_json)try{const f=JSON.parse(n.media_json);for(const b of(f||[]).slice(0,4)){const _=await e.env.DB.prepare("SELECT * FROM media_assets WHERE id=? AND user_id=?").bind(b,t.id).first();_!=null&&_.x_media_id&&c.push(_.x_media_id)}}catch{}const p=c.length>0?await za(d,l,c,null):await Wa(d,l);return await e.env.DB.prepare("UPDATE post_queue SET status='posted', external_post_id=?, posted_at=?, updated_at=? WHERE id=?").bind(p.id||"",v(),v(),a).run(),await e.env.DB.prepare(`UPDATE x_accounts SET last_posted_at=?, daily_post_count=daily_post_count+1,
         last_daily_reset_date = DATE('now','+9 hours'), updated_at=? WHERE id=?`).bind(v(),v(),i.id).run(),await oa(e.env,{record_id:a,account_id:i.id,user_id:t.id,account_name:i.account_name,source_type:n.source_type||"manual_post",generation_type:n.generation_type,post_mode:n.post_mode,content:n.body||"",content_hash:n.content_hash||"",link_url:n.link_url,posted_at:v(),status:"posted",api_response_summary:JSON.stringify({tweet_id:p.id})}),await ra(e.env,`X posted @${i.x_username||i.account_name} ID:${p.id}`),e.json({success:!0,tweet_id:p.id})}catch(d){return await e.env.DB.prepare("UPDATE post_queue SET status='failed', error_message=?, updated_at=? WHERE id=?").bind(d.message,v(),a).run(),await oa(e.env,{record_id:a,account_id:i.id,user_id:t.id,account_name:i.account_name,source_type:n.source_type,post_mode:n.post_mode,content:n.body||"",content_hash:n.content_hash||"",status:"failed",error_message:d.message}),d instanceof qt?await bt(e.env,i.id,"rate_limit",-15):await bt(e.env,i.id,"error",-5,{message:d.message}),await ra(e.env,`X post FAILED #${a} ${d.message}`),e.json({success:!1,error:d.message})}finally{await Qa(e.env,i.id)}});U.put("/api/admin/posts/:id",m,async e=>{const t=e.get("user"),a=parseInt(e.req.param("id"),10),s=await e.req.json(),n=v(),i=s.body?await De(s.body):null;return s.media_json!==void 0&&s.body===void 0?(await e.env.DB.prepare("UPDATE post_queue SET media_json=?, updated_at=? WHERE id=? AND user_id=?").bind(s.media_json,n,a,t.id).run(),e.json({success:!0})):s.account_id!==void 0&&s.body===void 0?(await e.env.DB.prepare("UPDATE post_queue SET account_id=?, updated_at=? WHERE id=? AND user_id=?").bind(s.account_id,n,a,t.id).run(),e.json({success:!0})):(await e.env.DB.prepare(`UPDATE post_queue SET
     ...
     VALUES ('x', ?, ?, ?, ?, 'thread', ?, ?, 'manual_post', 'pending', ?, ?)`).bind(t.id,n??null,a[0].body,a[0].link_url??s??null,a.length,r,i,i).run()).meta.last_row_id,l=[d];for(let c=1;c<a.length;c++){const p=await De(a[c].body),f=await e.env.DB.prepare(`INSERT INTO post_queue
       ...
       VALUES ('x', ?, ?, ?, ?, 'thread', ?, ?, ?, 'manual_post', 'pending', ?, ?)`).bind(t.id,n??null,a[c].body,a[c].link_url??null,d,c,p,i,i).run();l.push(f.meta.last_row_id)}return e.json({success:!0,parent_id:d,ids:l})});const ts=new D,zn=5;ts.post("/cron/tick",async e=>{const t=v(),{results:a}=await e.env.DB.prepare(`SELECT * FROM post_queue
      WHERE platform='x'
      ...
      LIMIT ?`).bind(zn).all();let s=0,n=0,i=0;for(const r of a||[]){const o=await e.env.DB.prepare("UPDATE post_queue SET status='publishing', updated_at=? WHERE id=? AND status IN ('pending','approved')").bind(t,r.id).run();if(!(!o.success||o.meta.changes===0)){s++;try{if(!r.account_id)throw new Error("account_id is null");const d=await e.env.DB.prepare("SELECT * FROM x_accounts WHERE id=?").bind(r.account_id).first();if(!d)throw new Error("account_not_found");const l=await es(e.env,d.id,r.body||"",r.link_url,r.hashtags);if(!l.ok)throw new Error("safety: "+l.errors.map(c=>c.message).join("; "));if(!await Za(e.env,d.id))throw new Error("account_busy");try{const c=await Ut(e.env,d);let p=wt(r.body||"",r.post_mode);r.link_url&&(p+=`
`+r.link_url),r.hashtags&&(p+=`
`+r.hashtags);const f=[];if(r.media_json)try{const _=JSON.parse(r.media_json);for(const S of(_||[]).slice(0,4)){const E=await e.env.DB.prepare("SELECT x_media_id FROM media_assets WHERE id=?").bind(S).first();E!=null&&E.x_media_id&&f.push(E.x_media_id)}}catch{}const b=f.length>0?await za(c,p,f,null):await Wa(c,p);await e.env.DB.prepare("UPDATE post_queue SET status='posted', external_post_id=?, posted_at=?, updated_at=? WHERE id=?").bind(b.id||"",v(),v(),r.id).run(),await e.env.DB.prepare(`UPDATE x_accounts SET
             last_posted_at = ?,
             ...
             updated_at = ?
           WHERE id = ?`).bind(v(),v(),d.id).run(),await e.env.DB.prepare(`INSERT INTO post_logs
           ...
           VALUES (?, ?, ?, ?, 'x', ?, ?, ?, ?, ?, ?, ?, ?, 'posted', ?)`).bind(r.id,d.id,r.user_id,d.account_name,r.source_type,r.generation_type,r.post_mode,r.body||"",r.content_hash||"",r.link_url||"",v(),v(),JSON.stringify({tweet_id:b.id})).run(),await e.env.DB.prepare(`INSERT INTO kpi_metrics (account_id, user_id, metric_date, posts_sent)
           VALUES (?, ?, date('now','+9 hours'), 1)
           ON CONFLICT(account_id, metric_date) DO UPDATE SET
             posts_sent = posts_sent + 1,
             updated_at = datetime('now','+9 hours')`).bind(d.id,r.user_id).run(),n++}finally{await Qa(e.env,d.id)}}catch(d){const l=(d==null?void 0:d.message)||"unknown_error";await e.env.DB.prepare("UPDATE post_queue SET status='failed', error_message=?, updated_at=? WHERE id=?").bind(l,v(),r.id).run(),await e.env.DB.prepare(`INSERT INTO post_logs
           (record_id, account_id, user_id, platform, source_type, post_mode, content, content_hash,
            status, error_message, executed_at)
         VALUES (?, ?, ?, 'x', ?, ?, ?, ?, 'failed', ?, ?)`).bind(r.id,r.account_id,r.user_id,r.source_type,r.post_mode,r.body||"",r.content_hash||"",l,v()).run(),r.account_id&&(d instanceof qt?await bt(e.env,r.account_id,"rate_limit",-15):await bt(e.env,r.account_id,"error",-5,{message:l})),r.account_id&&await e.env.DB.prepare(`INSERT INTO kpi_metrics (account_id, user_id, metric_date, posts_failed)
           VALUES (?, ?, date('now','+9 hours'), 1)
           ON CONFLICT(account_id, metric_date) DO UPDATE SET
     ...
     ON CONFLICT(id) DO UPDATE SET json_data=excluded.json_data, updated_at=excluded.updated_at`).bind(JSON.stringify(t)).run(),e.json({success:!0,topic_count:t.topics.length}))});We.post("/api/admin/chatbot",m,async e=>{var r,o,d;const t=e.get("user"),{message:a}=await e.req.json();if(!a)return e.json({reply:"メッセージが空です"},400);const s=await e.env.DB.prepare("SELECT value FROM system_settings WHERE key=?").bind("openai_api_key_"+t.id).first();if(!(s!=null&&s.value))return e.json({reply:"OpenAI APIキーが設定されていません。API設定ページから設定してください。"});const{decryptValue:n}=await Promise.resolve().then(()=>Et),i=await n(s.value,e.env.ENCRYPTION_KEY);try{const p=((d=(o=(r=(await(await fetch("https://api.openai.com/v1/chat/completions",{method:"POST",headers:{"Content-Type":"application/json",Authorization:"Bearer "+i},body:JSON.stringify({model:e.env.OPENAI_MODEL||"gpt-4o-mini",messages:[{role:"system",content:"あなたはGrowth-engine365XのAIアシスタントです。X(Twitter)の投稿戦略、AI生成、オートパイロット設定について日本語で簡潔にアドバイスしてください。"},{role:"user",content:a}],max_tokens:500})})).json()).choices)==null?void 0:r[0])==null?void 0:o.message)==null?void 0:d.content)||"応答を取得できませんでした";return e.json({reply:p})}catch(l){return e.json({reply:"AI応答エラー: "+l.message})}});const dt=new D;dt.get("/api/admin/drafts",m,async e=>{const t=e.get("user"),{results:a}=await e.env.DB.prepare(`SELECT id, account_id, title, body, link_url, hashtags, post_mode, created_at, updated_at
...
`)}function Y(e,t){return new Response(e,{headers:{"content-type":"text/csv; charset=utf-8","content-disposition":`attachment; filename="${t}"`,"cache-control":"no-store"}})}function as(e,t){return new Response(JSON.stringify(e,null,2),{headers:{"content-type":"application/json; charset=utf-8","content-disposition":`attachment; filename="${t}"`,"cache-control":"no-store"}})}function q(){const e=new Date,t=a=>String(a).padStart(2,"0");return`${e.getFullYear()}${t(e.getMonth()+1)}${t(e.getDate())}_${t(e.getHours())}${t(e.getMinutes())}`}N.get("/api/admin/export/posts",m,async e=>{const t=e.get("user"),a=e.req.query("status"),s=e.req.query("month");let n="WHERE pq.platform='x' AND pq.user_id = ?";const i=[t.id];a&&a!=="all"&&(n+=" AND pq.status = ?",i.push(a)),s&&(n+=" AND strftime('%Y-%m', COALESCE(pq.posted_at, pq.scheduled_at, pq.created_at)) = ?",i.push(s));const{results:r}=await e.env.DB.prepare(`SELECT pq.id, pq.body, pq.link_url, pq.hashtags, pq.post_mode, pq.status,
       ...
       WHERE aj.user_id = ?
       ORDER BY aj.id DESC LIMIT 10000`).bind(t.id).all(),n=z(["id","reservation_no","account_id","account_name","x_username","channel_type","content_mode","theme","keywords","prompt_text","title_memo","link_url","generate_at","publish_at","status","generated_post_id","external_post_id","error_message","created_at","updated_at"],a||[]);return Y(n,`ge365x_autopilot_${q()}.csv`)});N.get("/api/admin/export/drafts",m,async e=>{const t=e.get("user"),{results:a}=await e.env.DB.prepare(`SELECT id, account_id, title, body, link_url, hashtags, post_mode, created_at, updated_at
       FROM drafts WHERE user_id = ? ORDER BY id DESC LIMIT 5000`).bind(t.id).all(),n=z(["id","account_id","title","body","link_url","hashtags","post_mode","created_at","updated_at"],a||[]);return Y(n,`ge365x_drafts_${q()}.csv`)});N.get("/api/admin/export/kpi",m,async e=>{const t=e.get("user"),{results:a}=await e.env.DB.prepare(`SELECT km.id, km.account_id, xa.account_name, xa.x_username,
       ...
       WHERE km.user_id = ?
       ORDER BY km.metric_date DESC, km.account_id ASC LIMIT 10000`).bind(t.id).all(),n=z(["id","account_id","account_name","x_username","metric_date","posts_sent","posts_failed","impressions","engagements","followers_gained","created_at","updated_at"],a||[]);return Y(n,`ge365x_kpi_${q()}.csv`)});N.get("/api/admin/export/accounts",m,async e=>{const t=e.get("user"),{results:a}=await e.env.DB.prepare(`SELECT id, account_name, x_user_id, x_username,
            daily_post_count, daily_post_limit, last_posted_at,
            account_health_score, health_status, is_active, is_current,
            last_daily_reset_date, created_at, updated_at
       FROM x_accounts WHERE user_id = ? ORDER BY id DESC`).bind(t.id).all(),n=z(["id","account_name","x_user_id","x_username","daily_post_count","daily_post_limit","last_posted_at","account_health_score","health_status","is_active","is_current","last_daily_reset_date","created_at","updated_at"],a||[]);return Y(n,`ge365x_accounts_${q()}.csv`)});N.get("/api/admin/export/targets",m,async e=>{const t=e.get("user"),{results:a}=await e.env.DB.prepare(`SELECT id, account_id, template_key, label, age_range, gender, genre, occupation,
            pains, desires, purchase_triggers, problem, goal, knowledge, is_default
       FROM target_templates WHERE user_id = ? ORDER BY id DESC`).bind(t.id).all(),n=z(["id","account_id","template_key","label","age_range","gender","genre","occupation","pains","desires","purchase_triggers","problem","goal","knowledge","is_default"],a||[]);return Y(n,`ge365x_targets_${q()}.csv`)});N.get("/api/admin/export/voices",m,async e=>{const t=e.get("user"),{results:a}=await e.env.DB.prepare(`SELECT id, account_id, voice_key, label, tone, worldview, personal_story,
            prohibited_words, sample_posts, is_default
       FROM brand_voice WHERE user_id = ? ORDER BY id DESC`).bind(t.id).all(),n=z(["id","account_id","voice_key","label","tone","worldview","personal_story","prohibited_words","sample_posts","is_default"],a||[]);return Y(n,`ge365x_voices_${q()}.csv`)});N.get("/api/admin/export/all",m,async e=>{const t=e.get("user"),a=t.id,[s,n,i,r,o,d,l,c,p]=await Promise.all([e.env.DB.prepare(`SELECT pq.*, xa.account_name, xa.x_username
         FROM post_queue pq LEFT JOIN x_accounts xa ON pq.account_id = xa.id
       ...
       FROM auth_logs ORDER BY id DESC LIMIT 10000`).all(),s=z(["id","user_id","email","event_type","ip_address","user_agent","metadata","created_at"],t||[]);return Y(s,`ge365x_admin_audit_${q()}.csv`)});N.get("/api/admin/export/admin/all",m,I,async e=>{const[t,a,s,n,i,r,o]=await Promise.all([e.env.DB.prepare(`SELECT id, email, is_approved, is_admin, trial_start, trial_end, created_at, updated_at
         ...
         FROM x_accounts ORDER BY id DESC LIMIT 10000`).all()]),d={exported_at:new Date().toISOString(),users:t.results||[],user_subscriptions:a.results||[],licenses:s.results||[],auth_logs:n.results||[],post_queue:i.results||[],post_logs:r.results||[],x_accounts:o.results||[]};return as(d,`ge365x_admin_all_${q()}.json`)});const T=new D;T.use("/static/*",Xs({root:"./",manifest:{}}));T.get("/healthz",e=>e.json({ok:!0,service:"ge365x-web",time:new Date().toISOString()}));T.route("/",Ca);T.route("/",H);T.route("/",P);T.route("/",te);T.route("/",_e);T.route("/",be);T.route("/",U);T.route("/",ts);T.route("/",ve);T.route("/",We);T.route("/",dt);T.route("/",lt);T.route("/",zt);T.route("/",kt);T.route("/",St);T.route("/",Tt);T.route("/",Ie);T.route("/",N);T.notFound(e=>e.json({error:"not_found",path:e.req.path},404));T.onError((e,t)=>(console.error("[ge365x-web] error:",e),t.json({error:"internal_error",message:e.message},500)));const Yn={fetch:T.fetch,async scheduled(e,t,a){const s=e.cron;(!s||s==="*/1 * * * *")&&a.waitUntil(T.fetch(new Request("https://internal/cron/tick",{method:"POST"}),t,a).catch(n=>console.error("[tick]",n))),s==="*/5 * * * *"&&a.waitUntil(T.fetch(new Request("https://internal/cron/autopilot-tick",{method:"POST"}),t,a).catch(n=>console.error("[autopilot-tick]",n)))}},ca=new D,Jn=Object.assign({"/src/index.tsx":Yn});let ss=!1;for(const[,e]of Object.entries(Jn))e&&(ca.all("*",t=>{let a;try{a=t.executionCtx}catch{}return e.fetch(t.req.raw,t.env,a)}),ca.notFound(t=>{let a;try{a=t.executionCtx}catch{}return e.fetch(t.req.raw,t.env,a)}),ss=!0);if(!ss)throw new Error("Can't import modules from ['/src/index.ts','/src/index.tsx','/app/server.ts']");export{ca as default};
